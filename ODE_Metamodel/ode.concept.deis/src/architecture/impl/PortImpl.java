 ...
 * </p>
 * <ul>
 *   <li>{@link architecture.impl.PortImpl#getFlowType <em>Flow Type</em>}</li>
 *   <li>{@link architecture.impl.PortImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link architecture.impl.PortImpl#getInterfaceFailures <em>Interface Failures</em>}</li>
 *   <li>{@link architecture.impl.PortImpl#getRefinedPorts <em>Refined Ports</em>}</li>
 *   <li>{@link architecture.impl.PortImpl#getAssuranceLevel <em>Assurance Level</em>}</li>
 *   <li>{@link architecture.impl.PortImpl#getDependabilityRequirements <em>Dependability Requirements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PortImpl extends BaseElementImpl implements Port {
	...
	protected EClass eStaticClass() {
		return Architecture_Package.Literals.PORT;
	}
	...
	public void setFlowType(String newFlowType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PORT__FLOW_TYPE, oldFlowType, flowType));
	}
	...
	public void setDirection(PortDirection newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PORT__DIRECTION, oldDirection, direction));
	}
	...
	public EList<Failure> getInterfaceFailures() {
		if (interfaceFailures == null) {
			interfaceFailures = new EObjectResolvingEList<Failure>(Failure.class, this, Architecture_Package.PORT__INTERFACE_FAILURES);
		}
	...
	public EList<Port> getRefinedPorts() {
		if (refinedPorts == null) {
			refinedPorts = new EObjectResolvingEList<Port>(Port.class, this, Architecture_Package.PORT__REFINED_PORTS);
		}
		return refinedPorts;
	}
	...
	public AssuranceLevel getAssuranceLevel() {
		if (assuranceLevel != null && assuranceLevel.eIsProxy()) {
			...
			if (assuranceLevel != oldAssuranceLevel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Architecture_Package.PORT__ASSURANCE_LEVEL, oldAssuranceLevel, assuranceLevel));
			}
		}
	...
	public void setAssuranceLevel(AssuranceLevel newAssuranceLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PORT__ASSURANCE_LEVEL, oldAssuranceLevel, assuranceLevel));
	}
	...
	public EList<DependabilityRequirement> getDependabilityRequirements() {
		if (dependabilityRequirements == null) {
			dependabilityRequirements = new EObjectResolvingEList<DependabilityRequirement>(DependabilityRequirement.class, this, Architecture_Package.PORT__DEPENDABILITY_REQUIREMENTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Architecture_Package.PORT__FLOW_TYPE:
				return getFlowType();
			case Architecture_Package.PORT__DIRECTION:
				return getDirection();
			case Architecture_Package.PORT__INTERFACE_FAILURES:
				return getInterfaceFailures();
			case Architecture_Package.PORT__REFINED_PORTS:
				return getRefinedPorts();
			case Architecture_Package.PORT__ASSURANCE_LEVEL:
				if (resolve) return getAssuranceLevel();
				return basicGetAssuranceLevel();
			case Architecture_Package.PORT__DEPENDABILITY_REQUIREMENTS:
