 ...
 * </p>
 * <ul>
 *   <li>{@link architecture.impl.PerfCharsImpl#getResponseTime <em>Response Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PerfCharsImpl extends BaseElementImpl implements PerfChars {
	...
	protected EClass eStaticClass() {
		return Architecture_Package.Literals.PERF_CHARS;
	}
	...
	public void setResponseTime(double newResponseTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PERF_CHARS__RESPONSE_TIME, oldResponseTime, responseTime));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Architecture_Package.PERF_CHARS__RESPONSE_TIME:
