 ...
 * @generated
 */
public class Architecture_PackageImpl extends EPackageImpl implements Architecture_Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see architecture.Architecture_Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Architecture_PackageImpl() {
		super(eNS_URI, Architecture_Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Architecture_Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Architecture_Package init() {
		if (isInited) return (Architecture_Package)EPackage.Registry.INSTANCE.getEPackage(Architecture_Package.eNS_URI);

		// Obtain or create and register package
		Architecture_PackageImpl theArchitecture_Package = (Architecture_PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Architecture_PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Architecture_PackageImpl());
		...
		theArchitecture_Package.createPackageContents();

		// Initialize created meta-data
		theArchitecture_Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theArchitecture_Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Architecture_Package.eNS_URI, theArchitecture_Package);
		return theArchitecture_Package;
	}
	 ...
	 * @generated
	 */
	public Architecture_Factory getArchitecture_Factory() {
		return (Architecture_Factory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		designPackageEClass.getESuperTypes().add(theIntegration_Package.getODEProductPackage());
		...
		initEAttribute(getSystem_OverallLifetime(), ecorePackage.getEDouble(), "overallLifetime", null, 0, 1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_OverallLifetimeTimeUnit(), theOdeBasePackage.getTimeUnit(), "overallLifetimeTimeUnit", "Hour", 0, 1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_SystemBoundaries(), this.getSystemBoundary(), null, "systemBoundaries", null, 1, -1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Contexts(), this.getContext(), null, "contexts", null, 0, -1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Configurations(), this.getConfiguration(), null, "configurations", null, 0, -1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Signals(), this.getSignal(), null, "signals", null, 0, -1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Ports(), this.getPort(), null, "ports", null, 0, -1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_SubSystems(), this.getSystem(), null, "subSystems", null, 0, -1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_RealisedFunctions(), this.getFunction(), null, "realisedFunctions", null, 0, -1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_AsAsset(), theDependability_Package.getAsset(), null, "asAsset", null, 0, 1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_DependabilityRequirements(), theDependability_Package.getDependabilityRequirement(), null, "dependabilityRequirements", null, 0, -1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_AssuranceLevel(), theDependability_Package.getAssuranceLevel(), null, "assuranceLevel", null, 0, 1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_AppliedStandards(), theDependability_Package.getStandard(), null, "appliedStandards", null, 0, -1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_FailureModels(), theFailureLogic_Package.getFailureModel(), null, "failureModels", null, 0, -1, architecture.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
