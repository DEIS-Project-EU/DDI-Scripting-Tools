 ...
 * </p>
 * <ul>
 *   <li>{@link architecture.impl.PhysicalComponentImpl#getDimensions <em>Dimensions</em>}</li>
 *   <li>{@link architecture.impl.PhysicalComponentImpl#getPricePerUnit <em>Price Per Unit</em>}</li>
 *   <li>{@link architecture.impl.PhysicalComponentImpl#getMass <em>Mass</em>}</li>
 *   <li>{@link architecture.impl.PhysicalComponentImpl#getProtectionCategory <em>Protection Category</em>}</li>
 *   <li>{@link architecture.impl.PhysicalComponentImpl#getUsefulLifetime <em>Useful Lifetime</em>}</li>
 *   <li>{@link architecture.impl.PhysicalComponentImpl#getUsefulLifetimeTimeUnit <em>Useful Lifetime Time Unit</em>}</li>
 *   <li>{@link architecture.impl.PhysicalComponentImpl#getLifecycleConditions <em>Lifecycle Conditions</em>}</li>
 *   <li>{@link architecture.impl.PhysicalComponentImpl#getLogicalComponents <em>Logical Components</em>}</li>
 *   <li>{@link architecture.impl.PhysicalComponentImpl#getMaintenanceProcedure <em>Maintenance Procedure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PhysicalComponentImpl extends SystemImpl implements PhysicalComponent {
	...
	protected EClass eStaticClass() {
		return Architecture_Package.Literals.PHYSICAL_COMPONENT;
	}
	...
	public void setDimensions(String newDimensions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PHYSICAL_COMPONENT__DIMENSIONS, oldDimensions, dimensions));
	}
	...
	public void setPricePerUnit(int newPricePerUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PHYSICAL_COMPONENT__PRICE_PER_UNIT, oldPricePerUnit, pricePerUnit));
	}
	...
	public void setMass(double newMass) {
		...
		mass = newMass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PHYSICAL_COMPONENT__MASS, oldMass, mass));
	}
	...
	public void setProtectionCategory(int newProtectionCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PHYSICAL_COMPONENT__PROTECTION_CATEGORY, oldProtectionCategory, protectionCategory));
	}
	...
	public void setUsefulLifetime(double newUsefulLifetime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PHYSICAL_COMPONENT__USEFUL_LIFETIME, oldUsefulLifetime, usefulLifetime));
	}
	...
	public void setUsefulLifetimeTimeUnit(TimeUnit newUsefulLifetimeTimeUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PHYSICAL_COMPONENT__USEFUL_LIFETIME_TIME_UNIT, oldUsefulLifetimeTimeUnit, usefulLifetimeTimeUnit));
	}
	...
	public EList<LifecycleCondition> getLifecycleConditions() {
		if (lifecycleConditions == null) {
			lifecycleConditions = new EObjectContainmentEList<LifecycleCondition>(LifecycleCondition.class, this, Architecture_Package.PHYSICAL_COMPONENT__LIFECYCLE_CONDITIONS);
		}
	...
	public EList<LogicalComponent> getLogicalComponents() {
		if (logicalComponents == null) {
			logicalComponents = new EObjectResolvingEList<LogicalComponent>(LogicalComponent.class, this, Architecture_Package.PHYSICAL_COMPONENT__LOGICAL_COMPONENTS);
		}
	...
	public MaintenanceProcedure getMaintenanceProcedure() {
		if (maintenanceProcedure != null && maintenanceProcedure.eIsProxy()) {
			...
			if (maintenanceProcedure != oldMaintenanceProcedure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Architecture_Package.PHYSICAL_COMPONENT__MAINTENANCE_PROCEDURE, oldMaintenanceProcedure, maintenanceProcedure));
			}
		}
	...
	public void setMaintenanceProcedure(MaintenanceProcedure newMaintenanceProcedure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.PHYSICAL_COMPONENT__MAINTENANCE_PROCEDURE, oldMaintenanceProcedure, maintenanceProcedure));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Architecture_Package.PHYSICAL_COMPONENT__LIFECYCLE_CONDITIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Architecture_Package.PHYSICAL_COMPONENT__DIMENSIONS:
				return getDimensions();
			case Architecture_Package.PHYSICAL_COMPONENT__PRICE_PER_UNIT:
				return getPricePerUnit();
			case Architecture_Package.PHYSICAL_COMPONENT__MASS:
				return getMass();
			case Architecture_Package.PHYSICAL_COMPONENT__PROTECTION_CATEGORY:
				return getProtectionCategory();
			case Architecture_Package.PHYSICAL_COMPONENT__USEFUL_LIFETIME:
				return getUsefulLifetime();
			case Architecture_Package.PHYSICAL_COMPONENT__USEFUL_LIFETIME_TIME_UNIT:
				return getUsefulLifetimeTimeUnit();
			case Architecture_Package.PHYSICAL_COMPONENT__LIFECYCLE_CONDITIONS:
				return getLifecycleConditions();
			case Architecture_Package.PHYSICAL_COMPONENT__LOGICAL_COMPONENTS:
				return getLogicalComponents();
			case Architecture_Package.PHYSICAL_COMPONENT__MAINTENANCE_PROCEDURE:
