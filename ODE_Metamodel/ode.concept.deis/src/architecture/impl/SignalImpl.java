 ...
 * </p>
 * <ul>
 *   <li>{@link architecture.impl.SignalImpl#getFromPort <em>From Port</em>}</li>
 *   <li>{@link architecture.impl.SignalImpl#getToPort <em>To Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SignalImpl extends BaseElementImpl implements Signal {
	...
	protected EClass eStaticClass() {
		return Architecture_Package.Literals.SIGNAL;
	}
		...
		if (fromPort != null && fromPort.eIsProxy()) {
			...
			if (fromPort != oldFromPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Architecture_Package.SIGNAL__FROM_PORT, oldFromPort, fromPort));
			}
		}
		return fromPort;
	}
	...
	public void setFromPort(Port newFromPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.SIGNAL__FROM_PORT, oldFromPort, fromPort));
	}
	...
	public Port getToPort() {
		if (toPort != null && toPort.eIsProxy()) {
			...
			if (toPort != oldToPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Architecture_Package.SIGNAL__TO_PORT, oldToPort, toPort));
			}
		}
		return toPort;
	}
	...
	public void setToPort(Port newToPort) {
		...
		toPort = newToPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Architecture_Package.SIGNAL__TO_PORT, oldToPort, toPort));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Architecture_Package.SIGNAL__FROM_PORT:
				if (resolve) return getFromPort();
				return basicGetFromPort();
			case Architecture_Package.SIGNAL__TO_PORT:
