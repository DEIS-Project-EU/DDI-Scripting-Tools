 ...
 * </p>
 * <ul>
 *   <li>{@link dependability.impl.SafetyRequirementImpl#getFailureReactionTime <em>Failure Reaction Time</em>}</li>
 *   <li>{@link dependability.impl.SafetyRequirementImpl#getFailureDetectionTime <em>Failure Detection Time</em>}</li>
 *   <li>{@link dependability.impl.SafetyRequirementImpl#getFailureLatencyTime <em>Failure Latency Time</em>}</li>
 *   <li>{@link dependability.impl.SafetyRequirementImpl#isIsSafetyGoal <em>Is Safety Goal</em>}</li>
 *   <li>{@link dependability.impl.SafetyRequirementImpl#getHazards <em>Hazards</em>}</li>
 * </ul>
 *
 * @generated
 */
