 ...
 * </p>
 * <ul>
 *   <li>{@link dependability.impl.DependabilityPackageImpl#getMeasures <em>Measures</em>}</li>
 *   <li>{@link dependability.impl.DependabilityPackageImpl#getMeasureTypes <em>Measure Types</em>}</li>
 *   <li>{@link dependability.impl.DependabilityPackageImpl#getMaintenanceProcedures <em>Maintenance Procedures</em>}</li>
 *   <li>{@link dependability.impl.DependabilityPackageImpl#getHARAPackages <em>HARA Packages</em>}</li>
 *   <li>{@link dependability.impl.DependabilityPackageImpl#getRequirementPackages <em>Requirement Packages</em>}</li>
 *   <li>{@link dependability.impl.DependabilityPackageImpl#getDomainPackages <em>Domain Packages</em>}</li>
 *   <li>{@link dependability.impl.DependabilityPackageImpl#getTARAPackages <em>TARA Packages</em>}</li>
 * </ul>
 *
 * @generated
 */
