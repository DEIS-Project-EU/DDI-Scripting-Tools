 ...
 * </p>
 * <ul>
 *   <li>{@link dependability.impl.AttackImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link dependability.impl.AttackImpl#getFinancialCost <em>Financial Cost</em>}</li>
 *   <li>{@link dependability.impl.AttackImpl#getFinancialCostType <em>Financial Cost Type</em>}</li>
 *   <li>{@link dependability.impl.AttackImpl#getTimeRequired <em>Time Required</em>}</li>
 *   <li>{@link dependability.impl.AttackImpl#getTimeUnit <em>Time Unit</em>}</li>
 *   <li>{@link dependability.impl.AttackImpl#getDifficulty <em>Difficulty</em>}</li>
 *   <li>{@link dependability.impl.AttackImpl#getDetectability <em>Detectability</em>}</li>
 *   <li>{@link dependability.impl.AttackImpl#getViolations <em>Violations</em>}</li>
 *   <li>{@link dependability.impl.AttackImpl#getExploitedVulnerabilities <em>Exploited Vulnerabilities</em>}</li>
 * </ul>
 *
 * @generated
 */
