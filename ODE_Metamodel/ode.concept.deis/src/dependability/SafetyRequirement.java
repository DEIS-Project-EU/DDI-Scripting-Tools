 ...
 * </p>
 * <ul>
 *   <li>{@link dependability.SafetyRequirement#getFailureReactionTime <em>Failure Reaction Time</em>}</li>
 *   <li>{@link dependability.SafetyRequirement#getFailureDetectionTime <em>Failure Detection Time</em>}</li>
 *   <li>{@link dependability.SafetyRequirement#getFailureLatencyTime <em>Failure Latency Time</em>}</li>
 *   <li>{@link dependability.SafetyRequirement#isIsSafetyGoal <em>Is Safety Goal</em>}</li>
 *   <li>{@link dependability.SafetyRequirement#getHazards <em>Hazards</em>}</li>
 * </ul>
 *
 * @see dependability.Dependability_Package#getSafetyRequirement()
 * @model
 * @generated
 */
public interface SafetyRequirement extends DependabilityRequirement {
	 ...
	 * @see dependability.Dependability_Package#getSafetyRequirement_FailureReactionTime()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dependability.SafetyRequirement#getFailureReactionTime <em>Failure Reaction Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dependability.Dependability_Package#getSafetyRequirement_FailureDetectionTime()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dependability.SafetyRequirement#getFailureDetectionTime <em>Failure Detection Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dependability.Dependability_Package#getSafetyRequirement_FailureLatencyTime()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dependability.SafetyRequirement#getFailureLatencyTime <em>Failure Latency Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dependability.Dependability_Package#getSafetyRequirement_IsSafetyGoal()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dependability.SafetyRequirement#isIsSafetyGoal <em>Is Safety Goal</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dependability.Dependability_Package#getSafetyRequirement_Hazards()
	 * @model
	 * @generated
	 */
