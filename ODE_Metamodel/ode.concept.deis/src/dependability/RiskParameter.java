 ...
 * </p>
 * <ul>
 *   <li>{@link dependability.RiskParameter#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @see dependability.Dependability_Package#getRiskParameter()
 * @model
 * @generated
 */
public interface RiskParameter extends BaseElement {
	 ...
	 * @see dependability.Dependability_Package#getRiskParameter_Argument()
	 * @model
	 * @generated
	 */
	String getArgument();
	...
	/**
	 * Sets the value of the '{@link dependability.RiskParameter#getArgument <em>Argument</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
