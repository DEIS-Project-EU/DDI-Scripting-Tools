 ...
 * </p>
 * <ul>
 *   <li>{@link failureLogic.Cause#getCauseType <em>Cause Type</em>}</li>
 *   <li>{@link failureLogic.Cause#getFailure <em>Failure</em>}</li>
 * </ul>
 *
 * @see failureLogic.FailureLogic_Package#getCause()
 * @model
 * @generated
 */
public interface Cause extends BaseElement {
	 ...
	 * The literals are from the enumeration {@link failureLogic.CauseType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see failureLogic.FailureLogic_Package#getCause_CauseType()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link failureLogic.Cause#getCauseType <em>Cause Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see failureLogic.FailureLogic_Package#getCause_Failure()
	 * @model
	 * @generated
	 */
	Failure getFailure();
	...
	/**
	 * Sets the value of the '{@link failureLogic.Cause#getFailure <em>Failure</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
