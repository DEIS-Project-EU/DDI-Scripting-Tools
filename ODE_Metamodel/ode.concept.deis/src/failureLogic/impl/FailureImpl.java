 ...
 * </p>
 * <ul>
 *   <li>{@link failureLogic.impl.FailureImpl#getOriginType <em>Origin Type</em>}</li>
 *   <li>{@link failureLogic.impl.FailureImpl#getFailureClass <em>Failure Class</em>}</li>
 *   <li>{@link failureLogic.impl.FailureImpl#getFailureRate <em>Failure Rate</em>}</li>
 *   <li>{@link failureLogic.impl.FailureImpl#isIsCcf <em>Is Ccf</em>}</li>
 *   <li>{@link failureLogic.impl.FailureImpl#getFailureProbDistribution <em>Failure Prob Distribution</em>}</li>
 *   <li>{@link failureLogic.impl.FailureImpl#getCcfFailures <em>Ccf Failures</em>}</li>
 * </ul>
 *
 * @generated
 */
