...
public class FailureLogic_PackageImpl extends EPackageImpl implements FailureLogic_Package {
	 ...
	 * @see failureLogic.FailureLogic_Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static FailureLogic_Package init() {
		...
		Integration_Package.eINSTANCE.eClass();
	...
	public void initializePackageContents() {
		...
		failureLogicPackageEClass.getESuperTypes().add(theIntegration_Package.getODEProductPackage());
		...
		initEClass(fmeaEClass, failureLogic.FMEA.class, "FMEA", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFMEA_Type(), this.getFMEAType(), "type", null, 0, 1, failureLogic.FMEA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFMEA_Entries(), this.getFMEAEntry(), null, "entries", null, 0, -1, failureLogic.FMEA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
