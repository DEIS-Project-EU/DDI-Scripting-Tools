 ...
 * </p>
 * <ul>
 *   <li>{@link top.artifact.Event#getOccurence <em>Occurence</em>}</li>
 * </ul>
 *
 * @see top.artifact.Artifact_Package#getEvent()
 * @model
 * @generated
 */
public interface Event extends ArtifactAsset {
	 ...
	 * @see top.artifact.Artifact_Package#getEvent_Occurence()
	 * @model
	 * @generated
	 */
	Date getOccurence();
	...
	/**
	 * Sets the value of the '{@link top.artifact.Event#getOccurence <em>Occurence</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
