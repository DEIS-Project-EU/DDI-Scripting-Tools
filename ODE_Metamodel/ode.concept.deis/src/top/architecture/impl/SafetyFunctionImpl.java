 ...
 * </p>
 * <ul>
 *   <li>{@link top.architecture.impl.SafetyFunctionImpl#getObject <em>Object</em>}</li>
 *   <li>{@link top.architecture.impl.SafetyFunctionImpl#getBehavior <em>Behavior</em>}</li>
 *   <li>{@link top.architecture.impl.SafetyFunctionImpl#getSafeState <em>Safe State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SafetyFunctionImpl extends FunctionImpl implements SafetyFunction {
	...
	protected EClass eStaticClass() {
		return ArchitecturePackage.Literals.SAFETY_FUNCTION;
	}
	...
	public void setObject(String newObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.SAFETY_FUNCTION__OBJECT, oldObject, object));
	}
	...
	public void setBehavior(String newBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.SAFETY_FUNCTION__BEHAVIOR, oldBehavior, behavior));
	}
	...
	public void setSafeState(String newSafeState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.SAFETY_FUNCTION__SAFE_STATE, oldSafeState, safeState));
	}
