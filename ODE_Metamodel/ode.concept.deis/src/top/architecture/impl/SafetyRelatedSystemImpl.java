 ...
 * </p>
 * <ul>
 *   <li>{@link top.architecture.impl.SafetyRelatedSystemImpl#getSafeState <em>Safe State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SafetyRelatedSystemImpl extends SystemImpl implements SafetyRelatedSystem {
	...
	protected EClass eStaticClass() {
		return ArchitecturePackage.Literals.SAFETY_RELATED_SYSTEM;
	}
	...
	public void setSafeState(String newSafeState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.SAFETY_RELATED_SYSTEM__SAFE_STATE, oldSafeState, safeState));
	}
