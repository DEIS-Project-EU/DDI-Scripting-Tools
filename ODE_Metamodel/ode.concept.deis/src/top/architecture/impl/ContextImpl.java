 ...
 * </p>
 * <ul>
 *   <li>{@link top.architecture.impl.ContextImpl#getUsageHistory <em>Usage History</em>}</li>
 *   <li>{@link top.architecture.impl.ContextImpl#getMissionTime <em>Mission Time</em>}</li>
 *   <li>{@link top.architecture.impl.ContextImpl#getMissionTimeTimeUnit <em>Mission Time Time Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextImpl extends BaseElementImpl implements Context {
	...
	protected EClass eStaticClass() {
		return ArchitecturePackage.Literals.CONTEXT;
	}
	...
	public void setUsageHistory(String newUsageHistory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.CONTEXT__USAGE_HISTORY, oldUsageHistory, usageHistory));
	}
	...
	public void setMissionTime(double newMissionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.CONTEXT__MISSION_TIME, oldMissionTime, missionTime));
	}
	...
	public void setMissionTimeTimeUnit(TimeUnit newMissionTimeTimeUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.CONTEXT__MISSION_TIME_TIME_UNIT, oldMissionTimeTimeUnit, missionTimeTimeUnit));
	}
