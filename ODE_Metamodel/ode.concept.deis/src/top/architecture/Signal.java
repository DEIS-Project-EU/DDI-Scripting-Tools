 ...
 * </p>
 * <ul>
 *   <li>{@link top.architecture.Signal#getFromPort <em>From Port</em>}</li>
 *   <li>{@link top.architecture.Signal#getToPort <em>To Port</em>}</li>
 * </ul>
 *
 * @see top.architecture.ArchitecturePackage#getSignal()
 * @model
 * @generated
 */
public interface Signal extends BaseElement {
	 ...
	 * @see top.architecture.ArchitecturePackage#getSignal_FromPort()
	 * @model required="true"
	 * @generated
	 */
	Port getFromPort();
	...
	/**
	 * Sets the value of the '{@link top.architecture.Signal#getFromPort <em>From Port</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setToPort(Port)
	 * @see top.architecture.ArchitecturePackage#getSignal_ToPort()
	 * @model required="true"
	 * @generated
	 */
	Port getToPort();
	...
	/**
	 * Sets the value of the '{@link top.architecture.Signal#getToPort <em>To Port</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
