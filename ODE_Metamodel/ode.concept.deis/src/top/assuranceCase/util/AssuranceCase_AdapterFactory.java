/**
 */
package top.assuranceCase.util;
 ...
 * <!-- end-user-doc -->
 * @see top.assuranceCase.AssuranceCase_Package
 * @generated
 */
public class AssuranceCase_AdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public AssuranceCase_AdapterFactory() {
	 ...
	 * @generated
	 */
	protected AssuranceCase_Switch<Adapter> modelSwitch =
		new AssuranceCase_Switch<Adapter>() {
			@Override
			public Adapter caseAssuranceCasePackage(AssuranceCasePackage object) {
				return createAssuranceCasePackageAdapter();
			}
			@Override
			public Adapter caseAssuranceCasePackageBinding(AssuranceCasePackageBinding object) {
				return createAssuranceCasePackageBindingAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link top.assuranceCase.AssuranceCasePackage <em>Assurance Case Package</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link top.assuranceCase.AssuranceCasePackageBinding <em>Assurance Case Package Binding</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link top.assuranceCase.AssuranceCasePackageInterface <em>Assurance Case Package Interface</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
