...
public class ArgumentationPackageImpl extends EPackageImpl implements ArgumentationPackage {
	 ...
	 * @see top.argumentation.ArgumentationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		argumentationElementEClass.getESuperTypes().add(theBasePackage.getArtifactElement());
		...
		initEReference(getArgumentAsset_Content(), theBasePackage.getMultiLangString(), null, "content", null, 0, 1, ArgumentAsset.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getArtifactReference_ReferencedArtifactElement(), theBasePackage.getArtifactElement(), null, "referencedArtifactElement", null, 0, -1, ArtifactReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
