 ...
 * </p>
 * <ul>
 *   <li>{@link top.argumentation.impl.AssertedRelationshipImpl#isIsCounter <em>Is Counter</em>}</li>
 *   <li>{@link top.argumentation.impl.AssertedRelationshipImpl#getSource <em>Source</em>}</li>
 *   <li>{@link top.argumentation.impl.AssertedRelationshipImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link top.argumentation.impl.AssertedRelationshipImpl#getReasoning <em>Reasoning</em>}</li>
 *   <li>{@link top.argumentation.impl.AssertedRelationshipImpl#getRequies <em>Requies</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AssertedRelationshipImpl extends AssertionImpl implements AssertedRelationship {
	...
	public void setIsCounter(boolean newIsCounter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArgumentationPackage.ASSERTED_RELATIONSHIP__IS_COUNTER, oldIsCounter, isCounter));
	}
	...
	public ArgumentReasoning getReasoning() {
		if (reasoning != null && reasoning.eIsProxy()) {
			...
			if (reasoning != oldReasoning) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArgumentationPackage.ASSERTED_RELATIONSHIP__REASONING, oldReasoning, reasoning));
			}
		}
		return reasoning;
	}
	...
	public void setReasoning(ArgumentReasoning newReasoning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArgumentationPackage.ASSERTED_RELATIONSHIP__REASONING, oldReasoning, reasoning));
	}
	...
	public void setRequies(int newRequies) {
		...
		requies = newRequies;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArgumentationPackage.ASSERTED_RELATIONSHIP__REQUIES, oldRequies, requies));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ArgumentationPackage.ASSERTED_RELATIONSHIP__TARGET:
				return getTarget();
			case ArgumentationPackage.ASSERTED_RELATIONSHIP__REASONING:
