...
public class ArgumentationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArgumentationPackage.ARGUMENT_GROUP: {
			...
			case ArgumentationPackage.ARTIFACT_REFERENCE: {
			...
			case ArgumentationPackage.ASSERTED_ARTIFACT_SUPPORT: {
			...
			case ArgumentationPackage.ASSERTED_ARTIFACT_CONTEXT: {
