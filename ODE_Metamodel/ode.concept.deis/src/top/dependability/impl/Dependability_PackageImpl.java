...
public class Dependability_PackageImpl extends EPackageImpl implements Dependability_Package {
	 ...
	 * @see top.dependability.Dependability_Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		dependabilityPackageEClass.getESuperTypes().add(theIntegrationPackage.getODEProductPackage());
		haraPackageEClass.getESuperTypes().add(theIntegrationPackage.getODEProductPackage());
		...
		requirementPackageEClass.getESuperTypes().add(theIntegrationPackage.getODEProductPackage());
		...
		domainPackageEClass.getESuperTypes().add(theIntegrationPackage.getODEProductPackage());
		...
		taraPackageEClass.getESuperTypes().add(theIntegrationPackage.getODEProductPackage());
