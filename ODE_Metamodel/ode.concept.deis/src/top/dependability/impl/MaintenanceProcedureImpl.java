 ...
 * </p>
 * <ul>
 *   <li>{@link top.dependability.impl.MaintenanceProcedureImpl#getActivityDescription <em>Activity Description</em>}</li>
 *   <li>{@link top.dependability.impl.MaintenanceProcedureImpl#getTechnicalDescription <em>Technical Description</em>}</li>
 *   <li>{@link top.dependability.impl.MaintenanceProcedureImpl#getToolSpecification <em>Tool Specification</em>}</li>
 *   <li>{@link top.dependability.impl.MaintenanceProcedureImpl#getStaffNumber <em>Staff Number</em>}</li>
 *   <li>{@link top.dependability.impl.MaintenanceProcedureImpl#getStaffSkillLevel <em>Staff Skill Level</em>}</li>
 *   <li>{@link top.dependability.impl.MaintenanceProcedureImpl#getStaffTrainingDescription <em>Staff Training Description</em>}</li>
 * </ul>
 *
 * @generated
 */
