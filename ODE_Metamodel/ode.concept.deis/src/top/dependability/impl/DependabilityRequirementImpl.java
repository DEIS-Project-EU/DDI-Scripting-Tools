 ...
 * </p>
 * <ul>
 *   <li>{@link top.dependability.impl.DependabilityRequirementImpl#getDecompositionArgument <em>Decomposition Argument</em>}</li>
 *   <li>{@link top.dependability.impl.DependabilityRequirementImpl#getRefinedRequirements <em>Refined Requirements</em>}</li>
 *   <li>{@link top.dependability.impl.DependabilityRequirementImpl#getRequirementSource <em>Requirement Source</em>}</li>
 *   <li>{@link top.dependability.impl.DependabilityRequirementImpl#getMeasures <em>Measures</em>}</li>
 *   <li>{@link top.dependability.impl.DependabilityRequirementImpl#getFailures <em>Failures</em>}</li>
 *   <li>{@link top.dependability.impl.DependabilityRequirementImpl#getAssuranceLevel <em>Assurance Level</em>}</li>
 *   <li>{@link top.dependability.impl.DependabilityRequirementImpl#getMaintenanceProcedures <em>Maintenance Procedures</em>}</li>
 * </ul>
 *
 * @generated
 */
