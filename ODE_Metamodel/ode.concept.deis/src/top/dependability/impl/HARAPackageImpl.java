 ...
 * </p>
 * <ul>
 *   <li>{@link top.dependability.impl.HARAPackageImpl#getHazards <em>Hazards</em>}</li>
 *   <li>{@link top.dependability.impl.HARAPackageImpl#getHazardTypes <em>Hazard Types</em>}</li>
 *   <li>{@link top.dependability.impl.HARAPackageImpl#getHazardTypeSystems <em>Hazard Type Systems</em>}</li>
 *   <li>{@link top.dependability.impl.HARAPackageImpl#getMalfunctions <em>Malfunctions</em>}</li>
 *   <li>{@link top.dependability.impl.HARAPackageImpl#getRiskAssessments <em>Risk Assessments</em>}</li>
 *   <li>{@link top.dependability.impl.HARAPackageImpl#getRiskParameters <em>Risk Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
