 ...
 * </p>
 * <ul>
 *   <li>{@link top.dependability.impl.MeasureImpl#getIntrinsicSafety <em>Intrinsic Safety</em>}</li>
 *   <li>{@link top.dependability.impl.MeasureImpl#getSafeGuard <em>Safe Guard</em>}</li>
 *   <li>{@link top.dependability.impl.MeasureImpl#getApplierInformation <em>Applier Information</em>}</li>
 *   <li>{@link top.dependability.impl.MeasureImpl#isRiskAcceptability <em>Risk Acceptability</em>}</li>
 *   <li>{@link top.dependability.impl.MeasureImpl#getFurtherAction <em>Further Action</em>}</li>
 *   <li>{@link top.dependability.impl.MeasureImpl#getSource <em>Source</em>}</li>
 *   <li>{@link top.dependability.impl.MeasureImpl#getMeasureType <em>Measure Type</em>}</li>
 *   <li>{@link top.dependability.impl.MeasureImpl#getAssuranceLevel <em>Assurance Level</em>}</li>
 * </ul>
 *
 * @generated
 */
