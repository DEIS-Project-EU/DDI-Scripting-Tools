 ...
 * </p>
 * <ul>
 *   <li>{@link top.dependability.HazardTypeSystem#getHazardTypes <em>Hazard Types</em>}</li>
 * </ul>
 *
 * @see top.dependability.Dependability_Package#getHazardTypeSystem()
 * @model
 * @generated
 */
public interface HazardTypeSystem extends BaseElement {
	 ...
	 * @see top.dependability.Dependability_Package#getHazardTypeSystem_HazardTypes()
	 * @model
	 * @generated
	 */
