 ...
 * </p>
 * <ul>
 *   <li>{@link top.failureLogic.Gate#getGateType <em>Gate Type</em>}</li>
 *   <li>{@link top.failureLogic.Gate#getCauses <em>Causes</em>}</li>
 * </ul>
 *
 * @see top.failureLogic.FailureLogic_Package#getGate()
 * @model
 * @generated
 */
public interface Gate extends Cause {
	 ...
	 * The literals are from the enumeration {@link top.failureLogic.GateType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see top.failureLogic.FailureLogic_Package#getGate_GateType()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link top.failureLogic.Gate#getGateType <em>Gate Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see top.failureLogic.FailureLogic_Package#getGate_Causes()
	 * @model
	 * @generated
	 */
