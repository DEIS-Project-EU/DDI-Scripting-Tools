 ...
 * </p>
 * <ul>
 *   <li>{@link top.failureLogic.FMEAEntry#getEffect <em>Effect</em>}</li>
 *   <li>{@link top.failureLogic.FMEAEntry#getMode <em>Mode</em>}</li>
 * </ul>
 *
 * @see top.failureLogic.FailureLogic_Package#getFMEAEntry()
 * @model
 * @generated
 */
public interface FMEAEntry extends BaseElement {
	 ...
	 * @see top.failureLogic.FailureLogic_Package#getFMEAEntry_Effect()
	 * @model
	 * @generated
	 */
	Failure getEffect();
	...
	/**
	 * Sets the value of the '{@link top.failureLogic.FMEAEntry#getEffect <em>Effect</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setMode(Failure)
	 * @see top.failureLogic.FailureLogic_Package#getFMEAEntry_Mode()
	 * @model
	 * @generated
	 */
	Failure getMode();
	...
	/**
	 * Sets the value of the '{@link top.failureLogic.FMEAEntry#getMode <em>Mode</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
