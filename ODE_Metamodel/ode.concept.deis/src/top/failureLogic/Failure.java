 ...
 * </p>
 * <ul>
 *   <li>{@link top.failureLogic.Failure#getOriginType <em>Origin Type</em>}</li>
 *   <li>{@link top.failureLogic.Failure#getFailureClass <em>Failure Class</em>}</li>
 *   <li>{@link top.failureLogic.Failure#getFailureRate <em>Failure Rate</em>}</li>
 *   <li>{@link top.failureLogic.Failure#isIsCcf <em>Is Ccf</em>}</li>
 *   <li>{@link top.failureLogic.Failure#getFailureProbDistribution <em>Failure Prob Distribution</em>}</li>
 *   <li>{@link top.failureLogic.Failure#getCcfFailures <em>Ccf Failures</em>}</li>
 * </ul>
 *
 * @see top.failureLogic.FailureLogic_Package#getFailure()
 * @model
 * @generated
 */
public interface Failure extends BaseElement {
	 ...
	 * The literals are from the enumeration {@link top.failureLogic.FailureOriginType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see top.failureLogic.FailureLogic_Package#getFailure_OriginType()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link top.failureLogic.Failure#getOriginType <em>Origin Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see top.failureLogic.FailureLogic_Package#getFailure_FailureClass()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link top.failureLogic.Failure#getFailureClass <em>Failure Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see top.failureLogic.FailureLogic_Package#getFailure_FailureRate()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link top.failureLogic.Failure#getFailureRate <em>Failure Rate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see top.failureLogic.FailureLogic_Package#getFailure_IsCcf()
	 * @model
	 * @generated
	 */
	boolean isIsCcf();
	...
	/**
	 * Sets the value of the '{@link top.failureLogic.Failure#isIsCcf <em>Is Ccf</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see top.failureLogic.FailureLogic_Package#getFailure_FailureProbDistribution()
	...
	/**
	 * Sets the value of the '{@link top.failureLogic.Failure#getFailureProbDistribution <em>Failure Prob Distribution</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see top.failureLogic.FailureLogic_Package#getFailure_CcfFailures()
	 * @model
	 * @generated
	 */
