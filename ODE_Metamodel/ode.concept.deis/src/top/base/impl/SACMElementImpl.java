 ...
 * </p>
 * <ul>
 *   <li>{@link top.base.impl.SACMElementImpl#getGid <em>Gid</em>}</li>
 *   <li>{@link top.base.impl.SACMElementImpl#isIsCitation <em>Is Citation</em>}</li>
 *   <li>{@link top.base.impl.SACMElementImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link top.base.impl.SACMElementImpl#getCitedElement <em>Cited Element</em>}</li>
 *   <li>{@link top.base.impl.SACMElementImpl#getAbstractForm <em>Abstract Form</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SACMElementImpl extends ElementImpl implements SACMElement {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.SACM_ELEMENT;
	}
	...
	public void setGid(String newGid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.SACM_ELEMENT__GID, oldGid, gid));
	}
	...
	public void setIsCitation(boolean newIsCitation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.SACM_ELEMENT__IS_CITATION, oldIsCitation, isCitation));
	}
	...
	public void setIsAbstract(boolean newIsAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.SACM_ELEMENT__IS_ABSTRACT, oldIsAbstract, isAbstract));
	}
	...
	public SACMElement getCitedElement() {
		if (citedElement != null && citedElement.eIsProxy()) {
			...
			if (citedElement != oldCitedElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasePackage.SACM_ELEMENT__CITED_ELEMENT, oldCitedElement, citedElement));
			}
		}
		return citedElement;
	}
	...
	public void setCitedElement(SACMElement newCitedElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.SACM_ELEMENT__CITED_ELEMENT, oldCitedElement, citedElement));
	}
	...
	public SACMElement getAbstractForm() {
		if (abstractForm != null && abstractForm.eIsProxy()) {
			...
			if (abstractForm != oldAbstractForm) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasePackage.SACM_ELEMENT__ABSTRACT_FORM, oldAbstractForm, abstractForm));
			}
		}
		return abstractForm;
	}
	...
	public void setAbstractForm(SACMElement newAbstractForm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.SACM_ELEMENT__ABSTRACT_FORM, oldAbstractForm, abstractForm));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BasePackage.SACM_ELEMENT__IS_ABSTRACT:
				return isIsAbstract();
			case BasePackage.SACM_ELEMENT__CITED_ELEMENT:
				if (resolve) return getCitedElement();
				return basicGetCitedElement();
			case BasePackage.SACM_ELEMENT__ABSTRACT_FORM:
