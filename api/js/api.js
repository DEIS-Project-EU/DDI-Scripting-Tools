var apijson2 = {
  ...
  "GetID\r": {
    ...
    "comments\r": {
      "!text": "Generates a unique pseudo-random ID using java.util.Random <br>\r\nThe range is [0, MAX_ID], MAX_ID is a global Integer that should be defined by the user <br>\r\nThe user must also define a global ID_LIST Collection of existing IDs for checking the uniqueness \r"
    }
  },
  ...
  "BuildSystem(1)\r": {
    ...
    "comments\r": {
      "!text": "Builds a new System with given name and description, adds it to the context DesignPackage and returns it <br>\r\nThe built System is initialised with an ID using GetID()\r"
    }
  },
  "BuildSystem(2)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a new System with given name and description, adds it to the context DesignPackage and returns it <br>\r\nThe built System is initialised with an ID using GetID() <br>\r\nAdds the built System under the parentSystem's subSystems\r"
    }
  },
  "BuildFunction\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a new Function with given name and description, adds it to the context DesignPackage and returns it <br>\r\nThe built Function is initialised with an ID using GetID()\r"
    }
  },
  "BuildPort(1)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a new Port with given name and description, adds it to the context System's ports and returns it <br>\r\nThe built Port is initialised with an ID using GetID()\r"
    }
  },
  "BuildPort(2)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a new Port with given name and description, adds it to the context System's ports and returns it <br>\r\nThe built Port is initialised with an ID using GetID()\r\nAlso sets the Port's direction\r"
    }
  },
  "BuildPort(3)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a new Port with given name and description, adds it to the context Function's ports and returns it <br>\r\nThe built Port is initialised with an ID using GetID() <br>\r\nAlso sets the Port's direction\r"
    }
  },
  "SetDirection\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Sets the direction of the context Port <br>\r\n\"INOUT\" is assumed if the input does not match the other options\r"
    }
  },
  "BuildSignal(1)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Signal connecting two Ports, adding it under the context System's signals and returns it <br>\r\nThe built Signal is initialised with an ID using GetID()\r"
    }
  },
  "BuildSignal(2)\r": {
    "context\r": {
  ...
  "BuildFaultTree(1)\r": {
    ...
    "comments\r": {
      "!text": "Builds a FaultTree, adds it under the context FailureLogicPackage and returns it <br>\r\nThe built FaultTree is initialised with an ID using GetID()\r"
    }
  },
  "BuildFaultTree(2)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a FaultTree, adds it under the context FailureLogicPackage and the FailureModel and returns it <br>\r\nThe built FaultTree is initialised with an ID using GetID()\r"
    }
  },
  "BuildFailure\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Failure, adds it to the context FailureModel and returns it <br>\r\nThe Failure is initialised with an ID using GetID()\r"
    }
  },
  "BuildGate(1)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Gate, adds it to the context FaultTree and returns it <br>\r\nThe built Gate is initialised with an ID usign GetID()\r"
    }
  },
  "BuildGate(2)\r": {
    "context\r": {
  ...
  "BuildBasicEvent\r": {
    ...
    "comments\r": {
      "!text": "Builds a BasicEvent, adds it under the context FaultTree and returns it <br>\r\nThe built BasicEvent is initialised with an ID using GetID()\r"
    }
  },
  "BuildInputEvent\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Gate(InputEvent), adds it under the FaultTree and returns it <br>\r\nThe build Gate is initialised with an ID using GetID()\r"
    }
  },
  "BuildOutputEvent\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Gate(OutputEvent), adds it under the FaultTree and returns it <br>\r\nThe build Gate is initialised with an ID using GetID()\r"
    }
  },
  "SetOriginType\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Sets the Failure to the origin type (\"INPUT\", \"OUTPUT\", \"INTERNAL\") <br>\r\nSet by default to \"INTERNAL\" if the other options are not chosen instead\r"
    }
  },
  "SetGateType\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "The type (\"OR\", \"AND\", \"NOT\", \"XOR\", \"VOTE\", \"PAND\", \"SAND\", \"INPUT\", \"OUTPUT\") the context Gate should be set to <br>\r\nDefaults to \"OUTPUT\" if the other options are not chosen\r"
    }
  },
  "SetCauseType\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Sets the type of the context Cause to one of the mentioned options <br>\r\nIf no other options match, defaults to \"INTERNAL\"\r"
    }
  },
  "BuildHazardType\r": {
    "context": {
    ...
    "comments\r": {
      "!text": "Builds a HazardType, adds it to the HARAPackage and returns it <br>\r\nThe built HazardType is initialised with an ID using GetID()\r"
    }
  },
  "BuildHazard\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Hazard, adds it to the context HARAPackage and returns it <br>\r\nThe built Hazard is initialised with an ID using GetID() \r"
    }
  },
  "BuildMalfunction\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Malfunction, adds it to the context HARAPackage and returns it  <br>\r\nThe built Malfunction is initialised with an ID using GetID()\r"
    }
  },
  "SetName\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Sets the 'name' of a ModelElement; given ModelElements do not have an explicit 'name' property, <br>\r\nThe name is set as a LangString, added to the ModelElement. The LangString's lang is 'en' and its content is the name\r"
    }
  },
  "BuildLangString(1)\r": {
    "return-type\r": {
  ...
  "BuildLangString(2)\r": {
    ...
    "comments\r": {
      "!text": "Builds a LangString, adds it to the context MultiLangString <br>\r"
    }
  },
  "BuildTaggedValue\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a TaggedValue, adds it to the context ModelElement and returns it <br>\r\nNote that a MultiLangString does not have an explicit 'key' or 'value' property; <br>\r\nthe key is set as the lang of a LangString contained in the MultiLangString, the 'value' being the content <br>\r\nThe built TaggedValue is initialised with an ID using GetID() \r"
    }
  },
  "HasTaggedValue\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Searches across the context ModelElement's TaggedValues to find whether <br> \r\nthere is at least one with the same name as the parameter\r"
    }
  },
  ...
  "SetDescription\r": {
    ...
    "comments\r": {
      "!text": "Sets the context ModelElement's description\r"
    }
  },
  "BuildGoal(1)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Claim(Goal), adds it to the context ArgumentPackage and returns it <br>\r\nThe built Claim(Goal) is initialised with an ID using GetID()\r"
    }
  },
  "BuildGoal(2)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Claim(Goal), adds it to the context ArgumentPackage and returns it <br>\r\nThe built Claim(Goal) is initialised with an ID using GetID() <br>\r\nThis variant enables convenient construction of Claims(Goals) which have abstract descriptions, consisting of multiple LangString and ExpressionLangStrings\r"
    }
  },
  "BuildAssumption\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Claim(Assumption), with the assertionDeclaration property set to 'assumed' <br>\r\nAdds it to the context ArgumentPackage and returns it <br>\r\nThe built Claim(Assumption) is initialised with an ID using GetID()\r"
    }
  },
  "BuildJustification\r": {
    ...
    "comments\r": {
      "!text": "Builds a Claim(Justification), with the assertionDeclaration property set to 'axiomatic' <br>\r\nAdds it to the context ArgumentPackage and returns it <br>\r\nThe built Claim(Justification) is initialised with an ID using GetID()\r"
    }
  },
  "BuildStrategy(1)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds an AssertedInference(Strategy), adds it to the context ArgumentPackage and returns it <br>\r\nInternally builds an ArgumentReasoning, sets its name and description using the parameters and adds it to the AssertedInference(Strategy) <br>\r\nThe built AssertedInference(Strategy) is initialised with an ID using GetID()\r"
    }
  },
  "BuildStrategy(2)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds an AssertedInference(Strategy), adds it to the context ArgumentPackage and returns it <br>\r\nInternally builds an ArgumentReasoning, sets its name and description using the parameters and adds it to the AssertedInference(Strategy) <br>\r\nThe built AssertedInference(Strategy) is initialised with an ID using GetID() <br>\r\nThis variant allows convenient construction of AssertedInferences(Strategies) containing abstract descriptions, consisting of multiple LangString and ExpressionLangStrings\r"
    }
  },
  "BuildContext\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds an ArtifactReference(Context), adds it to the context ArgumentPackage and returns it <br>\r\nThe built ArtifactReference(Context) is initialised with an ID using GetID()\r"
    }
  },
  "BuildSolution\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds an ArtifactReference(Solution), adds it to the context ArgumentPackage and returns it <br>\r\nThe built ArtifactReference(Solution) is initialised with an ID using GetID()\r"
    }
  },
  "BuildArtifact\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds an Artifact, adds it to the context ArtifactPackage and returns it <br>\r\nThe built Artifact is initialised with an ID using GetID() <br>\r\nThe date is converted using java.util.Date for parsing the parameter\r"
    }
  },
  "BuildActivity\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds an Activity, adds it to the context ArtifactPackage and returns it <br>\r\nThe built Activity is initialised with an ID using GetID() <br>\r\nThe startTime and endTime are converted using java.util.Date for parsing the parameters\r"
    }
  },
  "BuildEvent\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds an Event, adds it to the context ArtifactPackage and returns it <br>\r\nThe built Event is initialised with an ID using GetID() <br>\r\nThe occurence is converted using java.util.Date for parsing the parameter\r"
    }
  },
  "LinkStrategyToContexts\r": {
    ...
    "comments\r": {
      "!text": "Links an AssertedInference(Strategy) to a Collection of ArtifactReferences(Contexts) by creating an AssertedContext <br>\r\nThe Strategy is the target of the AssertedContext, the linked Contexts are the source <br>\r\nThe created AssertedContext is initialised with an ID using GetID()\r"
    }
  },
  "LinkStrategyToContext\r": {
    ...
    "comments\r": {
      "!text": "Links an AssertedInference(Strategy) to an ArtifactReference(Context) by creating an AssertedContext <br>\r\nThe Strategy is the target of the AssertedContext, the linked Context is the source <br>\r\nThe created AssertedContext is initialised with an ID using GetID()\r"
    }
  },
  "LinkGoalToGoals(1)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Links a Claim(Goal) to a Collection of Claims(Goals) by creating an AssertedInference(Strategy) <br>\r\nThe Claim is the target of the AssertedInference, the Collection of Claims are the source <br>\r\nThe created AssertedInference is initialised with an ID using GetID()\r"
    }
  },
  "LinkGoalToGoals(2)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Links a Claim(Goal) to a Collection of Claims(Goals) by creating an AssertedInference(Strategy) <br>\r\nThe Claim is the target of the AssertedInference, the Collection of Claims are the source <br>\r\nThe created AssertedInference is initialised with an ID using GetID() <br>\r\nThis variation links the Claims(Goals) via an AssertedInference(Strategy) without a title or description\r"
    }
  },
  "LinkGoalToGoal\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Links a Claim(Goal) to a Claim(Goal) by creating an AssertedInference(Strategy) <br>\r\nThe Claim is the target of the AssertedInference, the subGoal Claim is the source <br>\r\nThe created AssertedInference is initialised with an ID using GetID()\r"
    }
  },
  "LinkGoalToEvidence(1)\r": {
    ...
    "comments\r": {
      "!text": "Links a Claim(Goal) to a Collection of ArtifactReferences(Evidence) by creating an AssertedEvidence <br>\r\nThe Claim is the target of the AssertedEvidence, the Collection of Evidence are the source <br>\r\nThe created AssertedEvidence is initialised with an ID using GetID()\r"
    }
  },
  "LinkGoalToEvidence(2)\r": {
    ...
    "comments\r": {
      "!text": "Links a Claim(Goal) to an ArtifactReference(Evidence) by creating an AssertedEvidence <br>\r\nThe Claim is the target of the AssertedEvidence, the Evidence is the source <br>\r\nThe created AssertedEvidence is initialised with an ID using GetID()\r"
    }
  },
  "LinkGoalToContexts\r": {
    ...
    "comments\r": {
      "!text": "Links a Claim(Goal) to a Collection of ArtifactReferences(Contexts) by creating an AssertedContext <br>\r\nThe Claim is the target of the AssertedContext, the Contexts are the source <br>\r\nThe created AssertedContext is initialised with an ID using GetID()\r"
    }
  },
  "LinkGoalToContext\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Links a Claim(Goal) to an ArtifactReference(Context) by creating an AssertedContext <br>\r\nThe Claim is the target of the AssertedContext, the Context is the source <br>\r\nThe created AssertedContext is initialised with an ID using GetID()\r"
    }
  },
  "LinkToArtifact\r": {
    "context\r": {
  ...
  "SetType\r": {
    ...
    "comments\r": {
      "!text": "Sets the context Term's type; since a Term does not have an explicit type, <br>\r\nthe type is set as the name of the Term using ModelElement::SetName\r"
    }
  },
  "GetType\r": {
    "context\r": {
  ...
  "BuildTerm(1)\r": {
    ...
    "comments\r": {
      "!text": "Builds a Term, adds it to the context TerminologyPackage and returns it <br>\r\nThe built Term is initialised with an ID using GetID() \r"
    }
  },
  "BuildTerm(2)\r": {
    "context\r": {
    ...
    "comments\r": {
      "!text": "Builds a Term, adds it to the context TerminologyPackage and returns it <br>\r\nThe built Term is initialised with an ID using GetID() <br>\r\nThis variation also sets the Term's value\r"
    }
  },
  "BuildExpression(1)\r": {
    "context\r": {
  ...
  "BuildExpression(2)\r": {
    ...
    "comments\r": {
      "!text": "Builds an Expression, adds it to the context TerminologyPackage and returns it <br>\r\nThe built Expression is initialised with an ID using GetID() <br>\r\nThis variation adds a Collection of ExpressionElements under the built Expression\r"
    }
  },
  "BuildExpression(3)\r": {
    "context\r": {
