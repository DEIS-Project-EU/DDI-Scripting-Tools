...
public class TDDITARAPackage implements org.apache.thrift.TBase<TDDITARAPackage, TDDITARAPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDITARAPackage> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3032 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list3032.size);
                TDDIKeyValueMap _elem3033;
                for (int _i3034 = 0; _i3034 < _list3032.size; ++_i3034)
                {
                  _elem3033 = new TDDIKeyValueMap();
                  _elem3033.read(iprot);
                  struct.KeyValueMaps.add(_elem3033);
                }
                iprot.readListEnd();
              }
          ...
          case 5: // IDENTIFIED_RISKS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3035 = iprot.readListBegin();
                struct.IdentifiedRisks = new java.util.ArrayList<TDDISecurityRisk>(_list3035.size);
                TDDISecurityRisk _elem3036;
                for (int _i3037 = 0; _i3037 < _list3035.size; ++_i3037)
                {
                  _elem3036 = new TDDISecurityRisk();
                  _elem3036.read(iprot);
                  struct.IdentifiedRisks.add(_elem3036);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // CONTROLS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3038 = iprot.readListBegin();
                struct.Controls = new java.util.ArrayList<TDDISecurityControl>(_list3038.size);
                TDDISecurityControl _elem3039;
                for (int _i3040 = 0; _i3040 < _list3038.size; ++_i3040)
                {
                  _elem3039 = new TDDISecurityControl();
                  _elem3039.read(iprot);
                  struct.Controls.add(_elem3039);
                }
                iprot.readListEnd();
              }
          ...
          case 7: // CONSIDERED_ASSETS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3041 = iprot.readListBegin();
                struct.ConsideredAssets = new java.util.ArrayList<TDDIAbstractAsset>(_list3041.size);
                TDDIAbstractAsset _elem3042;
                for (int _i3043 = 0; _i3043 < _list3041.size; ++_i3043)
                {
                  _elem3042 = new TDDIAbstractAsset();
                  _elem3042.read(iprot);
                  struct.ConsideredAssets.add(_elem3042);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // CONSIDERED_THREAT_AGENTS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3044 = iprot.readListBegin();
                struct.ConsideredThreatAgents = new java.util.ArrayList<TDDIAbstractThreatAgent>(_list3044.size);
                TDDIAbstractThreatAgent _elem3045;
                for (int _i3046 = 0; _i3046 < _list3044.size; ++_i3046)
                {
                  _elem3045 = new TDDIAbstractThreatAgent();
                  _elem3045.read(iprot);
                  struct.ConsideredThreatAgents.add(_elem3045);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDITARAPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter3047 : struct.KeyValueMaps)
          {
      ...
      if (struct.IdentifiedRisks != null) {
        oprot.writeFieldBegin(IDENTIFIED_RISKS_FIELD_DESC);
        {
          ...
          for (TDDISecurityRisk _iter3048 : struct.IdentifiedRisks)
          {
      ...
      if (struct.Controls != null) {
        oprot.writeFieldBegin(CONTROLS_FIELD_DESC);
        {
          ...
          for (TDDISecurityControl _iter3049 : struct.Controls)
          {
            _iter3049.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ConsideredAssets != null) {
        oprot.writeFieldBegin(CONSIDERED_ASSETS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractAsset _iter3050 : struct.ConsideredAssets)
          {
            _iter3050.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ConsideredThreatAgents != null) {
        oprot.writeFieldBegin(CONSIDERED_THREAT_AGENTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractThreatAgent _iter3051 : struct.ConsideredThreatAgents)
          {
            _iter3051.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDITARAPackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDITARAPackage> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter3052 : struct.KeyValueMaps)
          {
            _iter3052.write(oprot);
          }
        }
      }
      if (struct.isSetIdentifiedRisks()) {
        {
          ...
          for (TDDISecurityRisk _iter3053 : struct.IdentifiedRisks)
          {
            _iter3053.write(oprot);
          }
        }
      }
      if (struct.isSetControls()) {
        {
          ...
          for (TDDISecurityControl _iter3054 : struct.Controls)
          {
            _iter3054.write(oprot);
          }
        }
      }
      if (struct.isSetConsideredAssets()) {
        {
          ...
          for (TDDIAbstractAsset _iter3055 : struct.ConsideredAssets)
          {
            _iter3055.write(oprot);
          }
        }
      }
      if (struct.isSetConsideredThreatAgents()) {
        {
          ...
          for (TDDIAbstractThreatAgent _iter3056 : struct.ConsideredThreatAgents)
          {
            _iter3056.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDITARAPackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list3057 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list3057.size);
          TDDIKeyValueMap _elem3058;
          for (int _i3059 = 0; _i3059 < _list3057.size; ++_i3059)
          {
            _elem3058 = new TDDIKeyValueMap();
            _elem3058.read(iprot);
            struct.KeyValueMaps.add(_elem3058);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list3060 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.IdentifiedRisks = new java.util.ArrayList<TDDISecurityRisk>(_list3060.size);
          TDDISecurityRisk _elem3061;
          for (int _i3062 = 0; _i3062 < _list3060.size; ++_i3062)
          {
            _elem3061 = new TDDISecurityRisk();
            _elem3061.read(iprot);
            struct.IdentifiedRisks.add(_elem3061);
          }
        }
        struct.setIdentifiedRisksIsSet(true);
      }
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list3063 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Controls = new java.util.ArrayList<TDDISecurityControl>(_list3063.size);
          TDDISecurityControl _elem3064;
          for (int _i3065 = 0; _i3065 < _list3063.size; ++_i3065)
          {
            _elem3064 = new TDDISecurityControl();
            _elem3064.read(iprot);
            struct.Controls.add(_elem3064);
          }
        }
        struct.setControlsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list3066 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ConsideredAssets = new java.util.ArrayList<TDDIAbstractAsset>(_list3066.size);
          TDDIAbstractAsset _elem3067;
          for (int _i3068 = 0; _i3068 < _list3066.size; ++_i3068)
          {
            _elem3067 = new TDDIAbstractAsset();
            _elem3067.read(iprot);
            struct.ConsideredAssets.add(_elem3067);
          }
        }
        struct.setConsideredAssetsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.ConsideredThreatAgents = new java.util.ArrayList<TDDIAbstractThreatAgent>(_list3069.size);
          TDDIAbstractThreatAgent _elem3070;
          for (int _i3071 = 0; _i3071 < _list3069.size; ++_i3071)
          {
            _elem3070 = new TDDIAbstractThreatAgent();
            _elem3070.read(iprot);
            struct.ConsideredThreatAgents.add(_elem3070);
          }
        }
        struct.setConsideredThreatAgentsIsSet(true);
      }
