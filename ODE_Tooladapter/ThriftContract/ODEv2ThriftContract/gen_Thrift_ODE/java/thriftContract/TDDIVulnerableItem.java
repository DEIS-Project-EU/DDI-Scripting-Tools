            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Vulnerabilities = new java.util.ArrayList<TDDIVulnerability>(_list2803.size);
                TDDIVulnerability _elem2804;
                for (int _i2805 = 0; _i2805 < _list2803.size; ++_i2805)
                {
                  _elem2804 = new TDDIVulnerability();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIVulnerableItem struct) throws org.apache.thrift.TException {
      ...
      if (struct.Vulnerabilities != null) {
        oprot.writeFieldBegin(VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerability _iter2807 : struct.Vulnerabilities)
          {
      ...
      if (struct.isSetVulnerabilities()) {
        {
          ...
          for (TDDIVulnerability _iter2809 : struct.Vulnerabilities)
          {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.Vulnerabilities = new java.util.ArrayList<TDDIVulnerability>(_list2813.size);
          TDDIVulnerability _elem2814;
          for (int _i2815 = 0; _i2815 < _list2813.size; ++_i2815)
          {
            _elem2814 = new TDDIVulnerability();
