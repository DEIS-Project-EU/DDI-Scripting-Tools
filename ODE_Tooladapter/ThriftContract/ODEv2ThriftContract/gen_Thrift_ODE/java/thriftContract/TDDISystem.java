...
public class TDDISystem implements org.apache.thrift.TBase<TDDISystem, TDDISystem._Fields>, java.io.Serializable, Cloneable, Comparable<TDDISystem> {
  ...
  public TDDISystem setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDISystem setPorts(java.util.List<TDDIPort> Ports) {
    this.Ports = Ports;
    return this;
  }
  ...
  public TDDISystem setSignals(java.util.List<TDDISignal> Signals) {
    this.Signals = Signals;
    return this;
  }
  ...
  public TDDISystem setAsAsset(TDDIAbstractAsset AsAsset) {
    this.AsAsset = AsAsset;
    return this;
  }
  ...
  public TDDISystem setFailureModels(java.util.List<TDDIAbstractFailureModelRef> FailureModels) {
    this.FailureModels = FailureModels;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list304.size);
                TDDIKeyValueMap _elem305;
                for (int _i306 = 0; _i306 < _list304.size; ++_i306)
                {
                  _elem305 = new TDDIKeyValueMap();
                  _elem305.read(iprot);
                  struct.KeyValueMaps.add(_elem305);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Contexts = new java.util.ArrayList<TDDIContext>(_list307.size);
                TDDIContext _elem308;
                for (int _i309 = 0; _i309 < _list307.size; ++_i309)
                {
                  _elem308 = new TDDIContext();
                  _elem308.read(iprot);
                  struct.Contexts.add(_elem308);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Configurations = new java.util.ArrayList<TDDIConfiguration>(_list310.size);
                TDDIConfiguration _elem311;
                for (int _i312 = 0; _i312 < _list310.size; ++_i312)
                {
                  _elem311 = new TDDIConfiguration();
                  _elem311.read(iprot);
                  struct.Configurations.add(_elem311);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Ports = new java.util.ArrayList<TDDIPort>(_list313.size);
                TDDIPort _elem314;
                for (int _i315 = 0; _i315 < _list313.size; ++_i315)
                {
                  _elem314 = new TDDIPort();
                  _elem314.read(iprot);
                  struct.Ports.add(_elem314);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Signals = new java.util.ArrayList<TDDISignal>(_list316.size);
                TDDISignal _elem317;
                for (int _i318 = 0; _i318 < _list316.size; ++_i318)
                {
                  _elem317 = new TDDISignal();
                  _elem317.read(iprot);
                  struct.Signals.add(_elem317);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.SystemBoundaries = new java.util.ArrayList<TDDISystemBoundary>(_list319.size);
                TDDISystemBoundary _elem320;
                for (int _i321 = 0; _i321 < _list319.size; ++_i321)
                {
                  _elem320 = new TDDISystemBoundary();
                  _elem320.read(iprot);
                  struct.SystemBoundaries.add(_elem320);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.AppliedStandards = new java.util.ArrayList<TDDIAbstractStandardRef>(_list322.size);
                TDDIAbstractStandardRef _elem323;
                for (int _i324 = 0; _i324 < _list322.size; ++_i324)
                {
                  _elem323 = new TDDIAbstractStandardRef();
                  _elem323.read(iprot);
                  struct.AppliedStandards.add(_elem323);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.RealisedFunctions = new java.util.ArrayList<TDDIAbstractFunctionRef>(_list325.size);
                TDDIAbstractFunctionRef _elem326;
                for (int _i327 = 0; _i327 < _list325.size; ++_i327)
                {
                  _elem326 = new TDDIAbstractFunctionRef();
                  _elem326.read(iprot);
                  struct.RealisedFunctions.add(_elem326);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list328.size);
                TDDIAbstractDependabilityRequirementRef _elem329;
                for (int _i330 = 0; _i330 < _list328.size; ++_i330)
                {
                  _elem329 = new TDDIAbstractDependabilityRequirementRef();
                  _elem329.read(iprot);
                  struct.DependabilityRequirements.add(_elem329);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureModels = new java.util.ArrayList<TDDIAbstractFailureModelRef>(_list331.size);
                TDDIAbstractFailureModelRef _elem332;
                for (int _i333 = 0; _i333 < _list331.size; ++_i333)
                {
                  _elem332 = new TDDIAbstractFailureModelRef();
                  _elem332.read(iprot);
                  struct.FailureModels.add(_elem332);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.SubSystems = new java.util.ArrayList<TDDIAbstractSystemRef>(_list334.size);
                TDDIAbstractSystemRef _elem335;
                for (int _i336 = 0; _i336 < _list334.size; ++_i336)
                {
                  _elem335 = new TDDIAbstractSystemRef();
                  _elem335.read(iprot);
                  struct.SubSystems.add(_elem335);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDISystem struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter337 : struct.KeyValueMaps)
          {
      ...
      if (struct.Contexts != null) {
        oprot.writeFieldBegin(CONTEXTS_FIELD_DESC);
        {
          ...
          for (TDDIContext _iter338 : struct.Contexts)
          {
      ...
      if (struct.Configurations != null) {
        oprot.writeFieldBegin(CONFIGURATIONS_FIELD_DESC);
        {
          ...
          for (TDDIConfiguration _iter339 : struct.Configurations)
          {
      ...
      if (struct.Ports != null) {
        oprot.writeFieldBegin(PORTS_FIELD_DESC);
        {
          ...
          for (TDDIPort _iter340 : struct.Ports)
          {
      ...
      if (struct.Signals != null) {
        oprot.writeFieldBegin(SIGNALS_FIELD_DESC);
        {
          ...
          for (TDDISignal _iter341 : struct.Signals)
          {
      ...
      if (struct.SystemBoundaries != null) {
        oprot.writeFieldBegin(SYSTEM_BOUNDARIES_FIELD_DESC);
        {
          ...
          for (TDDISystemBoundary _iter342 : struct.SystemBoundaries)
          {
      ...
      if (struct.AppliedStandards != null) {
        oprot.writeFieldBegin(APPLIED_STANDARDS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractStandardRef _iter343 : struct.AppliedStandards)
          {
      ...
      if (struct.RealisedFunctions != null) {
        oprot.writeFieldBegin(REALISED_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFunctionRef _iter344 : struct.RealisedFunctions)
          {
      ...
      if (struct.DependabilityRequirements != null) {
        oprot.writeFieldBegin(DEPENDABILITY_REQUIREMENTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter345 : struct.DependabilityRequirements)
          {
      ...
      if (struct.FailureModels != null) {
        oprot.writeFieldBegin(FAILURE_MODELS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureModelRef _iter346 : struct.FailureModels)
          {
      ...
      if (struct.SubSystems != null) {
        oprot.writeFieldBegin(SUB_SYSTEMS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractSystemRef _iter347 : struct.SubSystems)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter348 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetContexts()) {
        {
          ...
          for (TDDIContext _iter349 : struct.Contexts)
          {
      ...
      if (struct.isSetConfigurations()) {
        {
          ...
          for (TDDIConfiguration _iter350 : struct.Configurations)
          {
      ...
      if (struct.isSetPorts()) {
        {
          ...
          for (TDDIPort _iter351 : struct.Ports)
          {
      ...
      if (struct.isSetSignals()) {
        {
          ...
          for (TDDISignal _iter352 : struct.Signals)
          {
      ...
      if (struct.isSetSystemBoundaries()) {
        {
          ...
          for (TDDISystemBoundary _iter353 : struct.SystemBoundaries)
          {
      ...
      if (struct.isSetAppliedStandards()) {
        {
          ...
          for (TDDIAbstractStandardRef _iter354 : struct.AppliedStandards)
          {
      ...
      if (struct.isSetRealisedFunctions()) {
        {
          ...
          for (TDDIAbstractFunctionRef _iter355 : struct.RealisedFunctions)
          {
      ...
      if (struct.isSetDependabilityRequirements()) {
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter356 : struct.DependabilityRequirements)
          {
      ...
      if (struct.isSetFailureModels()) {
        {
          ...
          for (TDDIAbstractFailureModelRef _iter357 : struct.FailureModels)
          {
      ...
      if (struct.isSetSubSystems()) {
        {
          ...
          for (TDDIAbstractSystemRef _iter358 : struct.SubSystems)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list359.size);
          TDDIKeyValueMap _elem360;
          for (int _i361 = 0; _i361 < _list359.size; ++_i361)
          {
            _elem360 = new TDDIKeyValueMap();
            _elem360.read(iprot);
            struct.KeyValueMaps.add(_elem360);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.Contexts = new java.util.ArrayList<TDDIContext>(_list362.size);
          TDDIContext _elem363;
          for (int _i364 = 0; _i364 < _list362.size; ++_i364)
          {
            _elem363 = new TDDIContext();
            _elem363.read(iprot);
            struct.Contexts.add(_elem363);
          }
        }
        struct.setContextsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.Configurations = new java.util.ArrayList<TDDIConfiguration>(_list365.size);
          TDDIConfiguration _elem366;
          for (int _i367 = 0; _i367 < _list365.size; ++_i367)
          {
            _elem366 = new TDDIConfiguration();
            _elem366.read(iprot);
            struct.Configurations.add(_elem366);
          }
        }
        struct.setConfigurationsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Ports = new java.util.ArrayList<TDDIPort>(_list368.size);
          TDDIPort _elem369;
          for (int _i370 = 0; _i370 < _list368.size; ++_i370)
          {
            _elem369 = new TDDIPort();
            _elem369.read(iprot);
            struct.Ports.add(_elem369);
          }
        }
        struct.setPortsIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.Signals = new java.util.ArrayList<TDDISignal>(_list371.size);
          TDDISignal _elem372;
          for (int _i373 = 0; _i373 < _list371.size; ++_i373)
          {
            _elem372 = new TDDISignal();
            _elem372.read(iprot);
            struct.Signals.add(_elem372);
          }
        }
        struct.setSignalsIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.SystemBoundaries = new java.util.ArrayList<TDDISystemBoundary>(_list374.size);
          TDDISystemBoundary _elem375;
          for (int _i376 = 0; _i376 < _list374.size; ++_i376)
          {
            _elem375 = new TDDISystemBoundary();
            _elem375.read(iprot);
            struct.SystemBoundaries.add(_elem375);
          }
        }
        struct.setSystemBoundariesIsSet(true);
      }
      if (incoming.get(11)) {
        {
          ...
          struct.AppliedStandards = new java.util.ArrayList<TDDIAbstractStandardRef>(_list377.size);
          TDDIAbstractStandardRef _elem378;
          for (int _i379 = 0; _i379 < _list377.size; ++_i379)
          {
            _elem378 = new TDDIAbstractStandardRef();
            _elem378.read(iprot);
            struct.AppliedStandards.add(_elem378);
          }
        }
        struct.setAppliedStandardsIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.RealisedFunctions = new java.util.ArrayList<TDDIAbstractFunctionRef>(_list380.size);
          TDDIAbstractFunctionRef _elem381;
          for (int _i382 = 0; _i382 < _list380.size; ++_i382)
          {
            _elem381 = new TDDIAbstractFunctionRef();
            _elem381.read(iprot);
            struct.RealisedFunctions.add(_elem381);
          }
        }
        struct.setRealisedFunctionsIsSet(true);
      }
      ...
      if (incoming.get(14)) {
        {
          ...
          struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list383.size);
          TDDIAbstractDependabilityRequirementRef _elem384;
          for (int _i385 = 0; _i385 < _list383.size; ++_i385)
          {
            _elem384 = new TDDIAbstractDependabilityRequirementRef();
            _elem384.read(iprot);
            struct.DependabilityRequirements.add(_elem384);
          }
        }
        struct.setDependabilityRequirementsIsSet(true);
      }
      ...
      if (incoming.get(16)) {
        {
          ...
          struct.FailureModels = new java.util.ArrayList<TDDIAbstractFailureModelRef>(_list386.size);
          TDDIAbstractFailureModelRef _elem387;
          for (int _i388 = 0; _i388 < _list386.size; ++_i388)
          {
            _elem387 = new TDDIAbstractFailureModelRef();
            _elem387.read(iprot);
            struct.FailureModels.add(_elem387);
          }
        }
        struct.setFailureModelsIsSet(true);
      }
      if (incoming.get(17)) {
        {
          ...
          struct.SubSystems = new java.util.ArrayList<TDDIAbstractSystemRef>(_list389.size);
          TDDIAbstractSystemRef _elem390;
          for (int _i391 = 0; _i391 < _list389.size; ++_i391)
          {
            _elem390 = new TDDIAbstractSystemRef();
            _elem390.read(iprot);
            struct.SubSystems.add(_elem390);
          }
        }
        struct.setSubSystemsIsSet(true);
      }
