...
public class TDDIAsset implements org.apache.thrift.TBase<TDDIAsset, TDDIAsset._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAsset> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2784 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2784.size);
                TDDIKeyValueMap _elem2785;
                for (int _i2786 = 0; _i2786 < _list2784.size; ++_i2786)
                {
                  _elem2785 = new TDDIKeyValueMap();
                  _elem2785.read(iprot);
                  struct.KeyValueMaps.add(_elem2785);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAsset struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2787 : struct.KeyValueMaps)
          {
            _iter2787.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIAssetTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAsset> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2788 : struct.KeyValueMaps)
          {
            _iter2788.write(oprot);
          }
        }
      }
      if (struct.isSetFinancialValue()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAsset struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2789 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2789.size);
          TDDIKeyValueMap _elem2790;
          for (int _i2791 = 0; _i2791 < _list2789.size; ++_i2791)
          {
            _elem2790 = new TDDIKeyValueMap();
            _elem2790.read(iprot);
            struct.KeyValueMaps.add(_elem2790);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
