...
public class TDDIArtifactPackageBinding implements org.apache.thrift.TBase<TDDIArtifactPackageBinding, TDDIArtifactPackageBinding._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArtifactPackageBinding> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1960 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1960.size);
                TDDIImplementationConstraintRef _elem1961;
                for (int _i1962 = 0; _i1962 < _list1960.size; ++_i1962)
                {
                  _elem1961 = new TDDIImplementationConstraintRef();
                  _elem1961.read(iprot);
                  struct.ImplementationConstraint.add(_elem1961);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1963 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1963.size);
                TDDINoteRef _elem1964;
                for (int _i1965 = 0; _i1965 < _list1963.size; ++_i1965)
                {
                  _elem1964 = new TDDINoteRef();
                  _elem1964.read(iprot);
                  struct.Note.add(_elem1964);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1966.size);
                TDDITaggedValueRef _elem1967;
                for (int _i1968 = 0; _i1968 < _list1966.size; ++_i1968)
                {
                  _elem1967 = new TDDITaggedValueRef();
                  _elem1967.read(iprot);
                  struct.TaggedValue.add(_elem1967);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // ARTIFACT_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1969 = iprot.readListBegin();
                struct.ArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list1969.size);
                TDDIAbstractArtifactElementRef _elem1970;
                for (int _i1971 = 0; _i1971 < _list1969.size; ++_i1971)
                {
                  _elem1970 = new TDDIAbstractArtifactElementRef();
                  _elem1970.read(iprot);
                  struct.ArtifactElement.add(_elem1970);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ParticipantPackage = new java.util.ArrayList<TDDIAbstractArtifactPackage>(_list1972.size);
                TDDIAbstractArtifactPackage _elem1973;
                for (int _i1974 = 0; _i1974 < _list1972.size; ++_i1974)
                {
                  _elem1973 = new TDDIAbstractArtifactPackage();
                  _elem1973.read(iprot);
                  struct.ParticipantPackage.add(_elem1973);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArtifactPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1975 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1976 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1977 : struct.TaggedValue)
          {
            _iter1977.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ArtifactElement != null) {
        oprot.writeFieldBegin(ARTIFACT_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter1978 : struct.ArtifactElement)
          {
            _iter1978.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ParticipantPackage != null) {
        oprot.writeFieldBegin(PARTICIPANT_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactPackage _iter1979 : struct.ParticipantPackage)
          {
            _iter1979.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIArtifactPackageBindingTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArtifactPackageBinding> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1980 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1981 : struct.Note)
          {
            _iter1981.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1982 : struct.TaggedValue)
          {
      ...
      if (struct.isSetArtifactElement()) {
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter1983 : struct.ArtifactElement)
          {
      ...
      if (struct.isSetParticipantPackage()) {
        {
          ...
          for (TDDIAbstractArtifactPackage _iter1984 : struct.ParticipantPackage)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArtifactPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1985 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1985.size);
          TDDIImplementationConstraintRef _elem1986;
          for (int _i1987 = 0; _i1987 < _list1985.size; ++_i1987)
          {
            _elem1986 = new TDDIImplementationConstraintRef();
            _elem1986.read(iprot);
            struct.ImplementationConstraint.add(_elem1986);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list1988 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1988.size);
          TDDINoteRef _elem1989;
          for (int _i1990 = 0; _i1990 < _list1988.size; ++_i1990)
          {
            _elem1989 = new TDDINoteRef();
            _elem1989.read(iprot);
            struct.Note.add(_elem1989);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1991 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1991.size);
          TDDITaggedValueRef _elem1992;
          for (int _i1993 = 0; _i1993 < _list1991.size; ++_i1993)
          {
            _elem1992 = new TDDITaggedValueRef();
            _elem1992.read(iprot);
            struct.TaggedValue.add(_elem1992);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list1994 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list1994.size);
          TDDIAbstractArtifactElementRef _elem1995;
          for (int _i1996 = 0; _i1996 < _list1994.size; ++_i1996)
          {
            _elem1995 = new TDDIAbstractArtifactElementRef();
            _elem1995.read(iprot);
            struct.ArtifactElement.add(_elem1995);
          }
        }
        struct.setArtifactElementIsSet(true);
      }
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list1997 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ParticipantPackage = new java.util.ArrayList<TDDIAbstractArtifactPackage>(_list1997.size);
          TDDIAbstractArtifactPackage _elem1998;
          for (int _i1999 = 0; _i1999 < _list1997.size; ++_i1999)
          {
            _elem1998 = new TDDIAbstractArtifactPackage();
            _elem1998.read(iprot);
            struct.ParticipantPackage.add(_elem1998);
          }
        }
        struct.setParticipantPackageIsSet(true);
      }
