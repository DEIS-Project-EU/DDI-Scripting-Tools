...
public class TDDIArtifactPackageInterface implements org.apache.thrift.TBase<TDDIArtifactPackageInterface, TDDIArtifactPackageInterface._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArtifactPackageInterface> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1928 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1928.size);
                TDDIImplementationConstraintRef _elem1929;
                for (int _i1930 = 0; _i1930 < _list1928.size; ++_i1930)
                {
                  _elem1929 = new TDDIImplementationConstraintRef();
                  _elem1929.read(iprot);
                  struct.ImplementationConstraint.add(_elem1929);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1931 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1931.size);
                TDDINoteRef _elem1932;
                for (int _i1933 = 0; _i1933 < _list1931.size; ++_i1933)
                {
                  _elem1932 = new TDDINoteRef();
                  _elem1932.read(iprot);
                  struct.Note.add(_elem1932);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1934.size);
                TDDITaggedValueRef _elem1935;
                for (int _i1936 = 0; _i1936 < _list1934.size; ++_i1936)
                {
                  _elem1935 = new TDDITaggedValueRef();
                  _elem1935.read(iprot);
                  struct.TaggedValue.add(_elem1935);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // ARTIFACT_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1937 = iprot.readListBegin();
                struct.ArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list1937.size);
                TDDIAbstractArtifactElementRef _elem1938;
                for (int _i1939 = 0; _i1939 < _list1937.size; ++_i1939)
                {
                  _elem1938 = new TDDIAbstractArtifactElementRef();
                  _elem1938.read(iprot);
                  struct.ArtifactElement.add(_elem1938);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArtifactPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1940 : struct.ImplementationConstraint)
          {
            _iter1940.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1941 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1942 : struct.TaggedValue)
          {
      ...
      if (struct.ArtifactElement != null) {
        oprot.writeFieldBegin(ARTIFACT_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter1943 : struct.ArtifactElement)
          {
            _iter1943.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIArtifactPackageInterfaceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArtifactPackageInterface> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1944 : struct.ImplementationConstraint)
          {
            _iter1944.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1945 : struct.Note)
          {
            _iter1945.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1946 : struct.TaggedValue)
          {
            _iter1946.write(oprot);
          }
        }
      }
      if (struct.isSetArtifactElement()) {
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter1947 : struct.ArtifactElement)
          {
            _iter1947.write(oprot);
          }
        }
      }
      if (struct.isSetImplements()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArtifactPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1948 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1948.size);
          TDDIImplementationConstraintRef _elem1949;
          for (int _i1950 = 0; _i1950 < _list1948.size; ++_i1950)
          {
            _elem1949 = new TDDIImplementationConstraintRef();
            _elem1949.read(iprot);
            struct.ImplementationConstraint.add(_elem1949);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list1951 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1951.size);
          TDDINoteRef _elem1952;
          for (int _i1953 = 0; _i1953 < _list1951.size; ++_i1953)
          {
            _elem1952 = new TDDINoteRef();
            _elem1952.read(iprot);
            struct.Note.add(_elem1952);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1954 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1954.size);
          TDDITaggedValueRef _elem1955;
          for (int _i1956 = 0; _i1956 < _list1954.size; ++_i1956)
          {
            _elem1955 = new TDDITaggedValueRef();
            _elem1955.read(iprot);
            struct.TaggedValue.add(_elem1955);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list1957 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list1957.size);
          TDDIAbstractArtifactElementRef _elem1958;
          for (int _i1959 = 0; _i1959 < _list1957.size; ++_i1959)
          {
            _elem1958 = new TDDIAbstractArtifactElementRef();
            _elem1958.read(iprot);
            struct.ArtifactElement.add(_elem1958);
          }
        }
        struct.setArtifactElementIsSet(true);
      }
