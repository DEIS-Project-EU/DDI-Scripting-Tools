...
public class TDDILegalContract implements org.apache.thrift.TBase<TDDILegalContract, TDDILegalContract._Fields>, java.io.Serializable, Cloneable, Comparable<TDDILegalContract> {
  ...
  public TDDILegalContract setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list1304.size);
                TDDIKeyValueMap _elem1305;
                for (int _i1306 = 0; _i1306 < _list1304.size; ++_i1306)
                {
                  _elem1305 = new TDDIKeyValueMap();
                  _elem1305.read(iprot);
                  struct.KeyValueMaps.add(_elem1305);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDILegalContract struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter1307 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter1308 : struct.KeyValueMaps)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list1309.size);
          TDDIKeyValueMap _elem1310;
          for (int _i1311 = 0; _i1311 < _list1309.size; ++_i1311)
          {
            _elem1310 = new TDDIKeyValueMap();
            _elem1310.read(iprot);
            struct.KeyValueMaps.add(_elem1310);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
