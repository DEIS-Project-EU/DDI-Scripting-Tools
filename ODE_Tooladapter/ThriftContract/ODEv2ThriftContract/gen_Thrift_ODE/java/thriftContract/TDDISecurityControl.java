            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Vulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2819.size);
                TDDIVulnerabilityRef _elem2820;
                for (int _i2821 = 0; _i2821 < _list2819.size; ++_i2821)
                {
                  _elem2820 = new TDDIVulnerabilityRef();
                  _elem2820.read(iprot);
                  struct.Vulnerabilities.add(_elem2820);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDISecurityControl struct) throws org.apache.thrift.TException {
      ...
      if (struct.Vulnerabilities != null) {
        oprot.writeFieldBegin(VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerabilityRef _iter2823 : struct.Vulnerabilities)
          {
      ...
      if (struct.isSetVulnerabilities()) {
        {
          ...
          for (TDDIVulnerabilityRef _iter2825 : struct.Vulnerabilities)
          {
      ...
      if (incoming.get(14)) {
        {
          ...
          struct.Vulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2829.size);
          TDDIVulnerabilityRef _elem2830;
          for (int _i2831 = 0; _i2831 < _list2829.size; ++_i2831)
          {
            _elem2830 = new TDDIVulnerabilityRef();
            _elem2830.read(iprot);
            struct.Vulnerabilities.add(_elem2830);
          }
        }
        struct.setVulnerabilitiesIsSet(true);
      }
