...
public class TDDIAssertedArtifactSupport implements org.apache.thrift.TBase<TDDIAssertedArtifactSupport, TDDIAssertedArtifactSupport._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAssertedArtifactSupport> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1656.size);
                TDDIImplementationConstraintRef _elem1657;
                for (int _i1658 = 0; _i1658 < _list1656.size; ++_i1658)
                {
                  _elem1657 = new TDDIImplementationConstraintRef();
                  _elem1657.read(iprot);
                  struct.ImplementationConstraint.add(_elem1657);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1659 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1659.size);
                TDDINoteRef _elem1660;
                for (int _i1661 = 0; _i1661 < _list1659.size; ++_i1661)
                {
                  _elem1660 = new TDDINoteRef();
                  _elem1660.read(iprot);
                  struct.Note.add(_elem1660);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1662.size);
                TDDITaggedValueRef _elem1663;
                for (int _i1664 = 0; _i1664 < _list1662.size; ++_i1664)
                {
                  _elem1663 = new TDDITaggedValueRef();
                  _elem1663.read(iprot);
                  struct.TaggedValue.add(_elem1663);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list1665.size);
                TDDIClaimRef _elem1666;
                for (int _i1667 = 0; _i1667 < _list1665.size; ++_i1667)
                {
                  _elem1666 = new TDDIClaimRef();
                  _elem1666.read(iprot);
                  struct.MetaClaim.add(_elem1666);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Source = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1668.size);
                TDDIAbstractArgumentAssetRef _elem1669;
                for (int _i1670 = 0; _i1670 < _list1668.size; ++_i1670)
                {
                  _elem1669 = new TDDIAbstractArgumentAssetRef();
                  _elem1669.read(iprot);
                  struct.Source.add(_elem1669);
                }
                iprot.readListEnd();
              }
          ...
          case 15: // TARGET
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1671 = iprot.readListBegin();
                struct.Target = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1671.size);
                TDDIAbstractArgumentAssetRef _elem1672;
                for (int _i1673 = 0; _i1673 < _list1671.size; ++_i1673)
                {
                  _elem1672 = new TDDIAbstractArgumentAssetRef();
                  _elem1672.read(iprot);
                  struct.Target.add(_elem1672);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAssertedArtifactSupport struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1674 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1675 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1676 : struct.TaggedValue)
          {
      ...
      if (struct.MetaClaim != null) {
        oprot.writeFieldBegin(META_CLAIM_FIELD_DESC);
        {
          ...
          for (TDDIClaimRef _iter1677 : struct.MetaClaim)
          {
      ...
      if (struct.Source != null) {
        oprot.writeFieldBegin(SOURCE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1678 : struct.Source)
          {
      ...
      if (struct.Target != null) {
        oprot.writeFieldBegin(TARGET_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1679 : struct.Target)
          {
            _iter1679.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIAssertedArtifactSupportTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAssertedArtifactSupport> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1680 : struct.ImplementationConstraint)
          {
            _iter1680.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1681 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1682 : struct.TaggedValue)
          {
      ...
      if (struct.isSetMetaClaim()) {
        {
          ...
          for (TDDIClaimRef _iter1683 : struct.MetaClaim)
          {
            _iter1683.write(oprot);
          }
        }
      }
      if (struct.isSetIsCounter()) {
      ...
      if (struct.isSetSource()) {
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1684 : struct.Source)
          {
            _iter1684.write(oprot);
          }
        }
      }
      if (struct.isSetTarget()) {
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1685 : struct.Target)
          {
            _iter1685.write(oprot);
          }
        }
      }
      if (struct.isSetReasoning()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAssertedArtifactSupport struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1686 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1686.size);
          TDDIImplementationConstraintRef _elem1687;
          for (int _i1688 = 0; _i1688 < _list1686.size; ++_i1688)
          {
            _elem1687 = new TDDIImplementationConstraintRef();
            _elem1687.read(iprot);
            struct.ImplementationConstraint.add(_elem1687);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1689.size);
          TDDINoteRef _elem1690;
          for (int _i1691 = 0; _i1691 < _list1689.size; ++_i1691)
          {
            _elem1690 = new TDDINoteRef();
            _elem1690.read(iprot);
            struct.Note.add(_elem1690);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1692 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1692.size);
          TDDITaggedValueRef _elem1693;
          for (int _i1694 = 0; _i1694 < _list1692.size; ++_i1694)
          {
            _elem1693 = new TDDITaggedValueRef();
            _elem1693.read(iprot);
            struct.TaggedValue.add(_elem1693);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list1695 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list1695.size);
          TDDIClaimRef _elem1696;
          for (int _i1697 = 0; _i1697 < _list1695.size; ++_i1697)
          {
            _elem1696 = new TDDIClaimRef();
            _elem1696.read(iprot);
            struct.MetaClaim.add(_elem1696);
          }
        }
        struct.setMetaClaimIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TList _list1698 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Source = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1698.size);
          TDDIAbstractArgumentAssetRef _elem1699;
          for (int _i1700 = 0; _i1700 < _list1698.size; ++_i1700)
          {
            _elem1699 = new TDDIAbstractArgumentAssetRef();
            _elem1699.read(iprot);
            struct.Source.add(_elem1699);
          }
        }
        struct.setSourceIsSet(true);
      }
      if (incoming.get(14)) {
        {
          org.apache.thrift.protocol.TList _list1701 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Target = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1701.size);
          TDDIAbstractArgumentAssetRef _elem1702;
          for (int _i1703 = 0; _i1703 < _list1701.size; ++_i1703)
          {
            _elem1702 = new TDDIAbstractArgumentAssetRef();
            _elem1702.read(iprot);
            struct.Target.add(_elem1702);
          }
        }
        struct.setTargetIsSet(true);
      }
