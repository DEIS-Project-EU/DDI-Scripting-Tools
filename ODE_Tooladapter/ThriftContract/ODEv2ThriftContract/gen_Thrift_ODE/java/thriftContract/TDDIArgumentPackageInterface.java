...
public class TDDIArgumentPackageInterface implements org.apache.thrift.TBase<TDDIArgumentPackageInterface, TDDIArgumentPackageInterface._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArgumentPackageInterface> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1528.size);
                TDDIImplementationConstraintRef _elem1529;
                for (int _i1530 = 0; _i1530 < _list1528.size; ++_i1530)
                {
                  _elem1529 = new TDDIImplementationConstraintRef();
                  _elem1529.read(iprot);
                  struct.ImplementationConstraint.add(_elem1529);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1531.size);
                TDDINoteRef _elem1532;
                for (int _i1533 = 0; _i1533 < _list1531.size; ++_i1533)
                {
                  _elem1532 = new TDDINoteRef();
                  _elem1532.read(iprot);
                  struct.Note.add(_elem1532);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1534.size);
                TDDITaggedValueRef _elem1535;
                for (int _i1536 = 0; _i1536 < _list1534.size; ++_i1536)
                {
                  _elem1535 = new TDDITaggedValueRef();
                  _elem1535.read(iprot);
                  struct.TaggedValue.add(_elem1535);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list1537.size);
                TDDIAbstractArgumentationElementRef _elem1538;
                for (int _i1539 = 0; _i1539 < _list1537.size; ++_i1539)
                {
                  _elem1538 = new TDDIAbstractArgumentationElementRef();
                  _elem1538.read(iprot);
                  struct.ArgumentationElement.add(_elem1538);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArgumentPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1540 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1541 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1542 : struct.TaggedValue)
          {
      ...
      if (struct.ArgumentationElement != null) {
        oprot.writeFieldBegin(ARGUMENTATION_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter1543 : struct.ArgumentationElement)
          {
  ...
  private static class TDDIArgumentPackageInterfaceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArgumentPackageInterface> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1544 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1545 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1546 : struct.TaggedValue)
          {
      ...
      if (struct.isSetArgumentationElement()) {
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter1547 : struct.ArgumentationElement)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArgumentPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1548 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1548.size);
          TDDIImplementationConstraintRef _elem1549;
          for (int _i1550 = 0; _i1550 < _list1548.size; ++_i1550)
          {
            _elem1549 = new TDDIImplementationConstraintRef();
            _elem1549.read(iprot);
            struct.ImplementationConstraint.add(_elem1549);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list1551 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1551.size);
          TDDINoteRef _elem1552;
          for (int _i1553 = 0; _i1553 < _list1551.size; ++_i1553)
          {
            _elem1552 = new TDDINoteRef();
            _elem1552.read(iprot);
            struct.Note.add(_elem1552);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1554 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1554.size);
          TDDITaggedValueRef _elem1555;
          for (int _i1556 = 0; _i1556 < _list1554.size; ++_i1556)
          {
            _elem1555 = new TDDITaggedValueRef();
            _elem1555.read(iprot);
            struct.TaggedValue.add(_elem1555);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list1557 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list1557.size);
          TDDIAbstractArgumentationElementRef _elem1558;
          for (int _i1559 = 0; _i1559 < _list1557.size; ++_i1559)
          {
            _elem1558 = new TDDIAbstractArgumentationElementRef();
            _elem1558.read(iprot);
            struct.ArgumentationElement.add(_elem1558);
          }
        }
        struct.setArgumentationElementIsSet(true);
      }
