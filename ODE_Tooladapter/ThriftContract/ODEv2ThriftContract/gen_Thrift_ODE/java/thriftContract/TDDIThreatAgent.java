    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIThreatAgent struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2974 : struct.KeyValueMaps)
          {
            _iter2974.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AttackerGoals != null) {
        oprot.writeFieldBegin(ATTACKER_GOALS_FIELD_DESC);
        {
          ...
          for (TDDIAttackerGoal _iter2975 : struct.AttackerGoals)
          {
            _iter2975.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2976 : struct.KeyValueMaps)
          {
            _iter2976.write(oprot);
          }
        }
      }
      if (struct.isSetSkillLevel()) {
      ...
      if (struct.isSetAttackerGoals()) {
        {
          ...
          for (TDDIAttackerGoal _iter2977 : struct.AttackerGoals)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2978.size);
          TDDIKeyValueMap _elem2979;
          for (int _i2980 = 0; _i2980 < _list2978.size; ++_i2980)
          {
            _elem2979 = new TDDIKeyValueMap();
            _elem2979.read(iprot);
            struct.KeyValueMaps.add(_elem2979);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list2981.size);
          TDDIAttackerGoal _elem2982;
          for (int _i2983 = 0; _i2983 < _list2981.size; ++_i2983)
          {
            _elem2982 = new TDDIAttackerGoal();
            _elem2982.read(iprot);
            struct.AttackerGoals.add(_elem2982);
          }
        }
        struct.setAttackerGoalsIsSet(true);
      }
