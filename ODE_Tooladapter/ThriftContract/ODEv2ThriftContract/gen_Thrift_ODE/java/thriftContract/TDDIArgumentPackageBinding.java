...
public class TDDIArgumentPackageBinding implements org.apache.thrift.TBase<TDDIArgumentPackageBinding, TDDIArgumentPackageBinding._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArgumentPackageBinding> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1560.size);
                TDDIImplementationConstraintRef _elem1561;
                for (int _i1562 = 0; _i1562 < _list1560.size; ++_i1562)
                {
                  _elem1561 = new TDDIImplementationConstraintRef();
                  _elem1561.read(iprot);
                  struct.ImplementationConstraint.add(_elem1561);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1563 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1563.size);
                TDDINoteRef _elem1564;
                for (int _i1565 = 0; _i1565 < _list1563.size; ++_i1565)
                {
                  _elem1564 = new TDDINoteRef();
                  _elem1564.read(iprot);
                  struct.Note.add(_elem1564);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1566.size);
                TDDITaggedValueRef _elem1567;
                for (int _i1568 = 0; _i1568 < _list1566.size; ++_i1568)
                {
                  _elem1567 = new TDDITaggedValueRef();
                  _elem1567.read(iprot);
                  struct.TaggedValue.add(_elem1567);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // ARGUMENTATION_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1569 = iprot.readListBegin();
                struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list1569.size);
                TDDIAbstractArgumentationElementRef _elem1570;
                for (int _i1571 = 0; _i1571 < _list1569.size; ++_i1571)
                {
                  _elem1570 = new TDDIAbstractArgumentationElementRef();
                  _elem1570.read(iprot);
                  struct.ArgumentationElement.add(_elem1570);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ParticipantPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(_list1572.size);
                TDDIAbstractArgumentPackageRef _elem1573;
                for (int _i1574 = 0; _i1574 < _list1572.size; ++_i1574)
                {
                  _elem1573 = new TDDIAbstractArgumentPackageRef();
                  _elem1573.read(iprot);
                  struct.ParticipantPackage.add(_elem1573);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArgumentPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1575 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1576 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1577 : struct.TaggedValue)
          {
      ...
      if (struct.ArgumentationElement != null) {
        oprot.writeFieldBegin(ARGUMENTATION_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter1578 : struct.ArgumentationElement)
          {
      ...
      if (struct.ParticipantPackage != null) {
        oprot.writeFieldBegin(PARTICIPANT_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentPackageRef _iter1579 : struct.ParticipantPackage)
          {
  ...
  private static class TDDIArgumentPackageBindingTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArgumentPackageBinding> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1580 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1581 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1582 : struct.TaggedValue)
          {
      ...
      if (struct.isSetArgumentationElement()) {
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter1583 : struct.ArgumentationElement)
          {
      ...
      if (struct.isSetParticipantPackage()) {
        {
          ...
          for (TDDIAbstractArgumentPackageRef _iter1584 : struct.ParticipantPackage)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArgumentPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1585 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1585.size);
          TDDIImplementationConstraintRef _elem1586;
          for (int _i1587 = 0; _i1587 < _list1585.size; ++_i1587)
          {
            _elem1586 = new TDDIImplementationConstraintRef();
            _elem1586.read(iprot);
            struct.ImplementationConstraint.add(_elem1586);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list1588 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1588.size);
          TDDINoteRef _elem1589;
          for (int _i1590 = 0; _i1590 < _list1588.size; ++_i1590)
          {
            _elem1589 = new TDDINoteRef();
            _elem1589.read(iprot);
            struct.Note.add(_elem1589);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1591 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1591.size);
          TDDITaggedValueRef _elem1592;
          for (int _i1593 = 0; _i1593 < _list1591.size; ++_i1593)
          {
            _elem1592 = new TDDITaggedValueRef();
            _elem1592.read(iprot);
            struct.TaggedValue.add(_elem1592);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list1594 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list1594.size);
          TDDIAbstractArgumentationElementRef _elem1595;
          for (int _i1596 = 0; _i1596 < _list1594.size; ++_i1596)
          {
            _elem1595 = new TDDIAbstractArgumentationElementRef();
            _elem1595.read(iprot);
            struct.ArgumentationElement.add(_elem1595);
          }
        }
        struct.setArgumentationElementIsSet(true);
      }
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list1597 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ParticipantPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(_list1597.size);
          TDDIAbstractArgumentPackageRef _elem1598;
          for (int _i1599 = 0; _i1599 < _list1597.size; ++_i1599)
          {
            _elem1598 = new TDDIAbstractArgumentPackageRef();
            _elem1598.read(iprot);
            struct.ParticipantPackage.add(_elem1598);
          }
        }
        struct.setParticipantPackageIsSet(true);
      }
