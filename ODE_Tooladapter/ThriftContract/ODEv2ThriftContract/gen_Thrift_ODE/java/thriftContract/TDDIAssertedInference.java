...
public class TDDIAssertedInference implements org.apache.thrift.TBase<TDDIAssertedInference, TDDIAssertedInference._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAssertedInference> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1752 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1752.size);
                TDDIImplementationConstraintRef _elem1753;
                for (int _i1754 = 0; _i1754 < _list1752.size; ++_i1754)
                {
                  _elem1753 = new TDDIImplementationConstraintRef();
                  _elem1753.read(iprot);
                  struct.ImplementationConstraint.add(_elem1753);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1755 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1755.size);
                TDDINoteRef _elem1756;
                for (int _i1757 = 0; _i1757 < _list1755.size; ++_i1757)
                {
                  _elem1756 = new TDDINoteRef();
                  _elem1756.read(iprot);
                  struct.Note.add(_elem1756);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1758.size);
                TDDITaggedValueRef _elem1759;
                for (int _i1760 = 0; _i1760 < _list1758.size; ++_i1760)
                {
                  _elem1759 = new TDDITaggedValueRef();
                  _elem1759.read(iprot);
                  struct.TaggedValue.add(_elem1759);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // META_CLAIM
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1761 = iprot.readListBegin();
                struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list1761.size);
                TDDIClaimRef _elem1762;
                for (int _i1763 = 0; _i1763 < _list1761.size; ++_i1763)
                {
                  _elem1762 = new TDDIClaimRef();
                  _elem1762.read(iprot);
                  struct.MetaClaim.add(_elem1762);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Source = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1764.size);
                TDDIAbstractArgumentAssetRef _elem1765;
                for (int _i1766 = 0; _i1766 < _list1764.size; ++_i1766)
                {
                  _elem1765 = new TDDIAbstractArgumentAssetRef();
                  _elem1765.read(iprot);
                  struct.Source.add(_elem1765);
                }
                iprot.readListEnd();
              }
          ...
          case 15: // TARGET
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1767 = iprot.readListBegin();
                struct.Target = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1767.size);
                TDDIAbstractArgumentAssetRef _elem1768;
                for (int _i1769 = 0; _i1769 < _list1767.size; ++_i1769)
                {
                  _elem1768 = new TDDIAbstractArgumentAssetRef();
                  _elem1768.read(iprot);
                  struct.Target.add(_elem1768);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAssertedInference struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1770 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1771 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1772 : struct.TaggedValue)
          {
      ...
      if (struct.MetaClaim != null) {
        oprot.writeFieldBegin(META_CLAIM_FIELD_DESC);
        {
          ...
          for (TDDIClaimRef _iter1773 : struct.MetaClaim)
          {
      ...
      if (struct.Source != null) {
        oprot.writeFieldBegin(SOURCE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1774 : struct.Source)
          {
            _iter1774.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Target != null) {
        oprot.writeFieldBegin(TARGET_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1775 : struct.Target)
          {
  ...
  private static class TDDIAssertedInferenceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAssertedInference> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1776 : struct.ImplementationConstraint)
          {
            _iter1776.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1777 : struct.Note)
          {
            _iter1777.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1778 : struct.TaggedValue)
          {
            _iter1778.write(oprot);
          }
        }
      }
      if (struct.isSetAssertionDeclaration()) {
      ...
      if (struct.isSetMetaClaim()) {
        {
          ...
          for (TDDIClaimRef _iter1779 : struct.MetaClaim)
          {
            _iter1779.write(oprot);
          }
        }
      }
      if (struct.isSetIsCounter()) {
      ...
      if (struct.isSetSource()) {
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1780 : struct.Source)
          {
            _iter1780.write(oprot);
          }
        }
      }
      if (struct.isSetTarget()) {
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1781 : struct.Target)
          {
            _iter1781.write(oprot);
          }
        }
      }
      if (struct.isSetReasoning()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAssertedInference struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1782 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1782.size);
          TDDIImplementationConstraintRef _elem1783;
          for (int _i1784 = 0; _i1784 < _list1782.size; ++_i1784)
          {
            _elem1783 = new TDDIImplementationConstraintRef();
            _elem1783.read(iprot);
            struct.ImplementationConstraint.add(_elem1783);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1785.size);
          TDDINoteRef _elem1786;
          for (int _i1787 = 0; _i1787 < _list1785.size; ++_i1787)
          {
            _elem1786 = new TDDINoteRef();
            _elem1786.read(iprot);
            struct.Note.add(_elem1786);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1788 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1788.size);
          TDDITaggedValueRef _elem1789;
          for (int _i1790 = 0; _i1790 < _list1788.size; ++_i1790)
          {
            _elem1789 = new TDDITaggedValueRef();
            _elem1789.read(iprot);
            struct.TaggedValue.add(_elem1789);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list1791 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list1791.size);
          TDDIClaimRef _elem1792;
          for (int _i1793 = 0; _i1793 < _list1791.size; ++_i1793)
          {
            _elem1792 = new TDDIClaimRef();
            _elem1792.read(iprot);
            struct.MetaClaim.add(_elem1792);
          }
        }
        struct.setMetaClaimIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TList _list1794 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Source = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1794.size);
          TDDIAbstractArgumentAssetRef _elem1795;
          for (int _i1796 = 0; _i1796 < _list1794.size; ++_i1796)
          {
            _elem1795 = new TDDIAbstractArgumentAssetRef();
            _elem1795.read(iprot);
            struct.Source.add(_elem1795);
          }
        }
        struct.setSourceIsSet(true);
      }
      if (incoming.get(14)) {
        {
          org.apache.thrift.protocol.TList _list1797 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Target = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1797.size);
          TDDIAbstractArgumentAssetRef _elem1798;
          for (int _i1799 = 0; _i1799 < _list1797.size; ++_i1799)
          {
            _elem1798 = new TDDIAbstractArgumentAssetRef();
            _elem1798.read(iprot);
            struct.Target.add(_elem1798);
          }
        }
        struct.setTargetIsSet(true);
      }
