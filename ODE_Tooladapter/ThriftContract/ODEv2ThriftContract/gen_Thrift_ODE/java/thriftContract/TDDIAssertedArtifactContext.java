...
public class TDDIAssertedArtifactContext implements org.apache.thrift.TBase<TDDIAssertedArtifactContext, TDDIAssertedArtifactContext._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAssertedArtifactContext> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1704.size);
                TDDIImplementationConstraintRef _elem1705;
                for (int _i1706 = 0; _i1706 < _list1704.size; ++_i1706)
                {
                  _elem1705 = new TDDIImplementationConstraintRef();
                  _elem1705.read(iprot);
                  struct.ImplementationConstraint.add(_elem1705);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1707.size);
                TDDINoteRef _elem1708;
                for (int _i1709 = 0; _i1709 < _list1707.size; ++_i1709)
                {
                  _elem1708 = new TDDINoteRef();
                  _elem1708.read(iprot);
                  struct.Note.add(_elem1708);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1710.size);
                TDDITaggedValueRef _elem1711;
                for (int _i1712 = 0; _i1712 < _list1710.size; ++_i1712)
                {
                  _elem1711 = new TDDITaggedValueRef();
                  _elem1711.read(iprot);
                  struct.TaggedValue.add(_elem1711);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // META_CLAIM
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1713 = iprot.readListBegin();
                struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list1713.size);
                TDDIClaimRef _elem1714;
                for (int _i1715 = 0; _i1715 < _list1713.size; ++_i1715)
                {
                  _elem1714 = new TDDIClaimRef();
                  _elem1714.read(iprot);
                  struct.MetaClaim.add(_elem1714);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Source = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1716.size);
                TDDIAbstractArgumentAssetRef _elem1717;
                for (int _i1718 = 0; _i1718 < _list1716.size; ++_i1718)
                {
                  _elem1717 = new TDDIAbstractArgumentAssetRef();
                  _elem1717.read(iprot);
                  struct.Source.add(_elem1717);
                }
                iprot.readListEnd();
              }
          ...
          case 15: // TARGET
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1719 = iprot.readListBegin();
                struct.Target = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1719.size);
                TDDIAbstractArgumentAssetRef _elem1720;
                for (int _i1721 = 0; _i1721 < _list1719.size; ++_i1721)
                {
                  _elem1720 = new TDDIAbstractArgumentAssetRef();
                  _elem1720.read(iprot);
                  struct.Target.add(_elem1720);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAssertedArtifactContext struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1722 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1723 : struct.Note)
          {
            _iter1723.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1724 : struct.TaggedValue)
          {
            _iter1724.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.MetaClaim != null) {
        oprot.writeFieldBegin(META_CLAIM_FIELD_DESC);
        {
          ...
          for (TDDIClaimRef _iter1725 : struct.MetaClaim)
          {
      ...
      if (struct.Source != null) {
        oprot.writeFieldBegin(SOURCE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1726 : struct.Source)
          {
      ...
      if (struct.Target != null) {
        oprot.writeFieldBegin(TARGET_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1727 : struct.Target)
          {
            _iter1727.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIAssertedArtifactContextTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAssertedArtifactContext> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1728 : struct.ImplementationConstraint)
          {
            _iter1728.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1729 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1730 : struct.TaggedValue)
          {
      ...
      if (struct.isSetMetaClaim()) {
        {
          ...
          for (TDDIClaimRef _iter1731 : struct.MetaClaim)
          {
            _iter1731.write(oprot);
          }
        }
      }
      if (struct.isSetIsCounter()) {
      ...
      if (struct.isSetSource()) {
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1732 : struct.Source)
          {
            _iter1732.write(oprot);
          }
        }
      }
      if (struct.isSetTarget()) {
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1733 : struct.Target)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAssertedArtifactContext struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1734 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1734.size);
          TDDIImplementationConstraintRef _elem1735;
          for (int _i1736 = 0; _i1736 < _list1734.size; ++_i1736)
          {
            _elem1735 = new TDDIImplementationConstraintRef();
            _elem1735.read(iprot);
            struct.ImplementationConstraint.add(_elem1735);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1737.size);
          TDDINoteRef _elem1738;
          for (int _i1739 = 0; _i1739 < _list1737.size; ++_i1739)
          {
            _elem1738 = new TDDINoteRef();
            _elem1738.read(iprot);
            struct.Note.add(_elem1738);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1740 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1740.size);
          TDDITaggedValueRef _elem1741;
          for (int _i1742 = 0; _i1742 < _list1740.size; ++_i1742)
          {
            _elem1741 = new TDDITaggedValueRef();
            _elem1741.read(iprot);
            struct.TaggedValue.add(_elem1741);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list1743 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list1743.size);
          TDDIClaimRef _elem1744;
          for (int _i1745 = 0; _i1745 < _list1743.size; ++_i1745)
          {
            _elem1744 = new TDDIClaimRef();
            _elem1744.read(iprot);
            struct.MetaClaim.add(_elem1744);
          }
        }
        struct.setMetaClaimIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TList _list1746 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Source = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1746.size);
          TDDIAbstractArgumentAssetRef _elem1747;
          for (int _i1748 = 0; _i1748 < _list1746.size; ++_i1748)
          {
            _elem1747 = new TDDIAbstractArgumentAssetRef();
            _elem1747.read(iprot);
            struct.Source.add(_elem1747);
          }
        }
        struct.setSourceIsSet(true);
      }
      if (incoming.get(14)) {
        {
          org.apache.thrift.protocol.TList _list1749 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Target = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1749.size);
          TDDIAbstractArgumentAssetRef _elem1750;
          for (int _i1751 = 0; _i1751 < _list1749.size; ++_i1751)
          {
            _elem1750 = new TDDIAbstractArgumentAssetRef();
            _elem1750.read(iprot);
            struct.Target.add(_elem1750);
          }
        }
        struct.setTargetIsSet(true);
      }
