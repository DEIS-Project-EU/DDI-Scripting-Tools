...
public class TDDIRiskParameter implements org.apache.thrift.TBase<TDDIRiskParameter, TDDIRiskParameter._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIRiskParameter> {
  ...
  public TDDIRiskParameter setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list1056.size);
                TDDIKeyValueMap _elem1057;
                for (int _i1058 = 0; _i1058 < _list1056.size; ++_i1058)
                {
                  _elem1057 = new TDDIKeyValueMap();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIRiskParameter struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter1059 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter1060 : struct.KeyValueMaps)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list1061.size);
          TDDIKeyValueMap _elem1062;
          for (int _i1063 = 0; _i1063 < _list1061.size; ++_i1063)
          {
            _elem1062 = new TDDIKeyValueMap();
            _elem1062.read(iprot);
            struct.KeyValueMaps.add(_elem1062);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
