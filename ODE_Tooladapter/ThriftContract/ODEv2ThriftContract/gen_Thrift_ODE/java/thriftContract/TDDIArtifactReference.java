...
public class TDDIArtifactReference implements org.apache.thrift.TBase<TDDIArtifactReference, TDDIArtifactReference._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArtifactReference> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1432.size);
                TDDIImplementationConstraintRef _elem1433;
                for (int _i1434 = 0; _i1434 < _list1432.size; ++_i1434)
                {
                  _elem1433 = new TDDIImplementationConstraintRef();
                  _elem1433.read(iprot);
                  struct.ImplementationConstraint.add(_elem1433);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1435.size);
                TDDINoteRef _elem1436;
                for (int _i1437 = 0; _i1437 < _list1435.size; ++_i1437)
                {
                  _elem1436 = new TDDINoteRef();
                  _elem1436.read(iprot);
                  struct.Note.add(_elem1436);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1438.size);
                TDDITaggedValueRef _elem1439;
                for (int _i1440 = 0; _i1440 < _list1438.size; ++_i1440)
                {
                  _elem1439 = new TDDITaggedValueRef();
                  _elem1439.read(iprot);
                  struct.TaggedValue.add(_elem1439);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ReferencedArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list1441.size);
                TDDIAbstractArtifactElementRef _elem1442;
                for (int _i1443 = 0; _i1443 < _list1441.size; ++_i1443)
                {
                  _elem1442 = new TDDIAbstractArtifactElementRef();
                  _elem1442.read(iprot);
                  struct.ReferencedArtifactElement.add(_elem1442);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArtifactReference struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1444 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1445 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1446 : struct.TaggedValue)
          {
      ...
      if (struct.ReferencedArtifactElement != null) {
        oprot.writeFieldBegin(REFERENCED_ARTIFACT_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter1447 : struct.ReferencedArtifactElement)
          {
  ...
  private static class TDDIArtifactReferenceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArtifactReference> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1448 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1449 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1450 : struct.TaggedValue)
          {
      ...
      if (struct.isSetReferencedArtifactElement()) {
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter1451 : struct.ReferencedArtifactElement)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArtifactReference struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1452 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1452.size);
          TDDIImplementationConstraintRef _elem1453;
          for (int _i1454 = 0; _i1454 < _list1452.size; ++_i1454)
          {
            _elem1453 = new TDDIImplementationConstraintRef();
            _elem1453.read(iprot);
            struct.ImplementationConstraint.add(_elem1453);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1455.size);
          TDDINoteRef _elem1456;
          for (int _i1457 = 0; _i1457 < _list1455.size; ++_i1457)
          {
            _elem1456 = new TDDINoteRef();
            _elem1456.read(iprot);
            struct.Note.add(_elem1456);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1458 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1458.size);
          TDDITaggedValueRef _elem1459;
          for (int _i1460 = 0; _i1460 < _list1458.size; ++_i1460)
          {
            _elem1459 = new TDDITaggedValueRef();
            _elem1459.read(iprot);
            struct.TaggedValue.add(_elem1459);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list1461 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ReferencedArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list1461.size);
          TDDIAbstractArtifactElementRef _elem1462;
          for (int _i1463 = 0; _i1463 < _list1461.size; ++_i1463)
          {
            _elem1462 = new TDDIAbstractArtifactElementRef();
            _elem1462.read(iprot);
            struct.ReferencedArtifactElement.add(_elem1462);
          }
        }
        struct.setReferencedArtifactElementIsSet(true);
      }
