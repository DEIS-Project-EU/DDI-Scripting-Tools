...
public class TDDIHuman implements org.apache.thrift.TBase<TDDIHuman, TDDIHuman._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIHuman> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2984.size);
                TDDIKeyValueMap _elem2985;
                for (int _i2986 = 0; _i2986 < _list2984.size; ++_i2986)
                {
                  _elem2985 = new TDDIKeyValueMap();
                  _elem2985.read(iprot);
                  struct.KeyValueMaps.add(_elem2985);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list2987.size);
                TDDIAttackerGoal _elem2988;
                for (int _i2989 = 0; _i2989 < _list2987.size; ++_i2989)
                {
                  _elem2988 = new TDDIAttackerGoal();
                  _elem2988.read(iprot);
                  struct.AttackerGoals.add(_elem2988);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Actions = new java.util.ArrayList<TDDIActionRef>(_list2990.size);
                TDDIActionRef _elem2991;
                for (int _i2992 = 0; _i2992 < _list2990.size; ++_i2992)
                {
                  _elem2991 = new TDDIActionRef();
                  _elem2991.read(iprot);
                  struct.Actions.add(_elem2991);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIHuman struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2993 : struct.KeyValueMaps)
          {
            _iter2993.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AttackerGoals != null) {
        oprot.writeFieldBegin(ATTACKER_GOALS_FIELD_DESC);
        {
          ...
          for (TDDIAttackerGoal _iter2994 : struct.AttackerGoals)
          {
            _iter2994.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Actions != null) {
        oprot.writeFieldBegin(ACTIONS_FIELD_DESC);
        {
          ...
          for (TDDIActionRef _iter2995 : struct.Actions)
          {
            _iter2995.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIHumanTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIHuman> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2996 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetAttackerGoals()) {
        {
          ...
          for (TDDIAttackerGoal _iter2997 : struct.AttackerGoals)
          {
      ...
      if (struct.isSetActions()) {
        {
          ...
          for (TDDIActionRef _iter2998 : struct.Actions)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIHuman struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2999 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2999.size);
          TDDIKeyValueMap _elem3000;
          for (int _i3001 = 0; _i3001 < _list2999.size; ++_i3001)
          {
            _elem3000 = new TDDIKeyValueMap();
            _elem3000.read(iprot);
            struct.KeyValueMaps.add(_elem3000);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list3002 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list3002.size);
          TDDIAttackerGoal _elem3003;
          for (int _i3004 = 0; _i3004 < _list3002.size; ++_i3004)
          {
            _elem3003 = new TDDIAttackerGoal();
            _elem3003.read(iprot);
            struct.AttackerGoals.add(_elem3003);
          }
        }
        struct.setAttackerGoalsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list3005 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Actions = new java.util.ArrayList<TDDIActionRef>(_list3005.size);
          TDDIActionRef _elem3006;
          for (int _i3007 = 0; _i3007 < _list3005.size; ++_i3007)
          {
            _elem3006 = new TDDIActionRef();
            _elem3006.read(iprot);
            struct.Actions.add(_elem3006);
          }
        }
        struct.setActionsIsSet(true);
      }
