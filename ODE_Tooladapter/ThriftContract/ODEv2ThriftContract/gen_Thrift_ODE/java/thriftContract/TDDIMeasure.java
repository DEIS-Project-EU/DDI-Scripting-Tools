...
public class TDDIMeasure implements org.apache.thrift.TBase<TDDIMeasure, TDDIMeasure._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIMeasure> {
  ...
  public TDDIMeasure setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list16.size);
                TDDIKeyValueMap _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new TDDIKeyValueMap();
                  _elem17.read(iprot);
                  struct.KeyValueMaps.add(_elem17);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIMeasure struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter19 : struct.KeyValueMaps)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter20 : struct.KeyValueMaps)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list21.size);
          TDDIKeyValueMap _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new TDDIKeyValueMap();
            _elem22.read(iprot);
            struct.KeyValueMaps.add(_elem22);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
