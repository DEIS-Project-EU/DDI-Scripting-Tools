...
public class TDDIAttack implements org.apache.thrift.TBase<TDDIAttack, TDDIAttack._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAttack> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2856.size);
                TDDIKeyValueMap _elem2857;
                for (int _i2858 = 0; _i2858 < _list2856.size; ++_i2858)
                {
                  _elem2857 = new TDDIKeyValueMap();
                  _elem2857.read(iprot);
                  struct.KeyValueMaps.add(_elem2857);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // EXPLOITED_VULNERABILITIES
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2859 = iprot.readListBegin();
                struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2859.size);
                TDDIVulnerabilityRef _elem2860;
                for (int _i2861 = 0; _i2861 < _list2859.size; ++_i2861)
                {
                  _elem2860 = new TDDIVulnerabilityRef();
                  _elem2860.read(iprot);
                  struct.ExploitedVulnerabilities.add(_elem2860);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // VIOLATIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2862 = iprot.readListBegin();
                struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2862.size);
                TDDISecurityViolationRef _elem2863;
                for (int _i2864 = 0; _i2864 < _list2862.size; ++_i2864)
                {
                  _elem2863 = new TDDISecurityViolationRef();
                  _elem2863.read(iprot);
                  struct.Violations.add(_elem2863);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAttack struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2865 : struct.KeyValueMaps)
          {
            _iter2865.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ExploitedVulnerabilities != null) {
        oprot.writeFieldBegin(EXPLOITED_VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerabilityRef _iter2866 : struct.ExploitedVulnerabilities)
          {
            _iter2866.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Violations != null) {
        oprot.writeFieldBegin(VIOLATIONS_FIELD_DESC);
        {
          ...
          for (TDDISecurityViolationRef _iter2867 : struct.Violations)
          {
            _iter2867.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIAttackTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAttack> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2868 : struct.KeyValueMaps)
          {
            _iter2868.write(oprot);
          }
        }
      }
      if (struct.isSetCategory()) {
      ...
      if (struct.isSetExploitedVulnerabilities()) {
        {
          ...
          for (TDDIVulnerabilityRef _iter2869 : struct.ExploitedVulnerabilities)
          {
            _iter2869.write(oprot);
          }
        }
      }
      if (struct.isSetViolations()) {
        {
          ...
          for (TDDISecurityViolationRef _iter2870 : struct.Violations)
          {
            _iter2870.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAttack struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2871 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2871.size);
          TDDIKeyValueMap _elem2872;
          for (int _i2873 = 0; _i2873 < _list2871.size; ++_i2873)
          {
            _elem2872 = new TDDIKeyValueMap();
            _elem2872.read(iprot);
            struct.KeyValueMaps.add(_elem2872);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list2874 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2874.size);
          TDDIVulnerabilityRef _elem2875;
          for (int _i2876 = 0; _i2876 < _list2874.size; ++_i2876)
          {
            _elem2875 = new TDDIVulnerabilityRef();
            _elem2875.read(iprot);
            struct.ExploitedVulnerabilities.add(_elem2875);
          }
        }
        struct.setExploitedVulnerabilitiesIsSet(true);
      }
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TList _list2877 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2877.size);
          TDDISecurityViolationRef _elem2878;
          for (int _i2879 = 0; _i2879 < _list2877.size; ++_i2879)
          {
            _elem2878 = new TDDISecurityViolationRef();
            _elem2878.read(iprot);
            struct.Violations.add(_elem2878);
          }
        }
        struct.setViolationsIsSet(true);
      }
