...
public class TDDIMinimalCutSet implements org.apache.thrift.TBase<TDDIMinimalCutSet, TDDIMinimalCutSet._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIMinimalCutSet> {
  ...
  private static final org.apache.thrift.protocol.TField FAILURES_FIELD_DESC = new org.apache.thrift.protocol.TField("Failures", org.apache.thrift.protocol.TType.LIST, (short)5);
  ...
  public TDDIMinimalCutSet setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIMinimalCutSet setFailures(java.util.List<TDDIAbstractFailureRef> Failures) {
    this.Failures = Failures;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list824.size);
                TDDIKeyValueMap _elem825;
                for (int _i826 = 0; _i826 < _list824.size; ++_i826)
                {
                  _elem825 = new TDDIKeyValueMap();
                  _elem825.read(iprot);
                  struct.KeyValueMaps.add(_elem825);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Failures = new java.util.ArrayList<TDDIAbstractFailureRef>(_list827.size);
                TDDIAbstractFailureRef _elem828;
                for (int _i829 = 0; _i829 < _list827.size; ++_i829)
                {
                  _elem828 = new TDDIAbstractFailureRef();
                  _elem828.read(iprot);
                  struct.Failures.add(_elem828);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIMinimalCutSet struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter830 : struct.KeyValueMaps)
          {
      ...
      if (struct.Failures != null) {
        oprot.writeFieldBegin(FAILURES_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureRef _iter831 : struct.Failures)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter832 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetFailures()) {
        {
          ...
          for (TDDIAbstractFailureRef _iter833 : struct.Failures)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list834.size);
          TDDIKeyValueMap _elem835;
          for (int _i836 = 0; _i836 < _list834.size; ++_i836)
          {
            _elem835 = new TDDIKeyValueMap();
            _elem835.read(iprot);
            struct.KeyValueMaps.add(_elem835);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.Failures = new java.util.ArrayList<TDDIAbstractFailureRef>(_list837.size);
          TDDIAbstractFailureRef _elem838;
          for (int _i839 = 0; _i839 < _list837.size; ++_i839)
          {
            _elem838 = new TDDIAbstractFailureRef();
            _elem838.read(iprot);
            struct.Failures.add(_elem838);
          }
        }
        struct.setFailuresIsSet(true);
      }
