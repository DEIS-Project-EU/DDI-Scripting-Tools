...
public class TDDINonHuman implements org.apache.thrift.TBase<TDDINonHuman, TDDINonHuman._Fields>, java.io.Serializable, Cloneable, Comparable<TDDINonHuman> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3008 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list3008.size);
                TDDIKeyValueMap _elem3009;
                for (int _i3010 = 0; _i3010 < _list3008.size; ++_i3010)
                {
                  _elem3009 = new TDDIKeyValueMap();
                  _elem3009.read(iprot);
                  struct.KeyValueMaps.add(_elem3009);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // ATTACKER_GOALS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3011 = iprot.readListBegin();
                struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list3011.size);
                TDDIAttackerGoal _elem3012;
                for (int _i3013 = 0; _i3013 < _list3011.size; ++_i3013)
                {
                  _elem3012 = new TDDIAttackerGoal();
                  _elem3012.read(iprot);
                  struct.AttackerGoals.add(_elem3012);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // PAYLOADS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3014 = iprot.readListBegin();
                struct.Payloads = new java.util.ArrayList<TDDIPayloadRef>(_list3014.size);
                TDDIPayloadRef _elem3015;
                for (int _i3016 = 0; _i3016 < _list3014.size; ++_i3016)
                {
                  _elem3015 = new TDDIPayloadRef();
                  _elem3015.read(iprot);
                  struct.Payloads.add(_elem3015);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDINonHuman struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter3017 : struct.KeyValueMaps)
          {
            _iter3017.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AttackerGoals != null) {
        oprot.writeFieldBegin(ATTACKER_GOALS_FIELD_DESC);
        {
          ...
          for (TDDIAttackerGoal _iter3018 : struct.AttackerGoals)
          {
            _iter3018.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Payloads != null) {
        oprot.writeFieldBegin(PAYLOADS_FIELD_DESC);
        {
          ...
          for (TDDIPayloadRef _iter3019 : struct.Payloads)
          {
            _iter3019.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDINonHumanTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDINonHuman> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter3020 : struct.KeyValueMaps)
          {
            _iter3020.write(oprot);
          }
        }
      }
      if (struct.isSetSkillLevel()) {
      ...
      if (struct.isSetAttackerGoals()) {
        {
          ...
          for (TDDIAttackerGoal _iter3021 : struct.AttackerGoals)
          {
            _iter3021.write(oprot);
          }
        }
      }
      if (struct.isSetPayloads()) {
        {
          ...
          for (TDDIPayloadRef _iter3022 : struct.Payloads)
          {
            _iter3022.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDINonHuman struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list3023 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list3023.size);
          TDDIKeyValueMap _elem3024;
          for (int _i3025 = 0; _i3025 < _list3023.size; ++_i3025)
          {
            _elem3024 = new TDDIKeyValueMap();
            _elem3024.read(iprot);
            struct.KeyValueMaps.add(_elem3024);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list3026 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list3026.size);
          TDDIAttackerGoal _elem3027;
          for (int _i3028 = 0; _i3028 < _list3026.size; ++_i3028)
          {
            _elem3027 = new TDDIAttackerGoal();
            _elem3027.read(iprot);
            struct.AttackerGoals.add(_elem3027);
          }
        }
        struct.setAttackerGoalsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list3029 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Payloads = new java.util.ArrayList<TDDIPayloadRef>(_list3029.size);
          TDDIPayloadRef _elem3030;
          for (int _i3031 = 0; _i3031 < _list3029.size; ++_i3031)
          {
            _elem3030 = new TDDIPayloadRef();
            _elem3030.read(iprot);
            struct.Payloads.add(_elem3030);
          }
        }
        struct.setPayloadsIsSet(true);
      }
