...
public class TDDINonHuman implements org.apache.thrift.TBase<TDDINonHuman, TDDINonHuman._Fields>, java.io.Serializable, Cloneable, Comparable<TDDINonHuman> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDINonHuman");
  ...
  private static final org.apache.thrift.protocol.TField PAYLOADS_FIELD_DESC = new org.apache.thrift.protocol.TField("Payloads", org.apache.thrift.protocol.TType.LIST, (short)9);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDINonHumanStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDINonHumanTupleSchemeFactory();
  ...
  public java.util.List<TDDIPayloadRef> Payloads; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.PAYLOADS, new org.apache.thrift.meta_data.FieldMetaData("Payloads", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TDDIPayloadRef.class))));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDINonHuman.class, metaDataMap);
  }
  ...
  public TDDINonHuman() {
    ...
    this.Payloads = new java.util.ArrayList<TDDIPayloadRef>();
  ...
  public TDDINonHuman(
    ...
    java.util.List<TDDIPayloadRef> Payloads)
  {
    this();
    this.Id = Id;
    setIdIsSet(true);
   ...
   */
  public TDDINonHuman(TDDINonHuman other) {
    ...
    if (other.isSetPayloads()) {
      java.util.List<TDDIPayloadRef> __this__Payloads = new java.util.ArrayList<TDDIPayloadRef>(other.Payloads.size());
      for (TDDIPayloadRef other_element : other.Payloads) {
        __this__Payloads.add(new TDDIPayloadRef(other_element));
      }
      this.Payloads = __this__Payloads;
    }
  }

  public TDDINonHuman deepCopy() {
    return new TDDINonHuman(this);
  }
  ...
  public TDDINonHuman setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDINonHuman setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDINonHuman setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDINonHuman setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDINonHuman setSkillLevel(java.lang.String SkillLevel) {
    this.SkillLevel = SkillLevel;
    return this;
  }
  ...
  public TDDINonHuman setMotivation(java.lang.String Motivation) {
    this.Motivation = Motivation;
    return this;
  }
  ...
  public TDDINonHuman setAnonymityDesire(java.lang.String AnonymityDesire) {
    this.AnonymityDesire = AnonymityDesire;
    return this;
  }
  ...
  public TDDINonHuman setAttackerGoals(java.util.List<TDDIAttackerGoal> AttackerGoals) {
    this.AttackerGoals = AttackerGoals;
    return this;
  }
  ...
  public java.util.Iterator<TDDIPayloadRef> getPayloadsIterator() {
    return (this.Payloads == null) ? null : this.Payloads.iterator();
  }

  public void addToPayloads(TDDIPayloadRef elem) {
  ...
  public java.util.List<TDDIPayloadRef> getPayloads() {
    return this.Payloads;
  }

  public TDDINonHuman setPayloads(java.util.List<TDDIPayloadRef> Payloads) {
    this.Payloads = Payloads;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PAYLOADS:
      if (value == null) {
        ...
        setPayloads((java.util.List<TDDIPayloadRef>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDINonHuman)
      return this.equals((TDDINonHuman)that);
    return false;
  }

  public boolean equals(TDDINonHuman that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDINonHuman other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDINonHuman(");
    boolean first = true;
  ...
  private static class TDDINonHumanStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDINonHumanStandardScheme getScheme() {
      return new TDDINonHumanStandardScheme();
    }
  }

  private static class TDDINonHumanStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDINonHuman> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDINonHuman struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3000 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list3000.size);
                TDDIKeyValueMap _elem3001;
                for (int _i3002 = 0; _i3002 < _list3000.size; ++_i3002)
                {
                  _elem3001 = new TDDIKeyValueMap();
                  _elem3001.read(iprot);
                  struct.KeyValueMaps.add(_elem3001);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // ATTACKER_GOALS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3003 = iprot.readListBegin();
                struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list3003.size);
                TDDIAttackerGoal _elem3004;
                for (int _i3005 = 0; _i3005 < _list3003.size; ++_i3005)
                {
                  _elem3004 = new TDDIAttackerGoal();
                  _elem3004.read(iprot);
                  struct.AttackerGoals.add(_elem3004);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // PAYLOADS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3006 = iprot.readListBegin();
                struct.Payloads = new java.util.ArrayList<TDDIPayloadRef>(_list3006.size);
                TDDIPayloadRef _elem3007;
                for (int _i3008 = 0; _i3008 < _list3006.size; ++_i3008)
                {
                  _elem3007 = new TDDIPayloadRef();
                  _elem3007.read(iprot);
                  struct.Payloads.add(_elem3007);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDINonHuman struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter3009 : struct.KeyValueMaps)
          {
            _iter3009.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AttackerGoals != null) {
        oprot.writeFieldBegin(ATTACKER_GOALS_FIELD_DESC);
        {
          ...
          for (TDDIAttackerGoal _iter3010 : struct.AttackerGoals)
          {
            _iter3010.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Payloads != null) {
        oprot.writeFieldBegin(PAYLOADS_FIELD_DESC);
        {
          ...
          for (TDDIPayloadRef _iter3011 : struct.Payloads)
          {
            _iter3011.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDINonHumanTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDINonHumanTupleScheme getScheme() {
      return new TDDINonHumanTupleScheme();
    }
  }

  private static class TDDINonHumanTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDINonHuman> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDINonHuman struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter3012 : struct.KeyValueMaps)
          {
            _iter3012.write(oprot);
          }
        }
      }
      if (struct.isSetSkillLevel()) {
      ...
      if (struct.isSetAttackerGoals()) {
        {
          ...
          for (TDDIAttackerGoal _iter3013 : struct.AttackerGoals)
          {
            _iter3013.write(oprot);
          }
        }
      }
      if (struct.isSetPayloads()) {
        {
          ...
          for (TDDIPayloadRef _iter3014 : struct.Payloads)
          {
            _iter3014.write(oprot);
          }
        }
      }
    }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDINonHuman struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list3015 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list3015.size);
          TDDIKeyValueMap _elem3016;
          for (int _i3017 = 0; _i3017 < _list3015.size; ++_i3017)
          {
            _elem3016 = new TDDIKeyValueMap();
            _elem3016.read(iprot);
            struct.KeyValueMaps.add(_elem3016);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list3018 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list3018.size);
          TDDIAttackerGoal _elem3019;
          for (int _i3020 = 0; _i3020 < _list3018.size; ++_i3020)
          {
            _elem3019 = new TDDIAttackerGoal();
            _elem3019.read(iprot);
            struct.AttackerGoals.add(_elem3019);
          }
        }
        struct.setAttackerGoalsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list3021 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Payloads = new java.util.ArrayList<TDDIPayloadRef>(_list3021.size);
          TDDIPayloadRef _elem3022;
          for (int _i3023 = 0; _i3023 < _list3021.size; ++_i3023)
          {
            _elem3022 = new TDDIPayloadRef();
            _elem3022.read(iprot);
            struct.Payloads.add(_elem3022);
          }
        }
        struct.setPayloadsIsSet(true);
      }
