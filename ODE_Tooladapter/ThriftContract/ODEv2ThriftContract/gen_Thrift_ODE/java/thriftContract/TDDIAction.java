...
public class TDDIAction implements org.apache.thrift.TBase<TDDIAction, TDDIAction._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAction> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIAction");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIActionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIActionTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIAction.class, metaDataMap);
  }
   ...
   */
  public TDDIAction(TDDIAction other) {
  ...
  public TDDIAction deepCopy() {
    return new TDDIAction(this);
  }
  ...
  public TDDIAction setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIAction setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIAction setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIAction setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIAction setCategory(java.lang.String Category) {
    this.Category = Category;
    return this;
  }
  ...
  public TDDIAction setFinancialCost(double FinancialCost) {
    this.FinancialCost = FinancialCost;
    setFinancialCostIsSet(true);
    return this;
  }
   ...
   * @see TDDIFinancialCostType
   */
  public TDDIAction setFinancialCostType(TDDIFinancialCostType FinancialCostType) {
    this.FinancialCostType = FinancialCostType;
    return this;
  }
  ...
  public TDDIAction setTimeRequired(double TimeRequired) {
    this.TimeRequired = TimeRequired;
    setTimeRequiredIsSet(true);
    return this;
  }
   ...
   * @see TDDITimeUnit
   */
  public TDDIAction setTimeUnit(TDDITimeUnit TimeUnit) {
    this.TimeUnit = TimeUnit;
    return this;
  }
  ...
  public TDDIAction setDifficulty(java.lang.String Difficulty) {
    this.Difficulty = Difficulty;
    return this;
  }
  ...
  public TDDIAction setDetectability(java.lang.String Detectability) {
    this.Detectability = Detectability;
    return this;
  }
  ...
  public TDDIAction setExploitedVulnerabilities(java.util.List<TDDIVulnerabilityRef> ExploitedVulnerabilities) {
    this.ExploitedVulnerabilities = ExploitedVulnerabilities;
    return this;
  }
  ...
  public TDDIAction setViolations(java.util.List<TDDISecurityViolationRef> Violations) {
    this.Violations = Violations;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIAction)
      return this.equals((TDDIAction)that);
    return false;
  }

  public boolean equals(TDDIAction that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIAction other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIAction(");
    boolean first = true;
  ...
  private static class TDDIActionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIActionStandardScheme getScheme() {
      return new TDDIActionStandardScheme();
    }
  }

  private static class TDDIActionStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIAction> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIAction struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2880.size);
                TDDIKeyValueMap _elem2881;
                for (int _i2882 = 0; _i2882 < _list2880.size; ++_i2882)
                {
                  _elem2881 = new TDDIKeyValueMap();
                  _elem2881.read(iprot);
                  struct.KeyValueMaps.add(_elem2881);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // EXPLOITED_VULNERABILITIES
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2883 = iprot.readListBegin();
                struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2883.size);
                TDDIVulnerabilityRef _elem2884;
                for (int _i2885 = 0; _i2885 < _list2883.size; ++_i2885)
                {
                  _elem2884 = new TDDIVulnerabilityRef();
                  _elem2884.read(iprot);
                  struct.ExploitedVulnerabilities.add(_elem2884);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // VIOLATIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2886 = iprot.readListBegin();
                struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2886.size);
                TDDISecurityViolationRef _elem2887;
                for (int _i2888 = 0; _i2888 < _list2886.size; ++_i2888)
                {
                  _elem2887 = new TDDISecurityViolationRef();
                  _elem2887.read(iprot);
                  struct.Violations.add(_elem2887);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAction struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2889 : struct.KeyValueMaps)
          {
            _iter2889.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ExploitedVulnerabilities != null) {
        oprot.writeFieldBegin(EXPLOITED_VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerabilityRef _iter2890 : struct.ExploitedVulnerabilities)
          {
            _iter2890.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Violations != null) {
        oprot.writeFieldBegin(VIOLATIONS_FIELD_DESC);
        {
          ...
          for (TDDISecurityViolationRef _iter2891 : struct.Violations)
          {
  ...
  private static class TDDIActionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIActionTupleScheme getScheme() {
      return new TDDIActionTupleScheme();
    }
  }

  private static class TDDIActionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAction> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIAction struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2892 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetExploitedVulnerabilities()) {
        {
          ...
          for (TDDIVulnerabilityRef _iter2893 : struct.ExploitedVulnerabilities)
          {
            _iter2893.write(oprot);
          }
        }
      }
      if (struct.isSetViolations()) {
        {
          ...
          for (TDDISecurityViolationRef _iter2894 : struct.Violations)
          {
            _iter2894.write(oprot);
          }
        }
      }
    }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAction struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2895 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2895.size);
          TDDIKeyValueMap _elem2896;
          for (int _i2897 = 0; _i2897 < _list2895.size; ++_i2897)
          {
            _elem2896 = new TDDIKeyValueMap();
            _elem2896.read(iprot);
            struct.KeyValueMaps.add(_elem2896);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list2898 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2898.size);
          TDDIVulnerabilityRef _elem2899;
          for (int _i2900 = 0; _i2900 < _list2898.size; ++_i2900)
          {
            _elem2899 = new TDDIVulnerabilityRef();
            _elem2899.read(iprot);
            struct.ExploitedVulnerabilities.add(_elem2899);
          }
        }
        struct.setExploitedVulnerabilitiesIsSet(true);
      }
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TList _list2901 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2901.size);
          TDDISecurityViolationRef _elem2902;
          for (int _i2903 = 0; _i2903 < _list2901.size; ++_i2903)
          {
            _elem2902 = new TDDISecurityViolationRef();
            _elem2902.read(iprot);
            struct.Violations.add(_elem2902);
          }
        }
        struct.setViolationsIsSet(true);
      }
