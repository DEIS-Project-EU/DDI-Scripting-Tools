...
public class TDDIAction implements org.apache.thrift.TBase<TDDIAction, TDDIAction._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAction> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2888.size);
                TDDIKeyValueMap _elem2889;
                for (int _i2890 = 0; _i2890 < _list2888.size; ++_i2890)
                {
                  _elem2889 = new TDDIKeyValueMap();
                  _elem2889.read(iprot);
                  struct.KeyValueMaps.add(_elem2889);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // EXPLOITED_VULNERABILITIES
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2891 = iprot.readListBegin();
                struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2891.size);
                TDDIVulnerabilityRef _elem2892;
                for (int _i2893 = 0; _i2893 < _list2891.size; ++_i2893)
                {
                  _elem2892 = new TDDIVulnerabilityRef();
                  _elem2892.read(iprot);
                  struct.ExploitedVulnerabilities.add(_elem2892);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // VIOLATIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2894 = iprot.readListBegin();
                struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2894.size);
                TDDISecurityViolationRef _elem2895;
                for (int _i2896 = 0; _i2896 < _list2894.size; ++_i2896)
                {
                  _elem2895 = new TDDISecurityViolationRef();
                  _elem2895.read(iprot);
                  struct.Violations.add(_elem2895);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAction struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2897 : struct.KeyValueMaps)
          {
            _iter2897.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ExploitedVulnerabilities != null) {
        oprot.writeFieldBegin(EXPLOITED_VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerabilityRef _iter2898 : struct.ExploitedVulnerabilities)
          {
            _iter2898.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Violations != null) {
        oprot.writeFieldBegin(VIOLATIONS_FIELD_DESC);
        {
          ...
          for (TDDISecurityViolationRef _iter2899 : struct.Violations)
          {
  ...
  private static class TDDIActionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAction> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2900 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetExploitedVulnerabilities()) {
        {
          ...
          for (TDDIVulnerabilityRef _iter2901 : struct.ExploitedVulnerabilities)
          {
      ...
      if (struct.isSetViolations()) {
        {
          ...
          for (TDDISecurityViolationRef _iter2902 : struct.Violations)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAction struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2903 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2903.size);
          TDDIKeyValueMap _elem2904;
          for (int _i2905 = 0; _i2905 < _list2903.size; ++_i2905)
          {
            _elem2904 = new TDDIKeyValueMap();
            _elem2904.read(iprot);
            struct.KeyValueMaps.add(_elem2904);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list2906 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2906.size);
          TDDIVulnerabilityRef _elem2907;
          for (int _i2908 = 0; _i2908 < _list2906.size; ++_i2908)
          {
            _elem2907 = new TDDIVulnerabilityRef();
            _elem2907.read(iprot);
            struct.ExploitedVulnerabilities.add(_elem2907);
          }
        }
        struct.setExploitedVulnerabilitiesIsSet(true);
      }
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TList _list2909 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2909.size);
          TDDISecurityViolationRef _elem2910;
          for (int _i2911 = 0; _i2911 < _list2909.size; ++_i2911)
          {
            _elem2910 = new TDDISecurityViolationRef();
            _elem2910.read(iprot);
            struct.Violations.add(_elem2910);
          }
        }
        struct.setViolationsIsSet(true);
      }
