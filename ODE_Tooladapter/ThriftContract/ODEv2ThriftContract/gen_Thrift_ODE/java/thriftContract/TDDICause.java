...
public class TDDICause implements org.apache.thrift.TBase<TDDICause, TDDICause._Fields>, java.io.Serializable, Cloneable, Comparable<TDDICause> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDICause");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDICauseStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDICauseTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDICause.class, metaDataMap);
  }
   ...
   */
  public TDDICause(TDDICause other) {
  ...
  public TDDICause deepCopy() {
    return new TDDICause(this);
  }
  ...
  public TDDICause setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDICause setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDICause setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDICause setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
   ...
   * @see TDDICauseType
   */
  public TDDICause setType(TDDICauseType Type) {
    this.Type = Type;
    return this;
  }
  ...
  public TDDICause setFailure(TDDIAbstractFailure Failure) {
    this.Failure = Failure;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDICause)
      return this.equals((TDDICause)that);
    return false;
  }

  public boolean equals(TDDICause that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDICause other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDICause(");
    boolean first = true;
  ...
  private static class TDDICauseStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDICauseStandardScheme getScheme() {
      return new TDDICauseStandardScheme();
    }
  }

  private static class TDDICauseStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDICause> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDICause struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list968.size);
                TDDIKeyValueMap _elem969;
                for (int _i970 = 0; _i970 < _list968.size; ++_i970)
                {
                  _elem969 = new TDDIKeyValueMap();
                  _elem969.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDICause struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter971 : struct.KeyValueMaps)
          {
  ...
  private static class TDDICauseTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDICauseTupleScheme getScheme() {
      return new TDDICauseTupleScheme();
    }
  }

  private static class TDDICauseTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDICause> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDICause struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter972 : struct.KeyValueMaps)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDICause struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list973.size);
          TDDIKeyValueMap _elem974;
          for (int _i975 = 0; _i975 < _list973.size; ++_i975)
          {
            _elem974 = new TDDIKeyValueMap();
            _elem974.read(iprot);
            struct.KeyValueMaps.add(_elem974);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
