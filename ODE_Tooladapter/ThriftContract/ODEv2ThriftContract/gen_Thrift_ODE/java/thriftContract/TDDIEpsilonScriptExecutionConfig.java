...
public class TDDIEpsilonScriptExecutionConfig implements org.apache.thrift.TBase<TDDIEpsilonScriptExecutionConfig, TDDIEpsilonScriptExecutionConfig._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIEpsilonScriptExecutionConfig> {
  ...
  static {
    ...
    tmpMap.put(_Fields.MODEL_CONFIGS, new org.apache.thrift.meta_data.FieldMetaData("ModelConfigs", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "TDDIEpsilonScriptModelConfig"))));
    tmpMap.put(_Fields.EXPORT_PARAMETERS, new org.apache.thrift.meta_data.FieldMetaData("ExportParameters", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "TDDIEpsilonParameter"))));
        ...
        switch (schemeField.id) {
          ...
          case 5: // MODEL_CONFIGS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2760 = iprot.readListBegin();
                struct.ModelConfigs = new java.util.ArrayList<TDDIEpsilonScriptModelConfig>(_list2760.size);
                TDDIEpsilonScriptModelConfig _elem2761;
                for (int _i2762 = 0; _i2762 < _list2760.size; ++_i2762)
                {
                  _elem2761 = new TDDIEpsilonScriptModelConfig();
                  _elem2761.read(iprot);
                  struct.ModelConfigs.add(_elem2761);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // EXPORT_PARAMETERS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2763 = iprot.readListBegin();
                struct.ExportParameters = new java.util.ArrayList<TDDIEpsilonParameter>(_list2763.size);
                TDDIEpsilonParameter _elem2764;
                for (int _i2765 = 0; _i2765 < _list2763.size; ++_i2765)
                {
                  _elem2764 = new TDDIEpsilonParameter();
                  _elem2764.read(iprot);
                  struct.ExportParameters.add(_elem2764);
                }
                iprot.readListEnd();
              }
          ...
          case 7: // IMPORT_PARAMETERS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2766 = iprot.readListBegin();
                struct.ImportParameters = new java.util.ArrayList<TDDIEpsilonParameter>(_list2766.size);
                TDDIEpsilonParameter _elem2767;
                for (int _i2768 = 0; _i2768 < _list2766.size; ++_i2768)
                {
                  _elem2767 = new TDDIEpsilonParameter();
                  _elem2767.read(iprot);
                  struct.ImportParameters.add(_elem2767);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIEpsilonScriptExecutionConfig struct) throws org.apache.thrift.TException {
      ...
      if (struct.ModelConfigs != null) {
        oprot.writeFieldBegin(MODEL_CONFIGS_FIELD_DESC);
        {
          ...
          for (TDDIEpsilonScriptModelConfig _iter2769 : struct.ModelConfigs)
          {
      ...
      if (struct.ExportParameters != null) {
        oprot.writeFieldBegin(EXPORT_PARAMETERS_FIELD_DESC);
        {
          ...
          for (TDDIEpsilonParameter _iter2770 : struct.ExportParameters)
          {
      ...
      if (struct.ImportParameters != null) {
        oprot.writeFieldBegin(IMPORT_PARAMETERS_FIELD_DESC);
        {
          ...
          for (TDDIEpsilonParameter _iter2771 : struct.ImportParameters)
          {
  ...
  private static class TDDIEpsilonScriptExecutionConfigTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIEpsilonScriptExecutionConfig> {
      ...
      if (struct.isSetModelConfigs()) {
        {
          ...
          for (TDDIEpsilonScriptModelConfig _iter2772 : struct.ModelConfigs)
          {
      ...
      if (struct.isSetExportParameters()) {
        {
          ...
          for (TDDIEpsilonParameter _iter2773 : struct.ExportParameters)
          {
      ...
      if (struct.isSetImportParameters()) {
        {
          ...
          for (TDDIEpsilonParameter _iter2774 : struct.ImportParameters)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIEpsilonScriptExecutionConfig struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list2775 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ModelConfigs = new java.util.ArrayList<TDDIEpsilonScriptModelConfig>(_list2775.size);
          TDDIEpsilonScriptModelConfig _elem2776;
          for (int _i2777 = 0; _i2777 < _list2775.size; ++_i2777)
          {
            _elem2776 = new TDDIEpsilonScriptModelConfig();
            _elem2776.read(iprot);
            struct.ModelConfigs.add(_elem2776);
          }
        }
        struct.setModelConfigsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list2778 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ExportParameters = new java.util.ArrayList<TDDIEpsilonParameter>(_list2778.size);
          TDDIEpsilonParameter _elem2779;
          for (int _i2780 = 0; _i2780 < _list2778.size; ++_i2780)
          {
            _elem2779 = new TDDIEpsilonParameter();
            _elem2779.read(iprot);
            struct.ExportParameters.add(_elem2779);
          }
        }
        struct.setExportParametersIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.ImportParameters = new java.util.ArrayList<TDDIEpsilonParameter>(_list2781.size);
          TDDIEpsilonParameter _elem2782;
          for (int _i2783 = 0; _i2783 < _list2781.size; ++_i2783)
          {
            _elem2782 = new TDDIEpsilonParameter();
            _elem2782.read(iprot);
            struct.ImportParameters.add(_elem2782);
          }
        }
        struct.setImportParametersIsSet(true);
      }
