...
public class TDDIArgumentGroup implements org.apache.thrift.TBase<TDDIArgumentGroup, TDDIArgumentGroup._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArgumentGroup> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1464.size);
                TDDIImplementationConstraintRef _elem1465;
                for (int _i1466 = 0; _i1466 < _list1464.size; ++_i1466)
                {
                  _elem1465 = new TDDIImplementationConstraintRef();
                  _elem1465.read(iprot);
                  struct.ImplementationConstraint.add(_elem1465);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1467.size);
                TDDINoteRef _elem1468;
                for (int _i1469 = 0; _i1469 < _list1467.size; ++_i1469)
                {
                  _elem1468 = new TDDINoteRef();
                  _elem1468.read(iprot);
                  struct.Note.add(_elem1468);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1470.size);
                TDDITaggedValueRef _elem1471;
                for (int _i1472 = 0; _i1472 < _list1470.size; ++_i1472)
                {
                  _elem1471 = new TDDITaggedValueRef();
                  _elem1471.read(iprot);
                  struct.TaggedValue.add(_elem1471);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // ARGUMENTATION_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1473 = iprot.readListBegin();
                struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list1473.size);
                TDDIAbstractArgumentationElementRef _elem1474;
                for (int _i1475 = 0; _i1475 < _list1473.size; ++_i1475)
                {
                  _elem1474 = new TDDIAbstractArgumentationElementRef();
                  _elem1474.read(iprot);
                  struct.ArgumentationElement.add(_elem1474);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArgumentGroup struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1476 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1477 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1478 : struct.TaggedValue)
          {
      ...
      if (struct.ArgumentationElement != null) {
        oprot.writeFieldBegin(ARGUMENTATION_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter1479 : struct.ArgumentationElement)
          {
  ...
  private static class TDDIArgumentGroupTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArgumentGroup> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1480 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1481 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1482 : struct.TaggedValue)
          {
      ...
      if (struct.isSetArgumentationElement()) {
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter1483 : struct.ArgumentationElement)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArgumentGroup struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1484 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1484.size);
          TDDIImplementationConstraintRef _elem1485;
          for (int _i1486 = 0; _i1486 < _list1484.size; ++_i1486)
          {
            _elem1485 = new TDDIImplementationConstraintRef();
            _elem1485.read(iprot);
            struct.ImplementationConstraint.add(_elem1485);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1487.size);
          TDDINoteRef _elem1488;
          for (int _i1489 = 0; _i1489 < _list1487.size; ++_i1489)
          {
            _elem1488 = new TDDINoteRef();
            _elem1488.read(iprot);
            struct.Note.add(_elem1488);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1490 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1490.size);
          TDDITaggedValueRef _elem1491;
          for (int _i1492 = 0; _i1492 < _list1490.size; ++_i1492)
          {
            _elem1491 = new TDDITaggedValueRef();
            _elem1491.read(iprot);
            struct.TaggedValue.add(_elem1491);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list1493.size);
          TDDIAbstractArgumentationElementRef _elem1494;
          for (int _i1495 = 0; _i1495 < _list1493.size; ++_i1495)
          {
            _elem1494 = new TDDIAbstractArgumentationElementRef();
            _elem1494.read(iprot);
            struct.ArgumentationElement.add(_elem1494);
          }
        }
        struct.setArgumentationElementIsSet(true);
      }
