...
public class TDDIAttackerGoal implements org.apache.thrift.TBase<TDDIAttackerGoal, TDDIAttackerGoal._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAttackerGoal> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2936 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2936.size);
                TDDIKeyValueMap _elem2937;
                for (int _i2938 = 0; _i2938 < _list2936.size; ++_i2938)
                {
                  _elem2937 = new TDDIKeyValueMap();
                  _elem2937.read(iprot);
                  struct.KeyValueMaps.add(_elem2937);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // ATTACKS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2939 = iprot.readListBegin();
                struct.Attacks = new java.util.ArrayList<TDDIAbstractAttack>(_list2939.size);
                TDDIAbstractAttack _elem2940;
                for (int _i2941 = 0; _i2941 < _list2939.size; ++_i2941)
                {
                  _elem2940 = new TDDIAbstractAttack();
                  _elem2940.read(iprot);
                  struct.Attacks.add(_elem2940);
                }
                iprot.readListEnd();
              }
          ...
          case 7: // ADDRESSED_BY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2942 = iprot.readListBegin();
                struct.AddressedBy = new java.util.ArrayList<TDDISecurityCapability>(_list2942.size);
                TDDISecurityCapability _elem2943;
                for (int _i2944 = 0; _i2944 < _list2942.size; ++_i2944)
                {
                  _elem2943 = new TDDISecurityCapability();
                  _elem2943.read(iprot);
                  struct.AddressedBy.add(_elem2943);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // ATTACKED_ITEMS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2945 = iprot.readListBegin();
                struct.AttackedItems = new java.util.ArrayList<TDDIVulnerableItemRef>(_list2945.size);
                TDDIVulnerableItemRef _elem2946;
                for (int _i2947 = 0; _i2947 < _list2945.size; ++_i2947)
                {
                  _elem2946 = new TDDIVulnerableItemRef();
                  _elem2946.read(iprot);
                  struct.AttackedItems.add(_elem2946);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAttackerGoal struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2948 : struct.KeyValueMaps)
          {
      ...
      if (struct.Attacks != null) {
        oprot.writeFieldBegin(ATTACKS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractAttack _iter2949 : struct.Attacks)
          {
            _iter2949.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AddressedBy != null) {
        oprot.writeFieldBegin(ADDRESSED_BY_FIELD_DESC);
        {
          ...
          for (TDDISecurityCapability _iter2950 : struct.AddressedBy)
          {
            _iter2950.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AttackedItems != null) {
        oprot.writeFieldBegin(ATTACKED_ITEMS_FIELD_DESC);
        {
          ...
          for (TDDIVulnerableItemRef _iter2951 : struct.AttackedItems)
          {
            _iter2951.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIAttackerGoalTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAttackerGoal> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2952 : struct.KeyValueMaps)
          {
            _iter2952.write(oprot);
          }
        }
      }
      if (struct.isSetCategory()) {
      ...
      if (struct.isSetAttacks()) {
        {
          ...
          for (TDDIAbstractAttack _iter2953 : struct.Attacks)
          {
            _iter2953.write(oprot);
          }
        }
      }
      if (struct.isSetAddressedBy()) {
        {
          ...
          for (TDDISecurityCapability _iter2954 : struct.AddressedBy)
          {
            _iter2954.write(oprot);
          }
        }
      }
      if (struct.isSetAttackedItems()) {
        {
          ...
          for (TDDIVulnerableItemRef _iter2955 : struct.AttackedItems)
          {
            _iter2955.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAttackerGoal struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2956 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2956.size);
          TDDIKeyValueMap _elem2957;
          for (int _i2958 = 0; _i2958 < _list2956.size; ++_i2958)
          {
            _elem2957 = new TDDIKeyValueMap();
            _elem2957.read(iprot);
            struct.KeyValueMaps.add(_elem2957);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list2959 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Attacks = new java.util.ArrayList<TDDIAbstractAttack>(_list2959.size);
          TDDIAbstractAttack _elem2960;
          for (int _i2961 = 0; _i2961 < _list2959.size; ++_i2961)
          {
            _elem2960 = new TDDIAbstractAttack();
            _elem2960.read(iprot);
            struct.Attacks.add(_elem2960);
          }
        }
        struct.setAttacksIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.AddressedBy = new java.util.ArrayList<TDDISecurityCapability>(_list2962.size);
          TDDISecurityCapability _elem2963;
          for (int _i2964 = 0; _i2964 < _list2962.size; ++_i2964)
          {
            _elem2963 = new TDDISecurityCapability();
            _elem2963.read(iprot);
            struct.AddressedBy.add(_elem2963);
          }
        }
        struct.setAddressedByIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.AttackedItems = new java.util.ArrayList<TDDIVulnerableItemRef>(_list2965.size);
          TDDIVulnerableItemRef _elem2966;
          for (int _i2967 = 0; _i2967 < _list2965.size; ++_i2967)
          {
            _elem2966 = new TDDIVulnerableItemRef();
            _elem2966.read(iprot);
            struct.AttackedItems.add(_elem2966);
          }
        }
        struct.setAttackedItemsIsSet(true);
      }
