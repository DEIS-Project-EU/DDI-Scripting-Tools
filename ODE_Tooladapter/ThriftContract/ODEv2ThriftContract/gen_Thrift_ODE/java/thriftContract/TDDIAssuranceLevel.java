...
public class TDDIAssuranceLevel implements org.apache.thrift.TBase<TDDIAssuranceLevel, TDDIAssuranceLevel._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAssuranceLevel> {
  ...
  public TDDIAssuranceLevel setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list736.size);
                TDDIKeyValueMap _elem737;
                for (int _i738 = 0; _i738 < _list736.size; ++_i738)
                {
                  _elem737 = new TDDIKeyValueMap();
                  _elem737.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAssuranceLevel struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter739 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter740 : struct.KeyValueMaps)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list741.size);
          TDDIKeyValueMap _elem742;
          for (int _i743 = 0; _i743 < _list741.size; ++_i743)
          {
            _elem742 = new TDDIKeyValueMap();
            _elem742.read(iprot);
