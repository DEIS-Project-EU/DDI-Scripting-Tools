...
public class TDDISecurityCapability implements org.apache.thrift.TBase<TDDISecurityCapability, TDDISecurityCapability._Fields>, java.io.Serializable, Cloneable, Comparable<TDDISecurityCapability> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2824.size);
                TDDIKeyValueMap _elem2825;
                for (int _i2826 = 0; _i2826 < _list2824.size; ++_i2826)
                {
                  _elem2825 = new TDDIKeyValueMap();
                  _elem2825.read(iprot);
                  struct.KeyValueMaps.add(_elem2825);
                }
                iprot.readListEnd();
              }
          ...
          case 7: // IMPLEMENTED_BY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2827 = iprot.readListBegin();
                struct.ImplementedBy = new java.util.ArrayList<TDDISecurityControlRef>(_list2827.size);
                TDDISecurityControlRef _elem2828;
                for (int _i2829 = 0; _i2829 < _list2827.size; ++_i2829)
                {
                  _elem2828 = new TDDISecurityControlRef();
                  _elem2828.read(iprot);
                  struct.ImplementedBy.add(_elem2828);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDISecurityCapability struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2830 : struct.KeyValueMaps)
          {
            _iter2830.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ImplementedBy != null) {
        oprot.writeFieldBegin(IMPLEMENTED_BY_FIELD_DESC);
        {
          ...
          for (TDDISecurityControlRef _iter2831 : struct.ImplementedBy)
          {
            _iter2831.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDISecurityCapabilityTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDISecurityCapability> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2832 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetImplementedBy()) {
        {
          ...
          for (TDDISecurityControlRef _iter2833 : struct.ImplementedBy)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDISecurityCapability struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2834 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2834.size);
          TDDIKeyValueMap _elem2835;
          for (int _i2836 = 0; _i2836 < _list2834.size; ++_i2836)
          {
            _elem2835 = new TDDIKeyValueMap();
            _elem2835.read(iprot);
            struct.KeyValueMaps.add(_elem2835);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list2837 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementedBy = new java.util.ArrayList<TDDISecurityControlRef>(_list2837.size);
          TDDISecurityControlRef _elem2838;
          for (int _i2839 = 0; _i2839 < _list2837.size; ++_i2839)
          {
            _elem2838 = new TDDISecurityControlRef();
            _elem2838.read(iprot);
            struct.ImplementedBy.add(_elem2838);
          }
        }
        struct.setImplementedByIsSet(true);
      }
