            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementedBy = new java.util.ArrayList<TDDISecurityControlRef>(_list2835.size);
                TDDISecurityControlRef _elem2836;
                for (int _i2837 = 0; _i2837 < _list2835.size; ++_i2837)
                {
                  _elem2836 = new TDDISecurityControlRef();
                  _elem2836.read(iprot);
                  struct.ImplementedBy.add(_elem2836);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDISecurityCapability struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementedBy != null) {
        oprot.writeFieldBegin(IMPLEMENTED_BY_FIELD_DESC);
        {
          ...
          for (TDDISecurityControlRef _iter2839 : struct.ImplementedBy)
          {
      ...
      if (struct.isSetImplementedBy()) {
        {
          ...
          for (TDDISecurityControlRef _iter2841 : struct.ImplementedBy)
          {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.ImplementedBy = new java.util.ArrayList<TDDISecurityControlRef>(_list2845.size);
          TDDISecurityControlRef _elem2846;
          for (int _i2847 = 0; _i2847 < _list2845.size; ++_i2847)
          {
            _elem2846 = new TDDISecurityControlRef();
            _elem2846.read(iprot);
            struct.ImplementedBy.add(_elem2846);
          }
        }
        struct.setImplementedByIsSet(true);
      }
