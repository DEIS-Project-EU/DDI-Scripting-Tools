...
public class TDDICategory implements org.apache.thrift.TBase<TDDICategory, TDDICategory._Fields>, java.io.Serializable, Cloneable, Comparable<TDDICategory> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2648 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2648.size);
                TDDIImplementationConstraintRef _elem2649;
                for (int _i2650 = 0; _i2650 < _list2648.size; ++_i2650)
                {
                  _elem2649 = new TDDIImplementationConstraintRef();
                  _elem2649.read(iprot);
                  struct.ImplementationConstraint.add(_elem2649);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2651 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2651.size);
                TDDINoteRef _elem2652;
                for (int _i2653 = 0; _i2653 < _list2651.size; ++_i2653)
                {
                  _elem2652 = new TDDINoteRef();
                  _elem2652.read(iprot);
                  struct.Note.add(_elem2652);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2654 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2654.size);
                TDDITaggedValueRef _elem2655;
                for (int _i2656 = 0; _i2656 < _list2654.size; ++_i2656)
                {
                  _elem2655 = new TDDITaggedValueRef();
                  _elem2655.read(iprot);
                  struct.TaggedValue.add(_elem2655);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDICategory struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2657 : struct.ImplementationConstraint)
          {
            _iter2657.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2658 : struct.Note)
          {
            _iter2658.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2659 : struct.TaggedValue)
          {
            _iter2659.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDICategoryTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDICategory> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2660 : struct.ImplementationConstraint)
          {
            _iter2660.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2661 : struct.Note)
          {
            _iter2661.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2662 : struct.TaggedValue)
          {
            _iter2662.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDICategory struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2663 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2663.size);
          TDDIImplementationConstraintRef _elem2664;
          for (int _i2665 = 0; _i2665 < _list2663.size; ++_i2665)
          {
            _elem2664 = new TDDIImplementationConstraintRef();
            _elem2664.read(iprot);
            struct.ImplementationConstraint.add(_elem2664);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2666 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2666.size);
          TDDINoteRef _elem2667;
          for (int _i2668 = 0; _i2668 < _list2666.size; ++_i2668)
          {
            _elem2667 = new TDDINoteRef();
            _elem2667.read(iprot);
            struct.Note.add(_elem2667);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2669 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2669.size);
          TDDITaggedValueRef _elem2670;
          for (int _i2671 = 0; _i2671 < _list2669.size; ++_i2671)
          {
            _elem2670 = new TDDITaggedValueRef();
            _elem2670.read(iprot);
            struct.TaggedValue.add(_elem2670);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
