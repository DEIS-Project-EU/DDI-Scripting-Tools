            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.AssuranceCasePackage = new java.util.ArrayList<TDDIAbstractAssuranceCasePackageRef>(_list2441.size);
                TDDIAbstractAssuranceCasePackageRef _elem2442;
                for (int _i2443 = 0; _i2443 < _list2441.size; ++_i2443)
                {
                  _elem2442 = new TDDIAbstractAssuranceCasePackageRef();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ArtifactPackage = new java.util.ArrayList<TDDIAbstractArtifactPackageRef>(_list2447.size);
                TDDIAbstractArtifactPackageRef _elem2448;
                for (int _i2449 = 0; _i2449 < _list2447.size; ++_i2449)
                {
                  _elem2448 = new TDDIAbstractArtifactPackageRef();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ArgumentPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(_list2450.size);
                TDDIAbstractArgumentPackageRef _elem2451;
                for (int _i2452 = 0; _i2452 < _list2450.size; ++_i2452)
                {
                  _elem2451 = new TDDIAbstractArgumentPackageRef();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TerminologyPackage = new java.util.ArrayList<TDDIAbstractTerminologyPackageRef>(_list2453.size);
                TDDIAbstractTerminologyPackageRef _elem2454;
                for (int _i2455 = 0; _i2455 < _list2453.size; ++_i2455)
                {
                  _elem2454 = new TDDIAbstractTerminologyPackageRef();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAssuranceCasePackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (struct.AssuranceCasePackage != null) {
        oprot.writeFieldBegin(ASSURANCE_CASE_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractAssuranceCasePackageRef _iter2462 : struct.AssuranceCasePackage)
          {
      ...
      if (struct.ArtifactPackage != null) {
        oprot.writeFieldBegin(ARTIFACT_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactPackageRef _iter2464 : struct.ArtifactPackage)
          {
      ...
      if (struct.ArgumentPackage != null) {
        oprot.writeFieldBegin(ARGUMENT_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentPackageRef _iter2465 : struct.ArgumentPackage)
          {
      ...
      if (struct.TerminologyPackage != null) {
        oprot.writeFieldBegin(TERMINOLOGY_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractTerminologyPackageRef _iter2466 : struct.TerminologyPackage)
          {
      ...
      if (struct.isSetAssuranceCasePackage()) {
        {
          ...
          for (TDDIAbstractAssuranceCasePackageRef _iter2471 : struct.AssuranceCasePackage)
          {
      ...
      if (struct.isSetArtifactPackage()) {
        {
          ...
          for (TDDIAbstractArtifactPackageRef _iter2473 : struct.ArtifactPackage)
          {
      ...
      if (struct.isSetArgumentPackage()) {
        {
          ...
          for (TDDIAbstractArgumentPackageRef _iter2474 : struct.ArgumentPackage)
          {
      ...
      if (struct.isSetTerminologyPackage()) {
        {
          ...
          for (TDDIAbstractTerminologyPackageRef _iter2475 : struct.TerminologyPackage)
          {
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.AssuranceCasePackage = new java.util.ArrayList<TDDIAbstractAssuranceCasePackageRef>(_list2486.size);
          TDDIAbstractAssuranceCasePackageRef _elem2487;
          for (int _i2488 = 0; _i2488 < _list2486.size; ++_i2488)
          {
            _elem2487 = new TDDIAbstractAssuranceCasePackageRef();
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.ArtifactPackage = new java.util.ArrayList<TDDIAbstractArtifactPackageRef>(_list2492.size);
          TDDIAbstractArtifactPackageRef _elem2493;
          for (int _i2494 = 0; _i2494 < _list2492.size; ++_i2494)
          {
            _elem2493 = new TDDIAbstractArtifactPackageRef();
      ...
      if (incoming.get(13)) {
        {
          ...
          struct.ArgumentPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(_list2495.size);
          TDDIAbstractArgumentPackageRef _elem2496;
          for (int _i2497 = 0; _i2497 < _list2495.size; ++_i2497)
          {
            _elem2496 = new TDDIAbstractArgumentPackageRef();
      ...
      if (incoming.get(14)) {
        {
          ...
          struct.TerminologyPackage = new java.util.ArrayList<TDDIAbstractTerminologyPackageRef>(_list2498.size);
          TDDIAbstractTerminologyPackageRef _elem2499;
          for (int _i2500 = 0; _i2500 < _list2498.size; ++_i2500)
          {
            _elem2499 = new TDDIAbstractTerminologyPackageRef();
