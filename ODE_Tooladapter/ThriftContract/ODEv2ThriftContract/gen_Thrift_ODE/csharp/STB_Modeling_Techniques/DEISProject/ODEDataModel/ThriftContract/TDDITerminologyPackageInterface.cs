              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1308 = iprot.ReadListBegin();
                  for( int _i1309 = 0; _i1309 < _list1308.Count; ++_i1309)
                  {
                    TDDIImplementationConstraintRef _elem1310;
                    _elem1310 = new TDDIImplementationConstraintRef();
                    _elem1310.Read(iprot);
                    ImplementationConstraint.Add(_elem1310);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1311 = iprot.ReadListBegin();
                  for( int _i1312 = 0; _i1312 < _list1311.Count; ++_i1312)
                  {
                    TDDINoteRef _elem1313;
                    _elem1313 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDITaggedValueRef _elem1316;
                    _elem1316 = new TDDITaggedValueRef();
                    _elem1316.Read(iprot);
                    TaggedValue.Add(_elem1316);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractTerminologyElement _elem1319;
                    _elem1319 = new TDDIAbstractTerminologyElement();
                    _elem1319.Read(iprot);
                    TerminologyElement.Add(_elem1319);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1320 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1321 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1322 in TaggedValue)
            {
        ...
        if (TerminologyElement != null && __isset.TerminologyElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractTerminologyElement _iter1323 in TerminologyElement)
            {
