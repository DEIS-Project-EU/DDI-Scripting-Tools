...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  public partial class TDDIRiskParameterUnion : TBase
  {
    ...
    private TDDIOperatorMeasure _OperatorMeasure;
    ...
    public TDDIOperatorMeasure OperatorMeasure
    {
      get
      {
        return _OperatorMeasure;
      }
      set
      {
        __isset.OperatorMeasure = true;
        this._OperatorMeasure = value;
      }
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (OperatorMeasure != null && __isset.OperatorMeasure) {
          field.Name = "OperatorMeasure";
          field.Type = TType.Struct;
          field.ID = 4;
          oprot.WriteFieldBegin(field);
    ...
    public override string ToString() {
      ...
      if (OperatorMeasure != null && __isset.OperatorMeasure) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("OperatorMeasure: ");
        __sb.Append(OperatorMeasure== null ? "<null>" : OperatorMeasure.ToString());
      }
      __sb.Append(")");
