              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIImplementationConstraintRef _elem734;
                    _elem734 = new TDDIImplementationConstraintRef();
                    _elem734.Read(iprot);
                    ImplementationConstraint.Add(_elem734);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem737;
                    _elem737 = new TDDINoteRef();
                    _elem737.Read(iprot);
                    Note.Add(_elem737);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDITaggedValueRef _elem740;
                    _elem740 = new TDDITaggedValueRef();
                    _elem740.Read(iprot);
                    TaggedValue.Add(_elem740);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractArgumentationElementRef _elem743;
                    _elem743 = new TDDIAbstractArgumentationElementRef();
                    _elem743.Read(iprot);
                    ArgumentationElement.Add(_elem743);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter744 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter745 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter746 in TaggedValue)
            {
        ...
        if (ArgumentationElement != null && __isset.ArgumentationElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentationElementRef _iter747 in ArgumentationElement)
            {
