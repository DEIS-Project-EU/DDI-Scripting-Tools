...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIAssertedArtifactSupport : TBase
  {
    private string _Gid;
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter846 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter847 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter848 in TaggedValue)
            {
        ...
        if (MetaClaim != null && __isset.MetaClaim) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIClaimRef _iter849 in MetaClaim)
            {
        ...
        if (Source != null && __isset.Source) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentAssetRef _iter850 in Source)
            {
        ...
        if (Target != null && __isset.Target) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentAssetRef _iter851 in Target)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIAssertedArtifactSupport(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
