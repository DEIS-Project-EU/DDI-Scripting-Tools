...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIFailure : TBase
  {
    private long _Id;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIFailure");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMap _iter402 in KeyValueMaps)
            {
        ...
        if (CCFFailures != null && __isset.CCFFailures) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFailureRef _iter403 in CCFFailures)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIFailure(");
      bool __first = true;
      if (__isset.Id) {
