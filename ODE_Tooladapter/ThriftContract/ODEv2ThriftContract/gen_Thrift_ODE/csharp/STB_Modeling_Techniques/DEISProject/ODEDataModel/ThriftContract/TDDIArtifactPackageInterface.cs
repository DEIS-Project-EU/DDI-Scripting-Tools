...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArtifactPackageInterface : TBase
  {
    private string _Gid;
    ...
    private TDDIAbstractArtifactPackage _Implements;
    ...
    public TDDIAbstractArtifactPackage Implements
    {
      get
      {
        return _Implements;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list964 = iprot.ReadListBegin();
                  for( int _i965 = 0; _i965 < _list964.Count; ++_i965)
                  {
                    TDDIImplementationConstraintRef _elem966;
                    _elem966 = new TDDIImplementationConstraintRef();
                    _elem966.Read(iprot);
                    ImplementationConstraint.Add(_elem966);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem969;
                    _elem969 = new TDDINoteRef();
                    _elem969.Read(iprot);
                    Note.Add(_elem969);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i971 = 0; _i971 < _list970.Count; ++_i971)
                  {
                    TDDITaggedValueRef _elem972;
                    _elem972 = new TDDITaggedValueRef();
                    _elem972.Read(iprot);
                    TaggedValue.Add(_elem972);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list973 = iprot.ReadListBegin();
                  for( int _i974 = 0; _i974 < _list973.Count; ++_i974)
                  {
                    TDDIAbstractArtifactElementRef _elem975;
                    _elem975 = new TDDIAbstractArtifactElementRef();
                    _elem975.Read(iprot);
                    ArtifactElement.Add(_elem975);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 12:
              if (field.Type == TType.Struct) {
                Implements = new TDDIAbstractArtifactPackage();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIArtifactPackageInterface");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter976 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter977 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter978 in TaggedValue)
            {
        ...
        if (ArtifactElement != null && __isset.ArtifactElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactElementRef _iter979 in ArtifactElement)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArtifactPackageInterface(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
