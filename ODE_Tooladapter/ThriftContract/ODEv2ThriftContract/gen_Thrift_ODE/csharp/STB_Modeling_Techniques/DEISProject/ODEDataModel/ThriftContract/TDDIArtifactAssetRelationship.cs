...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArtifactAssetRelationship : TBase
  {
    private string _Gid;
    ...
    private List<TDDIAbstractArtifactAssetRef> _Source;
    private List<TDDIAbstractArtifactAssetRef> _Target;
    ...
    public List<TDDIAbstractArtifactAssetRef> Source
    {
      get
      {
        return _Source;
    ...
    public List<TDDIAbstractArtifactAssetRef> Target
    {
      get
      {
        return _Target;
    ...
    public TDDIArtifactAssetRelationship() {
      ...
      this._Source = new List<TDDIAbstractArtifactAssetRef>();
      this.__isset.Source = true;
      this._Target = new List<TDDIAbstractArtifactAssetRef>();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1128 = iprot.ReadListBegin();
                  for( int _i1129 = 0; _i1129 < _list1128.Count; ++_i1129)
                  {
                    TDDIImplementationConstraintRef _elem1130;
                    _elem1130 = new TDDIImplementationConstraintRef();
                    _elem1130.Read(iprot);
                    ImplementationConstraint.Add(_elem1130);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem1133;
                    _elem1133 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1134 = iprot.ReadListBegin();
                  for( int _i1135 = 0; _i1135 < _list1134.Count; ++_i1135)
                  {
                    TDDITaggedValueRef _elem1136;
                    _elem1136 = new TDDITaggedValueRef();
                    _elem1136.Read(iprot);
                    TaggedValue.Add(_elem1136);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1137 = iprot.ReadListBegin();
                  for( int _i1138 = 0; _i1138 < _list1137.Count; ++_i1138)
                  {
                    TDDIPropertyRef _elem1139;
                    _elem1139 = new TDDIPropertyRef();
                    _elem1139.Read(iprot);
                    Property.Add(_elem1139);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1140 = iprot.ReadListBegin();
                  for( int _i1141 = 0; _i1141 < _list1140.Count; ++_i1141)
                  {
                    TDDIAbstractArtifactAssetRef _elem1142;
                    _elem1142 = new TDDIAbstractArtifactAssetRef();
                    _elem1142.Read(iprot);
                    Source.Add(_elem1142);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1143 = iprot.ReadListBegin();
                  for( int _i1144 = 0; _i1144 < _list1143.Count; ++_i1144)
                  {
                    TDDIAbstractArtifactAssetRef _elem1145;
                    _elem1145 = new TDDIAbstractArtifactAssetRef();
                    _elem1145.Read(iprot);
                    Target.Add(_elem1145);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIArtifactAssetRelationship");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1146 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1147 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1148 in TaggedValue)
            {
        ...
        if (Property != null && __isset.Property) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIPropertyRef _iter1149 in Property)
            {
        ...
        if (Source != null && __isset.Source) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactAssetRef _iter1150 in Source)
            {
        ...
        if (Target != null && __isset.Target) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactAssetRef _iter1151 in Target)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArtifactAssetRelationship(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
