...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIAssertedContext : TBase
  {
    private string _Gid;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIImplementationConstraintRef _elem926;
                    _elem926 = new TDDIImplementationConstraintRef();
                    _elem926.Read(iprot);
                    ImplementationConstraint.Add(_elem926);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem929;
                    _elem929 = new TDDINoteRef();
                    _elem929.Read(iprot);
                    Note.Add(_elem929);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list930 = iprot.ReadListBegin();
                  for( int _i931 = 0; _i931 < _list930.Count; ++_i931)
                  {
                    TDDITaggedValueRef _elem932;
                    _elem932 = new TDDITaggedValueRef();
                    _elem932.Read(iprot);
                    TaggedValue.Add(_elem932);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list933 = iprot.ReadListBegin();
                  for( int _i934 = 0; _i934 < _list933.Count; ++_i934)
                  {
                    TDDIClaimRef _elem935;
                    _elem935 = new TDDIClaimRef();
                    _elem935.Read(iprot);
                    MetaClaim.Add(_elem935);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list936 = iprot.ReadListBegin();
                  for( int _i937 = 0; _i937 < _list936.Count; ++_i937)
                  {
                    TDDIAbstractArgumentAssetRef _elem938;
                    _elem938 = new TDDIAbstractArgumentAssetRef();
                    _elem938.Read(iprot);
                    Source.Add(_elem938);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractArgumentAssetRef _elem941;
                    _elem941 = new TDDIAbstractArgumentAssetRef();
                    _elem941.Read(iprot);
                    Target.Add(_elem941);
                  }
                  iprot.ReadListEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIAssertedContext");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter942 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter943 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter944 in TaggedValue)
            {
        ...
        if (MetaClaim != null && __isset.MetaClaim) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIClaimRef _iter945 in MetaClaim)
            {
        ...
        if (Source != null && __isset.Source) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentAssetRef _iter946 in Source)
            {
        ...
        if (Target != null && __isset.Target) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentAssetRef _iter947 in Target)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIAssertedContext(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
