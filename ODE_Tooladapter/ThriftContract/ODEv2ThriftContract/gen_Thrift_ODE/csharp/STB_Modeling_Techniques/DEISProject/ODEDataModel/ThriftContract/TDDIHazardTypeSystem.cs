...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIHazardTypeSystem : TBase
  {
    private long _Id;
    private string _Name;
    private string _Description;
    private List<TDDIKeyValueMap> _KeyValueMaps;
    private List<TDDIHazardTypeRef> _HazardTypes;
    ...
    public List<TDDIHazardTypeRef> HazardTypes
    {
      get
      {
        return _HazardTypes;
    ...
    public TDDIHazardTypeSystem() {
      ...
      this._HazardTypes = new List<TDDIHazardTypeRef>();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIHazardTypeSystem");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMap _iter526 in KeyValueMaps)
            {
        ...
        if (HazardTypes != null && __isset.HazardTypes) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIHazardTypeRef _iter527 in HazardTypes)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIHazardTypeSystem(");
      bool __first = true;
      if (__isset.Id) {
