...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDITerminologyPackage : TBase
  {
    private string _Gid;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1272 = iprot.ReadListBegin();
                  for( int _i1273 = 0; _i1273 < _list1272.Count; ++_i1273)
                  {
                    TDDIImplementationConstraintRef _elem1274;
                    _elem1274 = new TDDIImplementationConstraintRef();
                    _elem1274.Read(iprot);
                    ImplementationConstraint.Add(_elem1274);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1275 = iprot.ReadListBegin();
                  for( int _i1276 = 0; _i1276 < _list1275.Count; ++_i1276)
                  {
                    TDDINoteRef _elem1277;
                    _elem1277 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDITaggedValueRef _elem1280;
                    _elem1280 = new TDDITaggedValueRef();
                    _elem1280.Read(iprot);
                    TaggedValue.Add(_elem1280);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1281 = iprot.ReadListBegin();
                  for( int _i1282 = 0; _i1282 < _list1281.Count; ++_i1282)
                  {
                    TDDIAbstractTerminologyElement _elem1283;
                    _elem1283 = new TDDIAbstractTerminologyElement();
                    _elem1283.Read(iprot);
                    TerminologyElement.Add(_elem1283);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDITerminologyPackage");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1284 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1285 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1286 in TaggedValue)
            {
        ...
        if (TerminologyElement != null && __isset.TerminologyElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractTerminologyElement _iter1287 in TerminologyElement)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDITerminologyPackage(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
