...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIStandard : TBase
  {
    private long _Id;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMap _elem374;
                    _elem374 = new TDDIKeyValueMap();
                    _elem374.Read(iprot);
                    KeyValueMaps.Add(_elem374);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIStandard");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMap _iter375 in KeyValueMaps)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIStandard(");
      bool __first = true;
      if (__isset.Id) {
