...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDITechnique : TBase
  {
    private string _Gid;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1032 = iprot.ReadListBegin();
                  for( int _i1033 = 0; _i1033 < _list1032.Count; ++_i1033)
                  {
                    TDDIImplementationConstraintRef _elem1034;
                    _elem1034 = new TDDIImplementationConstraintRef();
                    _elem1034.Read(iprot);
                    ImplementationConstraint.Add(_elem1034);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1035 = iprot.ReadListBegin();
                  for( int _i1036 = 0; _i1036 < _list1035.Count; ++_i1036)
                  {
                    TDDINoteRef _elem1037;
                    _elem1037 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i1039 = 0; _i1039 < _list1038.Count; ++_i1039)
                  {
                    TDDITaggedValueRef _elem1040;
                    _elem1040 = new TDDITaggedValueRef();
                    _elem1040.Read(iprot);
                    TaggedValue.Add(_elem1040);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1041 = iprot.ReadListBegin();
                  for( int _i1042 = 0; _i1042 < _list1041.Count; ++_i1042)
                  {
                    TDDIPropertyRef _elem1043;
                    _elem1043 = new TDDIPropertyRef();
                    _elem1043.Read(iprot);
                    Property.Add(_elem1043);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDITechnique");
        ...
        if (Property != null && __isset.Property) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIPropertyRef _iter1047 in Property)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDITechnique(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
