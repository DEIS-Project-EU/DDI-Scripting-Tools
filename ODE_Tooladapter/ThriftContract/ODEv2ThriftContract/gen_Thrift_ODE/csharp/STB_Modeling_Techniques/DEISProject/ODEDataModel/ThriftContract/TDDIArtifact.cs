              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1112 = iprot.ReadListBegin();
                  for( int _i1113 = 0; _i1113 < _list1112.Count; ++_i1113)
                  {
                    TDDIImplementationConstraintRef _elem1114;
                    _elem1114 = new TDDIImplementationConstraintRef();
                    _elem1114.Read(iprot);
                    ImplementationConstraint.Add(_elem1114);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1115 = iprot.ReadListBegin();
                  for( int _i1116 = 0; _i1116 < _list1115.Count; ++_i1116)
                  {
                    TDDINoteRef _elem1117;
                    _elem1117 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDITaggedValueRef _elem1120;
                    _elem1120 = new TDDITaggedValueRef();
                    _elem1120.Read(iprot);
                    TaggedValue.Add(_elem1120);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1121 = iprot.ReadListBegin();
                  for( int _i1122 = 0; _i1122 < _list1121.Count; ++_i1122)
                  {
                    TDDIPropertyRef _elem1123;
                    _elem1123 = new TDDIPropertyRef();
                    _elem1123.Read(iprot);
                    Property.Add(_elem1123);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
