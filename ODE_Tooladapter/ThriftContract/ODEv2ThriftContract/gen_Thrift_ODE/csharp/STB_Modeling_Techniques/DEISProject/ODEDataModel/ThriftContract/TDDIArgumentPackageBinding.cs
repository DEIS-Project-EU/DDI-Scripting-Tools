              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIImplementationConstraintRef _elem782;
                    _elem782 = new TDDIImplementationConstraintRef();
                    _elem782.Read(iprot);
                    ImplementationConstraint.Add(_elem782);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list783 = iprot.ReadListBegin();
                  for( int _i784 = 0; _i784 < _list783.Count; ++_i784)
                  {
                    TDDINoteRef _elem785;
                    _elem785 = new TDDINoteRef();
                    _elem785.Read(iprot);
                    Note.Add(_elem785);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDITaggedValueRef _elem788;
                    _elem788 = new TDDITaggedValueRef();
                    _elem788.Read(iprot);
                    TaggedValue.Add(_elem788);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractArgumentationElementRef _elem791;
                    _elem791 = new TDDIAbstractArgumentationElementRef();
                    _elem791.Read(iprot);
                    ArgumentationElement.Add(_elem791);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractArgumentPackageRef _elem794;
                    _elem794 = new TDDIAbstractArgumentPackageRef();
                    _elem794.Read(iprot);
                    ParticipantPackage.Add(_elem794);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter795 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter796 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter797 in TaggedValue)
            {
        ...
        if (ArgumentationElement != null && __isset.ArgumentationElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentationElementRef _iter798 in ArgumentationElement)
            {
        ...
        if (ParticipantPackage != null && __isset.ParticipantPackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentPackageRef _iter799 in ParticipantPackage)
            {
