              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIImplementationConstraintRef _elem1326;
                    _elem1326 = new TDDIImplementationConstraintRef();
                    _elem1326.Read(iprot);
                    ImplementationConstraint.Add(_elem1326);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1327 = iprot.ReadListBegin();
                  for( int _i1328 = 0; _i1328 < _list1327.Count; ++_i1328)
                  {
                    TDDINoteRef _elem1329;
                    _elem1329 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1330 = iprot.ReadListBegin();
                  for( int _i1331 = 0; _i1331 < _list1330.Count; ++_i1331)
                  {
                    TDDITaggedValueRef _elem1332;
                    _elem1332 = new TDDITaggedValueRef();
                    _elem1332.Read(iprot);
                    TaggedValue.Add(_elem1332);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1333 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1334 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1335 in TaggedValue)
            {
