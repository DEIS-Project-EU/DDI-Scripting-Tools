...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArtifactReference : TBase
  {
    private string _Gid;
    ...
    private List<TDDIAbstractArtifactElementRef> _ReferencedArtifactElement;
    ...
    public List<TDDIAbstractArtifactElementRef> ReferencedArtifactElement
    {
      get
      {
        return _ReferencedArtifactElement;
      }
      set
      {
        __isset.ReferencedArtifactElement = true;
        this._ReferencedArtifactElement = value;
      }
    }
    ...
    public struct Isset {
      ...
      public bool ReferencedArtifactElement;
    }
    ...
    public TDDIArtifactReference() {
      ...
      this._ReferencedArtifactElement = new List<TDDIAbstractArtifactElementRef>();
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIImplementationConstraintRef _elem718;
                    _elem718 = new TDDIImplementationConstraintRef();
                    _elem718.Read(iprot);
                    ImplementationConstraint.Add(_elem718);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem721;
                    _elem721 = new TDDINoteRef();
                    _elem721.Read(iprot);
                    Note.Add(_elem721);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i723 = 0; _i723 < _list722.Count; ++_i723)
                  {
                    TDDITaggedValueRef _elem724;
                    _elem724 = new TDDITaggedValueRef();
                    _elem724.Read(iprot);
                    TaggedValue.Add(_elem724);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 11:
              if (field.Type == TType.List) {
                {
                  ReferencedArtifactElement = new List<TDDIAbstractArtifactElementRef>();
                  TList _list725 = iprot.ReadListBegin();
                  for( int _i726 = 0; _i726 < _list725.Count; ++_i726)
                  {
                    TDDIAbstractArtifactElementRef _elem727;
                    _elem727 = new TDDIAbstractArtifactElementRef();
                    _elem727.Read(iprot);
                    ReferencedArtifactElement.Add(_elem727);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter728 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter729 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter730 in TaggedValue)
            {
        ...
        if (ReferencedArtifactElement != null && __isset.ReferencedArtifactElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactElementRef _iter731 in ReferencedArtifactElement)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArtifactReference(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
      ...
      if (ReferencedArtifactElement != null && __isset.ReferencedArtifactElement) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("ReferencedArtifactElement: ");
        __sb.Append(ReferencedArtifactElement);
      }
      __sb.Append(")");
