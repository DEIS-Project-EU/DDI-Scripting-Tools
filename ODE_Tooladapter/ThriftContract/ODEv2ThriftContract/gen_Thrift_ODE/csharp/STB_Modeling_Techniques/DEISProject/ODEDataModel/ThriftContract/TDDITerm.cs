...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDITerm : TBase
  {
    private string _Gid;
    ...
    private List<TDDICategoryRef> _Category;
    private string _ExternalReference;
    private TDDIAbstractModelElement _Origin;
    ...
    public List<TDDICategoryRef> Category
    {
      get
      {
        return _Category;
    ...
    public string ExternalReference
    {
      ...
      set
      {
        __isset.ExternalReference = true;
        this._ExternalReference = value;
      }
    }

    public TDDIAbstractModelElement Origin
    {
      get
      {
        return _Origin;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIImplementationConstraintRef _elem1358;
                    _elem1358 = new TDDIImplementationConstraintRef();
                    _elem1358.Read(iprot);
                    ImplementationConstraint.Add(_elem1358);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1359 = iprot.ReadListBegin();
                  for( int _i1360 = 0; _i1360 < _list1359.Count; ++_i1360)
                  {
                    TDDINoteRef _elem1361;
                    _elem1361 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i1363 = 0; _i1363 < _list1362.Count; ++_i1363)
                  {
                    TDDITaggedValueRef _elem1364;
                    _elem1364 = new TDDITaggedValueRef();
                    _elem1364.Read(iprot);
                    TaggedValue.Add(_elem1364);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 12:
              if (field.Type == TType.List) {
                {
                  Category = new List<TDDICategoryRef>();
                  TList _list1365 = iprot.ReadListBegin();
                  for( int _i1366 = 0; _i1366 < _list1365.Count; ++_i1366)
                  {
                    TDDICategoryRef _elem1367;
                    _elem1367 = new TDDICategoryRef();
                    _elem1367.Read(iprot);
                    Category.Add(_elem1367);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 13:
              if (field.Type == TType.String) {
                ExternalReference = iprot.ReadString();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
            case 14:
              if (field.Type == TType.Struct) {
                Origin = new TDDIAbstractModelElement();
                Origin.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1368 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1369 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1370 in TaggedValue)
            {
        ...
        if (Category != null && __isset.Category) {
          ...
          oprot.WriteFieldBegin(field);
          {
            oprot.WriteListBegin(new TList(TType.Struct, Category.Count));
            foreach (TDDICategoryRef _iter1371 in Category)
            {
