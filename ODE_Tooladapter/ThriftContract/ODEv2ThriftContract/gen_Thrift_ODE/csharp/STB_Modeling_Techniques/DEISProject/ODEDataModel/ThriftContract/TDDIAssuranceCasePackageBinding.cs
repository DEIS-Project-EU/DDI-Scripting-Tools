      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1243 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1244 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1245 in TaggedValue)
            {
        ...
        if (AssuranceCasePackage != null && __isset.AssuranceCasePackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractAssuranceCasePackageRef _iter1246 in AssuranceCasePackage)
            {
        ...
        if (Interface != null && __isset.@Interface) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAssuranceCasePackageInterfaceRef _iter1247 in Interface)
            {
        ...
        if (ArtifactPackage != null && __isset.ArtifactPackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactPackageRef _iter1248 in ArtifactPackage)
            {
        ...
        if (ArgumentPackage != null && __isset.ArgumentPackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentPackageRef _iter1249 in ArgumentPackage)
            {
        ...
        if (TerminologyPackage != null && __isset.TerminologyPackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractTerminologyPackageRef _iter1250 in TerminologyPackage)
            {
        ...
        if (ParticipantPackage != null && __isset.ParticipantPackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractAssuranceCasePackageRef _iter1251 in ParticipantPackage)
            {
