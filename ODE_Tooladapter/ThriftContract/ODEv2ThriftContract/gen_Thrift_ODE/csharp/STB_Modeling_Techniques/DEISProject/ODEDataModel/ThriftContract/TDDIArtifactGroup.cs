              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractArtifactElementRef _elem1011;
                    _elem1011 = new TDDIAbstractArtifactElementRef();
                    _elem1011.Read(iprot);
                    ArtifactElement.Add(_elem1011);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1012 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1013 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1014 in TaggedValue)
            {
        ...
        if (ArtifactElement != null && __isset.ArtifactElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactElementRef _iter1015 in ArtifactElement)
            {
