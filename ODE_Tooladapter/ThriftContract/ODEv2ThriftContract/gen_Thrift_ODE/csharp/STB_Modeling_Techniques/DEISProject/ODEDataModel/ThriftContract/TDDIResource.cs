              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIPropertyRef _elem1107;
                    _elem1107 = new TDDIPropertyRef();
                    _elem1107.Read(iprot);
                    Property.Add(_elem1107);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1108 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1109 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1110 in TaggedValue)
            {
        ...
        if (Property != null && __isset.Property) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIPropertyRef _iter1111 in Property)
            {
