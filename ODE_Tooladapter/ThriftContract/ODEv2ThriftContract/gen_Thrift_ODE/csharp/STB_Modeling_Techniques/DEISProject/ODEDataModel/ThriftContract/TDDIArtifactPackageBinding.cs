              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list980 = iprot.ReadListBegin();
                  for( int _i981 = 0; _i981 < _list980.Count; ++_i981)
                  {
                    TDDIImplementationConstraintRef _elem982;
                    _elem982 = new TDDIImplementationConstraintRef();
                    _elem982.Read(iprot);
                    ImplementationConstraint.Add(_elem982);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem985;
                    _elem985 = new TDDINoteRef();
                    _elem985.Read(iprot);
                    Note.Add(_elem985);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i987 = 0; _i987 < _list986.Count; ++_i987)
                  {
                    TDDITaggedValueRef _elem988;
                    _elem988 = new TDDITaggedValueRef();
                    _elem988.Read(iprot);
                    TaggedValue.Add(_elem988);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list989 = iprot.ReadListBegin();
                  for( int _i990 = 0; _i990 < _list989.Count; ++_i990)
                  {
                    TDDIAbstractArtifactElementRef _elem991;
                    _elem991 = new TDDIAbstractArtifactElementRef();
                    _elem991.Read(iprot);
                    ArtifactElement.Add(_elem991);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list992 = iprot.ReadListBegin();
                  for( int _i993 = 0; _i993 < _list992.Count; ++_i993)
                  {
                    TDDIAbstractArtifactPackage _elem994;
                    _elem994 = new TDDIAbstractArtifactPackage();
                    _elem994.Read(iprot);
                    ParticipantPackage.Add(_elem994);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter995 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter996 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter997 in TaggedValue)
            {
        ...
        if (ArtifactElement != null && __isset.ArtifactElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactElementRef _iter998 in ArtifactElement)
            {
        ...
        if (ParticipantPackage != null && __isset.ParticipantPackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactPackage _iter999 in ParticipantPackage)
            {
