...
public class TDDIArchitecturePackage implements org.apache.thrift.TBase<TDDIArchitecturePackage, TDDIArchitecturePackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArchitecturePackage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIArchitecturePackage");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIArchitecturePackageStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIArchitecturePackageTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIArchitecturePackage.class, metaDataMap);
  }

  public TDDIArchitecturePackage() {
    this.Name = "";
   ...
   */
  public TDDIArchitecturePackage(TDDIArchitecturePackage other) {
  ...
  public TDDIArchitecturePackage deepCopy() {
    return new TDDIArchitecturePackage(this);
  }
  ...
  public TDDIArchitecturePackage setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIArchitecturePackage setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIArchitecturePackage setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIArchitecturePackage setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIArchitecturePackage setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIArchitecturePackage setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIArchitecturePackage setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIArchitecturePackage setDependabilityRequirements(java.util.List<TDDIAbstractDependabilityRequirementRef> DependabilityRequirements) {
    this.DependabilityRequirements = DependabilityRequirements;
    return this;
  }
  ...
  public TDDIArchitecturePackage setAssuranceLevel(TDDIAssuranceLevel AssuranceLevel) {
    this.AssuranceLevel = AssuranceLevel;
    return this;
  }
  ...
  public TDDIArchitecturePackage setDesignArtifacts(java.util.List<TDDIAbstractDesignArtifactRef> DesignArtifacts) {
    this.DesignArtifacts = DesignArtifacts;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIArchitecturePackage)
      return this.equals((TDDIArchitecturePackage)that);
    return false;
  }

  public boolean equals(TDDIArchitecturePackage that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIArchitecturePackage other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIArchitecturePackage(");
    boolean first = true;
  ...
  private static class TDDIArchitecturePackageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArchitecturePackageStandardScheme getScheme() {
      return new TDDIArchitecturePackageStandardScheme();
    }
  }

  private static class TDDIArchitecturePackageStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIArchitecturePackage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIArchitecturePackage struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list0.size);
                TDDIKeyValueMapRef _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new TDDIKeyValueMapRef();
                  _elem1.read(iprot);
                  struct.KeyValueMaps.add(_elem1);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list3.size);
                TDDIAbstractDependabilityRequirementRef _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = new TDDIAbstractDependabilityRequirementRef();
                  _elem4.read(iprot);
                  struct.DependabilityRequirements.add(_elem4);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DesignArtifacts = new java.util.ArrayList<TDDIAbstractDesignArtifactRef>(_list6.size);
                TDDIAbstractDesignArtifactRef _elem7;
                for (int _i8 = 0; _i8 < _list6.size; ++_i8)
                {
                  _elem7 = new TDDIAbstractDesignArtifactRef();
                  _elem7.read(iprot);
                  struct.DesignArtifacts.add(_elem7);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArchitecturePackage struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter9 : struct.KeyValueMaps)
          {
            _iter9.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.DependabilityRequirements != null) {
        oprot.writeFieldBegin(DEPENDABILITY_REQUIREMENTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter10 : struct.DependabilityRequirements)
          {
            _iter10.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.DesignArtifacts != null) {
        oprot.writeFieldBegin(DESIGN_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDesignArtifactRef _iter11 : struct.DesignArtifacts)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TDDIArchitecturePackageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArchitecturePackageTupleScheme getScheme() {
      return new TDDIArchitecturePackageTupleScheme();
    }
  }

  private static class TDDIArchitecturePackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArchitecturePackage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIArchitecturePackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter12 : struct.KeyValueMaps)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (struct.isSetDependabilityRequirements()) {
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter13 : struct.DependabilityRequirements)
          {
            _iter13.write(oprot);
          }
        }
      ...
      if (struct.isSetDesignArtifacts()) {
        {
          ...
          for (TDDIAbstractDesignArtifactRef _iter14 : struct.DesignArtifacts)
          {
            _iter14.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArchitecturePackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list15.size);
          TDDIKeyValueMapRef _elem16;
          for (int _i17 = 0; _i17 < _list15.size; ++_i17)
          {
            _elem16 = new TDDIKeyValueMapRef();
            _elem16.read(iprot);
            struct.KeyValueMaps.add(_elem16);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list18.size);
          TDDIAbstractDependabilityRequirementRef _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new TDDIAbstractDependabilityRequirementRef();
            _elem19.read(iprot);
            struct.DependabilityRequirements.add(_elem19);
          }
        }
        struct.setDependabilityRequirementsIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.DesignArtifacts = new java.util.ArrayList<TDDIAbstractDesignArtifactRef>(_list21.size);
          TDDIAbstractDesignArtifactRef _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new TDDIAbstractDesignArtifactRef();
            _elem22.read(iprot);
            struct.DesignArtifacts.add(_elem22);
          }
        }
        struct.setDesignArtifactsIsSet(true);
      }
