...
public class TDDIArgumentPackageBinding implements org.apache.thrift.TBase<TDDIArgumentPackageBinding, TDDIArgumentPackageBinding._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArgumentPackageBinding> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIArgumentPackageBinding");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIArgumentPackageBindingStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIArgumentPackageBindingTupleSchemeFactory();
  ...
  public java.util.List<TDDIAbstractArgumentPackageRef> ParticipantPackage; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIArgumentPackageBinding.class, metaDataMap);
  }

  public TDDIArgumentPackageBinding() {
    this.Gid = "";
    ...
    this.ParticipantPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>();
  ...
  public TDDIArgumentPackageBinding(
    ...
    java.util.List<TDDIAbstractArgumentPackageRef> ParticipantPackage)
  {
    this();
    this.Gid = Gid;
   ...
   */
  public TDDIArgumentPackageBinding(TDDIArgumentPackageBinding other) {
    ...
    if (other.isSetParticipantPackage()) {
      java.util.List<TDDIAbstractArgumentPackageRef> __this__ParticipantPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(other.ParticipantPackage.size());
      for (TDDIAbstractArgumentPackageRef other_element : other.ParticipantPackage) {
        __this__ParticipantPackage.add(new TDDIAbstractArgumentPackageRef(other_element));
      }
      this.ParticipantPackage = __this__ParticipantPackage;
    }
  }

  public TDDIArgumentPackageBinding deepCopy() {
    return new TDDIArgumentPackageBinding(this);
  }
  ...
  public TDDIArgumentPackageBinding setGid(java.lang.String Gid) {
    this.Gid = Gid;
    return this;
  }
  ...
  public TDDIArgumentPackageBinding setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIArgumentPackageBinding setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIArgumentPackageBinding setCitedElement(TDDIAbstractSACMElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIArgumentPackageBinding setAbstractForm(TDDIAbstractSACMElement AbstractForm) {
    this.AbstractForm = AbstractForm;
    return this;
  }
  ...
  public TDDIArgumentPackageBinding setName(TDDIAbstractLangString Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIArgumentPackageBinding setDescription(TDDIDescription Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIArgumentPackageBinding setImplementationConstraint(java.util.List<TDDIImplementationConstraintRef> ImplementationConstraint) {
    this.ImplementationConstraint = ImplementationConstraint;
    return this;
  }
  ...
  public TDDIArgumentPackageBinding setNote(java.util.List<TDDINoteRef> Note) {
    this.Note = Note;
    return this;
  }
  ...
  public TDDIArgumentPackageBinding setTaggedValue(java.util.List<TDDITaggedValueRef> TaggedValue) {
    this.TaggedValue = TaggedValue;
    return this;
  }
  ...
  public TDDIArgumentPackageBinding setArgumentationElement(java.util.List<TDDIAbstractArgumentationElementRef> ArgumentationElement) {
    this.ArgumentationElement = ArgumentationElement;
    return this;
  }
  ...
  public java.util.Iterator<TDDIAbstractArgumentPackageRef> getParticipantPackageIterator() {
    return (this.ParticipantPackage == null) ? null : this.ParticipantPackage.iterator();
  }

  public void addToParticipantPackage(TDDIAbstractArgumentPackageRef elem) {
  ...
  public java.util.List<TDDIAbstractArgumentPackageRef> getParticipantPackage() {
    return this.ParticipantPackage;
  }

  public TDDIArgumentPackageBinding setParticipantPackage(java.util.List<TDDIAbstractArgumentPackageRef> ParticipantPackage) {
    this.ParticipantPackage = ParticipantPackage;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PARTICIPANT_PACKAGE:
      if (value == null) {
        ...
        setParticipantPackage((java.util.List<TDDIAbstractArgumentPackageRef>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIArgumentPackageBinding)
      return this.equals((TDDIArgumentPackageBinding)that);
    return false;
  }

  public boolean equals(TDDIArgumentPackageBinding that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIArgumentPackageBinding other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIArgumentPackageBinding(");
    boolean first = true;
  ...
  private static class TDDIArgumentPackageBindingStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArgumentPackageBindingStandardScheme getScheme() {
      return new TDDIArgumentPackageBindingStandardScheme();
    }
  }

  private static class TDDIArgumentPackageBindingStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIArgumentPackageBinding> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIArgumentPackageBinding struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2000 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2000.size);
                TDDIImplementationConstraintRef _elem2001;
                for (int _i2002 = 0; _i2002 < _list2000.size; ++_i2002)
                {
                  _elem2001 = new TDDIImplementationConstraintRef();
                  _elem2001.read(iprot);
                  struct.ImplementationConstraint.add(_elem2001);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2003 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2003.size);
                TDDINoteRef _elem2004;
                for (int _i2005 = 0; _i2005 < _list2003.size; ++_i2005)
                {
                  _elem2004 = new TDDINoteRef();
                  _elem2004.read(iprot);
                  struct.Note.add(_elem2004);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2006.size);
                TDDITaggedValueRef _elem2007;
                for (int _i2008 = 0; _i2008 < _list2006.size; ++_i2008)
                {
                  _elem2007 = new TDDITaggedValueRef();
                  _elem2007.read(iprot);
                  struct.TaggedValue.add(_elem2007);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // ARGUMENTATION_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2009 = iprot.readListBegin();
                struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list2009.size);
                TDDIAbstractArgumentationElementRef _elem2010;
                for (int _i2011 = 0; _i2011 < _list2009.size; ++_i2011)
                {
                  _elem2010 = new TDDIAbstractArgumentationElementRef();
                  _elem2010.read(iprot);
                  struct.ArgumentationElement.add(_elem2010);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ParticipantPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(_list2012.size);
                TDDIAbstractArgumentPackageRef _elem2013;
                for (int _i2014 = 0; _i2014 < _list2012.size; ++_i2014)
                {
                  _elem2013 = new TDDIAbstractArgumentPackageRef();
                  _elem2013.read(iprot);
                  struct.ParticipantPackage.add(_elem2013);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArgumentPackageBinding struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2015 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2016 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2017 : struct.TaggedValue)
          {
            _iter2017.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ArgumentationElement != null) {
        oprot.writeFieldBegin(ARGUMENTATION_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter2018 : struct.ArgumentationElement)
          {
            _iter2018.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ParticipantPackage != null) {
        oprot.writeFieldBegin(PARTICIPANT_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentPackageRef _iter2019 : struct.ParticipantPackage)
          {
            _iter2019.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIArgumentPackageBindingTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArgumentPackageBindingTupleScheme getScheme() {
      return new TDDIArgumentPackageBindingTupleScheme();
    }
  }

  private static class TDDIArgumentPackageBindingTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArgumentPackageBinding> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIArgumentPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2020 : struct.ImplementationConstraint)
          {
            _iter2020.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2021 : struct.Note)
          {
            _iter2021.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2022 : struct.TaggedValue)
          {
            _iter2022.write(oprot);
          }
        }
      }
      if (struct.isSetArgumentationElement()) {
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter2023 : struct.ArgumentationElement)
          {
      ...
      if (struct.isSetParticipantPackage()) {
        {
          ...
          for (TDDIAbstractArgumentPackageRef _iter2024 : struct.ParticipantPackage)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArgumentPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2025 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2025.size);
          TDDIImplementationConstraintRef _elem2026;
          for (int _i2027 = 0; _i2027 < _list2025.size; ++_i2027)
          {
            _elem2026 = new TDDIImplementationConstraintRef();
            _elem2026.read(iprot);
            struct.ImplementationConstraint.add(_elem2026);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2028 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2028.size);
          TDDINoteRef _elem2029;
          for (int _i2030 = 0; _i2030 < _list2028.size; ++_i2030)
          {
            _elem2029 = new TDDINoteRef();
            _elem2029.read(iprot);
            struct.Note.add(_elem2029);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2031 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2031.size);
          TDDITaggedValueRef _elem2032;
          for (int _i2033 = 0; _i2033 < _list2031.size; ++_i2033)
          {
            _elem2032 = new TDDITaggedValueRef();
            _elem2032.read(iprot);
            struct.TaggedValue.add(_elem2032);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2034 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list2034.size);
          TDDIAbstractArgumentationElementRef _elem2035;
          for (int _i2036 = 0; _i2036 < _list2034.size; ++_i2036)
          {
            _elem2035 = new TDDIAbstractArgumentationElementRef();
            _elem2035.read(iprot);
            struct.ArgumentationElement.add(_elem2035);
          }
        }
        struct.setArgumentationElementIsSet(true);
      }
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list2037 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ParticipantPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(_list2037.size);
          TDDIAbstractArgumentPackageRef _elem2038;
          for (int _i2039 = 0; _i2039 < _list2037.size; ++_i2039)
          {
            _elem2038 = new TDDIAbstractArgumentPackageRef();
            _elem2038.read(iprot);
            struct.ParticipantPackage.add(_elem2038);
          }
        }
        struct.setParticipantPackageIsSet(true);
      }
