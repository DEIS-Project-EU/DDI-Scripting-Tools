...
public class TDDIProbabilityDistribution implements org.apache.thrift.TBase<TDDIProbabilityDistribution, TDDIProbabilityDistribution._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIProbabilityDistribution> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIProbabilityDistribution");
  ...
  private static final org.apache.thrift.protocol.TField PROB_DIST_PARAMS_FIELD_DESC = new org.apache.thrift.protocol.TField("ProbDistParams", org.apache.thrift.protocol.TType.LIST, (short)9);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIProbabilityDistributionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIProbabilityDistributionTupleSchemeFactory();
  ...
  public java.util.List<TDDIProbDistParam> ProbDistParams; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    TYPE((short)8, "Type"),
    PROB_DIST_PARAMS((short)9, "ProbDistParams");
  ...
  static {
    ...
    tmpMap.put(_Fields.TYPE, new org.apache.thrift.meta_data.FieldMetaData("Type", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.PROB_DIST_PARAMS, new org.apache.thrift.meta_data.FieldMetaData("ProbDistParams", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIProbabilityDistribution.class, metaDataMap);
  }

  public TDDIProbabilityDistribution() {
    this.Name = "";
    ...
    this.ProbDistParams = new java.util.ArrayList<TDDIProbDistParam>();
  ...
  public TDDIProbabilityDistribution(
    ...
    java.util.List<TDDIProbDistParam> ProbDistParams)
  {
    this();
    this.Id = Id;
    setIdIsSet(true);
    ...
    this.Type = Type;
    this.ProbDistParams = ProbDistParams;
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TDDIProbabilityDistribution(TDDIProbabilityDistribution other) {
    ...
    if (other.isSetProbDistParams()) {
      java.util.List<TDDIProbDistParam> __this__ProbDistParams = new java.util.ArrayList<TDDIProbDistParam>(other.ProbDistParams.size());
      for (TDDIProbDistParam other_element : other.ProbDistParams) {
        __this__ProbDistParams.add(new TDDIProbDistParam(other_element));
      }
      this.ProbDistParams = __this__ProbDistParams;
    }
  }

  public TDDIProbabilityDistribution deepCopy() {
    return new TDDIProbabilityDistribution(this);
  }
  ...
  public TDDIProbabilityDistribution setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIProbabilityDistribution setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIProbabilityDistribution setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIProbabilityDistribution setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIProbabilityDistribution setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIProbabilityDistribution setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIProbabilityDistribution setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIProbabilityDistribution setType(java.lang.String Type) {
    this.Type = Type;
    return this;
  }
  ...
  public int getProbDistParamsSize() {
    return (this.ProbDistParams == null) ? 0 : this.ProbDistParams.size();
  }

  public java.util.Iterator<TDDIProbDistParam> getProbDistParamsIterator() {
    return (this.ProbDistParams == null) ? null : this.ProbDistParams.iterator();
  }

  public void addToProbDistParams(TDDIProbDistParam elem) {
    if (this.ProbDistParams == null) {
      this.ProbDistParams = new java.util.ArrayList<TDDIProbDistParam>();
    }
    this.ProbDistParams.add(elem);
  }

  public java.util.List<TDDIProbDistParam> getProbDistParams() {
    return this.ProbDistParams;
  }

  public TDDIProbabilityDistribution setProbDistParams(java.util.List<TDDIProbDistParam> ProbDistParams) {
    this.ProbDistParams = ProbDistParams;
    return this;
  }

  public void unsetProbDistParams() {
    this.ProbDistParams = null;
  }

  /** Returns true if field ProbDistParams is set (has been assigned a value) and false otherwise */
  public boolean isSetProbDistParams() {
    return this.ProbDistParams != null;
  }

  public void setProbDistParamsIsSet(boolean value) {
    if (!value) {
      this.ProbDistParams = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PROB_DIST_PARAMS:
      if (value == null) {
        unsetProbDistParams();
      } else {
        setProbDistParams((java.util.List<TDDIProbDistParam>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIProbabilityDistribution)
      return this.equals((TDDIProbabilityDistribution)that);
    return false;
  }

  public boolean equals(TDDIProbabilityDistribution that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_ProbDistParams = true && this.isSetProbDistParams();
    boolean that_present_ProbDistParams = true && that.isSetProbDistParams();
    if (this_present_ProbDistParams || that_present_ProbDistParams) {
      if (!(this_present_ProbDistParams && that_present_ProbDistParams))
        return false;
      if (!this.ProbDistParams.equals(that.ProbDistParams))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetProbDistParams()) ? 131071 : 524287);
    if (isSetProbDistParams())
      hashCode = hashCode * 8191 + ProbDistParams.hashCode();

    return hashCode;
  }

  @Override
  public int compareTo(TDDIProbabilityDistribution other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetProbDistParams()).compareTo(other.isSetProbDistParams());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetProbDistParams()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ProbDistParams, other.ProbDistParams);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIProbabilityDistribution(");
    boolean first = true;
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("ProbDistParams:");
    if (this.ProbDistParams == null) {
      sb.append("null");
    } else {
      sb.append(this.ProbDistParams);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class TDDIProbabilityDistributionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIProbabilityDistributionStandardScheme getScheme() {
      return new TDDIProbabilityDistributionStandardScheme();
    }
  }

  private static class TDDIProbabilityDistributionStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIProbabilityDistribution> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIProbabilityDistribution struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list864.size);
                TDDIKeyValueMapRef _elem865;
                for (int _i866 = 0; _i866 < _list864.size; ++_i866)
                {
                  _elem865 = new TDDIKeyValueMapRef();
                  _elem865.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ProbDistParams = new java.util.ArrayList<TDDIProbDistParam>(_list867.size);
                TDDIProbDistParam _elem868;
                for (int _i869 = 0; _i869 < _list867.size; ++_i869)
                {
                  _elem868 = new TDDIProbDistParam();
                  _elem868.read(iprot);
                  struct.ProbDistParams.add(_elem868);
                }
                iprot.readListEnd();
              }
              struct.setProbDistParamsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIProbabilityDistribution struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter870 : struct.KeyValueMaps)
          {
      ...
      if (struct.ProbDistParams != null) {
        oprot.writeFieldBegin(PROB_DIST_PARAMS_FIELD_DESC);
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.ProbDistParams.size()));
          for (TDDIProbDistParam _iter871 : struct.ProbDistParams)
          {
  ...
  private static class TDDIProbabilityDistributionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIProbabilityDistributionTupleScheme getScheme() {
      return new TDDIProbabilityDistributionTupleScheme();
    }
  }

  private static class TDDIProbabilityDistributionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIProbabilityDistribution> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIProbabilityDistribution struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter872 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetProbDistParams()) {
        {
          oprot.writeI32(struct.ProbDistParams.size());
          for (TDDIProbDistParam _iter873 : struct.ProbDistParams)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIProbabilityDistribution struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list874.size);
          TDDIKeyValueMapRef _elem875;
          for (int _i876 = 0; _i876 < _list874.size; ++_i876)
          {
            _elem875 = new TDDIKeyValueMapRef();
            _elem875.read(iprot);
            struct.KeyValueMaps.add(_elem875);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.ProbDistParams = new java.util.ArrayList<TDDIProbDistParam>(_list877.size);
          TDDIProbDistParam _elem878;
          for (int _i879 = 0; _i879 < _list877.size; ++_i879)
          {
            _elem878 = new TDDIProbDistParam();
            _elem878.read(iprot);
            struct.ProbDistParams.add(_elem878);
          }
        }
        struct.setProbDistParamsIsSet(true);
      }
