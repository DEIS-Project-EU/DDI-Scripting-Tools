...
public class TDDIDependabilityPackageInterface implements org.apache.thrift.TBase<TDDIDependabilityPackageInterface, TDDIDependabilityPackageInterface._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIDependabilityPackageInterface> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIDependabilityPackageInterface");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIDependabilityPackageInterfaceStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIDependabilityPackageInterfaceTupleSchemeFactory();
  ...
  public TDDIAbstractDependabilityPackage Implements; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIDependabilityPackageInterface.class, metaDataMap);
  }

  public TDDIDependabilityPackageInterface() {
    this.Name = "";
   ...
   */
  public TDDIDependabilityPackageInterface(TDDIDependabilityPackageInterface other) {
    ...
    if (other.isSetImplements()) {
      this.Implements = new TDDIAbstractDependabilityPackage(other.Implements);
    }
  }

  public TDDIDependabilityPackageInterface deepCopy() {
    return new TDDIDependabilityPackageInterface(this);
  }
  ...
  public TDDIDependabilityPackageInterface setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIDependabilityPackageInterface setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIDependabilityPackageInterface setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIDependabilityPackageInterface setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIDependabilityPackageInterface setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIDependabilityPackageInterface setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIDependabilityPackageInterface setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIDependabilityPackageInterface setDependabilityArtifacts(java.util.List<TDDIAbstractDependabilityArtifactRef> DependabilityArtifacts) {
    this.DependabilityArtifacts = DependabilityArtifacts;
    return this;
  }
  ...
  public TDDIAbstractDependabilityPackage getImplements() {
    return this.Implements;
  }

  public TDDIDependabilityPackageInterface setImplements(TDDIAbstractDependabilityPackage Implements) {
    this.Implements = Implements;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case IMPLEMENTS:
      if (value == null) {
        ...
        setImplements((TDDIAbstractDependabilityPackage)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIDependabilityPackageInterface)
      return this.equals((TDDIDependabilityPackageInterface)that);
    return false;
  }

  public boolean equals(TDDIDependabilityPackageInterface that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIDependabilityPackageInterface other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIDependabilityPackageInterface(");
    boolean first = true;
  ...
  private static class TDDIDependabilityPackageInterfaceStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIDependabilityPackageInterfaceStandardScheme getScheme() {
      return new TDDIDependabilityPackageInterfaceStandardScheme();
    }
  }

  private static class TDDIDependabilityPackageInterfaceStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIDependabilityPackageInterface> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIDependabilityPackageInterface struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list688.size);
                TDDIKeyValueMapRef _elem689;
                for (int _i690 = 0; _i690 < _list688.size; ++_i690)
                {
                  _elem689 = new TDDIKeyValueMapRef();
                  _elem689.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DependabilityArtifacts = new java.util.ArrayList<TDDIAbstractDependabilityArtifactRef>(_list691.size);
                TDDIAbstractDependabilityArtifactRef _elem692;
                for (int _i693 = 0; _i693 < _list691.size; ++_i693)
                {
                  _elem692 = new TDDIAbstractDependabilityArtifactRef();
                  _elem692.read(iprot);
                  struct.DependabilityArtifacts.add(_elem692);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // IMPLEMENTS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.Implements = new TDDIAbstractDependabilityPackage();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIDependabilityPackageInterface struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter694 : struct.KeyValueMaps)
          {
      ...
      if (struct.DependabilityArtifacts != null) {
        oprot.writeFieldBegin(DEPENDABILITY_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDependabilityArtifactRef _iter695 : struct.DependabilityArtifacts)
          {
  ...
  private static class TDDIDependabilityPackageInterfaceTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIDependabilityPackageInterfaceTupleScheme getScheme() {
      return new TDDIDependabilityPackageInterfaceTupleScheme();
    }
  }

  private static class TDDIDependabilityPackageInterfaceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIDependabilityPackageInterface> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIDependabilityPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter696 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetDependabilityArtifacts()) {
        {
          ...
          for (TDDIAbstractDependabilityArtifactRef _iter697 : struct.DependabilityArtifacts)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIDependabilityPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list698 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list698.size);
          TDDIKeyValueMapRef _elem699;
          for (int _i700 = 0; _i700 < _list698.size; ++_i700)
          {
            _elem699 = new TDDIKeyValueMapRef();
            _elem699.read(iprot);
            struct.KeyValueMaps.add(_elem699);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.DependabilityArtifacts = new java.util.ArrayList<TDDIAbstractDependabilityArtifactRef>(_list701.size);
          TDDIAbstractDependabilityArtifactRef _elem702;
          for (int _i703 = 0; _i703 < _list701.size; ++_i703)
          {
            _elem702 = new TDDIAbstractDependabilityArtifactRef();
            _elem702.read(iprot);
            struct.DependabilityArtifacts.add(_elem702);
          }
        }
        struct.setDependabilityArtifactsIsSet(true);
      }
