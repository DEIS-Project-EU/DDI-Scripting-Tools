...
public class TDDIAssuranceLevel implements org.apache.thrift.TBase<TDDIAssuranceLevel, TDDIAssuranceLevel._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAssuranceLevel> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIAssuranceLevel");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIAssuranceLevelStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIAssuranceLevelTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIAssuranceLevel.class, metaDataMap);
  }

  public TDDIAssuranceLevel() {
    this.Name = "";
   ...
   */
  public TDDIAssuranceLevel(TDDIAssuranceLevel other) {
  ...
  public TDDIAssuranceLevel deepCopy() {
    return new TDDIAssuranceLevel(this);
  }
  ...
  public TDDIAssuranceLevel setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIAssuranceLevel setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIAssuranceLevel setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIAssuranceLevel setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIAssuranceLevel setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIAssuranceLevel setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIAssuranceLevel setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIAssuranceLevel)
      return this.equals((TDDIAssuranceLevel)that);
    return false;
  }

  public boolean equals(TDDIAssuranceLevel that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIAssuranceLevel other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIAssuranceLevel(");
    boolean first = true;
  ...
  private static class TDDIAssuranceLevelStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIAssuranceLevelStandardScheme getScheme() {
      return new TDDIAssuranceLevelStandardScheme();
    }
  }

  private static class TDDIAssuranceLevelStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIAssuranceLevel> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIAssuranceLevel struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list816.size);
                TDDIKeyValueMapRef _elem817;
                for (int _i818 = 0; _i818 < _list816.size; ++_i818)
                {
                  _elem817 = new TDDIKeyValueMapRef();
                  _elem817.read(iprot);
                  struct.KeyValueMaps.add(_elem817);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAssuranceLevel struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter819 : struct.KeyValueMaps)
          {
  ...
  private static class TDDIAssuranceLevelTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIAssuranceLevelTupleScheme getScheme() {
      return new TDDIAssuranceLevelTupleScheme();
    }
  }

  private static class TDDIAssuranceLevelTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAssuranceLevel> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIAssuranceLevel struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter820 : struct.KeyValueMaps)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAssuranceLevel struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list821.size);
          TDDIKeyValueMapRef _elem822;
          for (int _i823 = 0; _i823 < _list821.size; ++_i823)
          {
            _elem822 = new TDDIKeyValueMapRef();
            _elem822.read(iprot);
            struct.KeyValueMaps.add(_elem822);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
