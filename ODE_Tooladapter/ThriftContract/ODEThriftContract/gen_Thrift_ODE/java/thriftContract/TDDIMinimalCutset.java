...
public class TDDIMinimalCutset implements org.apache.thrift.TBase<TDDIMinimalCutset, TDDIMinimalCutset._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIMinimalCutset> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIMinimalCutset");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIMinimalCutsetStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIMinimalCutsetTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIMinimalCutset.class, metaDataMap);
  }
   ...
   */
  public TDDIMinimalCutset(TDDIMinimalCutset other) {
  ...
  public TDDIMinimalCutset deepCopy() {
    return new TDDIMinimalCutset(this);
  }
  ...
  public TDDIMinimalCutset setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIMinimalCutset setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIMinimalCutset setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIMinimalCutset setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIMinimalCutset setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIMinimalCutset setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIMinimalCutset setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIMinimalCutset setFailures(java.util.List<TDDIAbstractFailure> Failures) {
    this.Failures = Failures;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIMinimalCutset)
      return this.equals((TDDIMinimalCutset)that);
    return false;
  }

  public boolean equals(TDDIMinimalCutset that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIMinimalCutset other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIMinimalCutset(");
    boolean first = true;
  ...
  private static class TDDIMinimalCutsetStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIMinimalCutsetStandardScheme getScheme() {
      return new TDDIMinimalCutsetStandardScheme();
    }
  }

  private static class TDDIMinimalCutsetStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIMinimalCutset> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIMinimalCutset struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list880.size);
                TDDIKeyValueMapRef _elem881;
                for (int _i882 = 0; _i882 < _list880.size; ++_i882)
                {
                  _elem881 = new TDDIKeyValueMapRef();
                  _elem881.read(iprot);
                  struct.KeyValueMaps.add(_elem881);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Failures = new java.util.ArrayList<TDDIAbstractFailure>(_list883.size);
                TDDIAbstractFailure _elem884;
                for (int _i885 = 0; _i885 < _list883.size; ++_i885)
                {
                  _elem884 = new TDDIAbstractFailure();
                  _elem884.read(iprot);
                  struct.Failures.add(_elem884);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIMinimalCutset struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter886 : struct.KeyValueMaps)
          {
      ...
      if (struct.Failures != null) {
        oprot.writeFieldBegin(FAILURES_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailure _iter887 : struct.Failures)
          {
  ...
  private static class TDDIMinimalCutsetTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIMinimalCutsetTupleScheme getScheme() {
      return new TDDIMinimalCutsetTupleScheme();
    }
  }

  private static class TDDIMinimalCutsetTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIMinimalCutset> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIMinimalCutset struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter888 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetFailures()) {
        {
          ...
          for (TDDIAbstractFailure _iter889 : struct.Failures)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIMinimalCutset struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list890.size);
          TDDIKeyValueMapRef _elem891;
          for (int _i892 = 0; _i892 < _list890.size; ++_i892)
          {
            _elem891 = new TDDIKeyValueMapRef();
            _elem891.read(iprot);
            struct.KeyValueMaps.add(_elem891);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.Failures = new java.util.ArrayList<TDDIAbstractFailure>(_list893.size);
          TDDIAbstractFailure _elem894;
          for (int _i895 = 0; _i895 < _list893.size; ++_i895)
          {
            _elem894 = new TDDIAbstractFailure();
            _elem894.read(iprot);
            struct.Failures.add(_elem894);
          }
        }
        struct.setFailuresIsSet(true);
      }
