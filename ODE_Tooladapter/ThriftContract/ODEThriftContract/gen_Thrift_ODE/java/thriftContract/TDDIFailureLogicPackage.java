...
public class TDDIFailureLogicPackage implements org.apache.thrift.TBase<TDDIFailureLogicPackage, TDDIFailureLogicPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIFailureLogicPackage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIFailureLogicPackage");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIFailureLogicPackageStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIFailureLogicPackageTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIFailureLogicPackage.class, metaDataMap);
  }
   ...
   */
  public TDDIFailureLogicPackage(TDDIFailureLogicPackage other) {
  ...
  public TDDIFailureLogicPackage deepCopy() {
    return new TDDIFailureLogicPackage(this);
  }
  ...
  public TDDIFailureLogicPackage setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIFailureLogicPackage setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIFailureLogicPackage setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIFailureLogicPackage setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIFailureLogicPackage setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIFailureLogicPackage setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIFailureLogicPackage setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIFailureLogicPackage setFailureAnalysisArtifacts(java.util.List<TDDIAbstractFailureAnalysisArtifact> FailureAnalysisArtifacts) {
    this.FailureAnalysisArtifacts = FailureAnalysisArtifacts;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIFailureLogicPackage)
      return this.equals((TDDIFailureLogicPackage)that);
    return false;
  }

  public boolean equals(TDDIFailureLogicPackage that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIFailureLogicPackage other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIFailureLogicPackage(");
    boolean first = true;
  ...
  private static class TDDIFailureLogicPackageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFailureLogicPackageStandardScheme getScheme() {
      return new TDDIFailureLogicPackageStandardScheme();
    }
  }

  private static class TDDIFailureLogicPackageStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIFailureLogicPackage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIFailureLogicPackage struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list952.size);
                TDDIKeyValueMapRef _elem953;
                for (int _i954 = 0; _i954 < _list952.size; ++_i954)
                {
                  _elem953 = new TDDIKeyValueMapRef();
                  _elem953.read(iprot);
                  struct.KeyValueMaps.add(_elem953);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifact>(_list955.size);
                TDDIAbstractFailureAnalysisArtifact _elem956;
                for (int _i957 = 0; _i957 < _list955.size; ++_i957)
                {
                  _elem956 = new TDDIAbstractFailureAnalysisArtifact();
                  _elem956.read(iprot);
                  struct.FailureAnalysisArtifacts.add(_elem956);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIFailureLogicPackage struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter958 : struct.KeyValueMaps)
          {
      ...
      if (struct.FailureAnalysisArtifacts != null) {
        oprot.writeFieldBegin(FAILURE_ANALYSIS_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifact _iter959 : struct.FailureAnalysisArtifacts)
          {
  ...
  private static class TDDIFailureLogicPackageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFailureLogicPackageTupleScheme getScheme() {
      return new TDDIFailureLogicPackageTupleScheme();
    }
  }

  private static class TDDIFailureLogicPackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIFailureLogicPackage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIFailureLogicPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter960 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetFailureAnalysisArtifacts()) {
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifact _iter961 : struct.FailureAnalysisArtifacts)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIFailureLogicPackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list962.size);
          TDDIKeyValueMapRef _elem963;
          for (int _i964 = 0; _i964 < _list962.size; ++_i964)
          {
            _elem963 = new TDDIKeyValueMapRef();
            _elem963.read(iprot);
            struct.KeyValueMaps.add(_elem963);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifact>(_list965.size);
          TDDIAbstractFailureAnalysisArtifact _elem966;
          for (int _i967 = 0; _i967 < _list965.size; ++_i967)
          {
            _elem966 = new TDDIAbstractFailureAnalysisArtifact();
            _elem966.read(iprot);
            struct.FailureAnalysisArtifacts.add(_elem966);
          }
        }
        struct.setFailureAnalysisArtifactsIsSet(true);
      }
