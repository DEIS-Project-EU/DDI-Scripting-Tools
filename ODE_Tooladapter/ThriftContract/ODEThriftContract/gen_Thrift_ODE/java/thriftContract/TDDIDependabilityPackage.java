...
public class TDDIDependabilityPackage implements org.apache.thrift.TBase<TDDIDependabilityPackage, TDDIDependabilityPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIDependabilityPackage> {
  ...
  public TDDIDependabilityPackage setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIDependabilityPackage setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIDependabilityPackage setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIDependabilityPackage setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIDependabilityPackage setDependabilityArtifacts(java.util.List<TDDIAbstractDependabilityArtifactRef> DependabilityArtifacts) {
    this.DependabilityArtifacts = DependabilityArtifacts;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list672.size);
                TDDIKeyValueMapRef _elem673;
                for (int _i674 = 0; _i674 < _list672.size; ++_i674)
                {
                  _elem673 = new TDDIKeyValueMapRef();
                  _elem673.read(iprot);
                  struct.KeyValueMaps.add(_elem673);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DependabilityArtifacts = new java.util.ArrayList<TDDIAbstractDependabilityArtifactRef>(_list675.size);
                TDDIAbstractDependabilityArtifactRef _elem676;
                for (int _i677 = 0; _i677 < _list675.size; ++_i677)
                {
                  _elem676 = new TDDIAbstractDependabilityArtifactRef();
                  _elem676.read(iprot);
                  struct.DependabilityArtifacts.add(_elem676);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIDependabilityPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter678 : struct.KeyValueMaps)
          {
      ...
      if (struct.DependabilityArtifacts != null) {
        oprot.writeFieldBegin(DEPENDABILITY_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDependabilityArtifactRef _iter679 : struct.DependabilityArtifacts)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter680 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetDependabilityArtifacts()) {
        {
          ...
          for (TDDIAbstractDependabilityArtifactRef _iter681 : struct.DependabilityArtifacts)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list682.size);
          TDDIKeyValueMapRef _elem683;
          for (int _i684 = 0; _i684 < _list682.size; ++_i684)
          {
            _elem683 = new TDDIKeyValueMapRef();
            _elem683.read(iprot);
            struct.KeyValueMaps.add(_elem683);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.DependabilityArtifacts = new java.util.ArrayList<TDDIAbstractDependabilityArtifactRef>(_list685.size);
          TDDIAbstractDependabilityArtifactRef _elem686;
          for (int _i687 = 0; _i687 < _list685.size; ++_i687)
          {
            _elem686 = new TDDIAbstractDependabilityArtifactRef();
            _elem686.read(iprot);
            struct.DependabilityArtifacts.add(_elem686);
          }
        }
        struct.setDependabilityArtifactsIsSet(true);
      }
