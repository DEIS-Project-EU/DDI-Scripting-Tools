...
public class TDDIAssuranceCasePackage implements org.apache.thrift.TBase<TDDIAssuranceCasePackage, TDDIAssuranceCasePackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAssuranceCasePackage> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2744 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2744.size);
                TDDIImplementationConstraintRef _elem2745;
                for (int _i2746 = 0; _i2746 < _list2744.size; ++_i2746)
                {
                  _elem2745 = new TDDIImplementationConstraintRef();
                  _elem2745.read(iprot);
                  struct.ImplementationConstraint.add(_elem2745);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2747 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2747.size);
                TDDINoteRef _elem2748;
                for (int _i2749 = 0; _i2749 < _list2747.size; ++_i2749)
                {
                  _elem2748 = new TDDINoteRef();
                  _elem2748.read(iprot);
                  struct.Note.add(_elem2748);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2750 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2750.size);
                TDDITaggedValueRef _elem2751;
                for (int _i2752 = 0; _i2752 < _list2750.size; ++_i2752)
                {
                  _elem2751 = new TDDITaggedValueRef();
                  _elem2751.read(iprot);
                  struct.TaggedValue.add(_elem2751);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // ASSURANCE_CASE_PACKAGE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2753 = iprot.readListBegin();
                struct.AssuranceCasePackage = new java.util.ArrayList<TDDIAbstractAssuranceCasePackageRef>(_list2753.size);
                TDDIAbstractAssuranceCasePackageRef _elem2754;
                for (int _i2755 = 0; _i2755 < _list2753.size; ++_i2755)
                {
                  _elem2754 = new TDDIAbstractAssuranceCasePackageRef();
                  _elem2754.read(iprot);
                  struct.AssuranceCasePackage.add(_elem2754);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Interface = new java.util.ArrayList<TDDIAssuranceCasePackageInterfaceRef>(_list2756.size);
                TDDIAssuranceCasePackageInterfaceRef _elem2757;
                for (int _i2758 = 0; _i2758 < _list2756.size; ++_i2758)
                {
                  _elem2757 = new TDDIAssuranceCasePackageInterfaceRef();
                  _elem2757.read(iprot);
                  struct.Interface.add(_elem2757);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // ARTIFACT_PACKAGE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2759 = iprot.readListBegin();
                struct.ArtifactPackage = new java.util.ArrayList<TDDIAbstractArtifactPackageRef>(_list2759.size);
                TDDIAbstractArtifactPackageRef _elem2760;
                for (int _i2761 = 0; _i2761 < _list2759.size; ++_i2761)
                {
                  _elem2760 = new TDDIAbstractArtifactPackageRef();
                  _elem2760.read(iprot);
                  struct.ArtifactPackage.add(_elem2760);
                }
                iprot.readListEnd();
              }
          ...
          case 14: // ARGUMENT_PACKAGE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2762 = iprot.readListBegin();
                struct.ArgumentPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(_list2762.size);
                TDDIAbstractArgumentPackageRef _elem2763;
                for (int _i2764 = 0; _i2764 < _list2762.size; ++_i2764)
                {
                  _elem2763 = new TDDIAbstractArgumentPackageRef();
                  _elem2763.read(iprot);
                  struct.ArgumentPackage.add(_elem2763);
                }
                iprot.readListEnd();
              }
          ...
          case 15: // TERMINOLOGY_PACKAGE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2765 = iprot.readListBegin();
                struct.TerminologyPackage = new java.util.ArrayList<TDDIAbstractTerminologyPackageRef>(_list2765.size);
                TDDIAbstractTerminologyPackageRef _elem2766;
                for (int _i2767 = 0; _i2767 < _list2765.size; ++_i2767)
                {
                  _elem2766 = new TDDIAbstractTerminologyPackageRef();
                  _elem2766.read(iprot);
                  struct.TerminologyPackage.add(_elem2766);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAssuranceCasePackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2768 : struct.ImplementationConstraint)
          {
            _iter2768.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2769 : struct.Note)
          {
            _iter2769.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2770 : struct.TaggedValue)
          {
            _iter2770.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AssuranceCasePackage != null) {
        oprot.writeFieldBegin(ASSURANCE_CASE_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractAssuranceCasePackageRef _iter2771 : struct.AssuranceCasePackage)
          {
            _iter2771.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Interface != null) {
        oprot.writeFieldBegin(INTERFACE_FIELD_DESC);
        {
          ...
          for (TDDIAssuranceCasePackageInterfaceRef _iter2772 : struct.Interface)
          {
            _iter2772.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ArtifactPackage != null) {
        oprot.writeFieldBegin(ARTIFACT_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactPackageRef _iter2773 : struct.ArtifactPackage)
          {
            _iter2773.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ArgumentPackage != null) {
        oprot.writeFieldBegin(ARGUMENT_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentPackageRef _iter2774 : struct.ArgumentPackage)
          {
            _iter2774.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TerminologyPackage != null) {
        oprot.writeFieldBegin(TERMINOLOGY_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractTerminologyPackageRef _iter2775 : struct.TerminologyPackage)
          {
            _iter2775.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIAssuranceCasePackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAssuranceCasePackage> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2776 : struct.ImplementationConstraint)
          {
            _iter2776.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2777 : struct.Note)
          {
            _iter2777.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2778 : struct.TaggedValue)
          {
            _iter2778.write(oprot);
          }
        }
      }
      if (struct.isSetAssuranceCasePackage()) {
        {
          ...
          for (TDDIAbstractAssuranceCasePackageRef _iter2779 : struct.AssuranceCasePackage)
          {
            _iter2779.write(oprot);
          }
        }
      }
      if (struct.isSetInterface()) {
        {
          ...
          for (TDDIAssuranceCasePackageInterfaceRef _iter2780 : struct.Interface)
          {
            _iter2780.write(oprot);
          }
        }
      }
      if (struct.isSetArtifactPackage()) {
        {
          ...
          for (TDDIAbstractArtifactPackageRef _iter2781 : struct.ArtifactPackage)
          {
            _iter2781.write(oprot);
          }
        }
      }
      if (struct.isSetArgumentPackage()) {
        {
          ...
          for (TDDIAbstractArgumentPackageRef _iter2782 : struct.ArgumentPackage)
          {
            _iter2782.write(oprot);
          }
        }
      }
      if (struct.isSetTerminologyPackage()) {
        {
          ...
          for (TDDIAbstractTerminologyPackageRef _iter2783 : struct.TerminologyPackage)
          {
            _iter2783.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAssuranceCasePackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2784 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2784.size);
          TDDIImplementationConstraintRef _elem2785;
          for (int _i2786 = 0; _i2786 < _list2784.size; ++_i2786)
          {
            _elem2785 = new TDDIImplementationConstraintRef();
            _elem2785.read(iprot);
            struct.ImplementationConstraint.add(_elem2785);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2787 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2787.size);
          TDDINoteRef _elem2788;
          for (int _i2789 = 0; _i2789 < _list2787.size; ++_i2789)
          {
            _elem2788 = new TDDINoteRef();
            _elem2788.read(iprot);
            struct.Note.add(_elem2788);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2790 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2790.size);
          TDDITaggedValueRef _elem2791;
          for (int _i2792 = 0; _i2792 < _list2790.size; ++_i2792)
          {
            _elem2791 = new TDDITaggedValueRef();
            _elem2791.read(iprot);
            struct.TaggedValue.add(_elem2791);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2793 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.AssuranceCasePackage = new java.util.ArrayList<TDDIAbstractAssuranceCasePackageRef>(_list2793.size);
          TDDIAbstractAssuranceCasePackageRef _elem2794;
          for (int _i2795 = 0; _i2795 < _list2793.size; ++_i2795)
          {
            _elem2794 = new TDDIAbstractAssuranceCasePackageRef();
            _elem2794.read(iprot);
            struct.AssuranceCasePackage.add(_elem2794);
          }
        }
        struct.setAssuranceCasePackageIsSet(true);
      }
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list2796 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Interface = new java.util.ArrayList<TDDIAssuranceCasePackageInterfaceRef>(_list2796.size);
          TDDIAssuranceCasePackageInterfaceRef _elem2797;
          for (int _i2798 = 0; _i2798 < _list2796.size; ++_i2798)
          {
            _elem2797 = new TDDIAssuranceCasePackageInterfaceRef();
            _elem2797.read(iprot);
            struct.Interface.add(_elem2797);
          }
        }
        struct.setInterfaceIsSet(true);
      }
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TList _list2799 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArtifactPackage = new java.util.ArrayList<TDDIAbstractArtifactPackageRef>(_list2799.size);
          TDDIAbstractArtifactPackageRef _elem2800;
          for (int _i2801 = 0; _i2801 < _list2799.size; ++_i2801)
          {
            _elem2800 = new TDDIAbstractArtifactPackageRef();
            _elem2800.read(iprot);
            struct.ArtifactPackage.add(_elem2800);
          }
        }
        struct.setArtifactPackageIsSet(true);
      }
      if (incoming.get(13)) {
        {
          ...
          struct.ArgumentPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(_list2802.size);
          TDDIAbstractArgumentPackageRef _elem2803;
          for (int _i2804 = 0; _i2804 < _list2802.size; ++_i2804)
          {
            _elem2803 = new TDDIAbstractArgumentPackageRef();
            _elem2803.read(iprot);
            struct.ArgumentPackage.add(_elem2803);
          }
        }
        struct.setArgumentPackageIsSet(true);
      }
      if (incoming.get(14)) {
        {
          ...
          struct.TerminologyPackage = new java.util.ArrayList<TDDIAbstractTerminologyPackageRef>(_list2805.size);
          TDDIAbstractTerminologyPackageRef _elem2806;
          for (int _i2807 = 0; _i2807 < _list2805.size; ++_i2807)
          {
            _elem2806 = new TDDIAbstractTerminologyPackageRef();
            _elem2806.read(iprot);
            struct.TerminologyPackage.add(_elem2806);
          }
        }
        struct.setTerminologyPackageIsSet(true);
      }
