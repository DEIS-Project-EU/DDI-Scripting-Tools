...
public class TDDIExpression implements org.apache.thrift.TBase<TDDIExpression, TDDIExpression._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIExpression> {
  ...
  private static final org.apache.thrift.protocol.TField CATEGORY_FIELD_DESC = new org.apache.thrift.protocol.TField("Category", org.apache.thrift.protocol.TType.STRUCT, (short)12);
  ...
  public TDDICategory Category; // required
  ...
  public TDDIExpression(TDDIExpression other) {
    ...
    if (other.isSetCategory()) {
      this.Category = new TDDICategory(other.Category);
    }
  ...
  public TDDIExpression setCategory(TDDICategory Category) {
    this.Category = Category;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CATEGORY:
      if (value == null) {
        ...
        setCategory((TDDICategory)value);
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3112 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list3112.size);
                TDDIImplementationConstraintRef _elem3113;
                for (int _i3114 = 0; _i3114 < _list3112.size; ++_i3114)
                {
                  _elem3113 = new TDDIImplementationConstraintRef();
                  _elem3113.read(iprot);
                  struct.ImplementationConstraint.add(_elem3113);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3115 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list3115.size);
                TDDINoteRef _elem3116;
                for (int _i3117 = 0; _i3117 < _list3115.size; ++_i3117)
                {
                  _elem3116 = new TDDINoteRef();
                  _elem3116.read(iprot);
                  struct.Note.add(_elem3116);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3118 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list3118.size);
                TDDITaggedValueRef _elem3119;
                for (int _i3120 = 0; _i3120 < _list3118.size; ++_i3120)
                {
                  _elem3119 = new TDDITaggedValueRef();
                  _elem3119.read(iprot);
                  struct.TaggedValue.add(_elem3119);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // CATEGORY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.Category = new TDDICategory();
          ...
          case 13: // ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3121 = iprot.readListBegin();
                struct.Element = new java.util.ArrayList<TDDIAbstractExpressionElementRef>(_list3121.size);
                TDDIAbstractExpressionElementRef _elem3122;
                for (int _i3123 = 0; _i3123 < _list3121.size; ++_i3123)
                {
                  _elem3122 = new TDDIAbstractExpressionElementRef();
                  _elem3122.read(iprot);
                  struct.Element.add(_elem3122);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIExpression struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter3124 : struct.ImplementationConstraint)
          {
            _iter3124.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter3125 : struct.Note)
          {
            _iter3125.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter3126 : struct.TaggedValue)
          {
            _iter3126.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Element != null) {
        oprot.writeFieldBegin(ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractExpressionElementRef _iter3127 : struct.Element)
          {
            _iter3127.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIExpressionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIExpression> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter3128 : struct.ImplementationConstraint)
          {
            _iter3128.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter3129 : struct.Note)
          {
            _iter3129.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter3130 : struct.TaggedValue)
          {
            _iter3130.write(oprot);
          }
        }
      }
      if (struct.isSetValue()) {
      ...
      if (struct.isSetElement()) {
        {
          ...
          for (TDDIAbstractExpressionElementRef _iter3131 : struct.Element)
          {
            _iter3131.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIExpression struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list3132 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list3132.size);
          TDDIImplementationConstraintRef _elem3133;
          for (int _i3134 = 0; _i3134 < _list3132.size; ++_i3134)
          {
            _elem3133 = new TDDIImplementationConstraintRef();
            _elem3133.read(iprot);
            struct.ImplementationConstraint.add(_elem3133);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list3135 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list3135.size);
          TDDINoteRef _elem3136;
          for (int _i3137 = 0; _i3137 < _list3135.size; ++_i3137)
          {
            _elem3136 = new TDDINoteRef();
            _elem3136.read(iprot);
            struct.Note.add(_elem3136);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list3138 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list3138.size);
          TDDITaggedValueRef _elem3139;
          for (int _i3140 = 0; _i3140 < _list3138.size; ++_i3140)
          {
            _elem3139 = new TDDITaggedValueRef();
            _elem3139.read(iprot);
            struct.TaggedValue.add(_elem3139);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      ...
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TList _list3141 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Element = new java.util.ArrayList<TDDIAbstractExpressionElementRef>(_list3141.size);
          TDDIAbstractExpressionElementRef _elem3142;
          for (int _i3143 = 0; _i3143 < _list3141.size; ++_i3143)
          {
            _elem3142 = new TDDIAbstractExpressionElementRef();
            _elem3142.read(iprot);
            struct.Element.add(_elem3142);
          }
        }
        struct.setElementIsSet(true);
      }
