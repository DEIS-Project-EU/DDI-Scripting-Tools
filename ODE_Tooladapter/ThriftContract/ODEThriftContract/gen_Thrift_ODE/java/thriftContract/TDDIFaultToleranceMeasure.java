...
public class TDDIFaultToleranceMeasure implements org.apache.thrift.TBase<TDDIFaultToleranceMeasure, TDDIFaultToleranceMeasure._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIFaultToleranceMeasure> {
  ...
  public TDDIFaultToleranceMeasure setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIFaultToleranceMeasure setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIFaultToleranceMeasure setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIFaultToleranceMeasure setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list744.size);
                TDDIKeyValueMapRef _elem745;
                for (int _i746 = 0; _i746 < _list744.size; ++_i746)
                {
                  _elem745 = new TDDIKeyValueMapRef();
                  _elem745.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIFaultToleranceMeasure struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter747 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter748 : struct.KeyValueMaps)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list749.size);
          TDDIKeyValueMapRef _elem750;
          for (int _i751 = 0; _i751 < _list749.size; ++_i751)
          {
            _elem750 = new TDDIKeyValueMapRef();
            _elem750.read(iprot);
