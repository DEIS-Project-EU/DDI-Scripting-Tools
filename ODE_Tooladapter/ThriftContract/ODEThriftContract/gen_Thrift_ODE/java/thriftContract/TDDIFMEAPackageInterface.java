...
public class TDDIFMEAPackageInterface implements org.apache.thrift.TBase<TDDIFMEAPackageInterface, TDDIFMEAPackageInterface._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIFMEAPackageInterface> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIFMEAPackageInterface");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIFMEAPackageInterfaceStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIFMEAPackageInterfaceTupleSchemeFactory();
  ...
  public TDDIAbstractFMEAPackage Implements; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIFMEAPackageInterface.class, metaDataMap);
  }
  ...
  public TDDIFMEAPackageInterface(
    ...
    TDDIAbstractFMEAPackage Implements)
  {
    this();
    this.Id = Id;
    setIdIsSet(true);
   ...
   */
  public TDDIFMEAPackageInterface(TDDIFMEAPackageInterface other) {
    ...
    if (other.isSetImplements()) {
      this.Implements = new TDDIAbstractFMEAPackage(other.Implements);
    }
  }

  public TDDIFMEAPackageInterface deepCopy() {
    return new TDDIFMEAPackageInterface(this);
  }
  ...
  public TDDIFMEAPackageInterface setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIFMEAPackageInterface setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIFMEAPackageInterface setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIFMEAPackageInterface setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIFMEAPackageInterface setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIFMEAPackageInterface setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIFMEAPackageInterface setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIFMEAPackageInterface setFailureAnalysisArtifacts(java.util.List<TDDIAbstractFailureAnalysisArtifactRef> FailureAnalysisArtifacts) {
    this.FailureAnalysisArtifacts = FailureAnalysisArtifacts;
    return this;
  }
  ...
  public TDDIFMEAPackageInterface setFMEAArtifacts(java.util.List<TDDIAbstractFMEAArtifactRef> FMEAArtifacts) {
    this.FMEAArtifacts = FMEAArtifacts;
    return this;
  }
  ...
  public TDDIAbstractFMEAPackage getImplements() {
    return this.Implements;
  }

  public TDDIFMEAPackageInterface setImplements(TDDIAbstractFMEAPackage Implements) {
    this.Implements = Implements;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case IMPLEMENTS:
      if (value == null) {
        ...
        setImplements((TDDIAbstractFMEAPackage)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIFMEAPackageInterface)
      return this.equals((TDDIFMEAPackageInterface)that);
    return false;
  }

  public boolean equals(TDDIFMEAPackageInterface that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIFMEAPackageInterface other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIFMEAPackageInterface(");
    boolean first = true;
  ...
  private static class TDDIFMEAPackageInterfaceStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFMEAPackageInterfaceStandardScheme getScheme() {
      return new TDDIFMEAPackageInterfaceStandardScheme();
    }
  }

  private static class TDDIFMEAPackageInterfaceStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIFMEAPackageInterface> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIFMEAPackageInterface struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1032.size);
                TDDIKeyValueMapRef _elem1033;
                for (int _i1034 = 0; _i1034 < _list1032.size; ++_i1034)
                {
                  _elem1033 = new TDDIKeyValueMapRef();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1035.size);
                TDDIAbstractFailureAnalysisArtifactRef _elem1036;
                for (int _i1037 = 0; _i1037 < _list1035.size; ++_i1037)
                {
                  _elem1036 = new TDDIAbstractFailureAnalysisArtifactRef();
                  _elem1036.read(iprot);
                  struct.FailureAnalysisArtifacts.add(_elem1036);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FMEAArtifacts = new java.util.ArrayList<TDDIAbstractFMEAArtifactRef>(_list1038.size);
                TDDIAbstractFMEAArtifactRef _elem1039;
                for (int _i1040 = 0; _i1040 < _list1038.size; ++_i1040)
                {
                  _elem1039 = new TDDIAbstractFMEAArtifactRef();
                  _elem1039.read(iprot);
                  struct.FMEAArtifacts.add(_elem1039);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // IMPLEMENTS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.Implements = new TDDIAbstractFMEAPackage();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIFMEAPackageInterface struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1041 : struct.KeyValueMaps)
          {
      ...
      if (struct.FailureAnalysisArtifacts != null) {
        oprot.writeFieldBegin(FAILURE_ANALYSIS_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1042 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.FMEAArtifacts != null) {
        oprot.writeFieldBegin(FMEAARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFMEAArtifactRef _iter1043 : struct.FMEAArtifacts)
          {
  ...
  private static class TDDIFMEAPackageInterfaceTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFMEAPackageInterfaceTupleScheme getScheme() {
      return new TDDIFMEAPackageInterfaceTupleScheme();
    }
  }

  private static class TDDIFMEAPackageInterfaceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIFMEAPackageInterface> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIFMEAPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1044 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetFailureAnalysisArtifacts()) {
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1045 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.isSetFMEAArtifacts()) {
        {
          ...
          for (TDDIAbstractFMEAArtifactRef _iter1046 : struct.FMEAArtifacts)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIFMEAPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1047.size);
          TDDIKeyValueMapRef _elem1048;
          for (int _i1049 = 0; _i1049 < _list1047.size; ++_i1049)
          {
            _elem1048 = new TDDIKeyValueMapRef();
            _elem1048.read(iprot);
            struct.KeyValueMaps.add(_elem1048);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1050.size);
          TDDIAbstractFailureAnalysisArtifactRef _elem1051;
          for (int _i1052 = 0; _i1052 < _list1050.size; ++_i1052)
          {
            _elem1051 = new TDDIAbstractFailureAnalysisArtifactRef();
            _elem1051.read(iprot);
            struct.FailureAnalysisArtifacts.add(_elem1051);
          }
        }
        struct.setFailureAnalysisArtifactsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.FMEAArtifacts = new java.util.ArrayList<TDDIAbstractFMEAArtifactRef>(_list1053.size);
          TDDIAbstractFMEAArtifactRef _elem1054;
          for (int _i1055 = 0; _i1055 < _list1053.size; ++_i1055)
          {
            _elem1054 = new TDDIAbstractFMEAArtifactRef();
            _elem1054.read(iprot);
            struct.FMEAArtifacts.add(_elem1054);
          }
        }
        struct.setFMEAArtifactsIsSet(true);
      }
