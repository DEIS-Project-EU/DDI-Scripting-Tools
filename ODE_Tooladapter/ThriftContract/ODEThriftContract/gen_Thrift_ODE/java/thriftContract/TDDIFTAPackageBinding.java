...
public class TDDIFTAPackageBinding implements org.apache.thrift.TBase<TDDIFTAPackageBinding, TDDIFTAPackageBinding._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIFTAPackageBinding> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIFTAPackageBinding");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIFTAPackageBindingStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIFTAPackageBindingTupleSchemeFactory();
  ...
  public java.util.List<TDDIAbstractFTAPackageRef> ParticipantPackages; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.PARTICIPANT_PACKAGES, new org.apache.thrift.meta_data.FieldMetaData("ParticipantPackages", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TDDIAbstractFTAPackageRef.class))));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIFTAPackageBinding.class, metaDataMap);
  }
  ...
  public TDDIFTAPackageBinding() {
    ...
    this.ParticipantPackages = new java.util.ArrayList<TDDIAbstractFTAPackageRef>();
  ...
  public TDDIFTAPackageBinding(
    ...
    java.util.List<TDDIAbstractFTAPackageRef> ParticipantPackages)
  {
    this();
    this.Id = Id;
    setIdIsSet(true);
   ...
   */
  public TDDIFTAPackageBinding(TDDIFTAPackageBinding other) {
    ...
    if (other.isSetParticipantPackages()) {
      java.util.List<TDDIAbstractFTAPackageRef> __this__ParticipantPackages = new java.util.ArrayList<TDDIAbstractFTAPackageRef>(other.ParticipantPackages.size());
      for (TDDIAbstractFTAPackageRef other_element : other.ParticipantPackages) {
        __this__ParticipantPackages.add(new TDDIAbstractFTAPackageRef(other_element));
      }
      this.ParticipantPackages = __this__ParticipantPackages;
    }
  }

  public TDDIFTAPackageBinding deepCopy() {
    return new TDDIFTAPackageBinding(this);
  }
  ...
  public TDDIFTAPackageBinding setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIFTAPackageBinding setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIFTAPackageBinding setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIFTAPackageBinding setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIFTAPackageBinding setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIFTAPackageBinding setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIFTAPackageBinding setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIFTAPackageBinding setFailureAnalysisArtifacts(java.util.List<TDDIAbstractFailureAnalysisArtifactRef> FailureAnalysisArtifacts) {
    this.FailureAnalysisArtifacts = FailureAnalysisArtifacts;
    return this;
  }
  ...
  public TDDIFTAPackageBinding setFTAArtifacts(java.util.List<TDDIAbstractFTAArtifact> FTAArtifacts) {
    this.FTAArtifacts = FTAArtifacts;
    return this;
  }
  ...
  public TDDIFTAPackageBinding setBasicEvents(java.util.List<TDDIBasicEvent> BasicEvents) {
    this.BasicEvents = BasicEvents;
    return this;
  }
  ...
  public java.util.Iterator<TDDIAbstractFTAPackageRef> getParticipantPackagesIterator() {
    return (this.ParticipantPackages == null) ? null : this.ParticipantPackages.iterator();
  }

  public void addToParticipantPackages(TDDIAbstractFTAPackageRef elem) {
  ...
  public java.util.List<TDDIAbstractFTAPackageRef> getParticipantPackages() {
    return this.ParticipantPackages;
  }

  public TDDIFTAPackageBinding setParticipantPackages(java.util.List<TDDIAbstractFTAPackageRef> ParticipantPackages) {
    this.ParticipantPackages = ParticipantPackages;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PARTICIPANT_PACKAGES:
      if (value == null) {
        ...
        setParticipantPackages((java.util.List<TDDIAbstractFTAPackageRef>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIFTAPackageBinding)
      return this.equals((TDDIFTAPackageBinding)that);
    return false;
  }

  public boolean equals(TDDIFTAPackageBinding that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIFTAPackageBinding other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIFTAPackageBinding(");
    boolean first = true;
  ...
  private static class TDDIFTAPackageBindingStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFTAPackageBindingStandardScheme getScheme() {
      return new TDDIFTAPackageBindingStandardScheme();
    }
  }

  private static class TDDIFTAPackageBindingStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIFTAPackageBinding> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIFTAPackageBinding struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1272.size);
                TDDIKeyValueMapRef _elem1273;
                for (int _i1274 = 0; _i1274 < _list1272.size; ++_i1274)
                {
                  _elem1273 = new TDDIKeyValueMapRef();
                  _elem1273.read(iprot);
                  struct.KeyValueMaps.add(_elem1273);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1275.size);
                TDDIAbstractFailureAnalysisArtifactRef _elem1276;
                for (int _i1277 = 0; _i1277 < _list1275.size; ++_i1277)
                {
                  _elem1276 = new TDDIAbstractFailureAnalysisArtifactRef();
                  _elem1276.read(iprot);
                  struct.FailureAnalysisArtifacts.add(_elem1276);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FTAArtifacts = new java.util.ArrayList<TDDIAbstractFTAArtifact>(_list1278.size);
                TDDIAbstractFTAArtifact _elem1279;
                for (int _i1280 = 0; _i1280 < _list1278.size; ++_i1280)
                {
                  _elem1279 = new TDDIAbstractFTAArtifact();
                  _elem1279.read(iprot);
                  struct.FTAArtifacts.add(_elem1279);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.BasicEvents = new java.util.ArrayList<TDDIBasicEvent>(_list1281.size);
                TDDIBasicEvent _elem1282;
                for (int _i1283 = 0; _i1283 < _list1281.size; ++_i1283)
                {
                  _elem1282 = new TDDIBasicEvent();
                  _elem1282.read(iprot);
                  struct.BasicEvents.add(_elem1282);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ParticipantPackages = new java.util.ArrayList<TDDIAbstractFTAPackageRef>(_list1284.size);
                TDDIAbstractFTAPackageRef _elem1285;
                for (int _i1286 = 0; _i1286 < _list1284.size; ++_i1286)
                {
                  _elem1285 = new TDDIAbstractFTAPackageRef();
                  _elem1285.read(iprot);
                  struct.ParticipantPackages.add(_elem1285);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIFTAPackageBinding struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1287 : struct.KeyValueMaps)
          {
      ...
      if (struct.FailureAnalysisArtifacts != null) {
        oprot.writeFieldBegin(FAILURE_ANALYSIS_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1288 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.FTAArtifacts != null) {
        oprot.writeFieldBegin(FTAARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFTAArtifact _iter1289 : struct.FTAArtifacts)
          {
      ...
      if (struct.BasicEvents != null) {
        oprot.writeFieldBegin(BASIC_EVENTS_FIELD_DESC);
        {
          ...
          for (TDDIBasicEvent _iter1290 : struct.BasicEvents)
          {
      ...
      if (struct.ParticipantPackages != null) {
        oprot.writeFieldBegin(PARTICIPANT_PACKAGES_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFTAPackageRef _iter1291 : struct.ParticipantPackages)
          {
  ...
  private static class TDDIFTAPackageBindingTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFTAPackageBindingTupleScheme getScheme() {
      return new TDDIFTAPackageBindingTupleScheme();
    }
  }

  private static class TDDIFTAPackageBindingTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIFTAPackageBinding> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIFTAPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1292 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetFailureAnalysisArtifacts()) {
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1293 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.isSetFTAArtifacts()) {
        {
          ...
          for (TDDIAbstractFTAArtifact _iter1294 : struct.FTAArtifacts)
          {
      ...
      if (struct.isSetBasicEvents()) {
        {
          ...
          for (TDDIBasicEvent _iter1295 : struct.BasicEvents)
          {
      ...
      if (struct.isSetParticipantPackages()) {
        {
          ...
          for (TDDIAbstractFTAPackageRef _iter1296 : struct.ParticipantPackages)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIFTAPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1297.size);
          TDDIKeyValueMapRef _elem1298;
          for (int _i1299 = 0; _i1299 < _list1297.size; ++_i1299)
          {
            _elem1298 = new TDDIKeyValueMapRef();
            _elem1298.read(iprot);
            struct.KeyValueMaps.add(_elem1298);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1300.size);
          TDDIAbstractFailureAnalysisArtifactRef _elem1301;
          for (int _i1302 = 0; _i1302 < _list1300.size; ++_i1302)
          {
            _elem1301 = new TDDIAbstractFailureAnalysisArtifactRef();
            _elem1301.read(iprot);
            struct.FailureAnalysisArtifacts.add(_elem1301);
          }
        }
        struct.setFailureAnalysisArtifactsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.FTAArtifacts = new java.util.ArrayList<TDDIAbstractFTAArtifact>(_list1303.size);
          TDDIAbstractFTAArtifact _elem1304;
          for (int _i1305 = 0; _i1305 < _list1303.size; ++_i1305)
          {
            _elem1304 = new TDDIAbstractFTAArtifact();
            _elem1304.read(iprot);
            struct.FTAArtifacts.add(_elem1304);
          }
        }
        struct.setFTAArtifactsIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1306 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.BasicEvents = new java.util.ArrayList<TDDIBasicEvent>(_list1306.size);
          TDDIBasicEvent _elem1307;
          for (int _i1308 = 0; _i1308 < _list1306.size; ++_i1308)
          {
            _elem1307 = new TDDIBasicEvent();
            _elem1307.read(iprot);
            struct.BasicEvents.add(_elem1307);
          }
        }
        struct.setBasicEventsIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.ParticipantPackages = new java.util.ArrayList<TDDIAbstractFTAPackageRef>(_list1309.size);
          TDDIAbstractFTAPackageRef _elem1310;
          for (int _i1311 = 0; _i1311 < _list1309.size; ++_i1311)
          {
            _elem1310 = new TDDIAbstractFTAPackageRef();
            _elem1310.read(iprot);
            struct.ParticipantPackages.add(_elem1310);
          }
        }
        struct.setParticipantPackagesIsSet(true);
      }
