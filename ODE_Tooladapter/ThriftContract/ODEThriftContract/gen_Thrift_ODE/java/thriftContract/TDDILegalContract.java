...
public class TDDILegalContract implements org.apache.thrift.TBase<TDDILegalContract, TDDILegalContract._Fields>, java.io.Serializable, Cloneable, Comparable<TDDILegalContract> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDILegalContract");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDILegalContractStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDILegalContractTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDILegalContract.class, metaDataMap);
  }
   ...
   */
  public TDDILegalContract(TDDILegalContract other) {
  ...
  public TDDILegalContract deepCopy() {
    return new TDDILegalContract(this);
  }
  ...
  public TDDILegalContract setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDILegalContract setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDILegalContract setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDILegalContract setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDILegalContract setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDILegalContract setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDILegalContract setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDILegalContract)
      return this.equals((TDDILegalContract)that);
    return false;
  }

  public boolean equals(TDDILegalContract that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDILegalContract other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDILegalContract(");
    boolean first = true;
  ...
  private static class TDDILegalContractStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDILegalContractStandardScheme getScheme() {
      return new TDDILegalContractStandardScheme();
    }
  }

  private static class TDDILegalContractStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDILegalContract> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDILegalContract struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1760.size);
                TDDIKeyValueMapRef _elem1761;
                for (int _i1762 = 0; _i1762 < _list1760.size; ++_i1762)
                {
                  _elem1761 = new TDDIKeyValueMapRef();
                  _elem1761.read(iprot);
                  struct.KeyValueMaps.add(_elem1761);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDILegalContract struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1763 : struct.KeyValueMaps)
          {
            _iter1763.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDILegalContractTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDILegalContractTupleScheme getScheme() {
      return new TDDILegalContractTupleScheme();
    }
  }

  private static class TDDILegalContractTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDILegalContract> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDILegalContract struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1764 : struct.KeyValueMaps)
          {
            _iter1764.write(oprot);
          }
        }
      }
      if (struct.isSetCitedElement()) {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDILegalContract struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list1765 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1765.size);
          TDDIKeyValueMapRef _elem1766;
          for (int _i1767 = 0; _i1767 < _list1765.size; ++_i1767)
          {
            _elem1766 = new TDDIKeyValueMapRef();
            _elem1766.read(iprot);
            struct.KeyValueMaps.add(_elem1766);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
