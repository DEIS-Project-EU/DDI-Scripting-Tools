...
public class TDDIAccident implements org.apache.thrift.TBase<TDDIAccident, TDDIAccident._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAccident> {
  ...
  private static final org.apache.thrift.protocol.TField SEVERITY_FIELD_DESC = new org.apache.thrift.protocol.TField("Severity", org.apache.thrift.protocol.TType.STRING, (short)9);
  ...
  public TDDIAccident setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIAccident setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIAccident setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIAccident setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1352.size);
                TDDIKeyValueMapRef _elem1353;
                for (int _i1354 = 0; _i1354 < _list1352.size; ++_i1354)
                {
                  _elem1353 = new TDDIKeyValueMapRef();
                  _elem1353.read(iprot);
                  struct.KeyValueMaps.add(_elem1353);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAccident struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1355 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1356 : struct.KeyValueMaps)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1357.size);
          TDDIKeyValueMapRef _elem1358;
          for (int _i1359 = 0; _i1359 < _list1357.size; ++_i1359)
          {
            _elem1358 = new TDDIKeyValueMapRef();
            _elem1358.read(iprot);
            struct.KeyValueMaps.add(_elem1358);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
