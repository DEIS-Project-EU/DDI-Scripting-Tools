...
public class TDDIMarkovChainPackage implements org.apache.thrift.TBase<TDDIMarkovChainPackage, TDDIMarkovChainPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIMarkovChainPackage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIMarkovChainPackage");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIMarkovChainPackageStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIMarkovChainPackageTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIMarkovChainPackage.class, metaDataMap);
  }

  public TDDIMarkovChainPackage() {
    this.Name = "";
   ...
   */
  public TDDIMarkovChainPackage(TDDIMarkovChainPackage other) {
  ...
  public TDDIMarkovChainPackage deepCopy() {
    return new TDDIMarkovChainPackage(this);
  }
  ...
  public TDDIMarkovChainPackage setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIMarkovChainPackage setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIMarkovChainPackage setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIMarkovChainPackage setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIMarkovChainPackage setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIMarkovChainPackage setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIMarkovChainPackage setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIMarkovChainPackage setFailureAnalysisArtifacts(java.util.List<TDDIAbstractFailureAnalysisArtifactRef> FailureAnalysisArtifacts) {
    this.FailureAnalysisArtifacts = FailureAnalysisArtifacts;
    return this;
  }
  ...
  public TDDIMarkovChainPackage setMarkovArtifacts(java.util.List<TDDIAbstractMarkovArtifact> MarkovArtifacts) {
    this.MarkovArtifacts = MarkovArtifacts;
    return this;
  }
  ...
  public TDDIMarkovChainPackage setFailStates(java.util.List<TDDIFailState> FailStates) {
    this.FailStates = FailStates;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIMarkovChainPackage)
      return this.equals((TDDIMarkovChainPackage)that);
    return false;
  }

  public boolean equals(TDDIMarkovChainPackage that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIMarkovChainPackage other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIMarkovChainPackage(");
    boolean first = true;
  ...
  private static class TDDIMarkovChainPackageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIMarkovChainPackageStandardScheme getScheme() {
      return new TDDIMarkovChainPackageStandardScheme();
    }
  }

  private static class TDDIMarkovChainPackageStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIMarkovChainPackage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIMarkovChainPackage struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1656.size);
                TDDIKeyValueMapRef _elem1657;
                for (int _i1658 = 0; _i1658 < _list1656.size; ++_i1658)
                {
                  _elem1657 = new TDDIKeyValueMapRef();
                  _elem1657.read(iprot);
                  struct.KeyValueMaps.add(_elem1657);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1659.size);
                TDDIAbstractFailureAnalysisArtifactRef _elem1660;
                for (int _i1661 = 0; _i1661 < _list1659.size; ++_i1661)
                {
                  _elem1660 = new TDDIAbstractFailureAnalysisArtifactRef();
                  _elem1660.read(iprot);
                  struct.FailureAnalysisArtifacts.add(_elem1660);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.MarkovArtifacts = new java.util.ArrayList<TDDIAbstractMarkovArtifact>(_list1662.size);
                TDDIAbstractMarkovArtifact _elem1663;
                for (int _i1664 = 0; _i1664 < _list1662.size; ++_i1664)
                {
                  _elem1663 = new TDDIAbstractMarkovArtifact();
                  _elem1663.read(iprot);
                  struct.MarkovArtifacts.add(_elem1663);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailStates = new java.util.ArrayList<TDDIFailState>(_list1665.size);
                TDDIFailState _elem1666;
                for (int _i1667 = 0; _i1667 < _list1665.size; ++_i1667)
                {
                  _elem1666 = new TDDIFailState();
                  _elem1666.read(iprot);
                  struct.FailStates.add(_elem1666);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIMarkovChainPackage struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1668 : struct.KeyValueMaps)
          {
      ...
      if (struct.FailureAnalysisArtifacts != null) {
        oprot.writeFieldBegin(FAILURE_ANALYSIS_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1669 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.MarkovArtifacts != null) {
        oprot.writeFieldBegin(MARKOV_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractMarkovArtifact _iter1670 : struct.MarkovArtifacts)
          {
      ...
      if (struct.FailStates != null) {
        oprot.writeFieldBegin(FAIL_STATES_FIELD_DESC);
        {
          ...
          for (TDDIFailState _iter1671 : struct.FailStates)
          {
            _iter1671.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIMarkovChainPackageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIMarkovChainPackageTupleScheme getScheme() {
      return new TDDIMarkovChainPackageTupleScheme();
    }
  }

  private static class TDDIMarkovChainPackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIMarkovChainPackage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIMarkovChainPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1672 : struct.KeyValueMaps)
          {
            _iter1672.write(oprot);
          }
        }
      }
      if (struct.isSetCitedElement()) {
      ...
      if (struct.isSetFailureAnalysisArtifacts()) {
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1673 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.isSetMarkovArtifacts()) {
        {
          ...
          for (TDDIAbstractMarkovArtifact _iter1674 : struct.MarkovArtifacts)
          {
      ...
      if (struct.isSetFailStates()) {
        {
          ...
          for (TDDIFailState _iter1675 : struct.FailStates)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIMarkovChainPackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list1676 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1676.size);
          TDDIKeyValueMapRef _elem1677;
          for (int _i1678 = 0; _i1678 < _list1676.size; ++_i1678)
          {
            _elem1677 = new TDDIKeyValueMapRef();
            _elem1677.read(iprot);
            struct.KeyValueMaps.add(_elem1677);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1679 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1679.size);
          TDDIAbstractFailureAnalysisArtifactRef _elem1680;
          for (int _i1681 = 0; _i1681 < _list1679.size; ++_i1681)
          {
            _elem1680 = new TDDIAbstractFailureAnalysisArtifactRef();
            _elem1680.read(iprot);
            struct.FailureAnalysisArtifacts.add(_elem1680);
          }
        }
        struct.setFailureAnalysisArtifactsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list1682 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.MarkovArtifacts = new java.util.ArrayList<TDDIAbstractMarkovArtifact>(_list1682.size);
          TDDIAbstractMarkovArtifact _elem1683;
          for (int _i1684 = 0; _i1684 < _list1682.size; ++_i1684)
          {
            _elem1683 = new TDDIAbstractMarkovArtifact();
            _elem1683.read(iprot);
            struct.MarkovArtifacts.add(_elem1683);
          }
        }
        struct.setMarkovArtifactsIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1685 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.FailStates = new java.util.ArrayList<TDDIFailState>(_list1685.size);
          TDDIFailState _elem1686;
          for (int _i1687 = 0; _i1687 < _list1685.size; ++_i1687)
          {
            _elem1686 = new TDDIFailState();
            _elem1686.read(iprot);
            struct.FailStates.add(_elem1686);
          }
        }
        struct.setFailStatesIsSet(true);
      }
