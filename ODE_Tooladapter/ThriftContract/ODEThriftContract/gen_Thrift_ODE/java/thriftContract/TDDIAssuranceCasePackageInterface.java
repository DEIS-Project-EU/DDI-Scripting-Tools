...
public class TDDIAssuranceCasePackageInterface implements org.apache.thrift.TBase<TDDIAssuranceCasePackageInterface, TDDIAssuranceCasePackageInterface._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAssuranceCasePackageInterface> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2808.size);
                TDDIImplementationConstraintRef _elem2809;
                for (int _i2810 = 0; _i2810 < _list2808.size; ++_i2810)
                {
                  _elem2809 = new TDDIImplementationConstraintRef();
                  _elem2809.read(iprot);
                  struct.ImplementationConstraint.add(_elem2809);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2811 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2811.size);
                TDDINoteRef _elem2812;
                for (int _i2813 = 0; _i2813 < _list2811.size; ++_i2813)
                {
                  _elem2812 = new TDDINoteRef();
                  _elem2812.read(iprot);
                  struct.Note.add(_elem2812);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2814 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2814.size);
                TDDITaggedValueRef _elem2815;
                for (int _i2816 = 0; _i2816 < _list2814.size; ++_i2816)
                {
                  _elem2815 = new TDDITaggedValueRef();
                  _elem2815.read(iprot);
                  struct.TaggedValue.add(_elem2815);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // ASSURANCE_CASE_PACKAGE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2817 = iprot.readListBegin();
                struct.AssuranceCasePackage = new java.util.ArrayList<TDDIAbstractAssuranceCasePackageRef>(_list2817.size);
                TDDIAbstractAssuranceCasePackageRef _elem2818;
                for (int _i2819 = 0; _i2819 < _list2817.size; ++_i2819)
                {
                  _elem2818 = new TDDIAbstractAssuranceCasePackageRef();
                  _elem2818.read(iprot);
                  struct.AssuranceCasePackage.add(_elem2818);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // INTERFACE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2820 = iprot.readListBegin();
                struct.Interface = new java.util.ArrayList<TDDIAssuranceCasePackageInterfaceRef>(_list2820.size);
                TDDIAssuranceCasePackageInterfaceRef _elem2821;
                for (int _i2822 = 0; _i2822 < _list2820.size; ++_i2822)
                {
                  _elem2821 = new TDDIAssuranceCasePackageInterfaceRef();
                  _elem2821.read(iprot);
                  struct.Interface.add(_elem2821);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // ARTIFACT_PACKAGE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2823 = iprot.readListBegin();
                struct.ArtifactPackage = new java.util.ArrayList<TDDIAbstractArtifactPackageRef>(_list2823.size);
                TDDIAbstractArtifactPackageRef _elem2824;
                for (int _i2825 = 0; _i2825 < _list2823.size; ++_i2825)
                {
                  _elem2824 = new TDDIAbstractArtifactPackageRef();
                  _elem2824.read(iprot);
                  struct.ArtifactPackage.add(_elem2824);
                }
                iprot.readListEnd();
              }
          ...
          case 14: // ARGUMENT_PACKAGE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2826 = iprot.readListBegin();
                struct.ArgumentPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(_list2826.size);
                TDDIAbstractArgumentPackageRef _elem2827;
                for (int _i2828 = 0; _i2828 < _list2826.size; ++_i2828)
                {
                  _elem2827 = new TDDIAbstractArgumentPackageRef();
                  _elem2827.read(iprot);
                  struct.ArgumentPackage.add(_elem2827);
                }
                iprot.readListEnd();
              }
          ...
          case 15: // TERMINOLOGY_PACKAGE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2829 = iprot.readListBegin();
                struct.TerminologyPackage = new java.util.ArrayList<TDDIAbstractTerminologyPackageRef>(_list2829.size);
                TDDIAbstractTerminologyPackageRef _elem2830;
                for (int _i2831 = 0; _i2831 < _list2829.size; ++_i2831)
                {
                  _elem2830 = new TDDIAbstractTerminologyPackageRef();
                  _elem2830.read(iprot);
                  struct.TerminologyPackage.add(_elem2830);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAssuranceCasePackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2832 : struct.ImplementationConstraint)
          {
            _iter2832.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2833 : struct.Note)
          {
            _iter2833.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2834 : struct.TaggedValue)
          {
            _iter2834.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AssuranceCasePackage != null) {
        oprot.writeFieldBegin(ASSURANCE_CASE_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractAssuranceCasePackageRef _iter2835 : struct.AssuranceCasePackage)
          {
            _iter2835.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Interface != null) {
        oprot.writeFieldBegin(INTERFACE_FIELD_DESC);
        {
          ...
          for (TDDIAssuranceCasePackageInterfaceRef _iter2836 : struct.Interface)
          {
            _iter2836.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ArtifactPackage != null) {
        oprot.writeFieldBegin(ARTIFACT_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactPackageRef _iter2837 : struct.ArtifactPackage)
          {
            _iter2837.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ArgumentPackage != null) {
        oprot.writeFieldBegin(ARGUMENT_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentPackageRef _iter2838 : struct.ArgumentPackage)
          {
            _iter2838.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TerminologyPackage != null) {
        oprot.writeFieldBegin(TERMINOLOGY_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractTerminologyPackageRef _iter2839 : struct.TerminologyPackage)
          {
            _iter2839.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIAssuranceCasePackageInterfaceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAssuranceCasePackageInterface> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2840 : struct.ImplementationConstraint)
          {
            _iter2840.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2841 : struct.Note)
          {
            _iter2841.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2842 : struct.TaggedValue)
          {
            _iter2842.write(oprot);
          }
        }
      }
      if (struct.isSetAssuranceCasePackage()) {
        {
          ...
          for (TDDIAbstractAssuranceCasePackageRef _iter2843 : struct.AssuranceCasePackage)
          {
      ...
      if (struct.isSetInterface()) {
        {
          ...
          for (TDDIAssuranceCasePackageInterfaceRef _iter2844 : struct.Interface)
          {
      ...
      if (struct.isSetArtifactPackage()) {
        {
          ...
          for (TDDIAbstractArtifactPackageRef _iter2845 : struct.ArtifactPackage)
          {
            _iter2845.write(oprot);
          }
        }
      }
      if (struct.isSetArgumentPackage()) {
        {
          ...
          for (TDDIAbstractArgumentPackageRef _iter2846 : struct.ArgumentPackage)
          {
            _iter2846.write(oprot);
          }
        }
      }
      if (struct.isSetTerminologyPackage()) {
        {
          ...
          for (TDDIAbstractTerminologyPackageRef _iter2847 : struct.TerminologyPackage)
          {
            _iter2847.write(oprot);
          }
        }
      }
      if (struct.isSetImplements()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAssuranceCasePackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2848 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2848.size);
          TDDIImplementationConstraintRef _elem2849;
          for (int _i2850 = 0; _i2850 < _list2848.size; ++_i2850)
          {
            _elem2849 = new TDDIImplementationConstraintRef();
            _elem2849.read(iprot);
            struct.ImplementationConstraint.add(_elem2849);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2851 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2851.size);
          TDDINoteRef _elem2852;
          for (int _i2853 = 0; _i2853 < _list2851.size; ++_i2853)
          {
            _elem2852 = new TDDINoteRef();
            _elem2852.read(iprot);
            struct.Note.add(_elem2852);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2854 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2854.size);
          TDDITaggedValueRef _elem2855;
          for (int _i2856 = 0; _i2856 < _list2854.size; ++_i2856)
          {
            _elem2855 = new TDDITaggedValueRef();
            _elem2855.read(iprot);
            struct.TaggedValue.add(_elem2855);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2857 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.AssuranceCasePackage = new java.util.ArrayList<TDDIAbstractAssuranceCasePackageRef>(_list2857.size);
          TDDIAbstractAssuranceCasePackageRef _elem2858;
          for (int _i2859 = 0; _i2859 < _list2857.size; ++_i2859)
          {
            _elem2858 = new TDDIAbstractAssuranceCasePackageRef();
            _elem2858.read(iprot);
            struct.AssuranceCasePackage.add(_elem2858);
          }
        }
        struct.setAssuranceCasePackageIsSet(true);
      }
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list2860 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Interface = new java.util.ArrayList<TDDIAssuranceCasePackageInterfaceRef>(_list2860.size);
          TDDIAssuranceCasePackageInterfaceRef _elem2861;
          for (int _i2862 = 0; _i2862 < _list2860.size; ++_i2862)
          {
            _elem2861 = new TDDIAssuranceCasePackageInterfaceRef();
            _elem2861.read(iprot);
            struct.Interface.add(_elem2861);
          }
        }
        struct.setInterfaceIsSet(true);
      }
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TList _list2863 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArtifactPackage = new java.util.ArrayList<TDDIAbstractArtifactPackageRef>(_list2863.size);
          TDDIAbstractArtifactPackageRef _elem2864;
          for (int _i2865 = 0; _i2865 < _list2863.size; ++_i2865)
          {
            _elem2864 = new TDDIAbstractArtifactPackageRef();
            _elem2864.read(iprot);
            struct.ArtifactPackage.add(_elem2864);
          }
        }
        struct.setArtifactPackageIsSet(true);
      }
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TList _list2866 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArgumentPackage = new java.util.ArrayList<TDDIAbstractArgumentPackageRef>(_list2866.size);
          TDDIAbstractArgumentPackageRef _elem2867;
          for (int _i2868 = 0; _i2868 < _list2866.size; ++_i2868)
          {
            _elem2867 = new TDDIAbstractArgumentPackageRef();
            _elem2867.read(iprot);
            struct.ArgumentPackage.add(_elem2867);
          }
        }
        struct.setArgumentPackageIsSet(true);
      }
      if (incoming.get(14)) {
        {
          org.apache.thrift.protocol.TList _list2869 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TerminologyPackage = new java.util.ArrayList<TDDIAbstractTerminologyPackageRef>(_list2869.size);
          TDDIAbstractTerminologyPackageRef _elem2870;
          for (int _i2871 = 0; _i2871 < _list2869.size; ++_i2871)
          {
            _elem2870 = new TDDIAbstractTerminologyPackageRef();
            _elem2870.read(iprot);
            struct.TerminologyPackage.add(_elem2870);
          }
        }
        struct.setTerminologyPackageIsSet(true);
      }
