...
public class TDDIArchitecturePackageInterface implements org.apache.thrift.TBase<TDDIArchitecturePackageInterface, TDDIArchitecturePackageInterface._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArchitecturePackageInterface> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIArchitecturePackageInterface");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIArchitecturePackageInterfaceStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIArchitecturePackageInterfaceTupleSchemeFactory();
  ...
  public TDDIAbstractArchitecturePackage Implements; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIArchitecturePackageInterface.class, metaDataMap);
  }

  public TDDIArchitecturePackageInterface() {
    this.Name = "";
   ...
   */
  public TDDIArchitecturePackageInterface(TDDIArchitecturePackageInterface other) {
    ...
    if (other.isSetImplements()) {
      this.Implements = new TDDIAbstractArchitecturePackage(other.Implements);
    }
  }

  public TDDIArchitecturePackageInterface deepCopy() {
    return new TDDIArchitecturePackageInterface(this);
  }
  ...
  public TDDIArchitecturePackageInterface setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIArchitecturePackageInterface setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIArchitecturePackageInterface setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIArchitecturePackageInterface setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIArchitecturePackageInterface setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIArchitecturePackageInterface setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIArchitecturePackageInterface setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIArchitecturePackageInterface setDependabilityRequirements(java.util.List<TDDIAbstractDependabilityRequirementRef> DependabilityRequirements) {
    this.DependabilityRequirements = DependabilityRequirements;
    return this;
  }
  ...
  public TDDIArchitecturePackageInterface setAssuranceLevel(TDDIAssuranceLevel AssuranceLevel) {
    this.AssuranceLevel = AssuranceLevel;
    return this;
  }
  ...
  public TDDIArchitecturePackageInterface setDesignArtifacts(java.util.List<TDDIAbstractDesignArtifactRef> DesignArtifacts) {
    this.DesignArtifacts = DesignArtifacts;
    return this;
  }
  ...
  public TDDIAbstractArchitecturePackage getImplements() {
    return this.Implements;
  }

  public TDDIArchitecturePackageInterface setImplements(TDDIAbstractArchitecturePackage Implements) {
    this.Implements = Implements;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case IMPLEMENTS:
      if (value == null) {
        ...
        setImplements((TDDIAbstractArchitecturePackage)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIArchitecturePackageInterface)
      return this.equals((TDDIArchitecturePackageInterface)that);
    return false;
  }

  public boolean equals(TDDIArchitecturePackageInterface that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIArchitecturePackageInterface other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIArchitecturePackageInterface(");
    boolean first = true;
  ...
  private static class TDDIArchitecturePackageInterfaceStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArchitecturePackageInterfaceStandardScheme getScheme() {
      return new TDDIArchitecturePackageInterfaceStandardScheme();
    }
  }

  private static class TDDIArchitecturePackageInterfaceStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIArchitecturePackageInterface> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIArchitecturePackageInterface struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list24.size);
                TDDIKeyValueMapRef _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new TDDIKeyValueMapRef();
                  _elem25.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list27.size);
                TDDIAbstractDependabilityRequirementRef _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new TDDIAbstractDependabilityRequirementRef();
                  _elem28.read(iprot);
                  struct.DependabilityRequirements.add(_elem28);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DesignArtifacts = new java.util.ArrayList<TDDIAbstractDesignArtifactRef>(_list30.size);
                TDDIAbstractDesignArtifactRef _elem31;
                for (int _i32 = 0; _i32 < _list30.size; ++_i32)
                {
                  _elem31 = new TDDIAbstractDesignArtifactRef();
                  _elem31.read(iprot);
                  struct.DesignArtifacts.add(_elem31);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // IMPLEMENTS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.Implements = new TDDIAbstractArchitecturePackage();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArchitecturePackageInterface struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter33 : struct.KeyValueMaps)
          {
            _iter33.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.DependabilityRequirements != null) {
        oprot.writeFieldBegin(DEPENDABILITY_REQUIREMENTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter34 : struct.DependabilityRequirements)
          {
            _iter34.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.DesignArtifacts != null) {
        oprot.writeFieldBegin(DESIGN_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDesignArtifactRef _iter35 : struct.DesignArtifacts)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TDDIArchitecturePackageInterfaceTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArchitecturePackageInterfaceTupleScheme getScheme() {
      return new TDDIArchitecturePackageInterfaceTupleScheme();
    }
  }

  private static class TDDIArchitecturePackageInterfaceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArchitecturePackageInterface> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIArchitecturePackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter36 : struct.KeyValueMaps)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (struct.isSetDependabilityRequirements()) {
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter37 : struct.DependabilityRequirements)
          {
            _iter37.write(oprot);
          }
        }
      ...
      if (struct.isSetDesignArtifacts()) {
        {
          ...
          for (TDDIAbstractDesignArtifactRef _iter38 : struct.DesignArtifacts)
          {
            _iter38.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArchitecturePackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list39.size);
          TDDIKeyValueMapRef _elem40;
          for (int _i41 = 0; _i41 < _list39.size; ++_i41)
          {
            _elem40 = new TDDIKeyValueMapRef();
            _elem40.read(iprot);
            struct.KeyValueMaps.add(_elem40);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list42.size);
          TDDIAbstractDependabilityRequirementRef _elem43;
          for (int _i44 = 0; _i44 < _list42.size; ++_i44)
          {
            _elem43 = new TDDIAbstractDependabilityRequirementRef();
            _elem43.read(iprot);
            struct.DependabilityRequirements.add(_elem43);
          }
        }
        struct.setDependabilityRequirementsIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.DesignArtifacts = new java.util.ArrayList<TDDIAbstractDesignArtifactRef>(_list45.size);
          TDDIAbstractDesignArtifactRef _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new TDDIAbstractDesignArtifactRef();
            _elem46.read(iprot);
            struct.DesignArtifacts.add(_elem46);
          }
        }
        struct.setDesignArtifactsIsSet(true);
      }
