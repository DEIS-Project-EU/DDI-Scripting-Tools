...
public class TDDITechnique implements org.apache.thrift.TBase<TDDITechnique, TDDITechnique._Fields>, java.io.Serializable, Cloneable, Comparable<TDDITechnique> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDITechnique");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDITechniqueStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDITechniqueTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDITechnique.class, metaDataMap);
  }

  public TDDITechnique() {
    this.Gid = "";
   ...
   */
  public TDDITechnique(TDDITechnique other) {
  ...
  public TDDITechnique deepCopy() {
    return new TDDITechnique(this);
  }
  ...
  public TDDITechnique setGid(java.lang.String Gid) {
    this.Gid = Gid;
    return this;
  }
  ...
  public TDDITechnique setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDITechnique setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDITechnique setCitedElement(TDDIAbstractSACMElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDITechnique setAbstractForm(TDDIAbstractSACMElement AbstractForm) {
    this.AbstractForm = AbstractForm;
    return this;
  }
  ...
  public TDDITechnique setName(TDDIAbstractLangString Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDITechnique setDescription(TDDIDescription Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDITechnique setImplementationConstraint(java.util.List<TDDIImplementationConstraintRef> ImplementationConstraint) {
    this.ImplementationConstraint = ImplementationConstraint;
    return this;
  }
  ...
  public TDDITechnique setNote(java.util.List<TDDINoteRef> Note) {
    this.Note = Note;
    return this;
  }
  ...
  public TDDITechnique setTaggedValue(java.util.List<TDDITaggedValueRef> TaggedValue) {
    this.TaggedValue = TaggedValue;
    return this;
  }
  ...
  public TDDITechnique setProperty(java.util.List<TDDIPropertyRef> Property) {
    this.Property = Property;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDITechnique)
      return this.equals((TDDITechnique)that);
    return false;
  }

  public boolean equals(TDDITechnique that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDITechnique other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDITechnique(");
    boolean first = true;
  ...
  private static class TDDITechniqueStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDITechniqueStandardScheme getScheme() {
      return new TDDITechniqueStandardScheme();
    }
  }

  private static class TDDITechniqueStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDITechnique> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDITechnique struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2504 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2504.size);
                TDDIImplementationConstraintRef _elem2505;
                for (int _i2506 = 0; _i2506 < _list2504.size; ++_i2506)
                {
                  _elem2505 = new TDDIImplementationConstraintRef();
                  _elem2505.read(iprot);
                  struct.ImplementationConstraint.add(_elem2505);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2507 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2507.size);
                TDDINoteRef _elem2508;
                for (int _i2509 = 0; _i2509 < _list2507.size; ++_i2509)
                {
                  _elem2508 = new TDDINoteRef();
                  _elem2508.read(iprot);
                  struct.Note.add(_elem2508);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2510 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2510.size);
                TDDITaggedValueRef _elem2511;
                for (int _i2512 = 0; _i2512 < _list2510.size; ++_i2512)
                {
                  _elem2511 = new TDDITaggedValueRef();
                  _elem2511.read(iprot);
                  struct.TaggedValue.add(_elem2511);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // PROPERTY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2513 = iprot.readListBegin();
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2513.size);
                TDDIPropertyRef _elem2514;
                for (int _i2515 = 0; _i2515 < _list2513.size; ++_i2515)
                {
                  _elem2514 = new TDDIPropertyRef();
                  _elem2514.read(iprot);
                  struct.Property.add(_elem2514);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDITechnique struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2516 : struct.ImplementationConstraint)
          {
            _iter2516.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2517 : struct.Note)
          {
            _iter2517.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2518 : struct.TaggedValue)
          {
            _iter2518.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2519 : struct.Property)
          {
            _iter2519.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDITechniqueTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDITechniqueTupleScheme getScheme() {
      return new TDDITechniqueTupleScheme();
    }
  }

  private static class TDDITechniqueTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDITechnique> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDITechnique struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2520 : struct.ImplementationConstraint)
          {
            _iter2520.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2521 : struct.Note)
          {
            _iter2521.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2522 : struct.TaggedValue)
          {
            _iter2522.write(oprot);
          }
        }
      }
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2523 : struct.Property)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDITechnique struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2524 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2524.size);
          TDDIImplementationConstraintRef _elem2525;
          for (int _i2526 = 0; _i2526 < _list2524.size; ++_i2526)
          {
            _elem2525 = new TDDIImplementationConstraintRef();
            _elem2525.read(iprot);
            struct.ImplementationConstraint.add(_elem2525);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2527 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2527.size);
          TDDINoteRef _elem2528;
          for (int _i2529 = 0; _i2529 < _list2527.size; ++_i2529)
          {
            _elem2528 = new TDDINoteRef();
            _elem2528.read(iprot);
            struct.Note.add(_elem2528);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2530 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2530.size);
          TDDITaggedValueRef _elem2531;
          for (int _i2532 = 0; _i2532 < _list2530.size; ++_i2532)
          {
            _elem2531 = new TDDITaggedValueRef();
            _elem2531.read(iprot);
            struct.TaggedValue.add(_elem2531);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2533 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2533.size);
          TDDIPropertyRef _elem2534;
          for (int _i2535 = 0; _i2535 < _list2533.size; ++_i2535)
          {
            _elem2534 = new TDDIPropertyRef();
            _elem2534.read(iprot);
            struct.Property.add(_elem2534);
          }
        }
        struct.setPropertyIsSet(true);
      }
