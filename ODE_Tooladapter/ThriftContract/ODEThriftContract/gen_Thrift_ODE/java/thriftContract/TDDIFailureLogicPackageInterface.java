...
public class TDDIFailureLogicPackageInterface implements org.apache.thrift.TBase<TDDIFailureLogicPackageInterface, TDDIFailureLogicPackageInterface._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIFailureLogicPackageInterface> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIFailureLogicPackageInterface");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIFailureLogicPackageInterfaceStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIFailureLogicPackageInterfaceTupleSchemeFactory();
  ...
  public TDDIAbstractFailureLogicPackage Implements; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIFailureLogicPackageInterface.class, metaDataMap);
  }
  ...
  public TDDIFailureLogicPackageInterface(
    ...
    TDDIAbstractFailureLogicPackage Implements)
  {
    this();
    this.Id = Id;
    setIdIsSet(true);
   ...
   */
  public TDDIFailureLogicPackageInterface(TDDIFailureLogicPackageInterface other) {
    ...
    if (other.isSetImplements()) {
      this.Implements = new TDDIAbstractFailureLogicPackage(other.Implements);
    }
  }

  public TDDIFailureLogicPackageInterface deepCopy() {
    return new TDDIFailureLogicPackageInterface(this);
  }
  ...
  public TDDIFailureLogicPackageInterface setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIFailureLogicPackageInterface setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIFailureLogicPackageInterface setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIFailureLogicPackageInterface setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIFailureLogicPackageInterface setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIFailureLogicPackageInterface setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIFailureLogicPackageInterface setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIFailureLogicPackageInterface setFailureAnalysisArtifacts(java.util.List<TDDIAbstractFailureAnalysisArtifact> FailureAnalysisArtifacts) {
    this.FailureAnalysisArtifacts = FailureAnalysisArtifacts;
    return this;
  }
  ...
  public TDDIAbstractFailureLogicPackage getImplements() {
    return this.Implements;
  }

  public TDDIFailureLogicPackageInterface setImplements(TDDIAbstractFailureLogicPackage Implements) {
    this.Implements = Implements;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case IMPLEMENTS:
      if (value == null) {
        ...
        setImplements((TDDIAbstractFailureLogicPackage)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIFailureLogicPackageInterface)
      return this.equals((TDDIFailureLogicPackageInterface)that);
    return false;
  }

  public boolean equals(TDDIFailureLogicPackageInterface that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIFailureLogicPackageInterface other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIFailureLogicPackageInterface(");
    boolean first = true;
  ...
  private static class TDDIFailureLogicPackageInterfaceStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFailureLogicPackageInterfaceStandardScheme getScheme() {
      return new TDDIFailureLogicPackageInterfaceStandardScheme();
    }
  }

  private static class TDDIFailureLogicPackageInterfaceStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIFailureLogicPackageInterface> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIFailureLogicPackageInterface struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list968.size);
                TDDIKeyValueMapRef _elem969;
                for (int _i970 = 0; _i970 < _list968.size; ++_i970)
                {
                  _elem969 = new TDDIKeyValueMapRef();
                  _elem969.read(iprot);
                  struct.KeyValueMaps.add(_elem969);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifact>(_list971.size);
                TDDIAbstractFailureAnalysisArtifact _elem972;
                for (int _i973 = 0; _i973 < _list971.size; ++_i973)
                {
                  _elem972 = new TDDIAbstractFailureAnalysisArtifact();
                  _elem972.read(iprot);
                  struct.FailureAnalysisArtifacts.add(_elem972);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // IMPLEMENTS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.Implements = new TDDIAbstractFailureLogicPackage();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIFailureLogicPackageInterface struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter974 : struct.KeyValueMaps)
          {
      ...
      if (struct.FailureAnalysisArtifacts != null) {
        oprot.writeFieldBegin(FAILURE_ANALYSIS_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifact _iter975 : struct.FailureAnalysisArtifacts)
          {
  ...
  private static class TDDIFailureLogicPackageInterfaceTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFailureLogicPackageInterfaceTupleScheme getScheme() {
      return new TDDIFailureLogicPackageInterfaceTupleScheme();
    }
  }

  private static class TDDIFailureLogicPackageInterfaceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIFailureLogicPackageInterface> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIFailureLogicPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter976 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetFailureAnalysisArtifacts()) {
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifact _iter977 : struct.FailureAnalysisArtifacts)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIFailureLogicPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list978.size);
          TDDIKeyValueMapRef _elem979;
          for (int _i980 = 0; _i980 < _list978.size; ++_i980)
          {
            _elem979 = new TDDIKeyValueMapRef();
            _elem979.read(iprot);
            struct.KeyValueMaps.add(_elem979);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifact>(_list981.size);
          TDDIAbstractFailureAnalysisArtifact _elem982;
          for (int _i983 = 0; _i983 < _list981.size; ++_i983)
          {
            _elem982 = new TDDIAbstractFailureAnalysisArtifact();
            _elem982.read(iprot);
            struct.FailureAnalysisArtifacts.add(_elem982);
          }
        }
        struct.setFailureAnalysisArtifactsIsSet(true);
      }
