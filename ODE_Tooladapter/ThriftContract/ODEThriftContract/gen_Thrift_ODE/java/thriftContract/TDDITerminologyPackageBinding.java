...
public class TDDITerminologyPackageBinding implements org.apache.thrift.TBase<TDDITerminologyPackageBinding, TDDITerminologyPackageBinding._Fields>, java.io.Serializable, Cloneable, Comparable<TDDITerminologyPackageBinding> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3016 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list3016.size);
                TDDIImplementationConstraintRef _elem3017;
                for (int _i3018 = 0; _i3018 < _list3016.size; ++_i3018)
                {
                  _elem3017 = new TDDIImplementationConstraintRef();
                  _elem3017.read(iprot);
                  struct.ImplementationConstraint.add(_elem3017);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3019 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list3019.size);
                TDDINoteRef _elem3020;
                for (int _i3021 = 0; _i3021 < _list3019.size; ++_i3021)
                {
                  _elem3020 = new TDDINoteRef();
                  _elem3020.read(iprot);
                  struct.Note.add(_elem3020);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3022 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list3022.size);
                TDDITaggedValueRef _elem3023;
                for (int _i3024 = 0; _i3024 < _list3022.size; ++_i3024)
                {
                  _elem3023 = new TDDITaggedValueRef();
                  _elem3023.read(iprot);
                  struct.TaggedValue.add(_elem3023);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // TERMINOLOGY_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3025 = iprot.readListBegin();
                struct.TerminologyElement = new java.util.ArrayList<TDDIAbstractTerminologyElement>(_list3025.size);
                TDDIAbstractTerminologyElement _elem3026;
                for (int _i3027 = 0; _i3027 < _list3025.size; ++_i3027)
                {
                  _elem3026 = new TDDIAbstractTerminologyElement();
                  _elem3026.read(iprot);
                  struct.TerminologyElement.add(_elem3026);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // PARTICIPANT_PACKAGE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3028 = iprot.readListBegin();
                struct.ParticipantPackage = new java.util.ArrayList<TDDIAbstractTerminologyPackage>(_list3028.size);
                TDDIAbstractTerminologyPackage _elem3029;
                for (int _i3030 = 0; _i3030 < _list3028.size; ++_i3030)
                {
                  _elem3029 = new TDDIAbstractTerminologyPackage();
                  _elem3029.read(iprot);
                  struct.ParticipantPackage.add(_elem3029);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDITerminologyPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter3031 : struct.ImplementationConstraint)
          {
            _iter3031.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter3032 : struct.Note)
          {
            _iter3032.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter3033 : struct.TaggedValue)
          {
            _iter3033.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TerminologyElement != null) {
        oprot.writeFieldBegin(TERMINOLOGY_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractTerminologyElement _iter3034 : struct.TerminologyElement)
          {
            _iter3034.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ParticipantPackage != null) {
        oprot.writeFieldBegin(PARTICIPANT_PACKAGE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractTerminologyPackage _iter3035 : struct.ParticipantPackage)
          {
            _iter3035.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDITerminologyPackageBindingTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDITerminologyPackageBinding> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter3036 : struct.ImplementationConstraint)
          {
            _iter3036.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter3037 : struct.Note)
          {
            _iter3037.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter3038 : struct.TaggedValue)
          {
            _iter3038.write(oprot);
          }
        }
      }
      if (struct.isSetTerminologyElement()) {
        {
          ...
          for (TDDIAbstractTerminologyElement _iter3039 : struct.TerminologyElement)
          {
      ...
      if (struct.isSetParticipantPackage()) {
        {
          ...
          for (TDDIAbstractTerminologyPackage _iter3040 : struct.ParticipantPackage)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDITerminologyPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list3041 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list3041.size);
          TDDIImplementationConstraintRef _elem3042;
          for (int _i3043 = 0; _i3043 < _list3041.size; ++_i3043)
          {
            _elem3042 = new TDDIImplementationConstraintRef();
            _elem3042.read(iprot);
            struct.ImplementationConstraint.add(_elem3042);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list3044 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list3044.size);
          TDDINoteRef _elem3045;
          for (int _i3046 = 0; _i3046 < _list3044.size; ++_i3046)
          {
            _elem3045 = new TDDINoteRef();
            _elem3045.read(iprot);
            struct.Note.add(_elem3045);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list3047 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list3047.size);
          TDDITaggedValueRef _elem3048;
          for (int _i3049 = 0; _i3049 < _list3047.size; ++_i3049)
          {
            _elem3048 = new TDDITaggedValueRef();
            _elem3048.read(iprot);
            struct.TaggedValue.add(_elem3048);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list3050 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TerminologyElement = new java.util.ArrayList<TDDIAbstractTerminologyElement>(_list3050.size);
          TDDIAbstractTerminologyElement _elem3051;
          for (int _i3052 = 0; _i3052 < _list3050.size; ++_i3052)
          {
            _elem3051 = new TDDIAbstractTerminologyElement();
            _elem3051.read(iprot);
            struct.TerminologyElement.add(_elem3051);
          }
        }
        struct.setTerminologyElementIsSet(true);
      }
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list3053 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ParticipantPackage = new java.util.ArrayList<TDDIAbstractTerminologyPackage>(_list3053.size);
          TDDIAbstractTerminologyPackage _elem3054;
          for (int _i3055 = 0; _i3055 < _list3053.size; ++_i3055)
          {
            _elem3054 = new TDDIAbstractTerminologyPackage();
            _elem3054.read(iprot);
            struct.ParticipantPackage.add(_elem3054);
          }
        }
        struct.setParticipantPackageIsSet(true);
      }
