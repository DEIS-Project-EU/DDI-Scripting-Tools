...
public class TDDIArgumentGroup implements org.apache.thrift.TBase<TDDIArgumentGroup, TDDIArgumentGroup._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArgumentGroup> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIArgumentGroup");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIArgumentGroupStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIArgumentGroupTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIArgumentGroup.class, metaDataMap);
  }

  public TDDIArgumentGroup() {
    this.Gid = "";
   ...
   */
  public TDDIArgumentGroup(TDDIArgumentGroup other) {
  ...
  public TDDIArgumentGroup deepCopy() {
    return new TDDIArgumentGroup(this);
  }
  ...
  public TDDIArgumentGroup setGid(java.lang.String Gid) {
    this.Gid = Gid;
    return this;
  }
  ...
  public TDDIArgumentGroup setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIArgumentGroup setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIArgumentGroup setCitedElement(TDDIAbstractSACMElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIArgumentGroup setAbstractForm(TDDIAbstractSACMElement AbstractForm) {
    this.AbstractForm = AbstractForm;
    return this;
  }
  ...
  public TDDIArgumentGroup setName(TDDIAbstractLangString Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIArgumentGroup setDescription(TDDIDescription Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIArgumentGroup setImplementationConstraint(java.util.List<TDDIImplementationConstraintRef> ImplementationConstraint) {
    this.ImplementationConstraint = ImplementationConstraint;
    return this;
  }
  ...
  public TDDIArgumentGroup setNote(java.util.List<TDDINoteRef> Note) {
    this.Note = Note;
    return this;
  }
  ...
  public TDDIArgumentGroup setTaggedValue(java.util.List<TDDITaggedValueRef> TaggedValue) {
    this.TaggedValue = TaggedValue;
    return this;
  }
  ...
  public TDDIArgumentGroup setArgumentationElement(java.util.List<TDDIAbstractArgumentationElementRef> ArgumentationElement) {
    this.ArgumentationElement = ArgumentationElement;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIArgumentGroup)
      return this.equals((TDDIArgumentGroup)that);
    return false;
  }

  public boolean equals(TDDIArgumentGroup that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIArgumentGroup other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIArgumentGroup(");
    boolean first = true;
  ...
  private static class TDDIArgumentGroupStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArgumentGroupStandardScheme getScheme() {
      return new TDDIArgumentGroupStandardScheme();
    }
  }

  private static class TDDIArgumentGroupStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIArgumentGroup> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIArgumentGroup struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1904.size);
                TDDIImplementationConstraintRef _elem1905;
                for (int _i1906 = 0; _i1906 < _list1904.size; ++_i1906)
                {
                  _elem1905 = new TDDIImplementationConstraintRef();
                  _elem1905.read(iprot);
                  struct.ImplementationConstraint.add(_elem1905);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1907 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1907.size);
                TDDINoteRef _elem1908;
                for (int _i1909 = 0; _i1909 < _list1907.size; ++_i1909)
                {
                  _elem1908 = new TDDINoteRef();
                  _elem1908.read(iprot);
                  struct.Note.add(_elem1908);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1910 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1910.size);
                TDDITaggedValueRef _elem1911;
                for (int _i1912 = 0; _i1912 < _list1910.size; ++_i1912)
                {
                  _elem1911 = new TDDITaggedValueRef();
                  _elem1911.read(iprot);
                  struct.TaggedValue.add(_elem1911);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // ARGUMENTATION_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1913 = iprot.readListBegin();
                struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list1913.size);
                TDDIAbstractArgumentationElementRef _elem1914;
                for (int _i1915 = 0; _i1915 < _list1913.size; ++_i1915)
                {
                  _elem1914 = new TDDIAbstractArgumentationElementRef();
                  _elem1914.read(iprot);
                  struct.ArgumentationElement.add(_elem1914);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArgumentGroup struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1916 : struct.ImplementationConstraint)
          {
            _iter1916.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1917 : struct.Note)
          {
            _iter1917.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1918 : struct.TaggedValue)
          {
            _iter1918.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ArgumentationElement != null) {
        oprot.writeFieldBegin(ARGUMENTATION_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter1919 : struct.ArgumentationElement)
          {
            _iter1919.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIArgumentGroupTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArgumentGroupTupleScheme getScheme() {
      return new TDDIArgumentGroupTupleScheme();
    }
  }

  private static class TDDIArgumentGroupTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArgumentGroup> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIArgumentGroup struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1920 : struct.ImplementationConstraint)
          {
            _iter1920.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1921 : struct.Note)
          {
            _iter1921.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1922 : struct.TaggedValue)
          {
            _iter1922.write(oprot);
          }
        }
      }
      if (struct.isSetArgumentationElement()) {
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter1923 : struct.ArgumentationElement)
          {
            _iter1923.write(oprot);
          }
        }
      }
    }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArgumentGroup struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1924 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1924.size);
          TDDIImplementationConstraintRef _elem1925;
          for (int _i1926 = 0; _i1926 < _list1924.size; ++_i1926)
          {
            _elem1925 = new TDDIImplementationConstraintRef();
            _elem1925.read(iprot);
            struct.ImplementationConstraint.add(_elem1925);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list1927 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1927.size);
          TDDINoteRef _elem1928;
          for (int _i1929 = 0; _i1929 < _list1927.size; ++_i1929)
          {
            _elem1928 = new TDDINoteRef();
            _elem1928.read(iprot);
            struct.Note.add(_elem1928);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1930 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1930.size);
          TDDITaggedValueRef _elem1931;
          for (int _i1932 = 0; _i1932 < _list1930.size; ++_i1932)
          {
            _elem1931 = new TDDITaggedValueRef();
            _elem1931.read(iprot);
            struct.TaggedValue.add(_elem1931);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list1933 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list1933.size);
          TDDIAbstractArgumentationElementRef _elem1934;
          for (int _i1935 = 0; _i1935 < _list1933.size; ++_i1935)
          {
            _elem1934 = new TDDIAbstractArgumentationElementRef();
            _elem1934.read(iprot);
            struct.ArgumentationElement.add(_elem1934);
          }
        }
        struct.setArgumentationElementIsSet(true);
      }
