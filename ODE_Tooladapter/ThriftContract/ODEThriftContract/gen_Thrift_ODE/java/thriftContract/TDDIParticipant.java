...
public class TDDIParticipant implements org.apache.thrift.TBase<TDDIParticipant, TDDIParticipant._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIParticipant> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIParticipant");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIParticipantStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIParticipantTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIParticipant.class, metaDataMap);
  }

  public TDDIParticipant() {
    this.Gid = "";
   ...
   */
  public TDDIParticipant(TDDIParticipant other) {
  ...
  public TDDIParticipant deepCopy() {
    return new TDDIParticipant(this);
  }
  ...
  public TDDIParticipant setGid(java.lang.String Gid) {
    this.Gid = Gid;
    return this;
  }
  ...
  public TDDIParticipant setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIParticipant setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIParticipant setCitedElement(TDDIAbstractSACMElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIParticipant setAbstractForm(TDDIAbstractSACMElement AbstractForm) {
    this.AbstractForm = AbstractForm;
    return this;
  }
  ...
  public TDDIParticipant setName(TDDIAbstractLangString Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIParticipant setDescription(TDDIDescription Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIParticipant setImplementationConstraint(java.util.List<TDDIImplementationConstraintRef> ImplementationConstraint) {
    this.ImplementationConstraint = ImplementationConstraint;
    return this;
  }
  ...
  public TDDIParticipant setNote(java.util.List<TDDINoteRef> Note) {
    this.Note = Note;
    return this;
  }
  ...
  public TDDIParticipant setTaggedValue(java.util.List<TDDITaggedValueRef> TaggedValue) {
    this.TaggedValue = TaggedValue;
    return this;
  }
  ...
  public TDDIParticipant setProperty(java.util.List<TDDIPropertyRef> Property) {
    this.Property = Property;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIParticipant)
      return this.equals((TDDIParticipant)that);
    return false;
  }

  public boolean equals(TDDIParticipant that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIParticipant other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIParticipant(");
    boolean first = true;
  ...
  private static class TDDIParticipantStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIParticipantStandardScheme getScheme() {
      return new TDDIParticipantStandardScheme();
    }
  }

  private static class TDDIParticipantStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIParticipant> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIParticipant struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2536.size);
                TDDIImplementationConstraintRef _elem2537;
                for (int _i2538 = 0; _i2538 < _list2536.size; ++_i2538)
                {
                  _elem2537 = new TDDIImplementationConstraintRef();
                  _elem2537.read(iprot);
                  struct.ImplementationConstraint.add(_elem2537);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2539 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2539.size);
                TDDINoteRef _elem2540;
                for (int _i2541 = 0; _i2541 < _list2539.size; ++_i2541)
                {
                  _elem2540 = new TDDINoteRef();
                  _elem2540.read(iprot);
                  struct.Note.add(_elem2540);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2542 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2542.size);
                TDDITaggedValueRef _elem2543;
                for (int _i2544 = 0; _i2544 < _list2542.size; ++_i2544)
                {
                  _elem2543 = new TDDITaggedValueRef();
                  _elem2543.read(iprot);
                  struct.TaggedValue.add(_elem2543);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // PROPERTY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2545 = iprot.readListBegin();
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2545.size);
                TDDIPropertyRef _elem2546;
                for (int _i2547 = 0; _i2547 < _list2545.size; ++_i2547)
                {
                  _elem2546 = new TDDIPropertyRef();
                  _elem2546.read(iprot);
                  struct.Property.add(_elem2546);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIParticipant struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2548 : struct.ImplementationConstraint)
          {
            _iter2548.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2549 : struct.Note)
          {
            _iter2549.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2550 : struct.TaggedValue)
          {
            _iter2550.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2551 : struct.Property)
          {
            _iter2551.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIParticipantTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIParticipantTupleScheme getScheme() {
      return new TDDIParticipantTupleScheme();
    }
  }

  private static class TDDIParticipantTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIParticipant> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIParticipant struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2552 : struct.ImplementationConstraint)
          {
            _iter2552.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2553 : struct.Note)
          {
            _iter2553.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2554 : struct.TaggedValue)
          {
            _iter2554.write(oprot);
          }
        }
      }
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2555 : struct.Property)
          {
            _iter2555.write(oprot);
          }
        }
      }
    }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIParticipant struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2556 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2556.size);
          TDDIImplementationConstraintRef _elem2557;
          for (int _i2558 = 0; _i2558 < _list2556.size; ++_i2558)
          {
            _elem2557 = new TDDIImplementationConstraintRef();
            _elem2557.read(iprot);
            struct.ImplementationConstraint.add(_elem2557);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2559 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2559.size);
          TDDINoteRef _elem2560;
          for (int _i2561 = 0; _i2561 < _list2559.size; ++_i2561)
          {
            _elem2560 = new TDDINoteRef();
            _elem2560.read(iprot);
            struct.Note.add(_elem2560);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2562 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2562.size);
          TDDITaggedValueRef _elem2563;
          for (int _i2564 = 0; _i2564 < _list2562.size; ++_i2564)
          {
            _elem2563 = new TDDITaggedValueRef();
            _elem2563.read(iprot);
            struct.TaggedValue.add(_elem2563);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2565 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2565.size);
          TDDIPropertyRef _elem2566;
          for (int _i2567 = 0; _i2567 < _list2565.size; ++_i2567)
          {
            _elem2566 = new TDDIPropertyRef();
            _elem2566.read(iprot);
            struct.Property.add(_elem2566);
          }
        }
        struct.setPropertyIsSet(true);
      }
