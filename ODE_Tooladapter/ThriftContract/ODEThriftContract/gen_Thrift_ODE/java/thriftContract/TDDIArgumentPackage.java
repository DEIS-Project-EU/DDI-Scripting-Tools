...
public class TDDIArgumentPackage implements org.apache.thrift.TBase<TDDIArgumentPackage, TDDIArgumentPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArgumentPackage> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1936 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1936.size);
                TDDIImplementationConstraintRef _elem1937;
                for (int _i1938 = 0; _i1938 < _list1936.size; ++_i1938)
                {
                  _elem1937 = new TDDIImplementationConstraintRef();
                  _elem1937.read(iprot);
                  struct.ImplementationConstraint.add(_elem1937);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1939 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1939.size);
                TDDINoteRef _elem1940;
                for (int _i1941 = 0; _i1941 < _list1939.size; ++_i1941)
                {
                  _elem1940 = new TDDINoteRef();
                  _elem1940.read(iprot);
                  struct.Note.add(_elem1940);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1942.size);
                TDDITaggedValueRef _elem1943;
                for (int _i1944 = 0; _i1944 < _list1942.size; ++_i1944)
                {
                  _elem1943 = new TDDITaggedValueRef();
                  _elem1943.read(iprot);
                  struct.TaggedValue.add(_elem1943);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list1945.size);
                TDDIAbstractArgumentationElementRef _elem1946;
                for (int _i1947 = 0; _i1947 < _list1945.size; ++_i1947)
                {
                  _elem1946 = new TDDIAbstractArgumentationElementRef();
                  _elem1946.read(iprot);
                  struct.ArgumentationElement.add(_elem1946);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArgumentPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1948 : struct.ImplementationConstraint)
          {
            _iter1948.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1949 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1950 : struct.TaggedValue)
          {
      ...
      if (struct.ArgumentationElement != null) {
        oprot.writeFieldBegin(ARGUMENTATION_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter1951 : struct.ArgumentationElement)
          {
            _iter1951.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIArgumentPackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArgumentPackage> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1952 : struct.ImplementationConstraint)
          {
            _iter1952.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1953 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1954 : struct.TaggedValue)
          {
      ...
      if (struct.isSetArgumentationElement()) {
        {
          ...
          for (TDDIAbstractArgumentationElementRef _iter1955 : struct.ArgumentationElement)
          {
            _iter1955.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArgumentPackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1956 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1956.size);
          TDDIImplementationConstraintRef _elem1957;
          for (int _i1958 = 0; _i1958 < _list1956.size; ++_i1958)
          {
            _elem1957 = new TDDIImplementationConstraintRef();
            _elem1957.read(iprot);
            struct.ImplementationConstraint.add(_elem1957);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list1959 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1959.size);
          TDDINoteRef _elem1960;
          for (int _i1961 = 0; _i1961 < _list1959.size; ++_i1961)
          {
            _elem1960 = new TDDINoteRef();
            _elem1960.read(iprot);
            struct.Note.add(_elem1960);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1962 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1962.size);
          TDDITaggedValueRef _elem1963;
          for (int _i1964 = 0; _i1964 < _list1962.size; ++_i1964)
          {
            _elem1963 = new TDDITaggedValueRef();
            _elem1963.read(iprot);
            struct.TaggedValue.add(_elem1963);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list1965 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArgumentationElement = new java.util.ArrayList<TDDIAbstractArgumentationElementRef>(_list1965.size);
          TDDIAbstractArgumentationElementRef _elem1966;
          for (int _i1967 = 0; _i1967 < _list1965.size; ++_i1967)
          {
            _elem1966 = new TDDIAbstractArgumentationElementRef();
            _elem1966.read(iprot);
            struct.ArgumentationElement.add(_elem1966);
          }
        }
        struct.setArgumentationElementIsSet(true);
      }
