...
public class TDDIArtifactPackageInterface implements org.apache.thrift.TBase<TDDIArtifactPackageInterface, TDDIArtifactPackageInterface._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArtifactPackageInterface> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIArtifactPackageInterface");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIArtifactPackageInterfaceStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIArtifactPackageInterfaceTupleSchemeFactory();
  ...
  public TDDIAbstractArtifactPackage Implements; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIArtifactPackageInterface.class, metaDataMap);
  }

  public TDDIArtifactPackageInterface() {
    this.Gid = "";
   ...
   */
  public TDDIArtifactPackageInterface(TDDIArtifactPackageInterface other) {
    ...
    if (other.isSetImplements()) {
      this.Implements = new TDDIAbstractArtifactPackage(other.Implements);
    }
  }

  public TDDIArtifactPackageInterface deepCopy() {
    return new TDDIArtifactPackageInterface(this);
  }
  ...
  public TDDIArtifactPackageInterface setGid(java.lang.String Gid) {
    this.Gid = Gid;
    return this;
  }
  ...
  public TDDIArtifactPackageInterface setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIArtifactPackageInterface setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIArtifactPackageInterface setCitedElement(TDDIAbstractSACMElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIArtifactPackageInterface setAbstractForm(TDDIAbstractSACMElement AbstractForm) {
    this.AbstractForm = AbstractForm;
    return this;
  }
  ...
  public TDDIArtifactPackageInterface setName(TDDIAbstractLangString Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIArtifactPackageInterface setDescription(TDDIDescription Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIArtifactPackageInterface setImplementationConstraint(java.util.List<TDDIImplementationConstraintRef> ImplementationConstraint) {
    this.ImplementationConstraint = ImplementationConstraint;
    return this;
  }
  ...
  public TDDIArtifactPackageInterface setNote(java.util.List<TDDINoteRef> Note) {
    this.Note = Note;
    return this;
  }
  ...
  public TDDIArtifactPackageInterface setTaggedValue(java.util.List<TDDITaggedValueRef> TaggedValue) {
    this.TaggedValue = TaggedValue;
    return this;
  }
  ...
  public TDDIArtifactPackageInterface setArtifactElement(java.util.List<TDDIAbstractArtifactElementRef> ArtifactElement) {
    this.ArtifactElement = ArtifactElement;
    return this;
  }
  ...
  public TDDIAbstractArtifactPackage getImplements() {
    return this.Implements;
  }

  public TDDIArtifactPackageInterface setImplements(TDDIAbstractArtifactPackage Implements) {
    this.Implements = Implements;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case IMPLEMENTS:
      if (value == null) {
        ...
        setImplements((TDDIAbstractArtifactPackage)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIArtifactPackageInterface)
      return this.equals((TDDIArtifactPackageInterface)that);
    return false;
  }

  public boolean equals(TDDIArtifactPackageInterface that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIArtifactPackageInterface other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIArtifactPackageInterface(");
    boolean first = true;
  ...
  private static class TDDIArtifactPackageInterfaceStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArtifactPackageInterfaceStandardScheme getScheme() {
      return new TDDIArtifactPackageInterfaceStandardScheme();
    }
  }

  private static class TDDIArtifactPackageInterfaceStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIArtifactPackageInterface> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIArtifactPackageInterface struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list2377.size);
                TDDIAbstractArtifactElementRef _elem2378;
                for (int _i2379 = 0; _i2379 < _list2377.size; ++_i2379)
                {
                  _elem2378 = new TDDIAbstractArtifactElementRef();
                  _elem2378.read(iprot);
                  struct.ArtifactElement.add(_elem2378);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // IMPLEMENTS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.Implements = new TDDIAbstractArtifactPackage();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArtifactPackageInterface struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2380 : struct.ImplementationConstraint)
          {
            _iter2380.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2381 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2382 : struct.TaggedValue)
          {
      ...
      if (struct.ArtifactElement != null) {
        oprot.writeFieldBegin(ARTIFACT_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter2383 : struct.ArtifactElement)
          {
            _iter2383.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIArtifactPackageInterfaceTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArtifactPackageInterfaceTupleScheme getScheme() {
      return new TDDIArtifactPackageInterfaceTupleScheme();
    }
  }

  private static class TDDIArtifactPackageInterfaceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArtifactPackageInterface> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIArtifactPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2384 : struct.ImplementationConstraint)
          {
            _iter2384.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2385 : struct.Note)
          {
            _iter2385.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2386 : struct.TaggedValue)
          {
            _iter2386.write(oprot);
          }
        }
      }
      if (struct.isSetArtifactElement()) {
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter2387 : struct.ArtifactElement)
          {
            _iter2387.write(oprot);
          }
        }
      }
      if (struct.isSetImplements()) {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArtifactPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2388 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2388.size);
          TDDIImplementationConstraintRef _elem2389;
          for (int _i2390 = 0; _i2390 < _list2388.size; ++_i2390)
          {
            _elem2389 = new TDDIImplementationConstraintRef();
            _elem2389.read(iprot);
            struct.ImplementationConstraint.add(_elem2389);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2391 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2391.size);
          TDDINoteRef _elem2392;
          for (int _i2393 = 0; _i2393 < _list2391.size; ++_i2393)
          {
            _elem2392 = new TDDINoteRef();
            _elem2392.read(iprot);
            struct.Note.add(_elem2392);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2394 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2394.size);
          TDDITaggedValueRef _elem2395;
          for (int _i2396 = 0; _i2396 < _list2394.size; ++_i2396)
          {
            _elem2395 = new TDDITaggedValueRef();
            _elem2395.read(iprot);
            struct.TaggedValue.add(_elem2395);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2397 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list2397.size);
          TDDIAbstractArtifactElementRef _elem2398;
          for (int _i2399 = 0; _i2399 < _list2397.size; ++_i2399)
          {
            _elem2398 = new TDDIAbstractArtifactElementRef();
            _elem2398.read(iprot);
            struct.ArtifactElement.add(_elem2398);
          }
        }
        struct.setArtifactElementIsSet(true);
      }
