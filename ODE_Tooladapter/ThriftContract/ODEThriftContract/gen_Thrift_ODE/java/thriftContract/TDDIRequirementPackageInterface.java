...
public class TDDIRequirementPackageInterface implements org.apache.thrift.TBase<TDDIRequirementPackageInterface, TDDIRequirementPackageInterface._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIRequirementPackageInterface> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIRequirementPackageInterface");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIRequirementPackageInterfaceStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIRequirementPackageInterfaceTupleSchemeFactory();
  ...
  public TDDIAbstractRequirementPackage Implements; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIRequirementPackageInterface.class, metaDataMap);
  }

  public TDDIRequirementPackageInterface() {
    this.Name = "";
  ...
  public TDDIRequirementPackageInterface(
    ...
    TDDIAbstractRequirementPackage Implements)
  {
    this();
    this.Id = Id;
    setIdIsSet(true);
   ...
   */
  public TDDIRequirementPackageInterface(TDDIRequirementPackageInterface other) {
    ...
    if (other.isSetImplements()) {
      this.Implements = new TDDIAbstractRequirementPackage(other.Implements);
    }
  }

  public TDDIRequirementPackageInterface deepCopy() {
    return new TDDIRequirementPackageInterface(this);
  }
  ...
  public TDDIRequirementPackageInterface setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIRequirementPackageInterface setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIRequirementPackageInterface setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIRequirementPackageInterface setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIRequirementPackageInterface setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIRequirementPackageInterface setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIRequirementPackageInterface setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIRequirementPackageInterface setRequirementArtifacts(java.util.List<TDDIAbstractRequirementArtifactRef> RequirementArtifacts) {
    this.RequirementArtifacts = RequirementArtifacts;
    return this;
  }
  ...
  public TDDIAbstractRequirementPackage getImplements() {
    return this.Implements;
  }

  public TDDIRequirementPackageInterface setImplements(TDDIAbstractRequirementPackage Implements) {
    this.Implements = Implements;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case IMPLEMENTS:
      if (value == null) {
        ...
        setImplements((TDDIAbstractRequirementPackage)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIRequirementPackageInterface)
      return this.equals((TDDIRequirementPackageInterface)that);
    return false;
  }

  public boolean equals(TDDIRequirementPackageInterface that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIRequirementPackageInterface other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIRequirementPackageInterface(");
    boolean first = true;
  ...
  private static class TDDIRequirementPackageInterfaceStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIRequirementPackageInterfaceStandardScheme getScheme() {
      return new TDDIRequirementPackageInterfaceStandardScheme();
    }
  }

  private static class TDDIRequirementPackageInterfaceStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIRequirementPackageInterface> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIRequirementPackageInterface struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1784.size);
                TDDIKeyValueMapRef _elem1785;
                for (int _i1786 = 0; _i1786 < _list1784.size; ++_i1786)
                {
                  _elem1785 = new TDDIKeyValueMapRef();
                  _elem1785.read(iprot);
                  struct.KeyValueMaps.add(_elem1785);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.RequirementArtifacts = new java.util.ArrayList<TDDIAbstractRequirementArtifactRef>(_list1787.size);
                TDDIAbstractRequirementArtifactRef _elem1788;
                for (int _i1789 = 0; _i1789 < _list1787.size; ++_i1789)
                {
                  _elem1788 = new TDDIAbstractRequirementArtifactRef();
                  _elem1788.read(iprot);
                  struct.RequirementArtifacts.add(_elem1788);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // IMPLEMENTS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.Implements = new TDDIAbstractRequirementPackage();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIRequirementPackageInterface struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1790 : struct.KeyValueMaps)
          {
      ...
      if (struct.RequirementArtifacts != null) {
        oprot.writeFieldBegin(REQUIREMENT_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractRequirementArtifactRef _iter1791 : struct.RequirementArtifacts)
          {
  ...
  private static class TDDIRequirementPackageInterfaceTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIRequirementPackageInterfaceTupleScheme getScheme() {
      return new TDDIRequirementPackageInterfaceTupleScheme();
    }
  }

  private static class TDDIRequirementPackageInterfaceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIRequirementPackageInterface> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIRequirementPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1792 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetRequirementArtifacts()) {
        {
          ...
          for (TDDIAbstractRequirementArtifactRef _iter1793 : struct.RequirementArtifacts)
          {
            _iter1793.write(oprot);
          }
        }
      }
      if (struct.isSetImplements()) {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIRequirementPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1794.size);
          TDDIKeyValueMapRef _elem1795;
          for (int _i1796 = 0; _i1796 < _list1794.size; ++_i1796)
          {
            _elem1795 = new TDDIKeyValueMapRef();
            _elem1795.read(iprot);
            struct.KeyValueMaps.add(_elem1795);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.RequirementArtifacts = new java.util.ArrayList<TDDIAbstractRequirementArtifactRef>(_list1797.size);
          TDDIAbstractRequirementArtifactRef _elem1798;
          for (int _i1799 = 0; _i1799 < _list1797.size; ++_i1799)
          {
            _elem1798 = new TDDIAbstractRequirementArtifactRef();
            _elem1798.read(iprot);
            struct.RequirementArtifacts.add(_elem1798);
          }
        }
        struct.setRequirementArtifactsIsSet(true);
      }
