...
public class TDDIFunction implements org.apache.thrift.TBase<TDDIFunction, TDDIFunction._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIFunction> {
  ...
  public TDDIFunction setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIFunction setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIFunction setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIFunction setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIFunction setPorts(java.util.List<TDDIPortRef> Ports) {
    this.Ports = Ports;
    return this;
  }
  ...
  public TDDIFunction setFailureModels(java.util.List<TDDIAbstractFailureLogicPackageRef> FailureModels) {
    this.FailureModels = FailureModels;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list568.size);
                TDDIKeyValueMapRef _elem569;
                for (int _i570 = 0; _i570 < _list568.size; ++_i570)
                {
                  _elem569 = new TDDIKeyValueMapRef();
                  _elem569.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list571.size);
                TDDIAbstractDependabilityRequirementRef _elem572;
                for (int _i573 = 0; _i573 < _list571.size; ++_i573)
                {
                  _elem572 = new TDDIAbstractDependabilityRequirementRef();
                  _elem572.read(iprot);
                  struct.DependabilityRequirements.add(_elem572);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.SubFunctions = new java.util.ArrayList<TDDIAbstractFunctionRef>(_list574.size);
                TDDIAbstractFunctionRef _elem575;
                for (int _i576 = 0; _i576 < _list574.size; ++_i576)
                {
                  _elem575 = new TDDIAbstractFunctionRef();
                  _elem575.read(iprot);
                  struct.SubFunctions.add(_elem575);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Ports = new java.util.ArrayList<TDDIPortRef>(_list577.size);
                TDDIPortRef _elem578;
                for (int _i579 = 0; _i579 < _list577.size; ++_i579)
                {
                  _elem578 = new TDDIPortRef();
                  _elem578.read(iprot);
                  struct.Ports.add(_elem578);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureModels = new java.util.ArrayList<TDDIAbstractFailureLogicPackageRef>(_list580.size);
                TDDIAbstractFailureLogicPackageRef _elem581;
                for (int _i582 = 0; _i582 < _list580.size; ++_i582)
                {
                  _elem581 = new TDDIAbstractFailureLogicPackageRef();
                  _elem581.read(iprot);
                  struct.FailureModels.add(_elem581);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Malfunctions = new java.util.ArrayList<TDDIMalFunctionRef>(_list583.size);
                TDDIMalFunctionRef _elem584;
                for (int _i585 = 0; _i585 < _list583.size; ++_i585)
                {
                  _elem584 = new TDDIMalFunctionRef();
                  _elem584.read(iprot);
                  struct.Malfunctions.add(_elem584);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIFunction struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter586 : struct.KeyValueMaps)
          {
      ...
      if (struct.DependabilityRequirements != null) {
        oprot.writeFieldBegin(DEPENDABILITY_REQUIREMENTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter587 : struct.DependabilityRequirements)
          {
      ...
      if (struct.SubFunctions != null) {
        oprot.writeFieldBegin(SUB_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFunctionRef _iter588 : struct.SubFunctions)
          {
      ...
      if (struct.Ports != null) {
        oprot.writeFieldBegin(PORTS_FIELD_DESC);
        {
          ...
          for (TDDIPortRef _iter589 : struct.Ports)
          {
      ...
      if (struct.FailureModels != null) {
        oprot.writeFieldBegin(FAILURE_MODELS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureLogicPackageRef _iter590 : struct.FailureModels)
          {
      ...
      if (struct.Malfunctions != null) {
        oprot.writeFieldBegin(MALFUNCTIONS_FIELD_DESC);
        {
          ...
          for (TDDIMalFunctionRef _iter591 : struct.Malfunctions)
          {
  ...
  private static class TDDIFunctionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIFunction> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter592 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetDependabilityRequirements()) {
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter593 : struct.DependabilityRequirements)
          {
      ...
      if (struct.isSetSubFunctions()) {
        {
          ...
          for (TDDIAbstractFunctionRef _iter594 : struct.SubFunctions)
          {
      ...
      if (struct.isSetPorts()) {
        {
          ...
          for (TDDIPortRef _iter595 : struct.Ports)
          {
      ...
      if (struct.isSetFailureModels()) {
        {
          ...
          for (TDDIAbstractFailureLogicPackageRef _iter596 : struct.FailureModels)
          {
      ...
      if (struct.isSetMalfunctions()) {
        {
          ...
          for (TDDIMalFunctionRef _iter597 : struct.Malfunctions)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIFunction struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list598 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list598.size);
          TDDIKeyValueMapRef _elem599;
          for (int _i600 = 0; _i600 < _list598.size; ++_i600)
          {
            _elem599 = new TDDIKeyValueMapRef();
            _elem599.read(iprot);
            struct.KeyValueMaps.add(_elem599);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list601.size);
          TDDIAbstractDependabilityRequirementRef _elem602;
          for (int _i603 = 0; _i603 < _list601.size; ++_i603)
          {
            _elem602 = new TDDIAbstractDependabilityRequirementRef();
            _elem602.read(iprot);
            struct.DependabilityRequirements.add(_elem602);
          }
        }
        struct.setDependabilityRequirementsIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.SubFunctions = new java.util.ArrayList<TDDIAbstractFunctionRef>(_list604.size);
          TDDIAbstractFunctionRef _elem605;
          for (int _i606 = 0; _i606 < _list604.size; ++_i606)
          {
            _elem605 = new TDDIAbstractFunctionRef();
            _elem605.read(iprot);
            struct.SubFunctions.add(_elem605);
          }
        }
        struct.setSubFunctionsIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.Ports = new java.util.ArrayList<TDDIPortRef>(_list607.size);
          TDDIPortRef _elem608;
          for (int _i609 = 0; _i609 < _list607.size; ++_i609)
          {
            _elem608 = new TDDIPortRef();
            _elem608.read(iprot);
            struct.Ports.add(_elem608);
          }
        }
        struct.setPortsIsSet(true);
      }
      ...
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TList _list610 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.FailureModels = new java.util.ArrayList<TDDIAbstractFailureLogicPackageRef>(_list610.size);
          TDDIAbstractFailureLogicPackageRef _elem611;
          for (int _i612 = 0; _i612 < _list610.size; ++_i612)
          {
            _elem611 = new TDDIAbstractFailureLogicPackageRef();
            _elem611.read(iprot);
            struct.FailureModels.add(_elem611);
          }
        }
        struct.setFailureModelsIsSet(true);
      }
      if (incoming.get(13)) {
        {
          ...
          struct.Malfunctions = new java.util.ArrayList<TDDIMalFunctionRef>(_list613.size);
          TDDIMalFunctionRef _elem614;
          for (int _i615 = 0; _i615 < _list613.size; ++_i615)
          {
            _elem614 = new TDDIMalFunctionRef();
            _elem614.read(iprot);
            struct.Malfunctions.add(_elem614);
          }
        }
        struct.setMalfunctionsIsSet(true);
      }
