...
public class TDDIClaim implements org.apache.thrift.TBase<TDDIClaim, TDDIClaim._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIClaim> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2064.size);
                TDDIImplementationConstraintRef _elem2065;
                for (int _i2066 = 0; _i2066 < _list2064.size; ++_i2066)
                {
                  _elem2065 = new TDDIImplementationConstraintRef();
                  _elem2065.read(iprot);
                  struct.ImplementationConstraint.add(_elem2065);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2067 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2067.size);
                TDDINoteRef _elem2068;
                for (int _i2069 = 0; _i2069 < _list2067.size; ++_i2069)
                {
                  _elem2068 = new TDDINoteRef();
                  _elem2068.read(iprot);
                  struct.Note.add(_elem2068);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2070.size);
                TDDITaggedValueRef _elem2071;
                for (int _i2072 = 0; _i2072 < _list2070.size; ++_i2072)
                {
                  _elem2071 = new TDDITaggedValueRef();
                  _elem2071.read(iprot);
                  struct.TaggedValue.add(_elem2071);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list2073.size);
                TDDIClaimRef _elem2074;
                for (int _i2075 = 0; _i2075 < _list2073.size; ++_i2075)
                {
                  _elem2074 = new TDDIClaimRef();
                  _elem2074.read(iprot);
                  struct.MetaClaim.add(_elem2074);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIClaim struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2076 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2077 : struct.Note)
          {
            _iter2077.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2078 : struct.TaggedValue)
          {
            _iter2078.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.MetaClaim != null) {
        oprot.writeFieldBegin(META_CLAIM_FIELD_DESC);
        {
          ...
          for (TDDIClaimRef _iter2079 : struct.MetaClaim)
          {
            _iter2079.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIClaimTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIClaim> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2080 : struct.ImplementationConstraint)
          {
            _iter2080.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2081 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2082 : struct.TaggedValue)
          {
      ...
      if (struct.isSetMetaClaim()) {
        {
          ...
          for (TDDIClaimRef _iter2083 : struct.MetaClaim)
          {
            _iter2083.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIClaim struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2084 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2084.size);
          TDDIImplementationConstraintRef _elem2085;
          for (int _i2086 = 0; _i2086 < _list2084.size; ++_i2086)
          {
            _elem2085 = new TDDIImplementationConstraintRef();
            _elem2085.read(iprot);
            struct.ImplementationConstraint.add(_elem2085);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2087 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2087.size);
          TDDINoteRef _elem2088;
          for (int _i2089 = 0; _i2089 < _list2087.size; ++_i2089)
          {
            _elem2088 = new TDDINoteRef();
            _elem2088.read(iprot);
            struct.Note.add(_elem2088);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2090 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2090.size);
          TDDITaggedValueRef _elem2091;
          for (int _i2092 = 0; _i2092 < _list2090.size; ++_i2092)
          {
            _elem2091 = new TDDITaggedValueRef();
            _elem2091.read(iprot);
            struct.TaggedValue.add(_elem2091);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list2093 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list2093.size);
          TDDIClaimRef _elem2094;
          for (int _i2095 = 0; _i2095 < _list2093.size; ++_i2095)
          {
            _elem2094 = new TDDIClaimRef();
            _elem2094.read(iprot);
            struct.MetaClaim.add(_elem2094);
          }
        }
        struct.setMetaClaimIsSet(true);
      }
