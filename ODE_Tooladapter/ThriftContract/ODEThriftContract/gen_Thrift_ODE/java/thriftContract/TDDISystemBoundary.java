...
public class TDDISystemBoundary implements org.apache.thrift.TBase<TDDISystemBoundary, TDDISystemBoundary._Fields>, java.io.Serializable, Cloneable, Comparable<TDDISystemBoundary> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDISystemBoundary");
  ...
  private static final org.apache.thrift.protocol.TField PORTS_FIELD_DESC = new org.apache.thrift.protocol.TField("Ports", org.apache.thrift.protocol.TType.LIST, (short)10);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDISystemBoundaryStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDISystemBoundaryTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDISystemBoundary.class, metaDataMap);
  }
   ...
   */
  public TDDISystemBoundary(TDDISystemBoundary other) {
  ...
  public TDDISystemBoundary deepCopy() {
    return new TDDISystemBoundary(this);
  }
  ...
  public TDDISystemBoundary setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDISystemBoundary setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDISystemBoundary setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDISystemBoundary setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDISystemBoundary setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDISystemBoundary setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDISystemBoundary setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDISystemBoundary setDependabilityRequirements(java.util.List<TDDIAbstractDependabilityRequirementRef> DependabilityRequirements) {
    this.DependabilityRequirements = DependabilityRequirements;
    return this;
  }
  ...
  public TDDISystemBoundary setAssuranceLevel(TDDIAssuranceLevel AssuranceLevel) {
    this.AssuranceLevel = AssuranceLevel;
    return this;
  }
  ...
  public TDDISystemBoundary setPorts(java.util.List<TDDIPortRef> Ports) {
    this.Ports = Ports;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDISystemBoundary)
      return this.equals((TDDISystemBoundary)that);
    return false;
  }

  public boolean equals(TDDISystemBoundary that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDISystemBoundary other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDISystemBoundary(");
    boolean first = true;
  ...
  private static class TDDISystemBoundaryStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDISystemBoundaryStandardScheme getScheme() {
      return new TDDISystemBoundaryStandardScheme();
    }
  }

  private static class TDDISystemBoundaryStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDISystemBoundary> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDISystemBoundary struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list184.size);
                TDDIKeyValueMapRef _elem185;
                for (int _i186 = 0; _i186 < _list184.size; ++_i186)
                {
                  _elem185 = new TDDIKeyValueMapRef();
                  _elem185.read(iprot);
                  struct.KeyValueMaps.add(_elem185);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list187.size);
                TDDIAbstractDependabilityRequirementRef _elem188;
                for (int _i189 = 0; _i189 < _list187.size; ++_i189)
                {
                  _elem188 = new TDDIAbstractDependabilityRequirementRef();
                  _elem188.read(iprot);
                  struct.DependabilityRequirements.add(_elem188);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Ports = new java.util.ArrayList<TDDIPortRef>(_list190.size);
                TDDIPortRef _elem191;
                for (int _i192 = 0; _i192 < _list190.size; ++_i192)
                {
                  _elem191 = new TDDIPortRef();
                  _elem191.read(iprot);
                  struct.Ports.add(_elem191);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDISystemBoundary struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter193 : struct.KeyValueMaps)
          {
      ...
      if (struct.DependabilityRequirements != null) {
        oprot.writeFieldBegin(DEPENDABILITY_REQUIREMENTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter194 : struct.DependabilityRequirements)
          {
      ...
      if (struct.Ports != null) {
        oprot.writeFieldBegin(PORTS_FIELD_DESC);
        {
          ...
          for (TDDIPortRef _iter195 : struct.Ports)
          {
  ...
  private static class TDDISystemBoundaryTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDISystemBoundaryTupleScheme getScheme() {
      return new TDDISystemBoundaryTupleScheme();
    }
  }

  private static class TDDISystemBoundaryTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDISystemBoundary> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDISystemBoundary struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter196 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetPorts()) {
        {
          ...
          for (TDDIPortRef _iter198 : struct.Ports)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDISystemBoundary struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list199.size);
          TDDIKeyValueMapRef _elem200;
          for (int _i201 = 0; _i201 < _list199.size; ++_i201)
          {
            _elem200 = new TDDIKeyValueMapRef();
            _elem200.read(iprot);
            struct.KeyValueMaps.add(_elem200);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list202.size);
          TDDIAbstractDependabilityRequirementRef _elem203;
          for (int _i204 = 0; _i204 < _list202.size; ++_i204)
          {
            _elem203 = new TDDIAbstractDependabilityRequirementRef();
            _elem203.read(iprot);
            struct.DependabilityRequirements.add(_elem203);
          }
        }
        struct.setDependabilityRequirementsIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.Ports = new java.util.ArrayList<TDDIPortRef>(_list205.size);
          TDDIPortRef _elem206;
          for (int _i207 = 0; _i207 < _list205.size; ++_i207)
          {
            _elem206 = new TDDIPortRef();
            _elem206.read(iprot);
            struct.Ports.add(_elem206);
          }
        }
        struct.setPortsIsSet(true);
      }
