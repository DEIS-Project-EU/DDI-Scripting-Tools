...
public class TDDIProbDistParam implements org.apache.thrift.TBase<TDDIProbDistParam, TDDIProbDistParam._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIProbDistParam> {
  ...
  public TDDIProbDistParam setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIProbDistParam setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIProbDistParam setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIProbDistParam setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list856.size);
                TDDIKeyValueMapRef _elem857;
                for (int _i858 = 0; _i858 < _list856.size; ++_i858)
                {
                  _elem857 = new TDDIKeyValueMapRef();
                  _elem857.read(iprot);
                  struct.KeyValueMaps.add(_elem857);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIProbDistParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter859 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter860 : struct.KeyValueMaps)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list861.size);
          TDDIKeyValueMapRef _elem862;
          for (int _i863 = 0; _i863 < _list861.size; ++_i863)
          {
            _elem862 = new TDDIKeyValueMapRef();
            _elem862.read(iprot);
            struct.KeyValueMaps.add(_elem862);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
