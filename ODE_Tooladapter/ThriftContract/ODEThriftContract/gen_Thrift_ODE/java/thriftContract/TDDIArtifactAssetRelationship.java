...
public class TDDIArtifactAssetRelationship implements org.apache.thrift.TBase<TDDIArtifactAssetRelationship, TDDIArtifactAssetRelationship._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArtifactAssetRelationship> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2696 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2696.size);
                TDDIImplementationConstraintRef _elem2697;
                for (int _i2698 = 0; _i2698 < _list2696.size; ++_i2698)
                {
                  _elem2697 = new TDDIImplementationConstraintRef();
                  _elem2697.read(iprot);
                  struct.ImplementationConstraint.add(_elem2697);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2699 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2699.size);
                TDDINoteRef _elem2700;
                for (int _i2701 = 0; _i2701 < _list2699.size; ++_i2701)
                {
                  _elem2700 = new TDDINoteRef();
                  _elem2700.read(iprot);
                  struct.Note.add(_elem2700);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2702 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2702.size);
                TDDITaggedValueRef _elem2703;
                for (int _i2704 = 0; _i2704 < _list2702.size; ++_i2704)
                {
                  _elem2703 = new TDDITaggedValueRef();
                  _elem2703.read(iprot);
                  struct.TaggedValue.add(_elem2703);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // PROPERTY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2705 = iprot.readListBegin();
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2705.size);
                TDDIPropertyRef _elem2706;
                for (int _i2707 = 0; _i2707 < _list2705.size; ++_i2707)
                {
                  _elem2706 = new TDDIPropertyRef();
                  _elem2706.read(iprot);
                  struct.Property.add(_elem2706);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // SOURCE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2708 = iprot.readListBegin();
                struct.Source = new java.util.ArrayList<TDDIAbstractArtifactAssetRef>(_list2708.size);
                TDDIAbstractArtifactAssetRef _elem2709;
                for (int _i2710 = 0; _i2710 < _list2708.size; ++_i2710)
                {
                  _elem2709 = new TDDIAbstractArtifactAssetRef();
                  _elem2709.read(iprot);
                  struct.Source.add(_elem2709);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // TARGET
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2711 = iprot.readListBegin();
                struct.Target = new java.util.ArrayList<TDDIAbstractArtifactAssetRef>(_list2711.size);
                TDDIAbstractArtifactAssetRef _elem2712;
                for (int _i2713 = 0; _i2713 < _list2711.size; ++_i2713)
                {
                  _elem2712 = new TDDIAbstractArtifactAssetRef();
                  _elem2712.read(iprot);
                  struct.Target.add(_elem2712);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArtifactAssetRelationship struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2714 : struct.ImplementationConstraint)
          {
            _iter2714.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2715 : struct.Note)
          {
            _iter2715.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2716 : struct.TaggedValue)
          {
            _iter2716.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2717 : struct.Property)
          {
      ...
      if (struct.Source != null) {
        oprot.writeFieldBegin(SOURCE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactAssetRef _iter2718 : struct.Source)
          {
      ...
      if (struct.Target != null) {
        oprot.writeFieldBegin(TARGET_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactAssetRef _iter2719 : struct.Target)
          {
            _iter2719.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIArtifactAssetRelationshipTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArtifactAssetRelationship> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2720 : struct.ImplementationConstraint)
          {
            _iter2720.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2721 : struct.Note)
          {
            _iter2721.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2722 : struct.TaggedValue)
          {
            _iter2722.write(oprot);
          }
        }
      }
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2723 : struct.Property)
          {
            _iter2723.write(oprot);
          }
        }
      }
      if (struct.isSetSource()) {
        {
          ...
          for (TDDIAbstractArtifactAssetRef _iter2724 : struct.Source)
          {
      ...
      if (struct.isSetTarget()) {
        {
          ...
          for (TDDIAbstractArtifactAssetRef _iter2725 : struct.Target)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArtifactAssetRelationship struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2726 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2726.size);
          TDDIImplementationConstraintRef _elem2727;
          for (int _i2728 = 0; _i2728 < _list2726.size; ++_i2728)
          {
            _elem2727 = new TDDIImplementationConstraintRef();
            _elem2727.read(iprot);
            struct.ImplementationConstraint.add(_elem2727);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2729 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2729.size);
          TDDINoteRef _elem2730;
          for (int _i2731 = 0; _i2731 < _list2729.size; ++_i2731)
          {
            _elem2730 = new TDDINoteRef();
            _elem2730.read(iprot);
            struct.Note.add(_elem2730);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2732.size);
          TDDITaggedValueRef _elem2733;
          for (int _i2734 = 0; _i2734 < _list2732.size; ++_i2734)
          {
            _elem2733 = new TDDITaggedValueRef();
            _elem2733.read(iprot);
            struct.TaggedValue.add(_elem2733);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2735.size);
          TDDIPropertyRef _elem2736;
          for (int _i2737 = 0; _i2737 < _list2735.size; ++_i2737)
          {
            _elem2736 = new TDDIPropertyRef();
            _elem2736.read(iprot);
            struct.Property.add(_elem2736);
          }
        }
        struct.setPropertyIsSet(true);
      }
      if (incoming.get(11)) {
        {
          ...
          struct.Source = new java.util.ArrayList<TDDIAbstractArtifactAssetRef>(_list2738.size);
          TDDIAbstractArtifactAssetRef _elem2739;
          for (int _i2740 = 0; _i2740 < _list2738.size; ++_i2740)
          {
            _elem2739 = new TDDIAbstractArtifactAssetRef();
            _elem2739.read(iprot);
            struct.Source.add(_elem2739);
          }
        }
        struct.setSourceIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.Target = new java.util.ArrayList<TDDIAbstractArtifactAssetRef>(_list2741.size);
          TDDIAbstractArtifactAssetRef _elem2742;
          for (int _i2743 = 0; _i2743 < _list2741.size; ++_i2743)
          {
            _elem2742 = new TDDIAbstractArtifactAssetRef();
            _elem2742.read(iprot);
            struct.Target.add(_elem2742);
          }
        }
        struct.setTargetIsSet(true);
      }
