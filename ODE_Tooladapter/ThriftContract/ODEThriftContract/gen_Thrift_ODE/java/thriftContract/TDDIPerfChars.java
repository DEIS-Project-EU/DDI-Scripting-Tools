...
public class TDDIPerfChars implements org.apache.thrift.TBase<TDDIPerfChars, TDDIPerfChars._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIPerfChars> {
  ...
  private static final org.apache.thrift.protocol.TField RESPONSE_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("ResponseTime", org.apache.thrift.protocol.TType.DOUBLE, (short)10);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    RESPONSE_TIME((short)10, "ResponseTime");
  ...
  public TDDIPerfChars setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIPerfChars setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIPerfChars setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIPerfChars setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIPerfChars setDependabilityRequirements(java.util.List<TDDIAbstractDependabilityRequirementRef> DependabilityRequirements) {
    this.DependabilityRequirements = DependabilityRequirements;
    return this;
  }
  ...
  public TDDIPerfChars setAssuranceLevel(TDDIAssuranceLevel AssuranceLevel) {
    this.AssuranceLevel = AssuranceLevel;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list80.size);
                TDDIKeyValueMapRef _elem81;
                for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                {
                  _elem81 = new TDDIKeyValueMapRef();
                  _elem81.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list83.size);
                TDDIAbstractDependabilityRequirementRef _elem84;
                for (int _i85 = 0; _i85 < _list83.size; ++_i85)
                {
                  _elem84 = new TDDIAbstractDependabilityRequirementRef();
                  _elem84.read(iprot);
                  struct.DependabilityRequirements.add(_elem84);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIPerfChars struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter86 : struct.KeyValueMaps)
          {
            _iter86.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.DependabilityRequirements != null) {
        oprot.writeFieldBegin(DEPENDABILITY_REQUIREMENTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter87 : struct.DependabilityRequirements)
          {
            _iter87.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter88 : struct.KeyValueMaps)
          {
            _iter88.write(oprot);
          }
        }
      ...
      if (struct.isSetDependabilityRequirements()) {
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter89 : struct.DependabilityRequirements)
          {
            _iter89.write(oprot);
          }
        }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list90.size);
          TDDIKeyValueMapRef _elem91;
          for (int _i92 = 0; _i92 < _list90.size; ++_i92)
          {
            _elem91 = new TDDIKeyValueMapRef();
            _elem91.read(iprot);
            struct.KeyValueMaps.add(_elem91);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list93.size);
          TDDIAbstractDependabilityRequirementRef _elem94;
          for (int _i95 = 0; _i95 < _list93.size; ++_i95)
          {
            _elem94 = new TDDIAbstractDependabilityRequirementRef();
            _elem94.read(iprot);
            struct.DependabilityRequirements.add(_elem94);
          }
        }
        struct.setDependabilityRequirementsIsSet(true);
      }
