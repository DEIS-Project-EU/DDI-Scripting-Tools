...
public class TDDIArtifact implements org.apache.thrift.TBase<TDDIArtifact, TDDIArtifact._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArtifact> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2664 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2664.size);
                TDDIImplementationConstraintRef _elem2665;
                for (int _i2666 = 0; _i2666 < _list2664.size; ++_i2666)
                {
                  _elem2665 = new TDDIImplementationConstraintRef();
                  _elem2665.read(iprot);
                  struct.ImplementationConstraint.add(_elem2665);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2667 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2667.size);
                TDDINoteRef _elem2668;
                for (int _i2669 = 0; _i2669 < _list2667.size; ++_i2669)
                {
                  _elem2668 = new TDDINoteRef();
                  _elem2668.read(iprot);
                  struct.Note.add(_elem2668);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2670 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2670.size);
                TDDITaggedValueRef _elem2671;
                for (int _i2672 = 0; _i2672 < _list2670.size; ++_i2672)
                {
                  _elem2671 = new TDDITaggedValueRef();
                  _elem2671.read(iprot);
                  struct.TaggedValue.add(_elem2671);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // PROPERTY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2673 = iprot.readListBegin();
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2673.size);
                TDDIPropertyRef _elem2674;
                for (int _i2675 = 0; _i2675 < _list2673.size; ++_i2675)
                {
                  _elem2674 = new TDDIPropertyRef();
                  _elem2674.read(iprot);
                  struct.Property.add(_elem2674);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArtifact struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2676 : struct.ImplementationConstraint)
          {
            _iter2676.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2677 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2678 : struct.TaggedValue)
          {
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2679 : struct.Property)
          {
            _iter2679.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIArtifactTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArtifact> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2680 : struct.ImplementationConstraint)
          {
            _iter2680.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2681 : struct.Note)
          {
            _iter2681.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2682 : struct.TaggedValue)
          {
            _iter2682.write(oprot);
          }
        }
      }
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2683 : struct.Property)
          {
            _iter2683.write(oprot);
          }
        }
      }
      if (struct.isSetVersion()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArtifact struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2684 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2684.size);
          TDDIImplementationConstraintRef _elem2685;
          for (int _i2686 = 0; _i2686 < _list2684.size; ++_i2686)
          {
            _elem2685 = new TDDIImplementationConstraintRef();
            _elem2685.read(iprot);
            struct.ImplementationConstraint.add(_elem2685);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2687.size);
          TDDINoteRef _elem2688;
          for (int _i2689 = 0; _i2689 < _list2687.size; ++_i2689)
          {
            _elem2688 = new TDDINoteRef();
            _elem2688.read(iprot);
            struct.Note.add(_elem2688);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2690 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2690.size);
          TDDITaggedValueRef _elem2691;
          for (int _i2692 = 0; _i2692 < _list2690.size; ++_i2692)
          {
            _elem2691 = new TDDITaggedValueRef();
            _elem2691.read(iprot);
            struct.TaggedValue.add(_elem2691);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2693 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2693.size);
          TDDIPropertyRef _elem2694;
          for (int _i2695 = 0; _i2695 < _list2693.size; ++_i2695)
          {
            _elem2694 = new TDDIPropertyRef();
            _elem2694.read(iprot);
            struct.Property.add(_elem2694);
          }
        }
        struct.setPropertyIsSet(true);
      }
