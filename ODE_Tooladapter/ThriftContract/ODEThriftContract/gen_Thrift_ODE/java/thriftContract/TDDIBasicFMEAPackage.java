...
public class TDDIBasicFMEAPackage implements org.apache.thrift.TBase<TDDIBasicFMEAPackage, TDDIBasicFMEAPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIBasicFMEAPackage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIBasicFMEAPackage");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIBasicFMEAPackageStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIBasicFMEAPackageTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIBasicFMEAPackage.class, metaDataMap);
  }
   ...
   */
  public TDDIBasicFMEAPackage(TDDIBasicFMEAPackage other) {
  ...
  public TDDIBasicFMEAPackage deepCopy() {
    return new TDDIBasicFMEAPackage(this);
  }
  ...
  public TDDIBasicFMEAPackage setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIBasicFMEAPackage setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIBasicFMEAPackage setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIBasicFMEAPackage setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIBasicFMEAPackage setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIBasicFMEAPackage setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIBasicFMEAPackage setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIBasicFMEAPackage setFailureAnalysisArtifacts(java.util.List<TDDIAbstractFailureAnalysisArtifactRef> FailureAnalysisArtifacts) {
    this.FailureAnalysisArtifacts = FailureAnalysisArtifacts;
    return this;
  }
  ...
  public TDDIBasicFMEAPackage setFMEAArtifacts(java.util.List<TDDIAbstractFMEAArtifactRef> FMEAArtifacts) {
    this.FMEAArtifacts = FMEAArtifacts;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIBasicFMEAPackage)
      return this.equals((TDDIBasicFMEAPackage)that);
    return false;
  }

  public boolean equals(TDDIBasicFMEAPackage that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIBasicFMEAPackage other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIBasicFMEAPackage(");
    boolean first = true;
  ...
  private static class TDDIBasicFMEAPackageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIBasicFMEAPackageStandardScheme getScheme() {
      return new TDDIBasicFMEAPackageStandardScheme();
    }
  }

  private static class TDDIBasicFMEAPackageStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIBasicFMEAPackage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIBasicFMEAPackage struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1088.size);
                TDDIKeyValueMapRef _elem1089;
                for (int _i1090 = 0; _i1090 < _list1088.size; ++_i1090)
                {
                  _elem1089 = new TDDIKeyValueMapRef();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1091.size);
                TDDIAbstractFailureAnalysisArtifactRef _elem1092;
                for (int _i1093 = 0; _i1093 < _list1091.size; ++_i1093)
                {
                  _elem1092 = new TDDIAbstractFailureAnalysisArtifactRef();
                  _elem1092.read(iprot);
                  struct.FailureAnalysisArtifacts.add(_elem1092);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FMEAArtifacts = new java.util.ArrayList<TDDIAbstractFMEAArtifactRef>(_list1094.size);
                TDDIAbstractFMEAArtifactRef _elem1095;
                for (int _i1096 = 0; _i1096 < _list1094.size; ++_i1096)
                {
                  _elem1095 = new TDDIAbstractFMEAArtifactRef();
                  _elem1095.read(iprot);
                  struct.FMEAArtifacts.add(_elem1095);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIBasicFMEAPackage struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1097 : struct.KeyValueMaps)
          {
      ...
      if (struct.FailureAnalysisArtifacts != null) {
        oprot.writeFieldBegin(FAILURE_ANALYSIS_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1098 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.FMEAArtifacts != null) {
        oprot.writeFieldBegin(FMEAARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFMEAArtifactRef _iter1099 : struct.FMEAArtifacts)
          {
  ...
  private static class TDDIBasicFMEAPackageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIBasicFMEAPackageTupleScheme getScheme() {
      return new TDDIBasicFMEAPackageTupleScheme();
    }
  }

  private static class TDDIBasicFMEAPackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIBasicFMEAPackage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIBasicFMEAPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1100 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetFailureAnalysisArtifacts()) {
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1101 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.isSetFMEAArtifacts()) {
        {
          ...
          for (TDDIAbstractFMEAArtifactRef _iter1102 : struct.FMEAArtifacts)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIBasicFMEAPackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1103.size);
          TDDIKeyValueMapRef _elem1104;
          for (int _i1105 = 0; _i1105 < _list1103.size; ++_i1105)
          {
            _elem1104 = new TDDIKeyValueMapRef();
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1106.size);
          TDDIAbstractFailureAnalysisArtifactRef _elem1107;
          for (int _i1108 = 0; _i1108 < _list1106.size; ++_i1108)
          {
            _elem1107 = new TDDIAbstractFailureAnalysisArtifactRef();
            _elem1107.read(iprot);
            struct.FailureAnalysisArtifacts.add(_elem1107);
          }
        }
        struct.setFailureAnalysisArtifactsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.FMEAArtifacts = new java.util.ArrayList<TDDIAbstractFMEAArtifactRef>(_list1109.size);
          TDDIAbstractFMEAArtifactRef _elem1110;
          for (int _i1111 = 0; _i1111 < _list1109.size; ++_i1111)
          {
            _elem1110 = new TDDIAbstractFMEAArtifactRef();
            _elem1110.read(iprot);
            struct.FMEAArtifacts.add(_elem1110);
          }
        }
        struct.setFMEAArtifactsIsSet(true);
      }
