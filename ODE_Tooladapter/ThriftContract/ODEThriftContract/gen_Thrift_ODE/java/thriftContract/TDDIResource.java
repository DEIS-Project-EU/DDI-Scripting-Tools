...
public class TDDIResource implements org.apache.thrift.TBase<TDDIResource, TDDIResource._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIResource> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIResource");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIResourceStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIResourceTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIResource.class, metaDataMap);
  }
   ...
   */
  public TDDIResource(TDDIResource other) {
  ...
  public TDDIResource deepCopy() {
    return new TDDIResource(this);
  }
  ...
  public TDDIResource setGid(java.lang.String Gid) {
    this.Gid = Gid;
    return this;
  }
  ...
  public TDDIResource setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIResource setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIResource setCitedElement(TDDIAbstractSACMElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIResource setAbstractForm(TDDIAbstractSACMElement AbstractForm) {
    this.AbstractForm = AbstractForm;
    return this;
  }
  ...
  public TDDIResource setName(TDDIAbstractLangString Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIResource setDescription(TDDIDescription Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIResource setImplementationConstraint(java.util.List<TDDIImplementationConstraintRef> ImplementationConstraint) {
    this.ImplementationConstraint = ImplementationConstraint;
    return this;
  }
  ...
  public TDDIResource setNote(java.util.List<TDDINoteRef> Note) {
    this.Note = Note;
    return this;
  }
  ...
  public TDDIResource setTaggedValue(java.util.List<TDDITaggedValueRef> TaggedValue) {
    this.TaggedValue = TaggedValue;
    return this;
  }
  ...
  public TDDIResource setProperty(java.util.List<TDDIPropertyRef> Property) {
    this.Property = Property;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIResource)
      return this.equals((TDDIResource)that);
    return false;
  }

  public boolean equals(TDDIResource that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIResource other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIResource(");
    boolean first = true;
  ...
  private static class TDDIResourceStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIResourceStandardScheme getScheme() {
      return new TDDIResourceStandardScheme();
    }
  }

  private static class TDDIResourceStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIResource> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIResource struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2632 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2632.size);
                TDDIImplementationConstraintRef _elem2633;
                for (int _i2634 = 0; _i2634 < _list2632.size; ++_i2634)
                {
                  _elem2633 = new TDDIImplementationConstraintRef();
                  _elem2633.read(iprot);
                  struct.ImplementationConstraint.add(_elem2633);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2635 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2635.size);
                TDDINoteRef _elem2636;
                for (int _i2637 = 0; _i2637 < _list2635.size; ++_i2637)
                {
                  _elem2636 = new TDDINoteRef();
                  _elem2636.read(iprot);
                  struct.Note.add(_elem2636);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2638 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2638.size);
                TDDITaggedValueRef _elem2639;
                for (int _i2640 = 0; _i2640 < _list2638.size; ++_i2640)
                {
                  _elem2639 = new TDDITaggedValueRef();
                  _elem2639.read(iprot);
                  struct.TaggedValue.add(_elem2639);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // PROPERTY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2641 = iprot.readListBegin();
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2641.size);
                TDDIPropertyRef _elem2642;
                for (int _i2643 = 0; _i2643 < _list2641.size; ++_i2643)
                {
                  _elem2642 = new TDDIPropertyRef();
                  _elem2642.read(iprot);
                  struct.Property.add(_elem2642);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIResource struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2644 : struct.ImplementationConstraint)
          {
            _iter2644.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2645 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2646 : struct.TaggedValue)
          {
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2647 : struct.Property)
          {
            _iter2647.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIResourceTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIResourceTupleScheme getScheme() {
      return new TDDIResourceTupleScheme();
    }
  }

  private static class TDDIResourceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIResource> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIResource struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2648 : struct.ImplementationConstraint)
          {
            _iter2648.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2649 : struct.Note)
          {
            _iter2649.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2650 : struct.TaggedValue)
          {
            _iter2650.write(oprot);
          }
        }
      }
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2651 : struct.Property)
          {
            _iter2651.write(oprot);
          }
        }
      }
    }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIResource struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2652 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2652.size);
          TDDIImplementationConstraintRef _elem2653;
          for (int _i2654 = 0; _i2654 < _list2652.size; ++_i2654)
          {
            _elem2653 = new TDDIImplementationConstraintRef();
            _elem2653.read(iprot);
            struct.ImplementationConstraint.add(_elem2653);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2655 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2655.size);
          TDDINoteRef _elem2656;
          for (int _i2657 = 0; _i2657 < _list2655.size; ++_i2657)
          {
            _elem2656 = new TDDINoteRef();
            _elem2656.read(iprot);
            struct.Note.add(_elem2656);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2658 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2658.size);
          TDDITaggedValueRef _elem2659;
          for (int _i2660 = 0; _i2660 < _list2658.size; ++_i2660)
          {
            _elem2659 = new TDDITaggedValueRef();
            _elem2659.read(iprot);
            struct.TaggedValue.add(_elem2659);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2661 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2661.size);
          TDDIPropertyRef _elem2662;
          for (int _i2663 = 0; _i2663 < _list2661.size; ++_i2663)
          {
            _elem2662 = new TDDIPropertyRef();
            _elem2662.read(iprot);
            struct.Property.add(_elem2662);
          }
        }
        struct.setPropertyIsSet(true);
      }
