...
public class TDDIFTAPackage implements org.apache.thrift.TBase<TDDIFTAPackage, TDDIFTAPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIFTAPackage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIFTAPackage");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIFTAPackageStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIFTAPackageTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIFTAPackage.class, metaDataMap);
  }
   ...
   */
  public TDDIFTAPackage(TDDIFTAPackage other) {
  ...
  public TDDIFTAPackage deepCopy() {
    return new TDDIFTAPackage(this);
  }
  ...
  public TDDIFTAPackage setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIFTAPackage setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIFTAPackage setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIFTAPackage setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIFTAPackage setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIFTAPackage setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIFTAPackage setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIFTAPackage setFailureAnalysisArtifacts(java.util.List<TDDIAbstractFailureAnalysisArtifactRef> FailureAnalysisArtifacts) {
    this.FailureAnalysisArtifacts = FailureAnalysisArtifacts;
    return this;
  }
  ...
  public TDDIFTAPackage setFTAArtifacts(java.util.List<TDDIAbstractFTAArtifact> FTAArtifacts) {
    this.FTAArtifacts = FTAArtifacts;
    return this;
  }
  ...
  public TDDIFTAPackage setBasicEvents(java.util.List<TDDIBasicEvent> BasicEvents) {
    this.BasicEvents = BasicEvents;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIFTAPackage)
      return this.equals((TDDIFTAPackage)that);
    return false;
  }

  public boolean equals(TDDIFTAPackage that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIFTAPackage other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIFTAPackage(");
    boolean first = true;
  ...
  private static class TDDIFTAPackageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFTAPackageStandardScheme getScheme() {
      return new TDDIFTAPackageStandardScheme();
    }
  }

  private static class TDDIFTAPackageStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIFTAPackage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIFTAPackage struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1208.size);
                TDDIKeyValueMapRef _elem1209;
                for (int _i1210 = 0; _i1210 < _list1208.size; ++_i1210)
                {
                  _elem1209 = new TDDIKeyValueMapRef();
                  _elem1209.read(iprot);
                  struct.KeyValueMaps.add(_elem1209);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1211.size);
                TDDIAbstractFailureAnalysisArtifactRef _elem1212;
                for (int _i1213 = 0; _i1213 < _list1211.size; ++_i1213)
                {
                  _elem1212 = new TDDIAbstractFailureAnalysisArtifactRef();
                  _elem1212.read(iprot);
                  struct.FailureAnalysisArtifacts.add(_elem1212);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FTAArtifacts = new java.util.ArrayList<TDDIAbstractFTAArtifact>(_list1214.size);
                TDDIAbstractFTAArtifact _elem1215;
                for (int _i1216 = 0; _i1216 < _list1214.size; ++_i1216)
                {
                  _elem1215 = new TDDIAbstractFTAArtifact();
                  _elem1215.read(iprot);
                  struct.FTAArtifacts.add(_elem1215);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.BasicEvents = new java.util.ArrayList<TDDIBasicEvent>(_list1217.size);
                TDDIBasicEvent _elem1218;
                for (int _i1219 = 0; _i1219 < _list1217.size; ++_i1219)
                {
                  _elem1218 = new TDDIBasicEvent();
                  _elem1218.read(iprot);
                  struct.BasicEvents.add(_elem1218);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIFTAPackage struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1220 : struct.KeyValueMaps)
          {
      ...
      if (struct.FailureAnalysisArtifacts != null) {
        oprot.writeFieldBegin(FAILURE_ANALYSIS_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1221 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.FTAArtifacts != null) {
        oprot.writeFieldBegin(FTAARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFTAArtifact _iter1222 : struct.FTAArtifacts)
          {
      ...
      if (struct.BasicEvents != null) {
        oprot.writeFieldBegin(BASIC_EVENTS_FIELD_DESC);
        {
          ...
          for (TDDIBasicEvent _iter1223 : struct.BasicEvents)
          {
  ...
  private static class TDDIFTAPackageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFTAPackageTupleScheme getScheme() {
      return new TDDIFTAPackageTupleScheme();
    }
  }

  private static class TDDIFTAPackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIFTAPackage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIFTAPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1224 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetFailureAnalysisArtifacts()) {
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1225 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.isSetFTAArtifacts()) {
        {
          ...
          for (TDDIAbstractFTAArtifact _iter1226 : struct.FTAArtifacts)
          {
      ...
      if (struct.isSetBasicEvents()) {
        {
          ...
          for (TDDIBasicEvent _iter1227 : struct.BasicEvents)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIFTAPackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1228.size);
          TDDIKeyValueMapRef _elem1229;
          for (int _i1230 = 0; _i1230 < _list1228.size; ++_i1230)
          {
            _elem1229 = new TDDIKeyValueMapRef();
            _elem1229.read(iprot);
            struct.KeyValueMaps.add(_elem1229);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1231.size);
          TDDIAbstractFailureAnalysisArtifactRef _elem1232;
          for (int _i1233 = 0; _i1233 < _list1231.size; ++_i1233)
          {
            _elem1232 = new TDDIAbstractFailureAnalysisArtifactRef();
            _elem1232.read(iprot);
            struct.FailureAnalysisArtifacts.add(_elem1232);
          }
        }
        struct.setFailureAnalysisArtifactsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.FTAArtifacts = new java.util.ArrayList<TDDIAbstractFTAArtifact>(_list1234.size);
          TDDIAbstractFTAArtifact _elem1235;
          for (int _i1236 = 0; _i1236 < _list1234.size; ++_i1236)
          {
            _elem1235 = new TDDIAbstractFTAArtifact();
            _elem1235.read(iprot);
            struct.FTAArtifacts.add(_elem1235);
          }
        }
        struct.setFTAArtifactsIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.BasicEvents = new java.util.ArrayList<TDDIBasicEvent>(_list1237.size);
          TDDIBasicEvent _elem1238;
          for (int _i1239 = 0; _i1239 < _list1237.size; ++_i1239)
          {
            _elem1238 = new TDDIBasicEvent();
            _elem1238.read(iprot);
            struct.BasicEvents.add(_elem1238);
          }
        }
        struct.setBasicEventsIsSet(true);
      }
