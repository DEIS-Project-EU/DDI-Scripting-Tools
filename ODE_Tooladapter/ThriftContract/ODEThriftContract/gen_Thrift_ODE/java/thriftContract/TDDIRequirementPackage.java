...
public class TDDIRequirementPackage implements org.apache.thrift.TBase<TDDIRequirementPackage, TDDIRequirementPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIRequirementPackage> {
  ...
  public TDDIRequirementPackage setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIRequirementPackage setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIRequirementPackage setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIRequirementPackage setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIRequirementPackage setRequirementArtifacts(java.util.List<TDDIAbstractRequirementArtifactRef> RequirementArtifacts) {
    this.RequirementArtifacts = RequirementArtifacts;
    return this;
  }
        ...
        switch (schemeField.id) {
          ...
          case 6: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1768 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1768.size);
                TDDIKeyValueMapRef _elem1769;
                for (int _i1770 = 0; _i1770 < _list1768.size; ++_i1770)
                {
                  _elem1769 = new TDDIKeyValueMapRef();
                  _elem1769.read(iprot);
                  struct.KeyValueMaps.add(_elem1769);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // REQUIREMENT_ARTIFACTS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1771 = iprot.readListBegin();
                struct.RequirementArtifacts = new java.util.ArrayList<TDDIAbstractRequirementArtifactRef>(_list1771.size);
                TDDIAbstractRequirementArtifactRef _elem1772;
                for (int _i1773 = 0; _i1773 < _list1771.size; ++_i1773)
                {
                  _elem1772 = new TDDIAbstractRequirementArtifactRef();
                  _elem1772.read(iprot);
                  struct.RequirementArtifacts.add(_elem1772);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIRequirementPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1774 : struct.KeyValueMaps)
          {
      ...
      if (struct.RequirementArtifacts != null) {
        oprot.writeFieldBegin(REQUIREMENT_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractRequirementArtifactRef _iter1775 : struct.RequirementArtifacts)
          {
  ...
  private static class TDDIRequirementPackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIRequirementPackage> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1776 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetRequirementArtifacts()) {
        {
          ...
          for (TDDIAbstractRequirementArtifactRef _iter1777 : struct.RequirementArtifacts)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIRequirementPackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list1778 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1778.size);
          TDDIKeyValueMapRef _elem1779;
          for (int _i1780 = 0; _i1780 < _list1778.size; ++_i1780)
          {
            _elem1779 = new TDDIKeyValueMapRef();
            _elem1779.read(iprot);
            struct.KeyValueMaps.add(_elem1779);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1781 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.RequirementArtifacts = new java.util.ArrayList<TDDIAbstractRequirementArtifactRef>(_list1781.size);
          TDDIAbstractRequirementArtifactRef _elem1782;
          for (int _i1783 = 0; _i1783 < _list1781.size; ++_i1783)
          {
            _elem1782 = new TDDIAbstractRequirementArtifactRef();
            _elem1782.read(iprot);
            struct.RequirementArtifacts.add(_elem1782);
          }
        }
        struct.setRequirementArtifactsIsSet(true);
      }
