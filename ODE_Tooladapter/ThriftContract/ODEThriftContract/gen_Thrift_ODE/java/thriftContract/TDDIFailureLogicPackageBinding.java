...
public class TDDIFailureLogicPackageBinding implements org.apache.thrift.TBase<TDDIFailureLogicPackageBinding, TDDIFailureLogicPackageBinding._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIFailureLogicPackageBinding> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIFailureLogicPackageBinding");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIFailureLogicPackageBindingStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIFailureLogicPackageBindingTupleSchemeFactory();
  ...
  public java.util.List<TDDIAbstractFailureAnalysisArtifact> FailureAnalysisArtifacts; // required
  public java.util.List<TDDIAbstractFailureLogicPackageRef> ParticipantPackages; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FAILURE_ANALYSIS_ARTIFACTS, new org.apache.thrift.meta_data.FieldMetaData("FailureAnalysisArtifacts", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TDDIAbstractFailureAnalysisArtifact.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIFailureLogicPackageBinding.class, metaDataMap);
  }

  public TDDIFailureLogicPackageBinding() {
    this.Name = "";
    ...
    this.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifact>();

    this.ParticipantPackages = new java.util.ArrayList<TDDIAbstractFailureLogicPackageRef>();
  ...
  public TDDIFailureLogicPackageBinding(
    ...
    java.util.List<TDDIAbstractFailureAnalysisArtifact> FailureAnalysisArtifacts,
    java.util.List<TDDIAbstractFailureLogicPackageRef> ParticipantPackages)
  {
    this();
    this.Id = Id;
    setIdIsSet(true);
   ...
   */
  public TDDIFailureLogicPackageBinding(TDDIFailureLogicPackageBinding other) {
    ...
    if (other.isSetFailureAnalysisArtifacts()) {
      java.util.List<TDDIAbstractFailureAnalysisArtifact> __this__FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifact>(other.FailureAnalysisArtifacts.size());
      for (TDDIAbstractFailureAnalysisArtifact other_element : other.FailureAnalysisArtifacts) {
        __this__FailureAnalysisArtifacts.add(new TDDIAbstractFailureAnalysisArtifact(other_element));
      }
      this.FailureAnalysisArtifacts = __this__FailureAnalysisArtifacts;
    }
    if (other.isSetParticipantPackages()) {
      java.util.List<TDDIAbstractFailureLogicPackageRef> __this__ParticipantPackages = new java.util.ArrayList<TDDIAbstractFailureLogicPackageRef>(other.ParticipantPackages.size());
      for (TDDIAbstractFailureLogicPackageRef other_element : other.ParticipantPackages) {
        __this__ParticipantPackages.add(new TDDIAbstractFailureLogicPackageRef(other_element));
      }
      this.ParticipantPackages = __this__ParticipantPackages;
    }
  }

  public TDDIFailureLogicPackageBinding deepCopy() {
    return new TDDIFailureLogicPackageBinding(this);
  }
  ...
  public TDDIFailureLogicPackageBinding setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIFailureLogicPackageBinding setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIFailureLogicPackageBinding setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIFailureLogicPackageBinding setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIFailureLogicPackageBinding setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIFailureLogicPackageBinding setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIFailureLogicPackageBinding setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public java.util.Iterator<TDDIAbstractFailureAnalysisArtifact> getFailureAnalysisArtifactsIterator() {
    return (this.FailureAnalysisArtifacts == null) ? null : this.FailureAnalysisArtifacts.iterator();
  }

  public void addToFailureAnalysisArtifacts(TDDIAbstractFailureAnalysisArtifact elem) {
  ...
  public java.util.List<TDDIAbstractFailureAnalysisArtifact> getFailureAnalysisArtifacts() {
    return this.FailureAnalysisArtifacts;
  }

  public TDDIFailureLogicPackageBinding setFailureAnalysisArtifacts(java.util.List<TDDIAbstractFailureAnalysisArtifact> FailureAnalysisArtifacts) {
    this.FailureAnalysisArtifacts = FailureAnalysisArtifacts;
    return this;
  }
  ...
  public java.util.Iterator<TDDIAbstractFailureLogicPackageRef> getParticipantPackagesIterator() {
    return (this.ParticipantPackages == null) ? null : this.ParticipantPackages.iterator();
  }

  public void addToParticipantPackages(TDDIAbstractFailureLogicPackageRef elem) {
  ...
  public java.util.List<TDDIAbstractFailureLogicPackageRef> getParticipantPackages() {
    return this.ParticipantPackages;
  }

  public TDDIFailureLogicPackageBinding setParticipantPackages(java.util.List<TDDIAbstractFailureLogicPackageRef> ParticipantPackages) {
    this.ParticipantPackages = ParticipantPackages;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case FAILURE_ANALYSIS_ARTIFACTS:
      if (value == null) {
        ...
        setFailureAnalysisArtifacts((java.util.List<TDDIAbstractFailureAnalysisArtifact>)value);
      }
      break;
    ...
    case PARTICIPANT_PACKAGES:
      if (value == null) {
        ...
        setParticipantPackages((java.util.List<TDDIAbstractFailureLogicPackageRef>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIFailureLogicPackageBinding)
      return this.equals((TDDIFailureLogicPackageBinding)that);
    return false;
  }

  public boolean equals(TDDIFailureLogicPackageBinding that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIFailureLogicPackageBinding other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIFailureLogicPackageBinding(");
    boolean first = true;
  ...
  private static class TDDIFailureLogicPackageBindingStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFailureLogicPackageBindingStandardScheme getScheme() {
      return new TDDIFailureLogicPackageBindingStandardScheme();
    }
  }

  private static class TDDIFailureLogicPackageBindingStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIFailureLogicPackageBinding> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIFailureLogicPackageBinding struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list984.size);
                TDDIKeyValueMapRef _elem985;
                for (int _i986 = 0; _i986 < _list984.size; ++_i986)
                {
                  _elem985 = new TDDIKeyValueMapRef();
                  _elem985.read(iprot);
                  struct.KeyValueMaps.add(_elem985);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifact>(_list987.size);
                TDDIAbstractFailureAnalysisArtifact _elem988;
                for (int _i989 = 0; _i989 < _list987.size; ++_i989)
                {
                  _elem988 = new TDDIAbstractFailureAnalysisArtifact();
                  _elem988.read(iprot);
                  struct.FailureAnalysisArtifacts.add(_elem988);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ParticipantPackages = new java.util.ArrayList<TDDIAbstractFailureLogicPackageRef>(_list990.size);
                TDDIAbstractFailureLogicPackageRef _elem991;
                for (int _i992 = 0; _i992 < _list990.size; ++_i992)
                {
                  _elem991 = new TDDIAbstractFailureLogicPackageRef();
                  _elem991.read(iprot);
                  struct.ParticipantPackages.add(_elem991);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIFailureLogicPackageBinding struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter993 : struct.KeyValueMaps)
          {
      ...
      if (struct.FailureAnalysisArtifacts != null) {
        oprot.writeFieldBegin(FAILURE_ANALYSIS_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifact _iter994 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.ParticipantPackages != null) {
        oprot.writeFieldBegin(PARTICIPANT_PACKAGES_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureLogicPackageRef _iter995 : struct.ParticipantPackages)
          {
  ...
  private static class TDDIFailureLogicPackageBindingTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFailureLogicPackageBindingTupleScheme getScheme() {
      return new TDDIFailureLogicPackageBindingTupleScheme();
    }
  }

  private static class TDDIFailureLogicPackageBindingTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIFailureLogicPackageBinding> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIFailureLogicPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter996 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetFailureAnalysisArtifacts()) {
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifact _iter997 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.isSetParticipantPackages()) {
        {
          ...
          for (TDDIAbstractFailureLogicPackageRef _iter998 : struct.ParticipantPackages)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIFailureLogicPackageBinding struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list999.size);
          TDDIKeyValueMapRef _elem1000;
          for (int _i1001 = 0; _i1001 < _list999.size; ++_i1001)
          {
            _elem1000 = new TDDIKeyValueMapRef();
            _elem1000.read(iprot);
            struct.KeyValueMaps.add(_elem1000);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifact>(_list1002.size);
          TDDIAbstractFailureAnalysisArtifact _elem1003;
          for (int _i1004 = 0; _i1004 < _list1002.size; ++_i1004)
          {
            _elem1003 = new TDDIAbstractFailureAnalysisArtifact();
            _elem1003.read(iprot);
            struct.FailureAnalysisArtifacts.add(_elem1003);
          }
        }
        struct.setFailureAnalysisArtifactsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.ParticipantPackages = new java.util.ArrayList<TDDIAbstractFailureLogicPackageRef>(_list1005.size);
          TDDIAbstractFailureLogicPackageRef _elem1006;
          for (int _i1007 = 0; _i1007 < _list1005.size; ++_i1007)
          {
            _elem1006 = new TDDIAbstractFailureLogicPackageRef();
            _elem1006.read(iprot);
            struct.ParticipantPackages.add(_elem1006);
          }
        }
        struct.setParticipantPackagesIsSet(true);
      }
