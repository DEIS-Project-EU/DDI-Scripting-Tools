...
public class TDDITerminologyGroup implements org.apache.thrift.TBase<TDDITerminologyGroup, TDDITerminologyGroup._Fields>, java.io.Serializable, Cloneable, Comparable<TDDITerminologyGroup> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2952 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2952.size);
                TDDIImplementationConstraintRef _elem2953;
                for (int _i2954 = 0; _i2954 < _list2952.size; ++_i2954)
                {
                  _elem2953 = new TDDIImplementationConstraintRef();
                  _elem2953.read(iprot);
                  struct.ImplementationConstraint.add(_elem2953);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2955 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2955.size);
                TDDINoteRef _elem2956;
                for (int _i2957 = 0; _i2957 < _list2955.size; ++_i2957)
                {
                  _elem2956 = new TDDINoteRef();
                  _elem2956.read(iprot);
                  struct.Note.add(_elem2956);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2958 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2958.size);
                TDDITaggedValueRef _elem2959;
                for (int _i2960 = 0; _i2960 < _list2958.size; ++_i2960)
                {
                  _elem2959 = new TDDITaggedValueRef();
                  _elem2959.read(iprot);
                  struct.TaggedValue.add(_elem2959);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // TERMINOLOGY_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2961 = iprot.readListBegin();
                struct.TerminologyElement = new java.util.ArrayList<TDDIAbstractTerminologyElement>(_list2961.size);
                TDDIAbstractTerminologyElement _elem2962;
                for (int _i2963 = 0; _i2963 < _list2961.size; ++_i2963)
                {
                  _elem2962 = new TDDIAbstractTerminologyElement();
                  _elem2962.read(iprot);
                  struct.TerminologyElement.add(_elem2962);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDITerminologyGroup struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2964 : struct.ImplementationConstraint)
          {
            _iter2964.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2965 : struct.Note)
          {
            _iter2965.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2966 : struct.TaggedValue)
          {
      ...
      if (struct.TerminologyElement != null) {
        oprot.writeFieldBegin(TERMINOLOGY_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractTerminologyElement _iter2967 : struct.TerminologyElement)
          {
  ...
  private static class TDDITerminologyGroupTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDITerminologyGroup> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2968 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2969 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2970 : struct.TaggedValue)
          {
            _iter2970.write(oprot);
          }
        }
      }
      if (struct.isSetTerminologyElement()) {
        {
          ...
          for (TDDIAbstractTerminologyElement _iter2971 : struct.TerminologyElement)
          {
            _iter2971.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDITerminologyGroup struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2972 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2972.size);
          TDDIImplementationConstraintRef _elem2973;
          for (int _i2974 = 0; _i2974 < _list2972.size; ++_i2974)
          {
            _elem2973 = new TDDIImplementationConstraintRef();
            _elem2973.read(iprot);
            struct.ImplementationConstraint.add(_elem2973);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2975 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2975.size);
          TDDINoteRef _elem2976;
          for (int _i2977 = 0; _i2977 < _list2975.size; ++_i2977)
          {
            _elem2976 = new TDDINoteRef();
            _elem2976.read(iprot);
            struct.Note.add(_elem2976);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2978 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2978.size);
          TDDITaggedValueRef _elem2979;
          for (int _i2980 = 0; _i2980 < _list2978.size; ++_i2980)
          {
            _elem2979 = new TDDITaggedValueRef();
            _elem2979.read(iprot);
            struct.TaggedValue.add(_elem2979);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2981 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TerminologyElement = new java.util.ArrayList<TDDIAbstractTerminologyElement>(_list2981.size);
          TDDIAbstractTerminologyElement _elem2982;
          for (int _i2983 = 0; _i2983 < _list2981.size; ++_i2983)
          {
            _elem2982 = new TDDIAbstractTerminologyElement();
            _elem2982.read(iprot);
            struct.TerminologyElement.add(_elem2982);
          }
        }
        struct.setTerminologyElementIsSet(true);
      }
