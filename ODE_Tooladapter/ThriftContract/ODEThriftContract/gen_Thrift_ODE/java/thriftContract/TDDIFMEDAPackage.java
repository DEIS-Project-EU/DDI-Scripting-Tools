...
public class TDDIFMEDAPackage implements org.apache.thrift.TBase<TDDIFMEDAPackage, TDDIFMEDAPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIFMEDAPackage> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIFMEDAPackage");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIFMEDAPackageStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIFMEDAPackageTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIFMEDAPackage.class, metaDataMap);
  }

  public TDDIFMEDAPackage() {
    this.Name = "";
   ...
   */
  public TDDIFMEDAPackage(TDDIFMEDAPackage other) {
  ...
  public TDDIFMEDAPackage deepCopy() {
    return new TDDIFMEDAPackage(this);
  }
  ...
  public TDDIFMEDAPackage setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIFMEDAPackage setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIFMEDAPackage setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIFMEDAPackage setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIFMEDAPackage setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIFMEDAPackage setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIFMEDAPackage setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIFMEDAPackage setFailureAnalysisArtifacts(java.util.List<TDDIAbstractFailureAnalysisArtifactRef> FailureAnalysisArtifacts) {
    this.FailureAnalysisArtifacts = FailureAnalysisArtifacts;
    return this;
  }
  ...
  public TDDIFMEDAPackage setFMEAArtifacts(java.util.List<TDDIAbstractFMEAArtifactRef> FMEAArtifacts) {
    this.FMEAArtifacts = FMEAArtifacts;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIFMEDAPackage)
      return this.equals((TDDIFMEDAPackage)that);
    return false;
  }

  public boolean equals(TDDIFMEDAPackage that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIFMEDAPackage other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIFMEDAPackage(");
    boolean first = true;
  ...
  private static class TDDIFMEDAPackageStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFMEDAPackageStandardScheme getScheme() {
      return new TDDIFMEDAPackageStandardScheme();
    }
  }

  private static class TDDIFMEDAPackageStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIFMEDAPackage> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIFMEDAPackage struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1112.size);
                TDDIKeyValueMapRef _elem1113;
                for (int _i1114 = 0; _i1114 < _list1112.size; ++_i1114)
                {
                  _elem1113 = new TDDIKeyValueMapRef();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1115.size);
                TDDIAbstractFailureAnalysisArtifactRef _elem1116;
                for (int _i1117 = 0; _i1117 < _list1115.size; ++_i1117)
                {
                  _elem1116 = new TDDIAbstractFailureAnalysisArtifactRef();
                  _elem1116.read(iprot);
                  struct.FailureAnalysisArtifacts.add(_elem1116);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FMEAArtifacts = new java.util.ArrayList<TDDIAbstractFMEAArtifactRef>(_list1118.size);
                TDDIAbstractFMEAArtifactRef _elem1119;
                for (int _i1120 = 0; _i1120 < _list1118.size; ++_i1120)
                {
                  _elem1119 = new TDDIAbstractFMEAArtifactRef();
                  _elem1119.read(iprot);
                  struct.FMEAArtifacts.add(_elem1119);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIFMEDAPackage struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1121 : struct.KeyValueMaps)
          {
      ...
      if (struct.FailureAnalysisArtifacts != null) {
        oprot.writeFieldBegin(FAILURE_ANALYSIS_ARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1122 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.FMEAArtifacts != null) {
        oprot.writeFieldBegin(FMEAARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFMEAArtifactRef _iter1123 : struct.FMEAArtifacts)
          {
  ...
  private static class TDDIFMEDAPackageTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFMEDAPackageTupleScheme getScheme() {
      return new TDDIFMEDAPackageTupleScheme();
    }
  }

  private static class TDDIFMEDAPackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIFMEDAPackage> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIFMEDAPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1124 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetFailureAnalysisArtifacts()) {
        {
          ...
          for (TDDIAbstractFailureAnalysisArtifactRef _iter1125 : struct.FailureAnalysisArtifacts)
          {
      ...
      if (struct.isSetFMEAArtifacts()) {
        {
          ...
          for (TDDIAbstractFMEAArtifactRef _iter1126 : struct.FMEAArtifacts)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIFMEDAPackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1127.size);
          TDDIKeyValueMapRef _elem1128;
          for (int _i1129 = 0; _i1129 < _list1127.size; ++_i1129)
          {
            _elem1128 = new TDDIKeyValueMapRef();
            _elem1128.read(iprot);
            struct.KeyValueMaps.add(_elem1128);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.FailureAnalysisArtifacts = new java.util.ArrayList<TDDIAbstractFailureAnalysisArtifactRef>(_list1130.size);
          TDDIAbstractFailureAnalysisArtifactRef _elem1131;
          for (int _i1132 = 0; _i1132 < _list1130.size; ++_i1132)
          {
            _elem1131 = new TDDIAbstractFailureAnalysisArtifactRef();
            _elem1131.read(iprot);
            struct.FailureAnalysisArtifacts.add(_elem1131);
          }
        }
        struct.setFailureAnalysisArtifactsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.FMEAArtifacts = new java.util.ArrayList<TDDIAbstractFMEAArtifactRef>(_list1133.size);
          TDDIAbstractFMEAArtifactRef _elem1134;
          for (int _i1135 = 0; _i1135 < _list1133.size; ++_i1135)
          {
            _elem1134 = new TDDIAbstractFMEAArtifactRef();
            _elem1134.read(iprot);
            struct.FMEAArtifacts.add(_elem1134);
          }
        }
        struct.setFMEAArtifactsIsSet(true);
      }
