...
public class TDDIState implements org.apache.thrift.TBase<TDDIState, TDDIState._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIState> {
  ...
  private static final org.apache.thrift.protocol.TField IS_INITIAL_STATE_FIELD_DESC = new org.apache.thrift.protocol.TField("IsInitialState", org.apache.thrift.protocol.TType.BOOL, (short)8);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    IS_INITIAL_STATE((short)8, "IsInitialState");
  ...
  private static final int __ISINITIALSTATE_ISSET_ID = 3;
  ...
  public TDDIState setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIState setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIState setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIState setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1624.size);
                TDDIKeyValueMapRef _elem1625;
                for (int _i1626 = 0; _i1626 < _list1624.size; ++_i1626)
                {
                  _elem1625 = new TDDIKeyValueMapRef();
                  _elem1625.read(iprot);
                  struct.KeyValueMaps.add(_elem1625);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIState struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1627 : struct.KeyValueMaps)
          {
  ...
  private static class TDDIStateTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIState> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1628 : struct.KeyValueMaps)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIState struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list1629 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1629.size);
          TDDIKeyValueMapRef _elem1630;
          for (int _i1631 = 0; _i1631 < _list1629.size; ++_i1631)
          {
            _elem1630 = new TDDIKeyValueMapRef();
            _elem1630.read(iprot);
            struct.KeyValueMaps.add(_elem1630);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
