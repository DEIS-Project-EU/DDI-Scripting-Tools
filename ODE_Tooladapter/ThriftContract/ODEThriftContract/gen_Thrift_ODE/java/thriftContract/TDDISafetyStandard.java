...
public class TDDISafetyStandard implements org.apache.thrift.TBase<TDDISafetyStandard, TDDISafetyStandard._Fields>, java.io.Serializable, Cloneable, Comparable<TDDISafetyStandard> {
  ...
  private static final org.apache.thrift.protocol.TField ASSURANCE_LEVELS_FIELD_DESC = new org.apache.thrift.protocol.TField("AssuranceLevels", org.apache.thrift.protocol.TType.LIST, (short)8);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ASSURANCE_LEVELS((short)8, "AssuranceLevels");
  ...
  public TDDISafetyStandard setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDISafetyStandard setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDISafetyStandard setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDISafetyStandard setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDISafetyStandard setAssuranceLevels(java.util.List<TDDIAssuranceLevel> AssuranceLevels) {
    this.AssuranceLevels = AssuranceLevels;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list832.size);
                TDDIKeyValueMapRef _elem833;
                for (int _i834 = 0; _i834 < _list832.size; ++_i834)
                {
                  _elem833 = new TDDIKeyValueMapRef();
                  _elem833.read(iprot);
                  struct.KeyValueMaps.add(_elem833);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.AssuranceLevels = new java.util.ArrayList<TDDIAssuranceLevel>(_list835.size);
                TDDIAssuranceLevel _elem836;
                for (int _i837 = 0; _i837 < _list835.size; ++_i837)
                {
                  _elem836 = new TDDIAssuranceLevel();
                  _elem836.read(iprot);
                  struct.AssuranceLevels.add(_elem836);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDISafetyStandard struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter838 : struct.KeyValueMaps)
          {
      ...
      if (struct.AssuranceLevels != null) {
        oprot.writeFieldBegin(ASSURANCE_LEVELS_FIELD_DESC);
        {
          ...
          for (TDDIAssuranceLevel _iter839 : struct.AssuranceLevels)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter840 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetAssuranceLevels()) {
        {
          ...
          for (TDDIAssuranceLevel _iter841 : struct.AssuranceLevels)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list842.size);
          TDDIKeyValueMapRef _elem843;
          for (int _i844 = 0; _i844 < _list842.size; ++_i844)
          {
            _elem843 = new TDDIKeyValueMapRef();
            _elem843.read(iprot);
            struct.KeyValueMaps.add(_elem843);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.AssuranceLevels = new java.util.ArrayList<TDDIAssuranceLevel>(_list845.size);
          TDDIAssuranceLevel _elem846;
          for (int _i847 = 0; _i847 < _list845.size; ++_i847)
          {
            _elem846 = new TDDIAssuranceLevel();
            _elem846.read(iprot);
            struct.AssuranceLevels.add(_elem846);
          }
        }
        struct.setAssuranceLevelsIsSet(true);
      }
