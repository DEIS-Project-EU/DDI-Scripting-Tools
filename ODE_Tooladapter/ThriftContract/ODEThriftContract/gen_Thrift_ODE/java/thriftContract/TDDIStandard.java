...
public class TDDIStandard implements org.apache.thrift.TBase<TDDIStandard, TDDIStandard._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIStandard> {
  ...
  public TDDIStandard setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIStandard setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIStandard setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIStandard setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list824.size);
                TDDIKeyValueMapRef _elem825;
                for (int _i826 = 0; _i826 < _list824.size; ++_i826)
                {
                  _elem825 = new TDDIKeyValueMapRef();
                  _elem825.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIStandard struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter827 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter828 : struct.KeyValueMaps)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list829.size);
          TDDIKeyValueMapRef _elem830;
          for (int _i831 = 0; _i831 < _list829.size; ++_i831)
          {
            _elem830 = new TDDIKeyValueMapRef();
            _elem830.read(iprot);
            struct.KeyValueMaps.add(_elem830);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
