...
public class TDDIEvent implements org.apache.thrift.TBase<TDDIEvent, TDDIEvent._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIEvent> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2600 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2600.size);
                TDDIImplementationConstraintRef _elem2601;
                for (int _i2602 = 0; _i2602 < _list2600.size; ++_i2602)
                {
                  _elem2601 = new TDDIImplementationConstraintRef();
                  _elem2601.read(iprot);
                  struct.ImplementationConstraint.add(_elem2601);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2603 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2603.size);
                TDDINoteRef _elem2604;
                for (int _i2605 = 0; _i2605 < _list2603.size; ++_i2605)
                {
                  _elem2604 = new TDDINoteRef();
                  _elem2604.read(iprot);
                  struct.Note.add(_elem2604);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2606 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2606.size);
                TDDITaggedValueRef _elem2607;
                for (int _i2608 = 0; _i2608 < _list2606.size; ++_i2608)
                {
                  _elem2607 = new TDDITaggedValueRef();
                  _elem2607.read(iprot);
                  struct.TaggedValue.add(_elem2607);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // PROPERTY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2609 = iprot.readListBegin();
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2609.size);
                TDDIPropertyRef _elem2610;
                for (int _i2611 = 0; _i2611 < _list2609.size; ++_i2611)
                {
                  _elem2610 = new TDDIPropertyRef();
                  _elem2610.read(iprot);
                  struct.Property.add(_elem2610);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIEvent struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2612 : struct.ImplementationConstraint)
          {
            _iter2612.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2613 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2614 : struct.TaggedValue)
          {
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2615 : struct.Property)
          {
            _iter2615.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIEventTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIEvent> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2616 : struct.ImplementationConstraint)
          {
            _iter2616.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2617 : struct.Note)
          {
            _iter2617.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2618 : struct.TaggedValue)
          {
            _iter2618.write(oprot);
          }
        }
      }
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2619 : struct.Property)
          {
            _iter2619.write(oprot);
          }
        }
      }
      if (struct.isSetOccurence()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIEvent struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2620 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2620.size);
          TDDIImplementationConstraintRef _elem2621;
          for (int _i2622 = 0; _i2622 < _list2620.size; ++_i2622)
          {
            _elem2621 = new TDDIImplementationConstraintRef();
            _elem2621.read(iprot);
            struct.ImplementationConstraint.add(_elem2621);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2623.size);
          TDDINoteRef _elem2624;
          for (int _i2625 = 0; _i2625 < _list2623.size; ++_i2625)
          {
            _elem2624 = new TDDINoteRef();
            _elem2624.read(iprot);
            struct.Note.add(_elem2624);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2626 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2626.size);
          TDDITaggedValueRef _elem2627;
          for (int _i2628 = 0; _i2628 < _list2626.size; ++_i2628)
          {
            _elem2627 = new TDDITaggedValueRef();
            _elem2627.read(iprot);
            struct.TaggedValue.add(_elem2627);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2629 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2629.size);
          TDDIPropertyRef _elem2630;
          for (int _i2631 = 0; _i2631 < _list2629.size; ++_i2631)
          {
            _elem2630 = new TDDIPropertyRef();
            _elem2630.read(iprot);
            struct.Property.add(_elem2630);
          }
        }
        struct.setPropertyIsSet(true);
      }
