...
public class TDDIMalFunction implements org.apache.thrift.TBase<TDDIMalFunction, TDDIMalFunction._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIMalFunction> {
  ...
  private static final org.apache.thrift.protocol.TField HAZARDS_FIELD_DESC = new org.apache.thrift.protocol.TField("Hazards", org.apache.thrift.protocol.TType.LIST, (short)8);
  ...
  public TDDIMalFunction setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIMalFunction setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIMalFunction setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIMalFunction setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIMalFunction setHazards(java.util.List<TDDIHazard> Hazards) {
    this.Hazards = Hazards;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1400.size);
                TDDIKeyValueMapRef _elem1401;
                for (int _i1402 = 0; _i1402 < _list1400.size; ++_i1402)
                {
                  _elem1401 = new TDDIKeyValueMapRef();
                  _elem1401.read(iprot);
                  struct.KeyValueMaps.add(_elem1401);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Hazards = new java.util.ArrayList<TDDIHazard>(_list1403.size);
                TDDIHazard _elem1404;
                for (int _i1405 = 0; _i1405 < _list1403.size; ++_i1405)
                {
                  _elem1404 = new TDDIHazard();
                  _elem1404.read(iprot);
                  struct.Hazards.add(_elem1404);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIMalFunction struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1406 : struct.KeyValueMaps)
          {
      ...
      if (struct.Hazards != null) {
        oprot.writeFieldBegin(HAZARDS_FIELD_DESC);
        {
          ...
          for (TDDIHazard _iter1407 : struct.Hazards)
          {
  ...
  private static class TDDIMalFunctionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIMalFunction> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1408 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetHazards()) {
        {
          ...
          for (TDDIHazard _iter1409 : struct.Hazards)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIMalFunction struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list1410 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1410.size);
          TDDIKeyValueMapRef _elem1411;
          for (int _i1412 = 0; _i1412 < _list1410.size; ++_i1412)
          {
            _elem1411 = new TDDIKeyValueMapRef();
            _elem1411.read(iprot);
            struct.KeyValueMaps.add(_elem1411);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.Hazards = new java.util.ArrayList<TDDIHazard>(_list1413.size);
          TDDIHazard _elem1414;
          for (int _i1415 = 0; _i1415 < _list1413.size; ++_i1415)
          {
            _elem1414 = new TDDIHazard();
            _elem1414.read(iprot);
            struct.Hazards.add(_elem1414);
          }
        }
        struct.setHazardsIsSet(true);
      }
