...
public class TDDIArgumentReasoning implements org.apache.thrift.TBase<TDDIArgumentReasoning, TDDIArgumentReasoning._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArgumentReasoning> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIArgumentReasoning");
  ...
  private static final org.apache.thrift.protocol.TField STRUCTURE_FIELD_DESC = new org.apache.thrift.protocol.TField("Structure", org.apache.thrift.protocol.TType.STRUCT, (short)11);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIArgumentReasoningStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIArgumentReasoningTupleSchemeFactory();
  ...
  public TDDIAbstractArgumentPackage Structure; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIArgumentReasoning.class, metaDataMap);
  }

  public TDDIArgumentReasoning() {
    this.Gid = "";
   ...
   */
  public TDDIArgumentReasoning(TDDIArgumentReasoning other) {
    ...
    if (other.isSetStructure()) {
      this.Structure = new TDDIAbstractArgumentPackage(other.Structure);
    }
  }

  public TDDIArgumentReasoning deepCopy() {
    return new TDDIArgumentReasoning(this);
  }
  ...
  public TDDIArgumentReasoning setGid(java.lang.String Gid) {
    this.Gid = Gid;
    return this;
  }
  ...
  public TDDIArgumentReasoning setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIArgumentReasoning setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIArgumentReasoning setCitedElement(TDDIAbstractSACMElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIArgumentReasoning setAbstractForm(TDDIAbstractSACMElement AbstractForm) {
    this.AbstractForm = AbstractForm;
    return this;
  }
  ...
  public TDDIArgumentReasoning setName(TDDIAbstractLangString Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIArgumentReasoning setDescription(TDDIDescription Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIArgumentReasoning setImplementationConstraint(java.util.List<TDDIImplementationConstraintRef> ImplementationConstraint) {
    this.ImplementationConstraint = ImplementationConstraint;
    return this;
  }
  ...
  public TDDIArgumentReasoning setNote(java.util.List<TDDINoteRef> Note) {
    this.Note = Note;
    return this;
  }
  ...
  public TDDIArgumentReasoning setTaggedValue(java.util.List<TDDITaggedValueRef> TaggedValue) {
    this.TaggedValue = TaggedValue;
    return this;
  }
  ...
  public TDDIAbstractArgumentPackage getStructure() {
    return this.Structure;
  }

  public TDDIArgumentReasoning setStructure(TDDIAbstractArgumentPackage Structure) {
    this.Structure = Structure;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case STRUCTURE:
      if (value == null) {
        ...
        setStructure((TDDIAbstractArgumentPackage)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIArgumentReasoning)
      return this.equals((TDDIArgumentReasoning)that);
    return false;
  }

  public boolean equals(TDDIArgumentReasoning that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetStructure()) ? 131071 : 524287);
    if (isSetStructure())
      hashCode = hashCode * 8191 + Structure.hashCode();

    return hashCode;
  }

  @Override
  public int compareTo(TDDIArgumentReasoning other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetStructure()).compareTo(other.isSetStructure());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetStructure()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIArgumentReasoning(");
    boolean first = true;
  ...
  private static class TDDIArgumentReasoningStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArgumentReasoningStandardScheme getScheme() {
      return new TDDIArgumentReasoningStandardScheme();
    }
  }

  private static class TDDIArgumentReasoningStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIArgumentReasoning> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIArgumentReasoning struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2040 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2040.size);
                TDDIImplementationConstraintRef _elem2041;
                for (int _i2042 = 0; _i2042 < _list2040.size; ++_i2042)
                {
                  _elem2041 = new TDDIImplementationConstraintRef();
                  _elem2041.read(iprot);
                  struct.ImplementationConstraint.add(_elem2041);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2043 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2043.size);
                TDDINoteRef _elem2044;
                for (int _i2045 = 0; _i2045 < _list2043.size; ++_i2045)
                {
                  _elem2044 = new TDDINoteRef();
                  _elem2044.read(iprot);
                  struct.Note.add(_elem2044);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2046.size);
                TDDITaggedValueRef _elem2047;
                for (int _i2048 = 0; _i2048 < _list2046.size; ++_i2048)
                {
                  _elem2047 = new TDDITaggedValueRef();
                  _elem2047.read(iprot);
                  struct.TaggedValue.add(_elem2047);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // STRUCTURE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.Structure = new TDDIAbstractArgumentPackage();
              struct.Structure.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArgumentReasoning struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2049 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2050 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2051 : struct.TaggedValue)
          {
  ...
  private static class TDDIArgumentReasoningTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIArgumentReasoningTupleScheme getScheme() {
      return new TDDIArgumentReasoningTupleScheme();
    }
  }

  private static class TDDIArgumentReasoningTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArgumentReasoning> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIArgumentReasoning struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2052 : struct.ImplementationConstraint)
          {
            _iter2052.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2053 : struct.Note)
          {
            _iter2053.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2054 : struct.TaggedValue)
          {
            _iter2054.write(oprot);
          }
        }
      }
      if (struct.isSetStructure()) {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArgumentReasoning struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2055.size);
          TDDIImplementationConstraintRef _elem2056;
          for (int _i2057 = 0; _i2057 < _list2055.size; ++_i2057)
          {
            _elem2056 = new TDDIImplementationConstraintRef();
            _elem2056.read(iprot);
            struct.ImplementationConstraint.add(_elem2056);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2058.size);
          TDDINoteRef _elem2059;
          for (int _i2060 = 0; _i2060 < _list2058.size; ++_i2060)
          {
            _elem2059 = new TDDINoteRef();
            _elem2059.read(iprot);
            struct.Note.add(_elem2059);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2061.size);
          TDDITaggedValueRef _elem2062;
          for (int _i2063 = 0; _i2063 < _list2061.size; ++_i2063)
          {
            _elem2062 = new TDDITaggedValueRef();
            _elem2062.read(iprot);
            struct.TaggedValue.add(_elem2062);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
