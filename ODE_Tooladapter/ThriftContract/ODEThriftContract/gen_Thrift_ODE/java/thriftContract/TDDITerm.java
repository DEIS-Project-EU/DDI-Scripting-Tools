...
public class TDDITerm implements org.apache.thrift.TBase<TDDITerm, TDDITerm._Fields>, java.io.Serializable, Cloneable, Comparable<TDDITerm> {
  ...
  public TDDITerm setCategory(TDDICategory Category) {
    this.Category = Category;
    return this;
  }
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3144 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list3144.size);
                TDDIImplementationConstraintRef _elem3145;
                for (int _i3146 = 0; _i3146 < _list3144.size; ++_i3146)
                {
                  _elem3145 = new TDDIImplementationConstraintRef();
                  _elem3145.read(iprot);
                  struct.ImplementationConstraint.add(_elem3145);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3147 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list3147.size);
                TDDINoteRef _elem3148;
                for (int _i3149 = 0; _i3149 < _list3147.size; ++_i3149)
                {
                  _elem3148 = new TDDINoteRef();
                  _elem3148.read(iprot);
                  struct.Note.add(_elem3148);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list3150 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list3150.size);
                TDDITaggedValueRef _elem3151;
                for (int _i3152 = 0; _i3152 < _list3150.size; ++_i3152)
                {
                  _elem3151 = new TDDITaggedValueRef();
                  _elem3151.read(iprot);
                  struct.TaggedValue.add(_elem3151);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDITerm struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter3153 : struct.ImplementationConstraint)
          {
            _iter3153.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter3154 : struct.Note)
          {
            _iter3154.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter3155 : struct.TaggedValue)
          {
            _iter3155.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDITermTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDITerm> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter3156 : struct.ImplementationConstraint)
          {
            _iter3156.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter3157 : struct.Note)
          {
            _iter3157.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter3158 : struct.TaggedValue)
          {
            _iter3158.write(oprot);
          }
        }
      }
      if (struct.isSetValue()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDITerm struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list3159 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list3159.size);
          TDDIImplementationConstraintRef _elem3160;
          for (int _i3161 = 0; _i3161 < _list3159.size; ++_i3161)
          {
            _elem3160 = new TDDIImplementationConstraintRef();
            _elem3160.read(iprot);
            struct.ImplementationConstraint.add(_elem3160);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list3162 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list3162.size);
          TDDINoteRef _elem3163;
          for (int _i3164 = 0; _i3164 < _list3162.size; ++_i3164)
          {
            _elem3163 = new TDDINoteRef();
            _elem3163.read(iprot);
            struct.Note.add(_elem3163);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list3165 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list3165.size);
          TDDITaggedValueRef _elem3166;
          for (int _i3167 = 0; _i3167 < _list3165.size; ++_i3167)
          {
            _elem3166 = new TDDITaggedValueRef();
            _elem3166.read(iprot);
            struct.TaggedValue.add(_elem3166);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
