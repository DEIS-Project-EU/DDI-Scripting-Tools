...
public class TDDISignal implements org.apache.thrift.TBase<TDDISignal, TDDISignal._Fields>, java.io.Serializable, Cloneable, Comparable<TDDISignal> {
  ...
  private static final org.apache.thrift.protocol.TField FROM_PORT_FIELD_DESC = new org.apache.thrift.protocol.TField("FromPort", org.apache.thrift.protocol.TType.STRUCT, (short)10);
  private static final org.apache.thrift.protocol.TField TO_PORT_FIELD_DESC = new org.apache.thrift.protocol.TField("ToPort", org.apache.thrift.protocol.TType.STRUCT, (short)11);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    FROM_PORT((short)10, "FromPort"),
    TO_PORT((short)11, "ToPort");
  ...
  public TDDISignal setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDISignal setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDISignal setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDISignal setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDISignal setDependabilityRequirements(java.util.List<TDDIAbstractDependabilityRequirementRef> DependabilityRequirements) {
    this.DependabilityRequirements = DependabilityRequirements;
    return this;
  }
  ...
  public TDDISignal setAssuranceLevel(TDDIAssuranceLevel AssuranceLevel) {
    this.AssuranceLevel = AssuranceLevel;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list128.size);
                TDDIKeyValueMapRef _elem129;
                for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                {
                  _elem129 = new TDDIKeyValueMapRef();
                  _elem129.read(iprot);
                  struct.KeyValueMaps.add(_elem129);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list131.size);
                TDDIAbstractDependabilityRequirementRef _elem132;
                for (int _i133 = 0; _i133 < _list131.size; ++_i133)
                {
                  _elem132 = new TDDIAbstractDependabilityRequirementRef();
                  _elem132.read(iprot);
                  struct.DependabilityRequirements.add(_elem132);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDISignal struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter134 : struct.KeyValueMaps)
          {
      ...
      if (struct.DependabilityRequirements != null) {
        oprot.writeFieldBegin(DEPENDABILITY_REQUIREMENTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter135 : struct.DependabilityRequirements)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter136 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetDependabilityRequirements()) {
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter137 : struct.DependabilityRequirements)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list138.size);
          TDDIKeyValueMapRef _elem139;
          for (int _i140 = 0; _i140 < _list138.size; ++_i140)
          {
            _elem139 = new TDDIKeyValueMapRef();
            _elem139.read(iprot);
            struct.KeyValueMaps.add(_elem139);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list141.size);
          TDDIAbstractDependabilityRequirementRef _elem142;
          for (int _i143 = 0; _i143 < _list141.size; ++_i143)
          {
            _elem142 = new TDDIAbstractDependabilityRequirementRef();
            _elem142.read(iprot);
            struct.DependabilityRequirements.add(_elem142);
          }
        }
        struct.setDependabilityRequirementsIsSet(true);
      }
