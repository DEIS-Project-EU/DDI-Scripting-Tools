...
public class TDDIHARAPackage implements org.apache.thrift.TBase<TDDIHARAPackage, TDDIHARAPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIHARAPackage> {
  ...
  public TDDIHARAPackage setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIHARAPackage setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIHARAPackage setKeyValueMaps(java.util.List<TDDIKeyValueMapRef> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIHARAPackage setCitedElement(TDDIAbstractBaseElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIHARAPackage setHARAArtifacts(java.util.List<TDDIAbstractHARAArtifact> HARAArtifacts) {
    this.HARAArtifacts = HARAArtifacts;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1416.size);
                TDDIKeyValueMapRef _elem1417;
                for (int _i1418 = 0; _i1418 < _list1416.size; ++_i1418)
                {
                  _elem1417 = new TDDIKeyValueMapRef();
                  _elem1417.read(iprot);
                  struct.KeyValueMaps.add(_elem1417);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.HARAArtifacts = new java.util.ArrayList<TDDIAbstractHARAArtifact>(_list1419.size);
                TDDIAbstractHARAArtifact _elem1420;
                for (int _i1421 = 0; _i1421 < _list1419.size; ++_i1421)
                {
                  _elem1420 = new TDDIAbstractHARAArtifact();
                  _elem1420.read(iprot);
                  struct.HARAArtifacts.add(_elem1420);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIHARAPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMapRef _iter1422 : struct.KeyValueMaps)
          {
      ...
      if (struct.HARAArtifacts != null) {
        oprot.writeFieldBegin(HARAARTIFACTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractHARAArtifact _iter1423 : struct.HARAArtifacts)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMapRef _iter1424 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetHARAArtifacts()) {
        {
          ...
          for (TDDIAbstractHARAArtifact _iter1425 : struct.HARAArtifacts)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMapRef>(_list1426.size);
          TDDIKeyValueMapRef _elem1427;
          for (int _i1428 = 0; _i1428 < _list1426.size; ++_i1428)
          {
            _elem1427 = new TDDIKeyValueMapRef();
            _elem1427.read(iprot);
            struct.KeyValueMaps.add(_elem1427);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.HARAArtifacts = new java.util.ArrayList<TDDIAbstractHARAArtifact>(_list1429.size);
          TDDIAbstractHARAArtifact _elem1430;
          for (int _i1431 = 0; _i1431 < _list1429.size; ++_i1431)
          {
            _elem1430 = new TDDIAbstractHARAArtifact();
            _elem1430.read(iprot);
            struct.HARAArtifacts.add(_elem1430);
          }
        }
        struct.setHARAArtifactsIsSet(true);
      }
