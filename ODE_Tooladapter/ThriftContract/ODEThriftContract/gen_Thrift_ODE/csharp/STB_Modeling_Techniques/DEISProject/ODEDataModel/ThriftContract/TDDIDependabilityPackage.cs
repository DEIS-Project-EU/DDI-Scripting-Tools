              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem338;
                    _elem338 = new TDDIKeyValueMapRef();
                    _elem338.Read(iprot);
                    KeyValueMaps.Add(_elem338);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractDependabilityArtifactRef _elem341;
                    _elem341 = new TDDIAbstractDependabilityArtifactRef();
                    _elem341.Read(iprot);
                    DependabilityArtifacts.Add(_elem341);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter342 in KeyValueMaps)
            {
        ...
        if (DependabilityArtifacts != null && __isset.DependabilityArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractDependabilityArtifactRef _iter343 in DependabilityArtifacts)
            {
