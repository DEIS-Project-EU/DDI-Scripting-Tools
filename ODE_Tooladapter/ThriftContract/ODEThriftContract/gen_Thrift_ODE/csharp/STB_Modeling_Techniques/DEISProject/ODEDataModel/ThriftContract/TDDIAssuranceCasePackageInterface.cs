      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1428 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1429 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1430 in TaggedValue)
            {
        ...
        if (AssuranceCasePackage != null && __isset.AssuranceCasePackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractAssuranceCasePackageRef _iter1431 in AssuranceCasePackage)
            {
        ...
        if (Interface != null && __isset.@Interface) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAssuranceCasePackageInterfaceRef _iter1432 in Interface)
            {
        ...
        if (ArtifactPackage != null && __isset.ArtifactPackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactPackageRef _iter1433 in ArtifactPackage)
            {
        ...
        if (ArgumentPackage != null && __isset.ArgumentPackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentPackageRef _iter1434 in ArgumentPackage)
            {
        ...
        if (TerminologyPackage != null && __isset.TerminologyPackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractTerminologyPackageRef _iter1435 in TerminologyPackage)
            {
