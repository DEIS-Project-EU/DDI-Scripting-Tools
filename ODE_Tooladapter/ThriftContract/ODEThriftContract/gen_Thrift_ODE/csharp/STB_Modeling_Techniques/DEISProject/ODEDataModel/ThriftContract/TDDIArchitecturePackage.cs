...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArchitecturePackage : TBase
  {
    private long _Id;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem2;
                    _elem2 = new TDDIKeyValueMapRef();
                    _elem2.Read(iprot);
                    KeyValueMaps.Add(_elem2);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractDependabilityRequirementRef _elem5;
                    _elem5 = new TDDIAbstractDependabilityRequirementRef();
                    _elem5.Read(iprot);
                    DependabilityRequirements.Add(_elem5);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractDesignArtifactRef _elem8;
                    _elem8 = new TDDIAbstractDesignArtifactRef();
                    _elem8.Read(iprot);
                    DesignArtifacts.Add(_elem8);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIArchitecturePackage");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter9 in KeyValueMaps)
            {
              _iter9.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (DependabilityRequirements != null && __isset.DependabilityRequirements) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractDependabilityRequirementRef _iter10 in DependabilityRequirements)
            {
              _iter10.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (DesignArtifacts != null && __isset.DesignArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractDesignArtifactRef _iter11 in DesignArtifacts)
            {
              _iter11.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArchitecturePackage(");
      bool __first = true;
      if (__isset.Id) {
