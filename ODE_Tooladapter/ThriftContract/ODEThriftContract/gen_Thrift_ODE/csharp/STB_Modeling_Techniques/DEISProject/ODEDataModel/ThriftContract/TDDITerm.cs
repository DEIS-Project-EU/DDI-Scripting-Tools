              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1572 = iprot.ReadListBegin();
                  for( int _i1573 = 0; _i1573 < _list1572.Count; ++_i1573)
                  {
                    TDDIImplementationConstraintRef _elem1574;
                    _elem1574 = new TDDIImplementationConstraintRef();
                    _elem1574.Read(iprot);
                    ImplementationConstraint.Add(_elem1574);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1575 = iprot.ReadListBegin();
                  for( int _i1576 = 0; _i1576 < _list1575.Count; ++_i1576)
                  {
                    TDDINoteRef _elem1577;
                    _elem1577 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1578 = iprot.ReadListBegin();
                  for( int _i1579 = 0; _i1579 < _list1578.Count; ++_i1579)
                  {
                    TDDITaggedValueRef _elem1580;
                    _elem1580 = new TDDITaggedValueRef();
                    _elem1580.Read(iprot);
                    TaggedValue.Add(_elem1580);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
