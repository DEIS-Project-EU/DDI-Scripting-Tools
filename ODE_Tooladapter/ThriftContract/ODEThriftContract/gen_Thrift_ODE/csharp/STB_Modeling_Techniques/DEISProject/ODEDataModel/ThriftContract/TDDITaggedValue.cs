...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDITaggedValue : TBase
  {
    private string _Gid;
    ...
    private TDDIMultiLangString _Key;
    ...
    public TDDIMultiLangString Key
    {
      get
      {
        return _Key;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDITaggedValue");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDITaggedValue(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
