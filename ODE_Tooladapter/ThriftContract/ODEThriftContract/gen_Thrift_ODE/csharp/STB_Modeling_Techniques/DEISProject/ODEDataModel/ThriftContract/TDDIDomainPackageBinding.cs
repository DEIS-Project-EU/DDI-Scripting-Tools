...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIDomainPackageBinding : TBase
  {
    private long _Id;
    ...
    private List<TDDIAbstractDomainElementRef> _DomainElements;
    private List<TDDIAbstractDomainPackageRef> _ParticipantPackages;
    ...
    public List<TDDIAbstractDomainElementRef> DomainElements
    {
      get
      {
        return _DomainElements;
      }
      set
      {
        __isset.DomainElements = true;
        this._DomainElements = value;
      }
    }

    public List<TDDIAbstractDomainPackageRef> ParticipantPackages
    {
      get
      {
    ...
    public TDDIDomainPackageBinding() {
      ...
      this._DomainElements = new List<TDDIAbstractDomainElementRef>();
      this.__isset.DomainElements = true;
      this._ParticipantPackages = new List<TDDIAbstractDomainPackageRef>();
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem398;
                    _elem398 = new TDDIKeyValueMapRef();
                    _elem398.Read(iprot);
            ...
            case 8:
              if (field.Type == TType.List) {
                {
                  DomainElements = new List<TDDIAbstractDomainElementRef>();
                  TList _list399 = iprot.ReadListBegin();
                  for( int _i400 = 0; _i400 < _list399.Count; ++_i400)
                  {
                    TDDIAbstractDomainElementRef _elem401;
                    _elem401 = new TDDIAbstractDomainElementRef();
                    _elem401.Read(iprot);
                    DomainElements.Add(_elem401);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 9:
              if (field.Type == TType.List) {
                {
                  ParticipantPackages = new List<TDDIAbstractDomainPackageRef>();
                  TList _list402 = iprot.ReadListBegin();
                  for( int _i403 = 0; _i403 < _list402.Count; ++_i403)
                  {
                    TDDIAbstractDomainPackageRef _elem404;
                    _elem404 = new TDDIAbstractDomainPackageRef();
                    _elem404.Read(iprot);
                    ParticipantPackages.Add(_elem404);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIDomainPackageBinding");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter405 in KeyValueMaps)
            {
        ...
        if (DomainElements != null && __isset.DomainElements) {
          field.Name = "DomainElements";
          field.Type = TType.List;
          field.ID = 8;
          oprot.WriteFieldBegin(field);
          {
            oprot.WriteListBegin(new TList(TType.Struct, DomainElements.Count));
            foreach (TDDIAbstractDomainElementRef _iter406 in DomainElements)
            {
        ...
        if (ParticipantPackages != null && __isset.ParticipantPackages) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractDomainPackageRef _iter407 in ParticipantPackages)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIDomainPackageBinding(");
      bool __first = true;
      if (__isset.Id) {
