...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIFMEAPropagation : TBase
  {
    private long _Id;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem574;
                    _elem574 = new TDDIKeyValueMapRef();
                    _elem574.Read(iprot);
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIFMEAPropagation");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter575 in KeyValueMaps)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIFMEAPropagation(");
      bool __first = true;
      if (__isset.Id) {
