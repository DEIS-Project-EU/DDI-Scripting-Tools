...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIParticipant : TBase
  {
    private string _Gid;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1268 = iprot.ReadListBegin();
                  for( int _i1269 = 0; _i1269 < _list1268.Count; ++_i1269)
                  {
                    TDDIImplementationConstraintRef _elem1270;
                    _elem1270 = new TDDIImplementationConstraintRef();
                    _elem1270.Read(iprot);
                    ImplementationConstraint.Add(_elem1270);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1271 = iprot.ReadListBegin();
                  for( int _i1272 = 0; _i1272 < _list1271.Count; ++_i1272)
                  {
                    TDDINoteRef _elem1273;
                    _elem1273 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i1275 = 0; _i1275 < _list1274.Count; ++_i1275)
                  {
                    TDDITaggedValueRef _elem1276;
                    _elem1276 = new TDDITaggedValueRef();
                    _elem1276.Read(iprot);
                    TaggedValue.Add(_elem1276);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1277 = iprot.ReadListBegin();
                  for( int _i1278 = 0; _i1278 < _list1277.Count; ++_i1278)
                  {
                    TDDIPropertyRef _elem1279;
                    _elem1279 = new TDDIPropertyRef();
                    _elem1279.Read(iprot);
                    Property.Add(_elem1279);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIParticipant");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1280 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1281 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1282 in TaggedValue)
            {
        ...
        if (Property != null && __isset.Property) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIPropertyRef _iter1283 in Property)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIParticipant(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
