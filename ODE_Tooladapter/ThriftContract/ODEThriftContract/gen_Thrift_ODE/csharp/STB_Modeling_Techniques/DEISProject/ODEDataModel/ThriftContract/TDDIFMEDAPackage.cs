...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIFMEDAPackage : TBase
  {
    private long _Id;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIFMEDAPackage");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter565 in KeyValueMaps)
            {
        ...
        if (FailureAnalysisArtifacts != null && __isset.FailureAnalysisArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFailureAnalysisArtifactRef _iter566 in FailureAnalysisArtifacts)
            {
        ...
        if (FMEAArtifacts != null && __isset.FMEAArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFMEAArtifactRef _iter567 in FMEAArtifacts)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIFMEDAPackage(");
      bool __first = true;
      if (__isset.Id) {
