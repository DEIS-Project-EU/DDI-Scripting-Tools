...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIDomainPackageInterface : TBase
  {
    private long _Id;
    ...
    private TDDIAbstractDomainPackage _Implements;
    ...
    public TDDIAbstractDomainPackage Implements
    {
      get
      {
        return _Implements;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem390;
                    _elem390 = new TDDIKeyValueMapRef();
                    _elem390.Read(iprot);
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractDomainElementRef _elem393;
                    _elem393 = new TDDIAbstractDomainElementRef();
                    _elem393.Read(iprot);
                    DomainElements.Add(_elem393);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 9:
              if (field.Type == TType.Struct) {
                Implements = new TDDIAbstractDomainPackage();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIDomainPackageInterface");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter394 in KeyValueMaps)
            {
        ...
        if (DomainElements != null && __isset.DomainElements) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractDomainElementRef _iter395 in DomainElements)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIDomainPackageInterface(");
      bool __first = true;
      if (__isset.Id) {
