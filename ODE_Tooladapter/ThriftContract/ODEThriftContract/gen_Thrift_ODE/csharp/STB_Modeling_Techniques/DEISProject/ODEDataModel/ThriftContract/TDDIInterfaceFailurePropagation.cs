...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIInterfaceFailurePropagation : TBase
  {
    private long _Id;
    ...
    private TDDIAbstractInterfaceFailure _Cause;
    private TDDIAbstractInterfaceFailure _Effect;
    ...
    public TDDIAbstractInterfaceFailure Cause
    {
      get
      {
        return _Cause;
    ...
    public TDDIAbstractInterfaceFailure Effect
    {
      get
      {
        return _Effect;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem462;
                    _elem462 = new TDDIKeyValueMapRef();
                    _elem462.Read(iprot);
            ...
            case 8:
              if (field.Type == TType.Struct) {
                Cause = new TDDIAbstractInterfaceFailure();
                Cause.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
            ...
            case 9:
              if (field.Type == TType.Struct) {
                Effect = new TDDIAbstractInterfaceFailure();
                Effect.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIInterfaceFailurePropagation");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter463 in KeyValueMaps)
            {
