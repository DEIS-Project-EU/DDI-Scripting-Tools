              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1236 = iprot.ReadListBegin();
                  for( int _i1237 = 0; _i1237 < _list1236.Count; ++_i1237)
                  {
                    TDDIImplementationConstraintRef _elem1238;
                    _elem1238 = new TDDIImplementationConstraintRef();
                    _elem1238.Read(iprot);
                    ImplementationConstraint.Add(_elem1238);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1239 = iprot.ReadListBegin();
                  for( int _i1240 = 0; _i1240 < _list1239.Count; ++_i1240)
                  {
                    TDDINoteRef _elem1241;
                    _elem1241 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1242 = iprot.ReadListBegin();
                  for( int _i1243 = 0; _i1243 < _list1242.Count; ++_i1243)
                  {
                    TDDITaggedValueRef _elem1244;
                    _elem1244 = new TDDITaggedValueRef();
                    _elem1244.Read(iprot);
                    TaggedValue.Add(_elem1244);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIPropertyRef _elem1247;
                    _elem1247 = new TDDIPropertyRef();
                    _elem1247.Read(iprot);
                    Property.Add(_elem1247);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1248 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1249 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1250 in TaggedValue)
            {
        ...
        if (Property != null && __isset.Property) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIPropertyRef _iter1251 in Property)
            {
