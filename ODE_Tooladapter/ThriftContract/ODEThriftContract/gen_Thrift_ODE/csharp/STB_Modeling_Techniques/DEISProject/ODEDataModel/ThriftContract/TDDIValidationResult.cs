              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1584 = iprot.ReadListBegin();
                  for( int _i1585 = 0; _i1585 < _list1584.Count; ++_i1585)
                  {
                    TDDIValidationViolationMessage _elem1586;
                    _elem1586 = new TDDIValidationViolationMessage();
                    _elem1586.Read(iprot);
                    ValidationViolationMessages.Add(_elem1586);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ValidationViolationMessages != null && __isset.ValidationViolationMessages) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIValidationViolationMessage _iter1587 in ValidationViolationMessages)
            {
