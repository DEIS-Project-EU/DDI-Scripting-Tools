...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIInputFailure : TBase
  {
    private long _Id;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem458;
                    _elem458 = new TDDIKeyValueMapRef();
                    _elem458.Read(iprot);
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIInputFailure");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter459 in KeyValueMaps)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIInputFailure(");
      bool __first = true;
      if (__isset.Id) {
