...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIEvent : TBase
  {
    private string _Gid;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIImplementationConstraintRef _elem1302;
                    _elem1302 = new TDDIImplementationConstraintRef();
                    _elem1302.Read(iprot);
                    ImplementationConstraint.Add(_elem1302);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem1305;
                    _elem1305 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i1307 = 0; _i1307 < _list1306.Count; ++_i1307)
                  {
                    TDDITaggedValueRef _elem1308;
                    _elem1308 = new TDDITaggedValueRef();
                    _elem1308.Read(iprot);
                    TaggedValue.Add(_elem1308);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIPropertyRef _elem1311;
                    _elem1311 = new TDDIPropertyRef();
                    _elem1311.Read(iprot);
                    Property.Add(_elem1311);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIEvent");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1312 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1313 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1314 in TaggedValue)
            {
        ...
        if (Property != null && __isset.Property) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIPropertyRef _iter1315 in Property)
            {
        ...
        if (Occurence != null && __isset.Occurence) {
          field.Name = "Occurence";
          field.Type = TType.String;
          field.ID = 12;
          oprot.WriteFieldBegin(field);
          oprot.WriteString(Occurence);
          oprot.WriteFieldEnd();
        }
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIEvent(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
