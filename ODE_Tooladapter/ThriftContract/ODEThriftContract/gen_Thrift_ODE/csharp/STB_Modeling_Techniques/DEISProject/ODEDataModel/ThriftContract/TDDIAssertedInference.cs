              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1096 = iprot.ReadListBegin();
                  for( int _i1097 = 0; _i1097 < _list1096.Count; ++_i1097)
                  {
                    TDDIImplementationConstraintRef _elem1098;
                    _elem1098 = new TDDIImplementationConstraintRef();
                    _elem1098.Read(iprot);
                    ImplementationConstraint.Add(_elem1098);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1099 = iprot.ReadListBegin();
                  for( int _i1100 = 0; _i1100 < _list1099.Count; ++_i1100)
                  {
                    TDDINoteRef _elem1101;
                    _elem1101 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i1103 = 0; _i1103 < _list1102.Count; ++_i1103)
                  {
                    TDDITaggedValueRef _elem1104;
                    _elem1104 = new TDDITaggedValueRef();
                    _elem1104.Read(iprot);
                    TaggedValue.Add(_elem1104);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIClaimRef _elem1107;
                    _elem1107 = new TDDIClaimRef();
                    _elem1107.Read(iprot);
                    MetaClaim.Add(_elem1107);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1108 = iprot.ReadListBegin();
                  for( int _i1109 = 0; _i1109 < _list1108.Count; ++_i1109)
                  {
                    TDDIAbstractArgumentAssetRef _elem1110;
                    _elem1110 = new TDDIAbstractArgumentAssetRef();
                    _elem1110.Read(iprot);
                    Source.Add(_elem1110);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1111 = iprot.ReadListBegin();
                  for( int _i1112 = 0; _i1112 < _list1111.Count; ++_i1112)
                  {
                    TDDIAbstractArgumentAssetRef _elem1113;
                    _elem1113 = new TDDIAbstractArgumentAssetRef();
                    _elem1113.Read(iprot);
                    Target.Add(_elem1113);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1114 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1115 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1116 in TaggedValue)
            {
        ...
        if (MetaClaim != null && __isset.MetaClaim) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIClaimRef _iter1117 in MetaClaim)
            {
        ...
        if (Source != null && __isset.Source) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentAssetRef _iter1118 in Source)
            {
        ...
        if (Target != null && __isset.Target) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentAssetRef _iter1119 in Target)
            {
