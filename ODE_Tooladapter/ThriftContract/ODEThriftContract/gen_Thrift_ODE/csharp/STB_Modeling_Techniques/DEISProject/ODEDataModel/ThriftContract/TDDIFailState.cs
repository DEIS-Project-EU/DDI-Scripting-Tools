...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIFailState : TBase
  {
    private long _Id;
    ...
    private List<TDDIState> _AssociatedStates;
    ...
    public List<TDDIState> AssociatedStates
    {
      get
      {
        return _AssociatedStates;
      }
      set
      {
        __isset.AssociatedStates = true;
        this._AssociatedStates = value;
      }
    }
    ...
    public TDDIFailState() {
      ...
      this._AssociatedStates = new List<TDDIState>();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIFailState(");
      bool __first = true;
      if (__isset.Id) {
