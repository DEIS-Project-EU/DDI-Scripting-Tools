...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIDependabilityPackageInterface : TBase
  {
    private long _Id;
    ...
    private TDDIAbstractDependabilityPackage _Implements;
    ...
    public TDDIAbstractDependabilityPackage Implements
    {
      get
      {
        return _Implements;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem346;
                    _elem346 = new TDDIKeyValueMapRef();
                    _elem346.Read(iprot);
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractDependabilityArtifactRef _elem349;
                    _elem349 = new TDDIAbstractDependabilityArtifactRef();
                    _elem349.Read(iprot);
                    DependabilityArtifacts.Add(_elem349);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 9:
              if (field.Type == TType.Struct) {
                Implements = new TDDIAbstractDependabilityPackage();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIDependabilityPackageInterface");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter350 in KeyValueMaps)
            {
        ...
        if (DependabilityArtifacts != null && __isset.DependabilityArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractDependabilityArtifactRef _iter351 in DependabilityArtifacts)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIDependabilityPackageInterface(");
      bool __first = true;
      if (__isset.Id) {
