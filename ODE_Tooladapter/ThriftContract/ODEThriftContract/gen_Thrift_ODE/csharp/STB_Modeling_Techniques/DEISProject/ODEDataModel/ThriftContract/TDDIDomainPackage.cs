              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem382;
                    _elem382 = new TDDIKeyValueMapRef();
                    _elem382.Read(iprot);
                    KeyValueMaps.Add(_elem382);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list383 = iprot.ReadListBegin();
                  for( int _i384 = 0; _i384 < _list383.Count; ++_i384)
                  {
                    TDDIAbstractDomainElementRef _elem385;
                    _elem385 = new TDDIAbstractDomainElementRef();
                    _elem385.Read(iprot);
                    DomainElements.Add(_elem385);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter386 in KeyValueMaps)
            {
        ...
        if (DomainElements != null && __isset.DomainElements) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractDomainElementRef _iter387 in DomainElements)
            {
