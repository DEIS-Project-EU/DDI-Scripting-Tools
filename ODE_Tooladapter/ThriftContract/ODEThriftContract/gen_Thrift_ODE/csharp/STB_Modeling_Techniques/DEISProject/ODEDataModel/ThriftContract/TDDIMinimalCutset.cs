              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem442;
                    _elem442 = new TDDIKeyValueMapRef();
                    _elem442.Read(iprot);
                    KeyValueMaps.Add(_elem442);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractFailure _elem445;
                    _elem445 = new TDDIAbstractFailure();
                    _elem445.Read(iprot);
                    Failures.Add(_elem445);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter446 in KeyValueMaps)
            {
        ...
        if (Failures != null && __isset.Failures) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFailure _iter447 in Failures)
            {
