              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1072 = iprot.ReadListBegin();
                  for( int _i1073 = 0; _i1073 < _list1072.Count; ++_i1073)
                  {
                    TDDIImplementationConstraintRef _elem1074;
                    _elem1074 = new TDDIImplementationConstraintRef();
                    _elem1074.Read(iprot);
                    ImplementationConstraint.Add(_elem1074);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1075 = iprot.ReadListBegin();
                  for( int _i1076 = 0; _i1076 < _list1075.Count; ++_i1076)
                  {
                    TDDINoteRef _elem1077;
                    _elem1077 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDITaggedValueRef _elem1080;
                    _elem1080 = new TDDITaggedValueRef();
                    _elem1080.Read(iprot);
                    TaggedValue.Add(_elem1080);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i1082 = 0; _i1082 < _list1081.Count; ++_i1082)
                  {
                    TDDIClaimRef _elem1083;
                    _elem1083 = new TDDIClaimRef();
                    _elem1083.Read(iprot);
                    MetaClaim.Add(_elem1083);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractArgumentAssetRef _elem1086;
                    _elem1086 = new TDDIAbstractArgumentAssetRef();
                    _elem1086.Read(iprot);
                    Source.Add(_elem1086);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1087 = iprot.ReadListBegin();
                  for( int _i1088 = 0; _i1088 < _list1087.Count; ++_i1088)
                  {
                    TDDIAbstractArgumentAssetRef _elem1089;
                    _elem1089 = new TDDIAbstractArgumentAssetRef();
                    _elem1089.Read(iprot);
                    Target.Add(_elem1089);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1090 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1091 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1092 in TaggedValue)
            {
        ...
        if (MetaClaim != null && __isset.MetaClaim) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIClaimRef _iter1093 in MetaClaim)
            {
        ...
        if (Source != null && __isset.Source) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentAssetRef _iter1094 in Source)
            {
        ...
        if (Target != null && __isset.Target) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentAssetRef _iter1095 in Target)
            {
