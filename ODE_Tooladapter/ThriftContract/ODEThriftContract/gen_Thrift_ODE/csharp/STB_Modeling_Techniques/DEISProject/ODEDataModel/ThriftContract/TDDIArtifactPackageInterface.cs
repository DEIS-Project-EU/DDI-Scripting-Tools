              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractArtifactElementRef _elem1195;
                    _elem1195 = new TDDIAbstractArtifactElementRef();
                    _elem1195.Read(iprot);
                    ArtifactElement.Add(_elem1195);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1196 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1197 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1198 in TaggedValue)
            {
        ...
        if (ArtifactElement != null && __isset.ArtifactElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactElementRef _iter1199 in ArtifactElement)
            {
