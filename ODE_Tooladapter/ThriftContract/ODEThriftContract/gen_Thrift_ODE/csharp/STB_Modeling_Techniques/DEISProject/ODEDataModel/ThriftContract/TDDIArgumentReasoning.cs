...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArgumentReasoning : TBase
  {
    private string _Gid;
    ...
    private TDDIAbstractArgumentPackage _Structure;
    ...
    public TDDIAbstractArgumentPackage Structure
    {
      get
      {
        return _Structure;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1020 = iprot.ReadListBegin();
                  for( int _i1021 = 0; _i1021 < _list1020.Count; ++_i1021)
                  {
                    TDDIImplementationConstraintRef _elem1022;
                    _elem1022 = new TDDIImplementationConstraintRef();
                    _elem1022.Read(iprot);
                    ImplementationConstraint.Add(_elem1022);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem1025;
                    _elem1025 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDITaggedValueRef _elem1028;
                    _elem1028 = new TDDITaggedValueRef();
                    _elem1028.Read(iprot);
                    TaggedValue.Add(_elem1028);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1029 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1030 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1031 in TaggedValue)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArgumentReasoning(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
      ...
      if (Structure != null && __isset.Structure) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Structure: ");
        __sb.Append(Structure== null ? "<null>" : Structure.ToString());
      }
      __sb.Append(")");
