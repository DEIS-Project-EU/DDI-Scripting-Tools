              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i1477 = 0; _i1477 < _list1476.Count; ++_i1477)
                  {
                    TDDIImplementationConstraintRef _elem1478;
                    _elem1478 = new TDDIImplementationConstraintRef();
                    _elem1478.Read(iprot);
                    ImplementationConstraint.Add(_elem1478);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1479 = iprot.ReadListBegin();
                  for( int _i1480 = 0; _i1480 < _list1479.Count; ++_i1480)
                  {
                    TDDINoteRef _elem1481;
                    _elem1481 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1482 = iprot.ReadListBegin();
                  for( int _i1483 = 0; _i1483 < _list1482.Count; ++_i1483)
                  {
                    TDDITaggedValueRef _elem1484;
                    _elem1484 = new TDDITaggedValueRef();
                    _elem1484.Read(iprot);
                    TaggedValue.Add(_elem1484);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1485 = iprot.ReadListBegin();
                  for( int _i1486 = 0; _i1486 < _list1485.Count; ++_i1486)
                  {
                    TDDIAbstractTerminologyElement _elem1487;
                    _elem1487 = new TDDIAbstractTerminologyElement();
                    _elem1487.Read(iprot);
                    TerminologyElement.Add(_elem1487);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1488 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1489 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1490 in TaggedValue)
            {
        ...
        if (TerminologyElement != null && __isset.TerminologyElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractTerminologyElement _iter1491 in TerminologyElement)
            {
