...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArgumentGroup : TBase
  {
    private string _Gid;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list952 = iprot.ReadListBegin();
                  for( int _i953 = 0; _i953 < _list952.Count; ++_i953)
                  {
                    TDDIImplementationConstraintRef _elem954;
                    _elem954 = new TDDIImplementationConstraintRef();
                    _elem954.Read(iprot);
                    ImplementationConstraint.Add(_elem954);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem957;
                    _elem957 = new TDDINoteRef();
                    _elem957.Read(iprot);
                    Note.Add(_elem957);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i959 = 0; _i959 < _list958.Count; ++_i959)
                  {
                    TDDITaggedValueRef _elem960;
                    _elem960 = new TDDITaggedValueRef();
                    _elem960.Read(iprot);
                    TaggedValue.Add(_elem960);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list961 = iprot.ReadListBegin();
                  for( int _i962 = 0; _i962 < _list961.Count; ++_i962)
                  {
                    TDDIAbstractArgumentationElementRef _elem963;
                    _elem963 = new TDDIAbstractArgumentationElementRef();
                    _elem963.Read(iprot);
                    ArgumentationElement.Add(_elem963);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIArgumentGroup");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter964 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter965 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter966 in TaggedValue)
            {
        ...
        if (ArgumentationElement != null && __isset.ArgumentationElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentationElementRef _iter967 in ArgumentationElement)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArgumentGroup(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
