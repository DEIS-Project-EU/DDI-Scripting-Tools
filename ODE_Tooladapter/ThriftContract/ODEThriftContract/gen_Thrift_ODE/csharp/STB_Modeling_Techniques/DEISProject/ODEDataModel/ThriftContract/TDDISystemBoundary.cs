              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem94;
                    _elem94 = new TDDIKeyValueMapRef();
                    _elem94.Read(iprot);
                    KeyValueMaps.Add(_elem94);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractDependabilityRequirementRef _elem97;
                    _elem97 = new TDDIAbstractDependabilityRequirementRef();
                    _elem97.Read(iprot);
                    DependabilityRequirements.Add(_elem97);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIPortRef _elem100;
                    _elem100 = new TDDIPortRef();
                    _elem100.Read(iprot);
                    Ports.Add(_elem100);
                  }
                  iprot.ReadListEnd();
      ...
      try
      {
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter101 in KeyValueMaps)
            {
        ...
        if (DependabilityRequirements != null && __isset.DependabilityRequirements) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractDependabilityRequirementRef _iter102 in DependabilityRequirements)
            {
        ...
        if (Ports != null && __isset.Ports) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIPortRef _iter103 in Ports)
            {
