...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIFTAPropagation : TBase
  {
    private long _Id;
    ...
    private TDDIAbstractFailureAnalysisArtifact _Source;
    private TDDIAbstractFailureAnalysisArtifact _Target;
    ...
    public TDDIAbstractFailureAnalysisArtifact Source
    {
      get
      {
        return _Source;
    ...
    public TDDIAbstractFailureAnalysisArtifact Target
    {
      get
      {
        return _Target;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem598;
                    _elem598 = new TDDIKeyValueMapRef();
                    _elem598.Read(iprot);
                    KeyValueMaps.Add(_elem598);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 8:
              if (field.Type == TType.Struct) {
                Source = new TDDIAbstractFailureAnalysisArtifact();
                Source.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
            ...
            case 9:
              if (field.Type == TType.Struct) {
                Target = new TDDIAbstractFailureAnalysisArtifact();
                Target.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIFTAPropagation");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter599 in KeyValueMaps)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIFTAPropagation(");
      bool __first = true;
      if (__isset.Id) {
      ...
      if (Source != null && __isset.Source) {
        ...
        __first = false;
        __sb.Append("Source: ");
        __sb.Append(Source== null ? "<null>" : Source.ToString());
      }
      if (Target != null && __isset.Target) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
