...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArchitecturePackageInterface : TBase
  {
    private long _Id;
    ...
    private TDDIAbstractArchitecturePackage _Implements;
    ...
    public TDDIAbstractArchitecturePackage Implements
    {
      get
      {
        return _Implements;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem14;
                    _elem14 = new TDDIKeyValueMapRef();
                    _elem14.Read(iprot);
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractDependabilityRequirementRef _elem17;
                    _elem17 = new TDDIAbstractDependabilityRequirementRef();
                    _elem17.Read(iprot);
                    DependabilityRequirements.Add(_elem17);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractDesignArtifactRef _elem20;
                    _elem20 = new TDDIAbstractDesignArtifactRef();
                    _elem20.Read(iprot);
                    DesignArtifacts.Add(_elem20);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 11:
              if (field.Type == TType.Struct) {
                Implements = new TDDIAbstractArchitecturePackage();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIArchitecturePackageInterface");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter21 in KeyValueMaps)
            {
              _iter21.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (DependabilityRequirements != null && __isset.DependabilityRequirements) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractDependabilityRequirementRef _iter22 in DependabilityRequirements)
            {
              _iter22.Write(oprot);
            }
            oprot.WriteListEnd();
        ...
        if (DesignArtifacts != null && __isset.DesignArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractDesignArtifactRef _iter23 in DesignArtifacts)
            {
              _iter23.Write(oprot);
            }
            oprot.WriteListEnd();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArchitecturePackageInterface(");
      bool __first = true;
      if (__isset.Id) {
