...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIBasicEvent : TBase
  {
    private long _Id;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem602;
                    _elem602 = new TDDIKeyValueMapRef();
                    _elem602.Read(iprot);
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIBasicEvent");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter603 in KeyValueMaps)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIBasicEvent(");
      bool __first = true;
      if (__isset.Id) {
