...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIProbabilityDistribution : TBase
  {
    private long _Id;
    ...
    private List<TDDIProbDistParam> _ProbDistParams;
    ...
    public List<TDDIProbDistParam> ProbDistParams
    {
      get
      {
        return _ProbDistParams;
      }
      set
      {
        __isset.ProbDistParams = true;
        this._ProbDistParams = value;
      }
    }
    ...
    public TDDIProbabilityDistribution() {
      ...
      this._ProbDistParams = new List<TDDIProbDistParam>();
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem434;
                    _elem434 = new TDDIKeyValueMapRef();
                    _elem434.Read(iprot);
            ...
            case 9:
              if (field.Type == TType.List) {
                {
                  ProbDistParams = new List<TDDIProbDistParam>();
                  TList _list435 = iprot.ReadListBegin();
                  for( int _i436 = 0; _i436 < _list435.Count; ++_i436)
                  {
                    TDDIProbDistParam _elem437;
                    _elem437 = new TDDIProbDistParam();
                    _elem437.Read(iprot);
                    ProbDistParams.Add(_elem437);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIProbabilityDistribution");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter438 in KeyValueMaps)
            {
        ...
        if (ProbDistParams != null && __isset.ProbDistParams) {
          field.Name = "ProbDistParams";
          field.Type = TType.List;
          field.ID = 9;
          oprot.WriteFieldBegin(field);
          {
            oprot.WriteListBegin(new TList(TType.Struct, ProbDistParams.Count));
            foreach (TDDIProbDistParam _iter439 in ProbDistParams)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIProbabilityDistribution(");
      bool __first = true;
      if (__isset.Id) {
