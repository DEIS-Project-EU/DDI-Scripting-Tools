...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIFailureLogicPackageBinding : TBase
  {
    private long _Id;
    ...
    private List<TDDIAbstractFailureLogicPackageRef> _ParticipantPackages;
    ...
    public List<TDDIAbstractFailureLogicPackageRef> ParticipantPackages
    {
      get
      {
    ...
    public TDDIFailureLogicPackageBinding() {
      ...
      this._ParticipantPackages = new List<TDDIAbstractFailureLogicPackageRef>();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIFailureLogicPackageBinding");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter501 in KeyValueMaps)
            {
        ...
        if (FailureAnalysisArtifacts != null && __isset.FailureAnalysisArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFailureAnalysisArtifact _iter502 in FailureAnalysisArtifacts)
            {
        ...
        if (ParticipantPackages != null && __isset.ParticipantPackages) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFailureLogicPackageRef _iter503 in ParticipantPackages)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIFailureLogicPackageBinding(");
      bool __first = true;
      if (__isset.Id) {
