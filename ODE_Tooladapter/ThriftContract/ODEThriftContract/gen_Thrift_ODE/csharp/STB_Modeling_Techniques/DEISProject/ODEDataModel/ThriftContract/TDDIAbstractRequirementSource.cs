...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  public partial class TDDIAbstractRequirementSource : TBase
  {
    ...
    private TDDIRequirementArtifactUnionType _UsedRequirementSourceType;
    ...
    /// </summary>
    public TDDIRequirementArtifactUnionType UsedRequirementSourceType
    {
      get
      {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              if (field.Type == TType.I32) {
                UsedRequirementSourceType = (TDDIRequirementArtifactUnionType)iprot.ReadI32();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
