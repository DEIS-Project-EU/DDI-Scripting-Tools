              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIImplementationConstraintRef _elem1494;
                    _elem1494 = new TDDIImplementationConstraintRef();
                    _elem1494.Read(iprot);
                    ImplementationConstraint.Add(_elem1494);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem1497;
                    _elem1497 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDITaggedValueRef _elem1500;
                    _elem1500 = new TDDITaggedValueRef();
                    _elem1500.Read(iprot);
                    TaggedValue.Add(_elem1500);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1501 = iprot.ReadListBegin();
                  for( int _i1502 = 0; _i1502 < _list1501.Count; ++_i1502)
                  {
                    TDDIAbstractTerminologyElement _elem1503;
                    _elem1503 = new TDDIAbstractTerminologyElement();
                    _elem1503.Read(iprot);
                    TerminologyElement.Add(_elem1503);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1504 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1505 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1506 in TaggedValue)
            {
        ...
        if (TerminologyElement != null && __isset.TerminologyElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractTerminologyElement _iter1507 in TerminologyElement)
            {
