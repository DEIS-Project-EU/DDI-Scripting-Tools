              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem418;
                    _elem418 = new TDDIKeyValueMapRef();
                    _elem418.Read(iprot);
                    KeyValueMaps.Add(_elem418);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list419 = iprot.ReadListBegin();
                  for( int _i420 = 0; _i420 < _list419.Count; ++_i420)
                  {
                    TDDIAssuranceLevel _elem421;
                    _elem421 = new TDDIAssuranceLevel();
                    _elem421.Read(iprot);
                    AssuranceLevels.Add(_elem421);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
