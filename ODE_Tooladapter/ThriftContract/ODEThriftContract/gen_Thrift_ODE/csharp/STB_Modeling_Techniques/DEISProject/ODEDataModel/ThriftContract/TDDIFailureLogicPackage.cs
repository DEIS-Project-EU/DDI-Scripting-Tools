              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem478;
                    _elem478 = new TDDIKeyValueMapRef();
                    _elem478.Read(iprot);
                    KeyValueMaps.Add(_elem478);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list479 = iprot.ReadListBegin();
                  for( int _i480 = 0; _i480 < _list479.Count; ++_i480)
                  {
                    TDDIAbstractFailureAnalysisArtifact _elem481;
                    _elem481 = new TDDIAbstractFailureAnalysisArtifact();
                    _elem481.Read(iprot);
                    FailureAnalysisArtifacts.Add(_elem481);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter482 in KeyValueMaps)
            {
        ...
        if (FailureAnalysisArtifacts != null && __isset.FailureAnalysisArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFailureAnalysisArtifact _iter483 in FailureAnalysisArtifacts)
            {
