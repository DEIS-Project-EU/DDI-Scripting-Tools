              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem710;
                    _elem710 = new TDDIKeyValueMapRef();
                    _elem710.Read(iprot);
                    KeyValueMaps.Add(_elem710);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractHARAArtifact _elem713;
                    _elem713 = new TDDIAbstractHARAArtifact();
                    _elem713.Read(iprot);
                    HARAArtifacts.Add(_elem713);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter714 in KeyValueMaps)
            {
        ...
        if (HARAArtifacts != null && __isset.HARAArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractHARAArtifact _iter715 in HARAArtifacts)
            {
