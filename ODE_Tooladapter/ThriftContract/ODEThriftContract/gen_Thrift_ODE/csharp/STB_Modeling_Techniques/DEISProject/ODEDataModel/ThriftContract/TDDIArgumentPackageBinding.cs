...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArgumentPackageBinding : TBase
  {
    private string _Gid;
    ...
    private List<TDDIAbstractArgumentPackageRef> _ParticipantPackage;
    ...
    public List<TDDIAbstractArgumentPackageRef> ParticipantPackage
    {
      get
      {
    ...
    public TDDIArgumentPackageBinding() {
      ...
      this._ParticipantPackage = new List<TDDIAbstractArgumentPackageRef>();
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1000 = iprot.ReadListBegin();
                  for( int _i1001 = 0; _i1001 < _list1000.Count; ++_i1001)
                  {
                    TDDIImplementationConstraintRef _elem1002;
                    _elem1002 = new TDDIImplementationConstraintRef();
                    _elem1002.Read(iprot);
                    ImplementationConstraint.Add(_elem1002);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem1005;
                    _elem1005 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i1007 = 0; _i1007 < _list1006.Count; ++_i1007)
                  {
                    TDDITaggedValueRef _elem1008;
                    _elem1008 = new TDDITaggedValueRef();
                    _elem1008.Read(iprot);
                    TaggedValue.Add(_elem1008);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1009 = iprot.ReadListBegin();
                  for( int _i1010 = 0; _i1010 < _list1009.Count; ++_i1010)
                  {
                    TDDIAbstractArgumentationElementRef _elem1011;
                    _elem1011 = new TDDIAbstractArgumentationElementRef();
                    _elem1011.Read(iprot);
                    ArgumentationElement.Add(_elem1011);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 12:
              if (field.Type == TType.List) {
                {
                  ParticipantPackage = new List<TDDIAbstractArgumentPackageRef>();
                  TList _list1012 = iprot.ReadListBegin();
                  for( int _i1013 = 0; _i1013 < _list1012.Count; ++_i1013)
                  {
                    TDDIAbstractArgumentPackageRef _elem1014;
                    _elem1014 = new TDDIAbstractArgumentPackageRef();
                    _elem1014.Read(iprot);
                    ParticipantPackage.Add(_elem1014);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIArgumentPackageBinding");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1015 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1016 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1017 in TaggedValue)
            {
        ...
        if (ArgumentationElement != null && __isset.ArgumentationElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentationElementRef _iter1018 in ArgumentationElement)
            {
        ...
        if (ParticipantPackage != null && __isset.ParticipantPackage) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentPackageRef _iter1019 in ParticipantPackage)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArgumentPackageBinding(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
