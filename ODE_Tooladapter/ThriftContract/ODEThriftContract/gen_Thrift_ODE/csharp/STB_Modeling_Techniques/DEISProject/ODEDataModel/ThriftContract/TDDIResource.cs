...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIResource : TBase
  {
    private string _Gid;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIImplementationConstraintRef _elem1318;
                    _elem1318 = new TDDIImplementationConstraintRef();
                    _elem1318.Read(iprot);
                    ImplementationConstraint.Add(_elem1318);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1319 = iprot.ReadListBegin();
                  for( int _i1320 = 0; _i1320 < _list1319.Count; ++_i1320)
                  {
                    TDDINoteRef _elem1321;
                    _elem1321 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i1323 = 0; _i1323 < _list1322.Count; ++_i1323)
                  {
                    TDDITaggedValueRef _elem1324;
                    _elem1324 = new TDDITaggedValueRef();
                    _elem1324.Read(iprot);
                    TaggedValue.Add(_elem1324);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIPropertyRef _elem1327;
                    _elem1327 = new TDDIPropertyRef();
                    _elem1327.Read(iprot);
                    Property.Add(_elem1327);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIResource");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1328 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1329 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1330 in TaggedValue)
            {
        ...
        if (Property != null && __isset.Property) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIPropertyRef _iter1331 in Property)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIResource(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
