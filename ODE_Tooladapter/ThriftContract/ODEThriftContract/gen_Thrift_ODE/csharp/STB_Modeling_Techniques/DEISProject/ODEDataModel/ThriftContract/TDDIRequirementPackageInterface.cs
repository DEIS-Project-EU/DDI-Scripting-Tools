...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIRequirementPackageInterface : TBase
  {
    private long _Id;
    ...
    private TDDIAbstractRequirementPackage _Implements;
    ...
    public TDDIAbstractRequirementPackage Implements
    {
      get
      {
        return _Implements;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list892 = iprot.ReadListBegin();
                  for( int _i893 = 0; _i893 < _list892.Count; ++_i893)
                  {
                    TDDIKeyValueMapRef _elem894;
                    _elem894 = new TDDIKeyValueMapRef();
                    _elem894.Read(iprot);
                    KeyValueMaps.Add(_elem894);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list895 = iprot.ReadListBegin();
                  for( int _i896 = 0; _i896 < _list895.Count; ++_i896)
                  {
                    TDDIAbstractRequirementArtifactRef _elem897;
                    _elem897 = new TDDIAbstractRequirementArtifactRef();
                    _elem897.Read(iprot);
                    RequirementArtifacts.Add(_elem897);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 9:
              if (field.Type == TType.Struct) {
                Implements = new TDDIAbstractRequirementPackage();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIRequirementPackageInterface");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter898 in KeyValueMaps)
            {
        ...
        if (RequirementArtifacts != null && __isset.RequirementArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractRequirementArtifactRef _iter899 in RequirementArtifacts)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIRequirementPackageInterface(");
      bool __first = true;
      if (__isset.Id) {
