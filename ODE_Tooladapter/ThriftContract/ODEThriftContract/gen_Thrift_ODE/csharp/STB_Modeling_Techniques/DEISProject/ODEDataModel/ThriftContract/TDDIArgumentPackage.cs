...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArgumentPackage : TBase
  {
    private string _Gid;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list968 = iprot.ReadListBegin();
                  for( int _i969 = 0; _i969 < _list968.Count; ++_i969)
                  {
                    TDDIImplementationConstraintRef _elem970;
                    _elem970 = new TDDIImplementationConstraintRef();
                    _elem970.Read(iprot);
                    ImplementationConstraint.Add(_elem970);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDINoteRef _elem973;
                    _elem973 = new TDDINoteRef();
                    _elem973.Read(iprot);
                    Note.Add(_elem973);
                  }
                  iprot.ReadListEnd();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDITaggedValueRef _elem976;
                    _elem976 = new TDDITaggedValueRef();
                    _elem976.Read(iprot);
                    TaggedValue.Add(_elem976);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list977 = iprot.ReadListBegin();
                  for( int _i978 = 0; _i978 < _list977.Count; ++_i978)
                  {
                    TDDIAbstractArgumentationElementRef _elem979;
                    _elem979 = new TDDIAbstractArgumentationElementRef();
                    _elem979.Read(iprot);
                    ArgumentationElement.Add(_elem979);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIArgumentPackage");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter980 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter981 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter982 in TaggedValue)
            {
        ...
        if (ArgumentationElement != null && __isset.ArgumentationElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArgumentationElementRef _iter983 in ArgumentationElement)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArgumentPackage(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
