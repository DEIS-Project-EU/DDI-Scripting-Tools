...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArtifactGroup : TBase
  {
    private string _Gid;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1220 = iprot.ReadListBegin();
                  for( int _i1221 = 0; _i1221 < _list1220.Count; ++_i1221)
                  {
                    TDDIImplementationConstraintRef _elem1222;
                    _elem1222 = new TDDIImplementationConstraintRef();
                    _elem1222.Read(iprot);
                    ImplementationConstraint.Add(_elem1222);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1223 = iprot.ReadListBegin();
                  for( int _i1224 = 0; _i1224 < _list1223.Count; ++_i1224)
                  {
                    TDDINoteRef _elem1225;
                    _elem1225 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  for( int _i1227 = 0; _i1227 < _list1226.Count; ++_i1227)
                  {
                    TDDITaggedValueRef _elem1228;
                    _elem1228 = new TDDITaggedValueRef();
                    _elem1228.Read(iprot);
                    TaggedValue.Add(_elem1228);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractArtifactElementRef _elem1231;
                    _elem1231 = new TDDIAbstractArtifactElementRef();
                    _elem1231.Read(iprot);
                    ArtifactElement.Add(_elem1231);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIArtifactGroup");
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1232 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1233 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1234 in TaggedValue)
            {
        ...
        if (ArtifactElement != null && __isset.ArtifactElement) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractArtifactElementRef _iter1235 in ArtifactElement)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArtifactGroup(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
