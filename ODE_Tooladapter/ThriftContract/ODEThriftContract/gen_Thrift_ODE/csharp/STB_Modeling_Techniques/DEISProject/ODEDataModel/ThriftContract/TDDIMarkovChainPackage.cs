...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIMarkovChainPackage : TBase
  {
    private long _Id;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIMarkovChainPackage");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter840 in KeyValueMaps)
            {
        ...
        if (FailureAnalysisArtifacts != null && __isset.FailureAnalysisArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFailureAnalysisArtifactRef _iter841 in FailureAnalysisArtifacts)
            {
        ...
        if (MarkovArtifacts != null && __isset.MarkovArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractMarkovArtifact _iter842 in MarkovArtifacts)
            {
        ...
        if (FailStates != null && __isset.FailStates) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIFailState _iter843 in FailStates)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIMarkovChainPackage(");
      bool __first = true;
      if (__isset.Id) {
