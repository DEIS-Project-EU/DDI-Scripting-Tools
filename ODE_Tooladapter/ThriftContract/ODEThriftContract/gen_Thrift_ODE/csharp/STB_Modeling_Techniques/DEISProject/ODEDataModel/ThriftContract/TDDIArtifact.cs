...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIArtifact : TBase
  {
    private string _Gid;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIImplementationConstraintRef _elem1334;
                    _elem1334 = new TDDIImplementationConstraintRef();
                    _elem1334.Read(iprot);
                    ImplementationConstraint.Add(_elem1334);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1335 = iprot.ReadListBegin();
                  for( int _i1336 = 0; _i1336 < _list1335.Count; ++_i1336)
                  {
                    TDDINoteRef _elem1337;
                    _elem1337 = new TDDINoteRef();
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list1338 = iprot.ReadListBegin();
                  for( int _i1339 = 0; _i1339 < _list1338.Count; ++_i1339)
                  {
                    TDDITaggedValueRef _elem1340;
                    _elem1340 = new TDDITaggedValueRef();
                    _elem1340.Read(iprot);
                    TaggedValue.Add(_elem1340);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIPropertyRef _elem1343;
                    _elem1343 = new TDDIPropertyRef();
                    _elem1343.Read(iprot);
                    Property.Add(_elem1343);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
      ...
      try
      {
        ...
        if (ImplementationConstraint != null && __isset.ImplementationConstraint) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIImplementationConstraintRef _iter1344 in ImplementationConstraint)
            {
        ...
        if (Note != null && __isset.Note) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDINoteRef _iter1345 in Note)
            {
        ...
        if (TaggedValue != null && __isset.TaggedValue) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDITaggedValueRef _iter1346 in TaggedValue)
            {
        ...
        if (Property != null && __isset.Property) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIPropertyRef _iter1347 in Property)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIArtifact(");
      bool __first = true;
      if (Gid != null && __isset.Gid) {
