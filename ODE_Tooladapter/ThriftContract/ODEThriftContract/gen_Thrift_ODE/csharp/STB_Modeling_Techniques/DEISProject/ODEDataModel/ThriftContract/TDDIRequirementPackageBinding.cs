...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIRequirementPackageBinding : TBase
  {
    private long _Id;
    ...
    private List<TDDIAbstractRequirementPackageRef> _ParticipantPackages;
    ...
    public List<TDDIAbstractRequirementPackageRef> ParticipantPackages
    {
      get
      {
    ...
    public TDDIRequirementPackageBinding() {
      ...
      this._ParticipantPackages = new List<TDDIAbstractRequirementPackageRef>();
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem902;
                    _elem902 = new TDDIKeyValueMapRef();
                    _elem902.Read(iprot);
                    KeyValueMaps.Add(_elem902);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractRequirementArtifactRef _elem905;
                    _elem905 = new TDDIAbstractRequirementArtifactRef();
                    _elem905.Read(iprot);
                    RequirementArtifacts.Add(_elem905);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 9:
              if (field.Type == TType.List) {
                {
                  ParticipantPackages = new List<TDDIAbstractRequirementPackageRef>();
                  TList _list906 = iprot.ReadListBegin();
                  for( int _i907 = 0; _i907 < _list906.Count; ++_i907)
                  {
                    TDDIAbstractRequirementPackageRef _elem908;
                    _elem908 = new TDDIAbstractRequirementPackageRef();
                    _elem908.Read(iprot);
                    ParticipantPackages.Add(_elem908);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIRequirementPackageBinding");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter909 in KeyValueMaps)
            {
        ...
        if (RequirementArtifacts != null && __isset.RequirementArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractRequirementArtifactRef _iter910 in RequirementArtifacts)
            {
        ...
        if (ParticipantPackages != null && __isset.ParticipantPackages) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractRequirementPackageRef _iter911 in ParticipantPackages)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIRequirementPackageBinding(");
      bool __first = true;
      if (__isset.Id) {
