...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIFMEAPackageBinding : TBase
  {
    private long _Id;
    ...
    private List<TDDIAbstractFMEAPackageRef> _ParticipantPackages;
    ...
    public List<TDDIAbstractFMEAPackageRef> ParticipantPackages
    {
      get
      {
    ...
    public TDDIFMEAPackageBinding() {
      ...
      this._ParticipantPackages = new List<TDDIAbstractFMEAPackageRef>();
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem530;
                    _elem530 = new TDDIKeyValueMapRef();
                    _elem530.Read(iprot);
                    KeyValueMaps.Add(_elem530);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list531 = iprot.ReadListBegin();
                  for( int _i532 = 0; _i532 < _list531.Count; ++_i532)
                  {
                    TDDIAbstractFailureAnalysisArtifactRef _elem533;
                    _elem533 = new TDDIAbstractFailureAnalysisArtifactRef();
                    _elem533.Read(iprot);
                    FailureAnalysisArtifacts.Add(_elem533);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  TList _list534 = iprot.ReadListBegin();
                  for( int _i535 = 0; _i535 < _list534.Count; ++_i535)
                  {
                    TDDIAbstractFMEAArtifactRef _elem536;
                    _elem536 = new TDDIAbstractFMEAArtifactRef();
                    _elem536.Read(iprot);
                    FMEAArtifacts.Add(_elem536);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 11:
              if (field.Type == TType.List) {
                {
                  ParticipantPackages = new List<TDDIAbstractFMEAPackageRef>();
                  TList _list537 = iprot.ReadListBegin();
                  for( int _i538 = 0; _i538 < _list537.Count; ++_i538)
                  {
                    TDDIAbstractFMEAPackageRef _elem539;
                    _elem539 = new TDDIAbstractFMEAPackageRef();
                    _elem539.Read(iprot);
                    ParticipantPackages.Add(_elem539);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIFMEAPackageBinding");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter540 in KeyValueMaps)
            {
        ...
        if (FailureAnalysisArtifacts != null && __isset.FailureAnalysisArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFailureAnalysisArtifactRef _iter541 in FailureAnalysisArtifacts)
            {
        ...
        if (FMEAArtifacts != null && __isset.FMEAArtifacts) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFMEAArtifactRef _iter542 in FMEAArtifacts)
            {
        ...
        if (ParticipantPackages != null && __isset.ParticipantPackages) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIAbstractFMEAPackageRef _iter543 in ParticipantPackages)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIFMEAPackageBinding(");
      bool __first = true;
      if (__isset.Id) {
