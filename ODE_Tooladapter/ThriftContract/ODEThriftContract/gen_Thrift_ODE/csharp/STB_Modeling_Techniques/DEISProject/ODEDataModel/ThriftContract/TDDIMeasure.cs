...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  [Serializable]
  #endif
  public partial class TDDIMeasure : TBase
  {
    private long _Id;
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem370;
                    _elem370 = new TDDIKeyValueMapRef();
                    _elem370.Read(iprot);
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TDDIMeasure");
        ...
        if (KeyValueMaps != null && __isset.KeyValueMaps) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (TDDIKeyValueMapRef _iter371 in KeyValueMaps)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TDDIMeasure(");
      bool __first = true;
      if (__isset.Id) {
