...
namespace STB_Modeling_Techniques.DEISProject.ODEDataModel.ThriftContract
{
  ...
  public partial class TDDILifecycleCondition : TBase
  {
    ...
    private List<TDDILifecycleConditionRef> _Conditions;
    ...
    public List<TDDILifecycleConditionRef> Conditions
    {
      get
      {
        return _Conditions;
    ...
    public TDDILifecycleCondition() {
      ...
      this._Conditions = new List<TDDILifecycleConditionRef>();
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIKeyValueMapRef _elem226;
                    _elem226 = new TDDIKeyValueMapRef();
                    _elem226.Read(iprot);
                    KeyValueMaps.Add(_elem226);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    TDDIAbstractDependabilityRequirementRef _elem229;
                    _elem229 = new TDDIAbstractDependabilityRequirementRef();
                    _elem229.Read(iprot);
                    DependabilityRequirements.Add(_elem229);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
            ...
            case 11:
              if (field.Type == TType.List) {
                {
                  Conditions = new List<TDDILifecycleConditionRef>();
                  TList _list230 = iprot.ReadListBegin();
                  for( int _i231 = 0; _i231 < _list230.Count; ++_i231)
                  {
                    TDDILifecycleConditionRef _elem232;
                    _elem232 = new TDDILifecycleConditionRef();
                    _elem232.Read(iprot);
                    Conditions.Add(_elem232);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
