...
public class TTransition implements IBaseElement {

	private TDDITransition thriftElement;
	
	private TTransition(TDDITransition thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TTransition wrap(TDDITransition tDDITransition) {
		return new TTransition(tDDITransition);
	}
	
	public TDDITransition unwrap() {
