...
public class TFMEA implements IFailureModel {

	private TDDIFMEA thriftElement;

	private TFMEA(TDDIFMEA thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TFMEA wrap(TDDIFMEA tDDIFMEA) {
		return new TFMEA(tDDIFMEA);
	}
	
	public TDDIFMEA unwrap() {
