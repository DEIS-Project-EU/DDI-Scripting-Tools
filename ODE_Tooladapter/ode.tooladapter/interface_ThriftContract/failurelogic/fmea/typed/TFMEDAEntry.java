...
public class TFMEDAEntry implements IFMEAEntry {

	private TDDIFMEDAEntry thriftElement;

	private TFMEDAEntry(TDDIFMEDAEntry thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TFMEDAEntry wrap(TDDIFMEDAEntry tDDIFMEDAEntry) {
		return new TFMEDAEntry(tDDIFMEDAEntry);
	}
	
	public TDDIFMEDAEntry unwrap() {
