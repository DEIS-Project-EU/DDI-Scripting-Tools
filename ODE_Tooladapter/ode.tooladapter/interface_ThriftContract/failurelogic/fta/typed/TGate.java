...
public class TGate implements ICause {

	private TDDIGate thriftElement;

	private TGate(TDDIGate thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TGate wrap(TDDIGate tDDIGate) {
		return new TGate(tDDIGate);
	}
	
	public TDDIGate unwrap() {
