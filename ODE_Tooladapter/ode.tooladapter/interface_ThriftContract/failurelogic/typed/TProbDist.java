...
public class TProbDist implements IBaseElement {

	private TDDIProbDist thriftElement;

	private TProbDist(TDDIProbDist thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TProbDist wrap(TDDIProbDist tDDIProbDist) {
		return new TProbDist(tDDIProbDist);
	}
	
	public TDDIProbDist unwrap() {
