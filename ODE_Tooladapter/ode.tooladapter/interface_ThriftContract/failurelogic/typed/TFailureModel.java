...
public class TFailureModel implements IFailureModel {

	private TDDIFailureModel thriftElement;

	private TFailureModel(TDDIFailureModel thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TFailureModel wrap(TDDIFailureModel tDDIFailureModel) {
		return new TFailureModel(tDDIFailureModel);
	}
	
	public TDDIFailureModel unwrap() {
