...
public class TLogicalComponent implements ISystem {
	private TDDILogicalComponent thriftElement;
	
	private TLogicalComponent(TDDILogicalComponent thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TLogicalComponent wrap(TDDILogicalComponent thriftElement) {
		return new TLogicalComponent(thriftElement);
	}
	
	public TDDILogicalComponent unwrap() {
