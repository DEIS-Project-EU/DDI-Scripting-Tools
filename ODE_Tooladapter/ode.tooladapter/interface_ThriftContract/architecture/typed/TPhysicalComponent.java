...
public class TPhysicalComponent implements ISystem {
	private TDDIPhysicalComponent thriftElement;
	
	private TPhysicalComponent(TDDIPhysicalComponent thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TPhysicalComponent wrap(TDDIPhysicalComponent thriftElement) {
		return new TPhysicalComponent(thriftElement);
	}
	
	public TDDIPhysicalComponent unwrap() {
