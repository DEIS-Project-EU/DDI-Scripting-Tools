...
public class TFunction implements IFunction {
	private TDDIFunction thriftElement;
	
	private TFunction(TDDIFunction thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TFunction wrap(TDDIFunction thriftElement) {
		return new TFunction(thriftElement);
	}
	
	public TDDIFunction unwrap() {
