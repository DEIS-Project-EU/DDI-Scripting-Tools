...
public class TSignal implements IBaseElement {
private TDDISignal thriftElement;
	
	private TSignal(TDDISignal thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TSignal wrap(TDDISignal thriftElement) {
		return new TSignal(thriftElement);
	}
	
	public TDDISignal unwrap() {
