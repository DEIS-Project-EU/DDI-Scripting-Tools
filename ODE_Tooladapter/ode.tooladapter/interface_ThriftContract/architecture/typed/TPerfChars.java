...
public class TPerfChars implements IBaseElement {
private TDDIPerfChars thriftElement;
	
	private TPerfChars(TDDIPerfChars thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TPerfChars wrap(TDDIPerfChars thriftElement) {
		return new TPerfChars(thriftElement);
	}
	
	public TDDIPerfChars unwrap() {
