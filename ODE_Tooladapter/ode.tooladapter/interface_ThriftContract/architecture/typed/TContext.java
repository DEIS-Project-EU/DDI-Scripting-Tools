...
public class TContext implements IBaseElement {
	private TDDIContext thriftElement;
	
	private TContext(TDDIContext thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TContext wrap(TDDIContext thriftElement) {
		return new TContext(thriftElement);
	}
	
	public TDDIContext unwrap() {
