...
public class TConfiguration implements IBaseElement {

	private TDDIConfiguration thriftElement;
	
	private TConfiguration(TDDIConfiguration thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TConfiguration wrap(TDDIConfiguration thriftElement) {
		return new TConfiguration(thriftElement);
	}
	
	public TDDIConfiguration unwrap() {
