...
public class TSystem implements ISystem {
	private TDDISystem thriftElement;
	
	private TSystem(TDDISystem thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TSystem wrap(TDDISystem thriftElement) {
		return new TSystem(thriftElement);
	}
	
	public TDDISystem unwrap() {
