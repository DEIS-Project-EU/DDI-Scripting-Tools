...
public class TPort implements IBaseElement {
private TDDIPort thriftElement;
	
	private TPort(TDDIPort thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TPort wrap(TDDIPort thriftElement) {
		return new TPort(thriftElement);
	}
	
	public TDDIPort unwrap() {
