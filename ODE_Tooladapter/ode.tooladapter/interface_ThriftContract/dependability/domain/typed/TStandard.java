...
public class TStandard implements IStandard {
	private TDDIStandard thriftElement;
	
	private TStandard(TDDIStandard thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TStandard wrap(TDDIStandard thriftElement) {
		return new TStandard(thriftElement);
	}
	
	public TDDIStandard unwrap() {
