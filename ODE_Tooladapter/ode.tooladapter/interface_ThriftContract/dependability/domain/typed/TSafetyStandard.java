...
public class TSafetyStandard implements IStandard {

	private TDDISafetyStandard thriftElement;
	
	private TSafetyStandard(TDDISafetyStandard thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TSafetyStandard wrap(TDDISafetyStandard tDDISafetyStandard) {
		return new TSafetyStandard(tDDISafetyStandard);
	}
	
	public TDDISafetyStandard unwrap() {
