...
public class TMeasure implements IMeasure {

	private TDDIMeasure thriftElement;
	
	private TMeasure(TDDIMeasure thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TMeasure wrap(TDDIMeasure thriftElement) {
		return new TMeasure(thriftElement);
	}
	
	public TDDIMeasure unwrap() {
