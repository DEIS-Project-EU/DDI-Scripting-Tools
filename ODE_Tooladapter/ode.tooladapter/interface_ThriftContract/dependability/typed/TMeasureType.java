...
public class TMeasureType implements IBaseElement {

	private TDDIMeasureType thriftElement;
	
	private TMeasureType(TDDIMeasureType thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TMeasureType wrap(TDDIMeasureType thriftElement) {
		return new TMeasureType(thriftElement);
	}
	
	public TDDIMeasureType unwrap() {
