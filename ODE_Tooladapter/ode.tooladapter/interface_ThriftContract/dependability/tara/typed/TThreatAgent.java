...
public class TThreatAgent implements IThreatAgent {

	private TDDIThreatAgent thriftElement;
	
	private TThreatAgent(TDDIThreatAgent thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TThreatAgent wrap(TDDIThreatAgent thriftElement) {
		return new TThreatAgent(thriftElement);
	}
	
	public TDDIThreatAgent unwrap() {
