...
public class TAction implements IAttack {

	private TDDIAction thriftElement;
	
	private TAction(TDDIAction thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TAction wrap(TDDIAction thriftElement) {
		return new TAction(thriftElement);
	}
	
	public TDDIAction unwrap() {
