...
public class TNonHuman implements IThreatAgent {

	private TDDINonHuman thriftElement;
	
	private TNonHuman(TDDINonHuman thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TNonHuman wrap(TDDINonHuman thriftElement) {
		return new TNonHuman(thriftElement);
	}
	
	public TDDINonHuman unwrap() {
