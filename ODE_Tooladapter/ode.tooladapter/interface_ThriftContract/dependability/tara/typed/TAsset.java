...
public class TAsset implements IAsset {

	private TDDIAsset thriftElement;
	
	private TAsset(TDDIAsset thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TAsset wrap(TDDIAsset thriftElement) {
		return new TAsset(thriftElement);
	}
	
	public TDDIAsset unwrap() {
