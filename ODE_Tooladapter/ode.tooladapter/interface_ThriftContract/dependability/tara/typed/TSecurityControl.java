...
public class TSecurityControl implements IMeasure {

	private TDDISecurityControl thriftElement;
	
	private TSecurityControl(TDDISecurityControl thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TSecurityControl wrap(TDDISecurityControl thriftElement) {
		return new TSecurityControl(thriftElement);
	}
	
	public TDDISecurityControl unwrap() {
