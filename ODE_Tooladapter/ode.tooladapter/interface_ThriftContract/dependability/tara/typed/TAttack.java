...
public class TAttack implements IAttack {

	private TDDIAttack thriftElement;
	
	private TAttack(TDDIAttack thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TAttack wrap(TDDIAttack thriftElement) {
		return new TAttack(thriftElement);
	}
	
	public TDDIAttack unwrap() {
