...
public class TLegalContract implements IRequirementSource {

	private TDDILegalContract thriftElement;
	
	private TLegalContract(TDDILegalContract thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TLegalContract wrap(TDDILegalContract thriftElement) {
		return new TLegalContract(thriftElement);
	}
	
	public TDDILegalContract unwrap() {
