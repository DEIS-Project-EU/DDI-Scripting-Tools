...
public class TSafetyRequirement implements IDependabilityRequirement {
	private TDDISafetyRequirement thriftElement;
	
	private TSafetyRequirement(TDDISafetyRequirement thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TSafetyRequirement wrap(TDDISafetyRequirement thriftElement) {
		return new TSafetyRequirement(thriftElement);
	}
	
	public TDDISafetyRequirement unwrap() {
