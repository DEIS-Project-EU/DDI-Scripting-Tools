...
public class THazardTypeSystem implements IBaseElement {

	private TDDIHazardTypeSystem thriftElement;
	
	private THazardTypeSystem(TDDIHazardTypeSystem thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static THazardTypeSystem wrap(TDDIHazardTypeSystem thriftElement) {
		return new THazardTypeSystem(thriftElement);
	}
	
	public TDDIHazardTypeSystem unwrap() {
