...
public class TMalfunction implements IBaseElement {
	private TDDIMalfunction thriftElement;
	
	private TMalfunction(TDDIMalfunction thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TMalfunction wrap(TDDIMalfunction thriftElement) {
		return new TMalfunction(thriftElement);
	}
	
	public TDDIMalfunction unwrap() {
