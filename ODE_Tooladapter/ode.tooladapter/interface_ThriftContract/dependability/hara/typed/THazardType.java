...
public class THazardType implements IBaseElement {

	private TDDIHazardType thriftElement;
	
	private THazardType(TDDIHazardType thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static THazardType wrap(TDDIHazardType thriftElement) {
		return new THazardType(thriftElement);
	}
	
	public TDDIHazardType unwrap() {
