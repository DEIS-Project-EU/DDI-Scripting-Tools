...
public class TOperatorMeasure implements IRiskParameter {

	private TDDIOperatorMeasure thriftElement;
	
	private TOperatorMeasure(TDDIOperatorMeasure thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TOperatorMeasure wrap(TDDIOperatorMeasure thriftElement) {
		return new TOperatorMeasure(thriftElement);
	}
	
	public TDDIOperatorMeasure unwrap() {
