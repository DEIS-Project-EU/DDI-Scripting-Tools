...
public class TArgumentGroup implements IArgumentationElement {
	private TDDIArgumentGroup thriftElement;
	
	private TArgumentGroup(TDDIArgumentGroup thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TArgumentGroup wrap(TDDIArgumentGroup thriftElement) {
		return new TArgumentGroup(thriftElement);
	}
	
	public TDDIArgumentGroup unwrap() {
