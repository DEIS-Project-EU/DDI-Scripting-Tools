...
public class TArgumentPackageInterface implements IArgumentPackage {

	TDDIArgumentPackageInterface thriftElement;
	
	public TArgumentPackageInterface(TDDIArgumentPackageInterface thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TArgumentPackageInterface wrap(TDDIArgumentPackageInterface thriftElement) {
		return new TArgumentPackageInterface(thriftElement);
	}
