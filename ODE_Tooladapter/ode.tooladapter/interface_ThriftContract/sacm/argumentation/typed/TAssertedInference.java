...
public class TAssertedInference implements IAssertedRelationship {
private TDDIAssertedInference thriftElement;
	
	private TAssertedInference(TDDIAssertedInference thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TAssertedInference wrap(TDDIAssertedInference thriftElement) {
		return new TAssertedInference(thriftElement);
	}
	
	public TDDIAssertedInference unwrap() {
