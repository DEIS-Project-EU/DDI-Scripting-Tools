...
public class TArgumentReasoning implements IArgumentAsset {
private TDDIArgumentReasoning thriftElement;
	
	private TArgumentReasoning(TDDIArgumentReasoning thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TArgumentReasoning wrap(TDDIArgumentReasoning thriftElement) {
		return new TArgumentReasoning(thriftElement);
	}
	
	public TDDIArgumentReasoning unwrap() {
