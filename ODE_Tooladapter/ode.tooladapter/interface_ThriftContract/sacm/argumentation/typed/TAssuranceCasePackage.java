...
public class TAssuranceCasePackage implements IModelElement {
	private TDDIAssuranceCasePackage thriftElement;
	
	private TAssuranceCasePackage(TDDIAssuranceCasePackage thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TAssuranceCasePackage wrap(TDDIAssuranceCasePackage thriftElement) {
		return new TAssuranceCasePackage(thriftElement);
	}
	
	public TDDIAssuranceCasePackage unwrap() {
