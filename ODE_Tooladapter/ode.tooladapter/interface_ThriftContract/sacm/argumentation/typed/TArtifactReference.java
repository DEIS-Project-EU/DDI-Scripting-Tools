...
public class TArtifactReference implements IArgumentAsset {
	private TDDIArtifactReference thriftElement;
	
	private TArtifactReference(TDDIArtifactReference thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TArtifactReference wrap(TDDIArtifactReference thriftElement) {
		return new TArtifactReference(thriftElement);
	}
	
	public TDDIArtifactReference unwrap() {
