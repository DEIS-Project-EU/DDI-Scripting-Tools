...
public class TAssertedContext  implements IAssertedRelationship {
	private TDDIAssertedContext thriftElement;
	
	private TAssertedContext(TDDIAssertedContext thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TAssertedContext wrap(TDDIAssertedContext thriftElement) {
		return new TAssertedContext(thriftElement);
	}
	
	public TDDIAssertedContext unwrap() {
