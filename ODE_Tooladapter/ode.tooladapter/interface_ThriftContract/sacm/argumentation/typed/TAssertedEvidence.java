...
public class TAssertedEvidence implements IAssertedRelationship {
	private TDDIAssertedEvidence thriftElement;
	
	private TAssertedEvidence(TDDIAssertedEvidence thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TAssertedEvidence wrap(TDDIAssertedEvidence thriftElement) {
		return new TAssertedEvidence(thriftElement);
	}
	
	public TDDIAssertedEvidence unwrap() {
