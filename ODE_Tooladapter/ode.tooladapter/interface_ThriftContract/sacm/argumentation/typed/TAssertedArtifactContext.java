...
public class TAssertedArtifactContext implements IAssertedRelationship {
	private TDDIAssertedArtifactContext thriftElement;
	
	private TAssertedArtifactContext(TDDIAssertedArtifactContext thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TAssertedArtifactContext wrap(TDDIAssertedArtifactContext thriftElement) {
		return new TAssertedArtifactContext(thriftElement);
	}
	
	public TDDIAssertedArtifactContext unwrap() {
