...
public class TArgumentPackage implements IArgumentPackage {

	private TDDIArgumentPackage thriftElement;
	
	private TArgumentPackage(TDDIArgumentPackage thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TArgumentPackage wrap(TDDIArgumentPackage thriftElement) {
		return new TArgumentPackage(thriftElement);
	}
	
	public TDDIArgumentPackage unwrap() {
