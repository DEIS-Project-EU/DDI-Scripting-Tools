...
public class TClaim implements IAssertion {
private TDDIClaim thriftElement;
	
	private TClaim(TDDIClaim thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TClaim wrap(TDDIClaim thriftElement) {
		return new TClaim(thriftElement);
	}
	
	public TDDIClaim unwrap() {
