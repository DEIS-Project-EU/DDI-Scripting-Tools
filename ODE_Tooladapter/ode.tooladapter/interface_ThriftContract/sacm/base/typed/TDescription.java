...
public class TDescription implements IUtilityElement{

	private TDDIDescription thriftElement;
	
	private TDescription(TDDIDescription thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TDescription wrap(TDDIDescription thriftElement) {
		return new TDescription(thriftElement);
	}
	
	public TDDIDescription unwrap() {
