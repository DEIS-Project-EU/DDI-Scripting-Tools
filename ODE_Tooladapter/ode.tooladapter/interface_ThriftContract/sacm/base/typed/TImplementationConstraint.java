...
public class TImplementationConstraint implements IUtilityElement{

	private TDDIImplementationConstraint thriftElement;
	
	private TImplementationConstraint(TDDIImplementationConstraint thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TImplementationConstraint wrap(TDDIImplementationConstraint thriftElement) {
		return new TImplementationConstraint(thriftElement);
	}
	
	public TDDIImplementationConstraint unwrap() {
