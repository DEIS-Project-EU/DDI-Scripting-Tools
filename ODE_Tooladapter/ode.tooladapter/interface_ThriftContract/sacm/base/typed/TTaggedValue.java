...
public class TTaggedValue implements IUtilityElement{

	private TDDITaggedValue thriftElement;
	
	private TTaggedValue(TDDITaggedValue thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TTaggedValue wrap(TDDITaggedValue thriftElement) {
		return new TTaggedValue(thriftElement);
	}
	
	public TDDITaggedValue unwrap() {
