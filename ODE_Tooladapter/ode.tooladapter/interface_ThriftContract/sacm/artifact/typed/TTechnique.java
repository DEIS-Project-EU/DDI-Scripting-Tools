...
public class TTechnique implements IArtifactAsset{

	TDDITechnique thriftElement;
	
	public TTechnique(TDDITechnique thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TTechnique wrap(TDDITechnique thriftElement) {
		return new TTechnique(thriftElement);
	}
