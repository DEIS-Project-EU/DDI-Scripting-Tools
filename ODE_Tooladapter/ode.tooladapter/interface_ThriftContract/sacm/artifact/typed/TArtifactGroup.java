...
public class TArtifactGroup implements IArtifactElement {

	TDDIArtifactGroup thriftElement;
	
	public TArtifactGroup(TDDIArtifactGroup thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TArtifactGroup wrap(TDDIArtifactGroup thriftElement) {
		return new TArtifactGroup(thriftElement);
	}
