...
public class TArtifactPackageInterface implements IArtifactPackage {

	TDDIArtifactPackageInterface thriftElement;
	
	public TArtifactPackageInterface(TDDIArtifactPackageInterface thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TArtifactPackageInterface wrap(TDDIArtifactPackageInterface thriftElement) {
		return new TArtifactPackageInterface(thriftElement);
	}
