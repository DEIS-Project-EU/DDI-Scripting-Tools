...
public class TParticipant implements IArtifactAsset{

	TDDIParticipant thriftElement;
	
	public TParticipant(TDDIParticipant thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TParticipant wrap(TDDIParticipant thriftElement) {
		return new TParticipant(thriftElement);
	}
