...
public class TProperty implements IArtifactAsset{

	TDDIProperty thriftElement;
	
	public TProperty(TDDIProperty thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TProperty wrap(TDDIProperty thriftElement) {
		return new TProperty(thriftElement);
	}
