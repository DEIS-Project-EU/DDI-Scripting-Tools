...
public class TArtifactPackageBinding implements IArtifactPackage{

	TDDIArtifactPackageBinding thriftElement;
	
	public TArtifactPackageBinding(TDDIArtifactPackageBinding thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TArtifactPackageBinding wrap(TDDIArtifactPackageBinding thriftElement) {
		return new TArtifactPackageBinding(thriftElement);
	}
