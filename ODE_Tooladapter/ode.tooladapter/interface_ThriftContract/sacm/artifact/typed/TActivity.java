...
public class TActivity implements IArtifactAsset {

	TDDIActivity thriftElement;
	
	public TActivity(TDDIActivity thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TActivity wrap(TDDIActivity thriftElement) {
		return new TActivity(thriftElement);
	}
