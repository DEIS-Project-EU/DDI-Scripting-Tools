...
public class TArtifact implements IArtifactAsset {

	TDDIArtifact thriftElement;
	
	public TArtifact(TDDIArtifact thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TArtifact wrap(TDDIArtifact thriftElement) {
		return new TArtifact(thriftElement);
	}
