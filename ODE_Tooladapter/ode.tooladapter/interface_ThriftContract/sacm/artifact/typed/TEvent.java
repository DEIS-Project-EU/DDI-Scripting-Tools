...
public class TEvent implements IArtifactAsset {

	TDDIEvent thriftElement;
	
	public TEvent(TDDIEvent thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TEvent wrap(TDDIEvent thriftElement) {
		return new TEvent(thriftElement);
	}
