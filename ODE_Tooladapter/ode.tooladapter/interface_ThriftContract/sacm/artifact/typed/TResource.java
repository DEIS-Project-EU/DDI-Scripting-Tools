...
public class TResource implements IArtifactAsset{
	
	TDDIResource thriftElement;
	
	public TResource(TDDIResource thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TResource wrap(TDDIResource thriftElement) {
		return new TResource(thriftElement);
	}
