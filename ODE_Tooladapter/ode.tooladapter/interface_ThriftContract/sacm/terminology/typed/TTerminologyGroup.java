...
public class TTerminologyGroup implements ITerminologyElement {

	TDDITerminologyGroup thriftElement;
	
	public TTerminologyGroup(TDDITerminologyGroup thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TTerminologyGroup wrap(TDDITerminologyGroup thriftElement) {
		return new TTerminologyGroup(thriftElement);
	}
