...
public class TTerm implements IExpressionElement{

	TDDITerm thriftElement;
	
	public TTerm(TDDITerm thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TTerm wrap(TDDITerm thriftElement) {
		return new TTerm(thriftElement);
	}
	...
	public void addToCategory(TDDICategoryRef value) {
		...
		thriftElement.addToCategory(value);
	}
