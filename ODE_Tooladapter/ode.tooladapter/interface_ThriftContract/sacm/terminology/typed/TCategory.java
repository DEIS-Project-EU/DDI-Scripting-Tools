...
public class TCategory implements ITerminologyAsset{

	TDDICategory thriftElement;
	
	public TCategory(TDDICategory thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TCategory wrap(TDDICategory thriftElement) {
		return new TCategory(thriftElement);
	}
