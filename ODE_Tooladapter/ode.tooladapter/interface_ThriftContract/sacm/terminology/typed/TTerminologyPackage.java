...
public class TTerminologyPackage implements ITerminologyPackage{

	TDDITerminologyPackage thriftElement;
	
	public TTerminologyPackage(TDDITerminologyPackage thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TTerminologyPackage wrap(TDDITerminologyPackage thriftElement) {
		return new TTerminologyPackage(thriftElement);
	}
