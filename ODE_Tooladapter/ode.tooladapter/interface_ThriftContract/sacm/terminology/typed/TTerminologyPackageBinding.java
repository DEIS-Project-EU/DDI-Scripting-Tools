...
public class TTerminologyPackageBinding implements ITerminologyPackage {

	TDDITerminologyPackageBinding thriftElement;
	
	public TTerminologyPackageBinding(TDDITerminologyPackageBinding thriftELement) {
		this.thriftElement = thriftELement;
	}
	
	public static TTerminologyPackageBinding wrap(TDDITerminologyPackageBinding thriftELement) {
		return new TTerminologyPackageBinding(thriftELement);
	}
