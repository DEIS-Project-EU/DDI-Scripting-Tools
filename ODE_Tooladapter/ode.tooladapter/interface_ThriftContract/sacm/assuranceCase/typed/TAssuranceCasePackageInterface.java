...
public class TAssuranceCasePackageInterface implements IAssuranceCasePackage{

	TDDIAssuranceCasePackageInterface thriftElement;
	
	public TAssuranceCasePackageInterface(TDDIAssuranceCasePackageInterface thriftElement) {
		this.thriftElement = thriftElement;
	}
	
	public static TAssuranceCasePackageInterface wrap(TDDIAssuranceCasePackageInterface thriftElement) {
		return new TAssuranceCasePackageInterface(thriftElement);
	}
