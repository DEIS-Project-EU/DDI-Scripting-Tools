...
public class TDDIMeasureType implements org.apache.thrift.TBase<TDDIMeasureType, TDDIMeasureType._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIMeasureType> {
  ...
  public TDDIMeasureType setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list8.size);
                TDDIKeyValueMap _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new TDDIKeyValueMap();
                  _elem9.read(iprot);
                  struct.KeyValueMaps.add(_elem9);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIMeasureType struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter11 : struct.KeyValueMaps)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter12 : struct.KeyValueMaps)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list13.size);
          TDDIKeyValueMap _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new TDDIKeyValueMap();
            _elem14.read(iprot);
            struct.KeyValueMaps.add(_elem14);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
