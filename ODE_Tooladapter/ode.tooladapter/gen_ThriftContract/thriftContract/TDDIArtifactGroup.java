...
public class TDDIArtifactGroup implements org.apache.thrift.TBase<TDDIArtifactGroup, TDDIArtifactGroup._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArtifactGroup> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list2009.size);
                TDDIAbstractArtifactElementRef _elem2010;
                for (int _i2011 = 0; _i2011 < _list2009.size; ++_i2011)
                {
                  _elem2010 = new TDDIAbstractArtifactElementRef();
                  _elem2010.read(iprot);
                  struct.ArtifactElement.add(_elem2010);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArtifactGroup struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2012 : struct.ImplementationConstraint)
          {
            _iter2012.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2013 : struct.Note)
          {
            _iter2013.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2014 : struct.TaggedValue)
          {
            _iter2014.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ArtifactElement != null) {
        oprot.writeFieldBegin(ARTIFACT_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter2015 : struct.ArtifactElement)
          {
  ...
  private static class TDDIArtifactGroupTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArtifactGroup> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2016 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2017 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2018 : struct.TaggedValue)
          {
      ...
      if (struct.isSetArtifactElement()) {
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter2019 : struct.ArtifactElement)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArtifactGroup struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2020 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2020.size);
          TDDIImplementationConstraintRef _elem2021;
          for (int _i2022 = 0; _i2022 < _list2020.size; ++_i2022)
          {
            _elem2021 = new TDDIImplementationConstraintRef();
            _elem2021.read(iprot);
            struct.ImplementationConstraint.add(_elem2021);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2023 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2023.size);
          TDDINoteRef _elem2024;
          for (int _i2025 = 0; _i2025 < _list2023.size; ++_i2025)
          {
            _elem2024 = new TDDINoteRef();
            _elem2024.read(iprot);
            struct.Note.add(_elem2024);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2026 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2026.size);
          TDDITaggedValueRef _elem2027;
          for (int _i2028 = 0; _i2028 < _list2026.size; ++_i2028)
          {
            _elem2027 = new TDDITaggedValueRef();
            _elem2027.read(iprot);
            struct.TaggedValue.add(_elem2027);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2029 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list2029.size);
          TDDIAbstractArtifactElementRef _elem2030;
          for (int _i2031 = 0; _i2031 < _list2029.size; ++_i2031)
          {
            _elem2030 = new TDDIAbstractArtifactElementRef();
            _elem2030.read(iprot);
            struct.ArtifactElement.add(_elem2030);
          }
        }
        struct.setArtifactElementIsSet(true);
      }
