...
public class TDDIEvent implements org.apache.thrift.TBase<TDDIEvent, TDDIEvent._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIEvent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIEvent");
  ...
  private static final org.apache.thrift.protocol.TField OCCURENCE_FIELD_DESC = new org.apache.thrift.protocol.TField("Occurence", org.apache.thrift.protocol.TType.STRING, (short)12);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIEventStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIEventTupleSchemeFactory();
  ...
  public java.lang.String Occurence; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.OCCURENCE, new org.apache.thrift.meta_data.FieldMetaData("Occurence", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIEvent.class, metaDataMap);
  }
   ...
   */
  public TDDIEvent(TDDIEvent other) {
    ...
    if (other.isSetOccurence()) {
      this.Occurence = other.Occurence;
    }
  }

  public TDDIEvent deepCopy() {
    return new TDDIEvent(this);
  }
  ...
  public TDDIEvent setGid(java.lang.String Gid) {
    this.Gid = Gid;
    return this;
  }
  ...
  public TDDIEvent setIsCitation(boolean IsCitation) {
    this.IsCitation = IsCitation;
    setIsCitationIsSet(true);
    return this;
  }
  ...
  public TDDIEvent setIsAbstract(boolean IsAbstract) {
    this.IsAbstract = IsAbstract;
    setIsAbstractIsSet(true);
    return this;
  }
  ...
  public TDDIEvent setCitedElement(TDDIAbstractSACMElement CitedElement) {
    this.CitedElement = CitedElement;
    return this;
  }
  ...
  public TDDIEvent setAbstractForm(TDDIAbstractSACMElement AbstractForm) {
    this.AbstractForm = AbstractForm;
    return this;
  }
  ...
  public TDDIEvent setName(TDDIAbstractLangString Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIEvent setDescription(TDDIDescription Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIEvent setImplementationConstraint(java.util.List<TDDIImplementationConstraintRef> ImplementationConstraint) {
    this.ImplementationConstraint = ImplementationConstraint;
    return this;
  }
  ...
  public TDDIEvent setNote(java.util.List<TDDINoteRef> Note) {
    this.Note = Note;
    return this;
  }
  ...
  public TDDIEvent setTaggedValue(java.util.List<TDDITaggedValueRef> TaggedValue) {
    this.TaggedValue = TaggedValue;
    return this;
  }
  ...
  public TDDIEvent setProperty(java.util.List<TDDIPropertyRef> Property) {
    this.Property = Property;
    return this;
  }
  ...
  public TDDIEvent setOccurence(java.lang.String Occurence) {
    this.Occurence = Occurence;
    return this;
  }

  public void unsetOccurence() {
    this.Occurence = null;
  }

  /** Returns true if field Occurence is set (has been assigned a value) and false otherwise */
  public boolean isSetOccurence() {
    return this.Occurence != null;
  }

  public void setOccurenceIsSet(boolean value) {
    if (!value) {
      this.Occurence = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case OCCURENCE:
      if (value == null) {
        ...
        setOccurence((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIEvent)
      return this.equals((TDDIEvent)that);
    return false;
  }

  public boolean equals(TDDIEvent that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_Occurence = true && this.isSetOccurence();
    boolean that_present_Occurence = true && that.isSetOccurence();
    if (this_present_Occurence || that_present_Occurence) {
      if (!(this_present_Occurence && that_present_Occurence))
        return false;
      if (!this.Occurence.equals(that.Occurence))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetOccurence()) ? 131071 : 524287);
    if (isSetOccurence())
      hashCode = hashCode * 8191 + Occurence.hashCode();

    return hashCode;
  }

  @Override
  public int compareTo(TDDIEvent other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOccurence()).compareTo(other.isSetOccurence());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOccurence()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.Occurence, other.Occurence);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIEvent(");
    boolean first = true;
  ...
  private static class TDDIEventStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIEventStandardScheme getScheme() {
      return new TDDIEventStandardScheme();
    }
  }

  private static class TDDIEventStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIEvent struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2160 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2160.size);
                TDDIImplementationConstraintRef _elem2161;
                for (int _i2162 = 0; _i2162 < _list2160.size; ++_i2162)
                {
                  _elem2161 = new TDDIImplementationConstraintRef();
                  _elem2161.read(iprot);
                  struct.ImplementationConstraint.add(_elem2161);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2163 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2163.size);
                TDDINoteRef _elem2164;
                for (int _i2165 = 0; _i2165 < _list2163.size; ++_i2165)
                {
                  _elem2164 = new TDDINoteRef();
                  _elem2164.read(iprot);
                  struct.Note.add(_elem2164);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2166 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2166.size);
                TDDITaggedValueRef _elem2167;
                for (int _i2168 = 0; _i2168 < _list2166.size; ++_i2168)
                {
                  _elem2167 = new TDDITaggedValueRef();
                  _elem2167.read(iprot);
                  struct.TaggedValue.add(_elem2167);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // PROPERTY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2169 = iprot.readListBegin();
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2169.size);
                TDDIPropertyRef _elem2170;
                for (int _i2171 = 0; _i2171 < _list2169.size; ++_i2171)
                {
                  _elem2170 = new TDDIPropertyRef();
                  _elem2170.read(iprot);
                  struct.Property.add(_elem2170);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // OCCURENCE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.Occurence = iprot.readString();
              struct.setOccurenceIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIEvent struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2172 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2173 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2174 : struct.TaggedValue)
          {
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2175 : struct.Property)
          {
      ...
      if (struct.Occurence != null) {
        oprot.writeFieldBegin(OCCURENCE_FIELD_DESC);
        oprot.writeString(struct.Occurence);
        oprot.writeFieldEnd();
      }
  ...
  private static class TDDIEventTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIEventTupleScheme getScheme() {
      return new TDDIEventTupleScheme();
    }
  }

  private static class TDDIEventTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIEvent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIEvent struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2176 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2177 : struct.Note)
          {
            _iter2177.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2178 : struct.TaggedValue)
          {
            _iter2178.write(oprot);
          }
        }
      }
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2179 : struct.Property)
          {
            _iter2179.write(oprot);
          }
        }
      }
      if (struct.isSetOccurence()) {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIEvent struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2180.size);
          TDDIImplementationConstraintRef _elem2181;
          for (int _i2182 = 0; _i2182 < _list2180.size; ++_i2182)
          {
            _elem2181 = new TDDIImplementationConstraintRef();
            _elem2181.read(iprot);
            struct.ImplementationConstraint.add(_elem2181);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2183.size);
          TDDINoteRef _elem2184;
          for (int _i2185 = 0; _i2185 < _list2183.size; ++_i2185)
          {
            _elem2184 = new TDDINoteRef();
            _elem2184.read(iprot);
            struct.Note.add(_elem2184);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2186.size);
          TDDITaggedValueRef _elem2187;
          for (int _i2188 = 0; _i2188 < _list2186.size; ++_i2188)
          {
            _elem2187 = new TDDITaggedValueRef();
            _elem2187.read(iprot);
            struct.TaggedValue.add(_elem2187);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2189.size);
          TDDIPropertyRef _elem2190;
          for (int _i2191 = 0; _i2191 < _list2189.size; ++_i2191)
          {
            _elem2190 = new TDDIPropertyRef();
            _elem2190.read(iprot);
            struct.Property.add(_elem2190);
          }
        }
        struct.setPropertyIsSet(true);
      }
