...
public class TDDISituation implements org.apache.thrift.TBase<TDDISituation, TDDISituation._Fields>, java.io.Serializable, Cloneable, Comparable<TDDISituation> {
  ...
  private static final org.apache.thrift.protocol.TField LIKELIHOOD_FIELD_DESC = new org.apache.thrift.protocol.TField("Likelihood", org.apache.thrift.protocol.TType.STRING, (short)6);
  ...
  public TDDISituation setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list1064.size);
                TDDIKeyValueMap _elem1065;
                for (int _i1066 = 0; _i1066 < _list1064.size; ++_i1066)
                {
                  _elem1065 = new TDDIKeyValueMap();
                  _elem1065.read(iprot);
                  struct.KeyValueMaps.add(_elem1065);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDISituation struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter1067 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter1068 : struct.KeyValueMaps)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list1069.size);
          TDDIKeyValueMap _elem1070;
          for (int _i1071 = 0; _i1071 < _list1069.size; ++_i1071)
          {
            _elem1070 = new TDDIKeyValueMap();
            _elem1070.read(iprot);
            struct.KeyValueMaps.add(_elem1070);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
