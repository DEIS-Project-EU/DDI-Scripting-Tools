...
public class TDDIParticipant implements org.apache.thrift.TBase<TDDIParticipant, TDDIParticipant._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIParticipant> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2105.size);
                TDDIPropertyRef _elem2106;
                for (int _i2107 = 0; _i2107 < _list2105.size; ++_i2107)
                {
                  _elem2106 = new TDDIPropertyRef();
                  _elem2106.read(iprot);
                  struct.Property.add(_elem2106);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIParticipant struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2108 : struct.ImplementationConstraint)
          {
            _iter2108.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2109 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2110 : struct.TaggedValue)
          {
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2111 : struct.Property)
          {
            _iter2111.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIParticipantTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIParticipant> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2112 : struct.ImplementationConstraint)
          {
            _iter2112.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2113 : struct.Note)
          {
            _iter2113.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2114 : struct.TaggedValue)
          {
      ...
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2115 : struct.Property)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIParticipant struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2116 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2116.size);
          TDDIImplementationConstraintRef _elem2117;
          for (int _i2118 = 0; _i2118 < _list2116.size; ++_i2118)
          {
            _elem2117 = new TDDIImplementationConstraintRef();
            _elem2117.read(iprot);
            struct.ImplementationConstraint.add(_elem2117);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2119 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2119.size);
          TDDINoteRef _elem2120;
          for (int _i2121 = 0; _i2121 < _list2119.size; ++_i2121)
          {
            _elem2120 = new TDDINoteRef();
            _elem2120.read(iprot);
            struct.Note.add(_elem2120);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2122 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2122.size);
          TDDITaggedValueRef _elem2123;
          for (int _i2124 = 0; _i2124 < _list2122.size; ++_i2124)
          {
            _elem2123 = new TDDITaggedValueRef();
            _elem2123.read(iprot);
            struct.TaggedValue.add(_elem2123);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2125 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2125.size);
          TDDIPropertyRef _elem2126;
          for (int _i2127 = 0; _i2127 < _list2125.size; ++_i2127)
          {
            _elem2126 = new TDDIPropertyRef();
            _elem2126.read(iprot);
            struct.Property.add(_elem2126);
          }
        }
        struct.setPropertyIsSet(true);
      }
