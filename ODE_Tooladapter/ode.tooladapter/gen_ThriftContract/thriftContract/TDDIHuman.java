...
public class TDDIHuman implements org.apache.thrift.TBase<TDDIHuman, TDDIHuman._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIHuman> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2976 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2976.size);
                TDDIKeyValueMap _elem2977;
                for (int _i2978 = 0; _i2978 < _list2976.size; ++_i2978)
                {
                  _elem2977 = new TDDIKeyValueMap();
                  _elem2977.read(iprot);
                  struct.KeyValueMaps.add(_elem2977);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // ATTACKER_GOALS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2979 = iprot.readListBegin();
                struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list2979.size);
                TDDIAttackerGoal _elem2980;
                for (int _i2981 = 0; _i2981 < _list2979.size; ++_i2981)
                {
                  _elem2980 = new TDDIAttackerGoal();
                  _elem2980.read(iprot);
                  struct.AttackerGoals.add(_elem2980);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // ACTIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2982 = iprot.readListBegin();
                struct.Actions = new java.util.ArrayList<TDDIActionRef>(_list2982.size);
                TDDIActionRef _elem2983;
                for (int _i2984 = 0; _i2984 < _list2982.size; ++_i2984)
                {
                  _elem2983 = new TDDIActionRef();
                  _elem2983.read(iprot);
                  struct.Actions.add(_elem2983);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIHuman struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2985 : struct.KeyValueMaps)
          {
            _iter2985.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AttackerGoals != null) {
        oprot.writeFieldBegin(ATTACKER_GOALS_FIELD_DESC);
        {
          ...
          for (TDDIAttackerGoal _iter2986 : struct.AttackerGoals)
          {
            _iter2986.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Actions != null) {
        oprot.writeFieldBegin(ACTIONS_FIELD_DESC);
        {
          ...
          for (TDDIActionRef _iter2987 : struct.Actions)
          {
            _iter2987.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIHumanTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIHuman> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2988 : struct.KeyValueMaps)
          {
            _iter2988.write(oprot);
          }
        }
      }
      if (struct.isSetSkillLevel()) {
      ...
      if (struct.isSetAttackerGoals()) {
        {
          ...
          for (TDDIAttackerGoal _iter2989 : struct.AttackerGoals)
          {
            _iter2989.write(oprot);
          }
        }
      }
      if (struct.isSetActions()) {
        {
          ...
          for (TDDIActionRef _iter2990 : struct.Actions)
          {
            _iter2990.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIHuman struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2991 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2991.size);
          TDDIKeyValueMap _elem2992;
          for (int _i2993 = 0; _i2993 < _list2991.size; ++_i2993)
          {
            _elem2992 = new TDDIKeyValueMap();
            _elem2992.read(iprot);
            struct.KeyValueMaps.add(_elem2992);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2994 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list2994.size);
          TDDIAttackerGoal _elem2995;
          for (int _i2996 = 0; _i2996 < _list2994.size; ++_i2996)
          {
            _elem2995 = new TDDIAttackerGoal();
            _elem2995.read(iprot);
            struct.AttackerGoals.add(_elem2995);
          }
        }
        struct.setAttackerGoalsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2997 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Actions = new java.util.ArrayList<TDDIActionRef>(_list2997.size);
          TDDIActionRef _elem2998;
          for (int _i2999 = 0; _i2999 < _list2997.size; ++_i2999)
          {
            _elem2998 = new TDDIActionRef();
            _elem2998.read(iprot);
            struct.Actions.add(_elem2998);
          }
        }
        struct.setActionsIsSet(true);
      }
