...
public class TDDIAssertedEvidence implements org.apache.thrift.TBase<TDDIAssertedEvidence, TDDIAssertedEvidence._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAssertedEvidence> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1800.size);
                TDDIImplementationConstraintRef _elem1801;
                for (int _i1802 = 0; _i1802 < _list1800.size; ++_i1802)
                {
                  _elem1801 = new TDDIImplementationConstraintRef();
                  _elem1801.read(iprot);
                  struct.ImplementationConstraint.add(_elem1801);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1803 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1803.size);
                TDDINoteRef _elem1804;
                for (int _i1805 = 0; _i1805 < _list1803.size; ++_i1805)
                {
                  _elem1804 = new TDDINoteRef();
                  _elem1804.read(iprot);
                  struct.Note.add(_elem1804);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1806 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1806.size);
                TDDITaggedValueRef _elem1807;
                for (int _i1808 = 0; _i1808 < _list1806.size; ++_i1808)
                {
                  _elem1807 = new TDDITaggedValueRef();
                  _elem1807.read(iprot);
                  struct.TaggedValue.add(_elem1807);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // META_CLAIM
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1809 = iprot.readListBegin();
                struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list1809.size);
                TDDIClaimRef _elem1810;
                for (int _i1811 = 0; _i1811 < _list1809.size; ++_i1811)
                {
                  _elem1810 = new TDDIClaimRef();
                  _elem1810.read(iprot);
                  struct.MetaClaim.add(_elem1810);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Source = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1812.size);
                TDDIAbstractArgumentAssetRef _elem1813;
                for (int _i1814 = 0; _i1814 < _list1812.size; ++_i1814)
                {
                  _elem1813 = new TDDIAbstractArgumentAssetRef();
                  _elem1813.read(iprot);
                  struct.Source.add(_elem1813);
                }
                iprot.readListEnd();
              }
          ...
          case 15: // TARGET
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1815 = iprot.readListBegin();
                struct.Target = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1815.size);
                TDDIAbstractArgumentAssetRef _elem1816;
                for (int _i1817 = 0; _i1817 < _list1815.size; ++_i1817)
                {
                  _elem1816 = new TDDIAbstractArgumentAssetRef();
                  _elem1816.read(iprot);
                  struct.Target.add(_elem1816);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAssertedEvidence struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1818 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1819 : struct.Note)
          {
            _iter1819.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1820 : struct.TaggedValue)
          {
            _iter1820.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.MetaClaim != null) {
        oprot.writeFieldBegin(META_CLAIM_FIELD_DESC);
        {
          ...
          for (TDDIClaimRef _iter1821 : struct.MetaClaim)
          {
            _iter1821.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Source != null) {
        oprot.writeFieldBegin(SOURCE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1822 : struct.Source)
          {
            _iter1822.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Target != null) {
        oprot.writeFieldBegin(TARGET_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1823 : struct.Target)
          {
  ...
  private static class TDDIAssertedEvidenceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAssertedEvidence> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1824 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1825 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1826 : struct.TaggedValue)
          {
      ...
      if (struct.isSetMetaClaim()) {
        {
          ...
          for (TDDIClaimRef _iter1827 : struct.MetaClaim)
          {
            _iter1827.write(oprot);
          }
        }
      }
      if (struct.isSetIsCounter()) {
      ...
      if (struct.isSetSource()) {
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1828 : struct.Source)
          {
            _iter1828.write(oprot);
          }
        }
      }
      if (struct.isSetTarget()) {
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1829 : struct.Target)
          {
            _iter1829.write(oprot);
          }
        }
      }
      if (struct.isSetReasoning()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAssertedEvidence struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1830 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1830.size);
          TDDIImplementationConstraintRef _elem1831;
          for (int _i1832 = 0; _i1832 < _list1830.size; ++_i1832)
          {
            _elem1831 = new TDDIImplementationConstraintRef();
            _elem1831.read(iprot);
            struct.ImplementationConstraint.add(_elem1831);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1833.size);
          TDDINoteRef _elem1834;
          for (int _i1835 = 0; _i1835 < _list1833.size; ++_i1835)
          {
            _elem1834 = new TDDINoteRef();
            _elem1834.read(iprot);
            struct.Note.add(_elem1834);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1836 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1836.size);
          TDDITaggedValueRef _elem1837;
          for (int _i1838 = 0; _i1838 < _list1836.size; ++_i1838)
          {
            _elem1837 = new TDDITaggedValueRef();
            _elem1837.read(iprot);
            struct.TaggedValue.add(_elem1837);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list1839 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list1839.size);
          TDDIClaimRef _elem1840;
          for (int _i1841 = 0; _i1841 < _list1839.size; ++_i1841)
          {
            _elem1840 = new TDDIClaimRef();
            _elem1840.read(iprot);
            struct.MetaClaim.add(_elem1840);
          }
        }
        struct.setMetaClaimIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TList _list1842 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Source = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1842.size);
          TDDIAbstractArgumentAssetRef _elem1843;
          for (int _i1844 = 0; _i1844 < _list1842.size; ++_i1844)
          {
            _elem1843 = new TDDIAbstractArgumentAssetRef();
            _elem1843.read(iprot);
            struct.Source.add(_elem1843);
          }
        }
        struct.setSourceIsSet(true);
      }
      if (incoming.get(14)) {
        {
          org.apache.thrift.protocol.TList _list1845 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Target = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1845.size);
          TDDIAbstractArgumentAssetRef _elem1846;
          for (int _i1847 = 0; _i1847 < _list1845.size; ++_i1847)
          {
            _elem1846 = new TDDIAbstractArgumentAssetRef();
            _elem1846.read(iprot);
            struct.Target.add(_elem1846);
          }
        }
        struct.setTargetIsSet(true);
      }
