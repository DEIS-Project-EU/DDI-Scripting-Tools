...
public class TDDIResource implements org.apache.thrift.TBase<TDDIResource, TDDIResource._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIResource> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2201.size);
                TDDIPropertyRef _elem2202;
                for (int _i2203 = 0; _i2203 < _list2201.size; ++_i2203)
                {
                  _elem2202 = new TDDIPropertyRef();
                  _elem2202.read(iprot);
                  struct.Property.add(_elem2202);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIResource struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2204 : struct.ImplementationConstraint)
          {
            _iter2204.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2205 : struct.Note)
          {
            _iter2205.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2206 : struct.TaggedValue)
          {
            _iter2206.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2207 : struct.Property)
          {
            _iter2207.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIResourceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIResource> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2208 : struct.ImplementationConstraint)
          {
            _iter2208.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2209 : struct.Note)
          {
            _iter2209.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2210 : struct.TaggedValue)
          {
      ...
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2211 : struct.Property)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIResource struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2212 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2212.size);
          TDDIImplementationConstraintRef _elem2213;
          for (int _i2214 = 0; _i2214 < _list2212.size; ++_i2214)
          {
            _elem2213 = new TDDIImplementationConstraintRef();
            _elem2213.read(iprot);
            struct.ImplementationConstraint.add(_elem2213);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2215 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2215.size);
          TDDINoteRef _elem2216;
          for (int _i2217 = 0; _i2217 < _list2215.size; ++_i2217)
          {
            _elem2216 = new TDDINoteRef();
            _elem2216.read(iprot);
            struct.Note.add(_elem2216);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2218 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2218.size);
          TDDITaggedValueRef _elem2219;
          for (int _i2220 = 0; _i2220 < _list2218.size; ++_i2220)
          {
            _elem2219 = new TDDITaggedValueRef();
            _elem2219.read(iprot);
            struct.TaggedValue.add(_elem2219);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2221 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2221.size);
          TDDIPropertyRef _elem2222;
          for (int _i2223 = 0; _i2223 < _list2221.size; ++_i2223)
          {
            _elem2222 = new TDDIPropertyRef();
            _elem2222.read(iprot);
            struct.Property.add(_elem2222);
          }
        }
        struct.setPropertyIsSet(true);
      }
