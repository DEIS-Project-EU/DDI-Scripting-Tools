...
public class TDDIProperty implements org.apache.thrift.TBase<TDDIProperty, TDDIProperty._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIProperty> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2032 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2032.size);
                TDDIImplementationConstraintRef _elem2033;
                for (int _i2034 = 0; _i2034 < _list2032.size; ++_i2034)
                {
                  _elem2033 = new TDDIImplementationConstraintRef();
                  _elem2033.read(iprot);
                  struct.ImplementationConstraint.add(_elem2033);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2035 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2035.size);
                TDDINoteRef _elem2036;
                for (int _i2037 = 0; _i2037 < _list2035.size; ++_i2037)
                {
                  _elem2036 = new TDDINoteRef();
                  _elem2036.read(iprot);
                  struct.Note.add(_elem2036);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2038.size);
                TDDITaggedValueRef _elem2039;
                for (int _i2040 = 0; _i2040 < _list2038.size; ++_i2040)
                {
                  _elem2039 = new TDDITaggedValueRef();
                  _elem2039.read(iprot);
                  struct.TaggedValue.add(_elem2039);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // PROPERTY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2041 = iprot.readListBegin();
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2041.size);
                TDDIPropertyRef _elem2042;
                for (int _i2043 = 0; _i2043 < _list2041.size; ++_i2043)
                {
                  _elem2042 = new TDDIPropertyRef();
                  _elem2042.read(iprot);
                  struct.Property.add(_elem2042);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIProperty struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2044 : struct.ImplementationConstraint)
          {
            _iter2044.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2045 : struct.Note)
          {
            _iter2045.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2046 : struct.TaggedValue)
          {
            _iter2046.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2047 : struct.Property)
          {
  ...
  private static class TDDIPropertyTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIProperty> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2048 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2049 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2050 : struct.TaggedValue)
          {
      ...
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2051 : struct.Property)
          {
            _iter2051.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIProperty struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2052 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2052.size);
          TDDIImplementationConstraintRef _elem2053;
          for (int _i2054 = 0; _i2054 < _list2052.size; ++_i2054)
          {
            _elem2053 = new TDDIImplementationConstraintRef();
            _elem2053.read(iprot);
            struct.ImplementationConstraint.add(_elem2053);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2055 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2055.size);
          TDDINoteRef _elem2056;
          for (int _i2057 = 0; _i2057 < _list2055.size; ++_i2057)
          {
            _elem2056 = new TDDINoteRef();
            _elem2056.read(iprot);
            struct.Note.add(_elem2056);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2058 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2058.size);
          TDDITaggedValueRef _elem2059;
          for (int _i2060 = 0; _i2060 < _list2058.size; ++_i2060)
          {
            _elem2059 = new TDDITaggedValueRef();
            _elem2059.read(iprot);
            struct.TaggedValue.add(_elem2059);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2061 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2061.size);
          TDDIPropertyRef _elem2062;
          for (int _i2063 = 0; _i2063 < _list2061.size; ++_i2063)
          {
            _elem2062 = new TDDIPropertyRef();
            _elem2062.read(iprot);
            struct.Property.add(_elem2062);
          }
        }
        struct.setPropertyIsSet(true);
      }
