...
public class TDDISecurityControl implements org.apache.thrift.TBase<TDDISecurityControl, TDDISecurityControl._Fields>, java.io.Serializable, Cloneable, Comparable<TDDISecurityControl> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2800.size);
                TDDIKeyValueMap _elem2801;
                for (int _i2802 = 0; _i2802 < _list2800.size; ++_i2802)
                {
                  _elem2801 = new TDDIKeyValueMap();
                  _elem2801.read(iprot);
                  struct.KeyValueMaps.add(_elem2801);
                }
                iprot.readListEnd();
              }
          ...
          case 15: // VULNERABILITIES
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2803 = iprot.readListBegin();
                struct.Vulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2803.size);
                TDDIVulnerabilityRef _elem2804;
                for (int _i2805 = 0; _i2805 < _list2803.size; ++_i2805)
                {
                  _elem2804 = new TDDIVulnerabilityRef();
                  _elem2804.read(iprot);
                  struct.Vulnerabilities.add(_elem2804);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDISecurityControl struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2806 : struct.KeyValueMaps)
          {
            _iter2806.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Vulnerabilities != null) {
        oprot.writeFieldBegin(VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerabilityRef _iter2807 : struct.Vulnerabilities)
          {
            _iter2807.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDISecurityControlTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDISecurityControl> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2808 : struct.KeyValueMaps)
          {
            _iter2808.write(oprot);
          }
        }
      }
      if (struct.isSetIntrinsicSafety()) {
      ...
      if (struct.isSetVulnerabilities()) {
        {
          ...
          for (TDDIVulnerabilityRef _iter2809 : struct.Vulnerabilities)
          {
            _iter2809.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDISecurityControl struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2810 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2810.size);
          TDDIKeyValueMap _elem2811;
          for (int _i2812 = 0; _i2812 < _list2810.size; ++_i2812)
          {
            _elem2811 = new TDDIKeyValueMap();
            _elem2811.read(iprot);
            struct.KeyValueMaps.add(_elem2811);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(14)) {
        {
          ...
          struct.Vulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2813.size);
          TDDIVulnerabilityRef _elem2814;
          for (int _i2815 = 0; _i2815 < _list2813.size; ++_i2815)
          {
            _elem2814 = new TDDIVulnerabilityRef();
            _elem2814.read(iprot);
            struct.Vulnerabilities.add(_elem2814);
          }
        }
        struct.setVulnerabilitiesIsSet(true);
      }
