...
public class TDDIEpsilonScriptExecutionConfig implements org.apache.thrift.TBase<TDDIEpsilonScriptExecutionConfig, TDDIEpsilonScriptExecutionConfig._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIEpsilonScriptExecutionConfig> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ModelConfigs = new java.util.ArrayList<TDDIEpsilonScriptModelConfig>(_list2744.size);
                TDDIEpsilonScriptModelConfig _elem2745;
                for (int _i2746 = 0; _i2746 < _list2744.size; ++_i2746)
                {
                  _elem2745 = new TDDIEpsilonScriptModelConfig();
                  _elem2745.read(iprot);
                  struct.ModelConfigs.add(_elem2745);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ExportParameters = new java.util.ArrayList<TDDIEpsilonParameter>(_list2747.size);
                TDDIEpsilonParameter _elem2748;
                for (int _i2749 = 0; _i2749 < _list2747.size; ++_i2749)
                {
                  _elem2748 = new TDDIEpsilonParameter();
                  _elem2748.read(iprot);
                  struct.ExportParameters.add(_elem2748);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImportParameters = new java.util.ArrayList<TDDIEpsilonParameter>(_list2750.size);
                TDDIEpsilonParameter _elem2751;
                for (int _i2752 = 0; _i2752 < _list2750.size; ++_i2752)
                {
                  _elem2751 = new TDDIEpsilonParameter();
                  _elem2751.read(iprot);
                  struct.ImportParameters.add(_elem2751);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIEpsilonScriptExecutionConfig struct) throws org.apache.thrift.TException {
      ...
      if (struct.ModelConfigs != null) {
        oprot.writeFieldBegin(MODEL_CONFIGS_FIELD_DESC);
        {
          ...
          for (TDDIEpsilonScriptModelConfig _iter2753 : struct.ModelConfigs)
          {
            _iter2753.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ExportParameters != null) {
        oprot.writeFieldBegin(EXPORT_PARAMETERS_FIELD_DESC);
        {
          ...
          for (TDDIEpsilonParameter _iter2754 : struct.ExportParameters)
          {
            _iter2754.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ImportParameters != null) {
        oprot.writeFieldBegin(IMPORT_PARAMETERS_FIELD_DESC);
        {
          ...
          for (TDDIEpsilonParameter _iter2755 : struct.ImportParameters)
          {
  ...
  private static class TDDIEpsilonScriptExecutionConfigTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIEpsilonScriptExecutionConfig> {
      ...
      if (struct.isSetModelConfigs()) {
        {
          ...
          for (TDDIEpsilonScriptModelConfig _iter2756 : struct.ModelConfigs)
          {
      ...
      if (struct.isSetExportParameters()) {
        {
          ...
          for (TDDIEpsilonParameter _iter2757 : struct.ExportParameters)
          {
      ...
      if (struct.isSetImportParameters()) {
        {
          ...
          for (TDDIEpsilonParameter _iter2758 : struct.ImportParameters)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIEpsilonScriptExecutionConfig struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list2759 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ModelConfigs = new java.util.ArrayList<TDDIEpsilonScriptModelConfig>(_list2759.size);
          TDDIEpsilonScriptModelConfig _elem2760;
          for (int _i2761 = 0; _i2761 < _list2759.size; ++_i2761)
          {
            _elem2760 = new TDDIEpsilonScriptModelConfig();
            _elem2760.read(iprot);
            struct.ModelConfigs.add(_elem2760);
          }
        }
        struct.setModelConfigsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list2762 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ExportParameters = new java.util.ArrayList<TDDIEpsilonParameter>(_list2762.size);
          TDDIEpsilonParameter _elem2763;
          for (int _i2764 = 0; _i2764 < _list2762.size; ++_i2764)
          {
            _elem2763 = new TDDIEpsilonParameter();
            _elem2763.read(iprot);
            struct.ExportParameters.add(_elem2763);
          }
        }
        struct.setExportParametersIsSet(true);
      }
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list2765 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImportParameters = new java.util.ArrayList<TDDIEpsilonParameter>(_list2765.size);
          TDDIEpsilonParameter _elem2766;
          for (int _i2767 = 0; _i2767 < _list2765.size; ++_i2767)
          {
            _elem2766 = new TDDIEpsilonParameter();
            _elem2766.read(iprot);
            struct.ImportParameters.add(_elem2766);
          }
        }
        struct.setImportParametersIsSet(true);
      }
