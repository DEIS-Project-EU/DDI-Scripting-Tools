...
public class TDDIFMEAEntry implements org.apache.thrift.TBase<TDDIFMEAEntry, TDDIFMEAEntry._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIFMEAEntry> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIFMEAEntry");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIFMEAEntryStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIFMEAEntryTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIFMEAEntry.class, metaDataMap);
  }

  public TDDIFMEAEntry() {
    this.Name = "";
   ...
   */
  public TDDIFMEAEntry(TDDIFMEAEntry other) {
  ...
  public TDDIFMEAEntry deepCopy() {
    return new TDDIFMEAEntry(this);
  }
  ...
  public TDDIFMEAEntry setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIFMEAEntry setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIFMEAEntry setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIFMEAEntry setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIFMEAEntry setEffect(TDDIAbstractFailure Effect) {
    this.Effect = Effect;
    return this;
  }
  ...
  public TDDIFMEAEntry setMode(TDDIAbstractFailure Mode) {
    this.Mode = Mode;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIFMEAEntry)
      return this.equals((TDDIFMEAEntry)that);
    return false;
  }

  public boolean equals(TDDIFMEAEntry that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIFMEAEntry other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIFMEAEntry(");
    boolean first = true;
  ...
  private static class TDDIFMEAEntryStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFMEAEntryStandardScheme getScheme() {
      return new TDDIFMEAEntryStandardScheme();
    }
  }

  private static class TDDIFMEAEntryStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIFMEAEntry> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIFMEAEntry struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list912.size);
                TDDIKeyValueMap _elem913;
                for (int _i914 = 0; _i914 < _list912.size; ++_i914)
                {
                  _elem913 = new TDDIKeyValueMap();
                  _elem913.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIFMEAEntry struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter915 : struct.KeyValueMaps)
          {
  ...
  private static class TDDIFMEAEntryTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIFMEAEntryTupleScheme getScheme() {
      return new TDDIFMEAEntryTupleScheme();
    }
  }

  private static class TDDIFMEAEntryTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIFMEAEntry> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIFMEAEntry struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter916 : struct.KeyValueMaps)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIFMEAEntry struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list917.size);
          TDDIKeyValueMap _elem918;
          for (int _i919 = 0; _i919 < _list917.size; ++_i919)
          {
            _elem918 = new TDDIKeyValueMap();
            _elem918.read(iprot);
