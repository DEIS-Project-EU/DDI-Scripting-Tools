            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list3016.size);
                TDDIKeyValueMap _elem3017;
                for (int _i3018 = 0; _i3018 < _list3016.size; ++_i3018)
                {
                  _elem3017 = new TDDIKeyValueMap();
                  _elem3017.read(iprot);
                  struct.KeyValueMaps.add(_elem3017);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.IdentifiedRisks = new java.util.ArrayList<TDDISecurityRisk>(_list3019.size);
                TDDISecurityRisk _elem3020;
                for (int _i3021 = 0; _i3021 < _list3019.size; ++_i3021)
                {
                  _elem3020 = new TDDISecurityRisk();
                  _elem3020.read(iprot);
                  struct.IdentifiedRisks.add(_elem3020);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Controls = new java.util.ArrayList<TDDISecurityControl>(_list3022.size);
                TDDISecurityControl _elem3023;
                for (int _i3024 = 0; _i3024 < _list3022.size; ++_i3024)
                {
                  _elem3023 = new TDDISecurityControl();
                  _elem3023.read(iprot);
                  struct.Controls.add(_elem3023);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ConsideredAssets = new java.util.ArrayList<TDDIAbstractAsset>(_list3025.size);
                TDDIAbstractAsset _elem3026;
                for (int _i3027 = 0; _i3027 < _list3025.size; ++_i3027)
                {
                  _elem3026 = new TDDIAbstractAsset();
                  _elem3026.read(iprot);
                  struct.ConsideredAssets.add(_elem3026);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ConsideredThreatAgents = new java.util.ArrayList<TDDIAbstractThreatAgent>(_list3028.size);
                TDDIAbstractThreatAgent _elem3029;
                for (int _i3030 = 0; _i3030 < _list3028.size; ++_i3030)
                {
                  _elem3029 = new TDDIAbstractThreatAgent();
                  _elem3029.read(iprot);
                  struct.ConsideredThreatAgents.add(_elem3029);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDITARAPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter3031 : struct.KeyValueMaps)
          {
      ...
      if (struct.IdentifiedRisks != null) {
        oprot.writeFieldBegin(IDENTIFIED_RISKS_FIELD_DESC);
        {
          ...
          for (TDDISecurityRisk _iter3032 : struct.IdentifiedRisks)
          {
      ...
      if (struct.Controls != null) {
        oprot.writeFieldBegin(CONTROLS_FIELD_DESC);
        {
          ...
          for (TDDISecurityControl _iter3033 : struct.Controls)
          {
      ...
      if (struct.ConsideredAssets != null) {
        oprot.writeFieldBegin(CONSIDERED_ASSETS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractAsset _iter3034 : struct.ConsideredAssets)
          {
      ...
      if (struct.ConsideredThreatAgents != null) {
        oprot.writeFieldBegin(CONSIDERED_THREAT_AGENTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractThreatAgent _iter3035 : struct.ConsideredThreatAgents)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter3036 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetIdentifiedRisks()) {
        {
          ...
          for (TDDISecurityRisk _iter3037 : struct.IdentifiedRisks)
          {
      ...
      if (struct.isSetControls()) {
        {
          ...
          for (TDDISecurityControl _iter3038 : struct.Controls)
          {
      ...
      if (struct.isSetConsideredAssets()) {
        {
          ...
          for (TDDIAbstractAsset _iter3039 : struct.ConsideredAssets)
          {
      ...
      if (struct.isSetConsideredThreatAgents()) {
        {
          ...
          for (TDDIAbstractThreatAgent _iter3040 : struct.ConsideredThreatAgents)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list3041.size);
          TDDIKeyValueMap _elem3042;
          for (int _i3043 = 0; _i3043 < _list3041.size; ++_i3043)
          {
            _elem3042 = new TDDIKeyValueMap();
            _elem3042.read(iprot);
            struct.KeyValueMaps.add(_elem3042);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.IdentifiedRisks = new java.util.ArrayList<TDDISecurityRisk>(_list3044.size);
          TDDISecurityRisk _elem3045;
          for (int _i3046 = 0; _i3046 < _list3044.size; ++_i3046)
          {
            _elem3045 = new TDDISecurityRisk();
            _elem3045.read(iprot);
            struct.IdentifiedRisks.add(_elem3045);
          }
        }
        struct.setIdentifiedRisksIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.Controls = new java.util.ArrayList<TDDISecurityControl>(_list3047.size);
          TDDISecurityControl _elem3048;
          for (int _i3049 = 0; _i3049 < _list3047.size; ++_i3049)
          {
            _elem3048 = new TDDISecurityControl();
            _elem3048.read(iprot);
            struct.Controls.add(_elem3048);
          }
        }
        struct.setControlsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.ConsideredAssets = new java.util.ArrayList<TDDIAbstractAsset>(_list3050.size);
          TDDIAbstractAsset _elem3051;
          for (int _i3052 = 0; _i3052 < _list3050.size; ++_i3052)
          {
            _elem3051 = new TDDIAbstractAsset();
            _elem3051.read(iprot);
            struct.ConsideredAssets.add(_elem3051);
          }
        }
        struct.setConsideredAssetsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.ConsideredThreatAgents = new java.util.ArrayList<TDDIAbstractThreatAgent>(_list3053.size);
          TDDIAbstractThreatAgent _elem3054;
          for (int _i3055 = 0; _i3055 < _list3053.size; ++_i3055)
          {
            _elem3054 = new TDDIAbstractThreatAgent();
            _elem3054.read(iprot);
            struct.ConsideredThreatAgents.add(_elem3054);
          }
        }
        struct.setConsideredThreatAgentsIsSet(true);
      }
