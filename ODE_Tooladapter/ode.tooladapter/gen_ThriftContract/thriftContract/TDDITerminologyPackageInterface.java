...
public class TDDITerminologyPackageInterface implements org.apache.thrift.TBase<TDDITerminologyPackageInterface, TDDITerminologyPackageInterface._Fields>, java.io.Serializable, Cloneable, Comparable<TDDITerminologyPackageInterface> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2616 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2616.size);
                TDDIImplementationConstraintRef _elem2617;
                for (int _i2618 = 0; _i2618 < _list2616.size; ++_i2618)
                {
                  _elem2617 = new TDDIImplementationConstraintRef();
                  _elem2617.read(iprot);
                  struct.ImplementationConstraint.add(_elem2617);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2619 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2619.size);
                TDDINoteRef _elem2620;
                for (int _i2621 = 0; _i2621 < _list2619.size; ++_i2621)
                {
                  _elem2620 = new TDDINoteRef();
                  _elem2620.read(iprot);
                  struct.Note.add(_elem2620);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2622 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2622.size);
                TDDITaggedValueRef _elem2623;
                for (int _i2624 = 0; _i2624 < _list2622.size; ++_i2624)
                {
                  _elem2623 = new TDDITaggedValueRef();
                  _elem2623.read(iprot);
                  struct.TaggedValue.add(_elem2623);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // TERMINOLOGY_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2625 = iprot.readListBegin();
                struct.TerminologyElement = new java.util.ArrayList<TDDIAbstractTerminologyElement>(_list2625.size);
                TDDIAbstractTerminologyElement _elem2626;
                for (int _i2627 = 0; _i2627 < _list2625.size; ++_i2627)
                {
                  _elem2626 = new TDDIAbstractTerminologyElement();
                  _elem2626.read(iprot);
                  struct.TerminologyElement.add(_elem2626);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDITerminologyPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2628 : struct.ImplementationConstraint)
          {
            _iter2628.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2629 : struct.Note)
          {
            _iter2629.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2630 : struct.TaggedValue)
          {
            _iter2630.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TerminologyElement != null) {
        oprot.writeFieldBegin(TERMINOLOGY_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractTerminologyElement _iter2631 : struct.TerminologyElement)
          {
            _iter2631.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDITerminologyPackageInterfaceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDITerminologyPackageInterface> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2632 : struct.ImplementationConstraint)
          {
            _iter2632.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2633 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2634 : struct.TaggedValue)
          {
            _iter2634.write(oprot);
          }
        }
      }
      if (struct.isSetTerminologyElement()) {
        {
          ...
          for (TDDIAbstractTerminologyElement _iter2635 : struct.TerminologyElement)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDITerminologyPackageInterface struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2636 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2636.size);
          TDDIImplementationConstraintRef _elem2637;
          for (int _i2638 = 0; _i2638 < _list2636.size; ++_i2638)
          {
            _elem2637 = new TDDIImplementationConstraintRef();
            _elem2637.read(iprot);
            struct.ImplementationConstraint.add(_elem2637);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2639.size);
          TDDINoteRef _elem2640;
          for (int _i2641 = 0; _i2641 < _list2639.size; ++_i2641)
          {
            _elem2640 = new TDDINoteRef();
            _elem2640.read(iprot);
            struct.Note.add(_elem2640);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2642 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2642.size);
          TDDITaggedValueRef _elem2643;
          for (int _i2644 = 0; _i2644 < _list2642.size; ++_i2644)
          {
            _elem2643 = new TDDITaggedValueRef();
            _elem2643.read(iprot);
            struct.TaggedValue.add(_elem2643);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2645 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TerminologyElement = new java.util.ArrayList<TDDIAbstractTerminologyElement>(_list2645.size);
          TDDIAbstractTerminologyElement _elem2646;
          for (int _i2647 = 0; _i2647 < _list2645.size; ++_i2647)
          {
            _elem2646 = new TDDIAbstractTerminologyElement();
            _elem2646.read(iprot);
            struct.TerminologyElement.add(_elem2646);
          }
        }
        struct.setTerminologyElementIsSet(true);
      }
