      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2851.size);
                TDDIVulnerabilityRef _elem2852;
                for (int _i2853 = 0; _i2853 < _list2851.size; ++_i2853)
                {
                  _elem2852 = new TDDIVulnerabilityRef();
                  _elem2852.read(iprot);
                  struct.ExploitedVulnerabilities.add(_elem2852);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // VIOLATIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2854 = iprot.readListBegin();
                struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2854.size);
                TDDISecurityViolationRef _elem2855;
                for (int _i2856 = 0; _i2856 < _list2854.size; ++_i2856)
                {
                  _elem2855 = new TDDISecurityViolationRef();
                  _elem2855.read(iprot);
                  struct.Violations.add(_elem2855);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAttack struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2857 : struct.KeyValueMaps)
          {
      ...
      if (struct.ExploitedVulnerabilities != null) {
        oprot.writeFieldBegin(EXPLOITED_VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerabilityRef _iter2858 : struct.ExploitedVulnerabilities)
          {
            _iter2858.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Violations != null) {
        oprot.writeFieldBegin(VIOLATIONS_FIELD_DESC);
        {
          ...
          for (TDDISecurityViolationRef _iter2859 : struct.Violations)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2860 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetExploitedVulnerabilities()) {
        {
          ...
          for (TDDIVulnerabilityRef _iter2861 : struct.ExploitedVulnerabilities)
          {
            _iter2861.write(oprot);
          }
        }
      }
      if (struct.isSetViolations()) {
        {
          ...
          for (TDDISecurityViolationRef _iter2862 : struct.Violations)
          {
            _iter2862.write(oprot);
          }
        }
      }
    }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2863.size);
          TDDIKeyValueMap _elem2864;
          for (int _i2865 = 0; _i2865 < _list2863.size; ++_i2865)
          {
            _elem2864 = new TDDIKeyValueMap();
            _elem2864.read(iprot);
            struct.KeyValueMaps.add(_elem2864);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2866.size);
          TDDIVulnerabilityRef _elem2867;
          for (int _i2868 = 0; _i2868 < _list2866.size; ++_i2868)
          {
            _elem2867 = new TDDIVulnerabilityRef();
            _elem2867.read(iprot);
            struct.ExploitedVulnerabilities.add(_elem2867);
          }
        }
        struct.setExploitedVulnerabilitiesIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2869.size);
          TDDISecurityViolationRef _elem2870;
          for (int _i2871 = 0; _i2871 < _list2869.size; ++_i2871)
          {
            _elem2870 = new TDDISecurityViolationRef();
            _elem2870.read(iprot);
            struct.Violations.add(_elem2870);
          }
        }
        struct.setViolationsIsSet(true);
      }
