...
public class TDDIArtifactPackage implements org.apache.thrift.TBase<TDDIArtifactPackage, TDDIArtifactPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIArtifactPackage> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1896.size);
                TDDIImplementationConstraintRef _elem1897;
                for (int _i1898 = 0; _i1898 < _list1896.size; ++_i1898)
                {
                  _elem1897 = new TDDIImplementationConstraintRef();
                  _elem1897.read(iprot);
                  struct.ImplementationConstraint.add(_elem1897);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1899 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1899.size);
                TDDINoteRef _elem1900;
                for (int _i1901 = 0; _i1901 < _list1899.size; ++_i1901)
                {
                  _elem1900 = new TDDINoteRef();
                  _elem1900.read(iprot);
                  struct.Note.add(_elem1900);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1902 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1902.size);
                TDDITaggedValueRef _elem1903;
                for (int _i1904 = 0; _i1904 < _list1902.size; ++_i1904)
                {
                  _elem1903 = new TDDITaggedValueRef();
                  _elem1903.read(iprot);
                  struct.TaggedValue.add(_elem1903);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // ARTIFACT_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1905 = iprot.readListBegin();
                struct.ArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list1905.size);
                TDDIAbstractArtifactElementRef _elem1906;
                for (int _i1907 = 0; _i1907 < _list1905.size; ++_i1907)
                {
                  _elem1906 = new TDDIAbstractArtifactElementRef();
                  _elem1906.read(iprot);
                  struct.ArtifactElement.add(_elem1906);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArtifactPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1908 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1909 : struct.Note)
          {
            _iter1909.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1910 : struct.TaggedValue)
          {
            _iter1910.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ArtifactElement != null) {
        oprot.writeFieldBegin(ARTIFACT_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter1911 : struct.ArtifactElement)
          {
            _iter1911.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIArtifactPackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIArtifactPackage> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1912 : struct.ImplementationConstraint)
          {
            _iter1912.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1913 : struct.Note)
          {
            _iter1913.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1914 : struct.TaggedValue)
          {
            _iter1914.write(oprot);
          }
        }
      }
      if (struct.isSetArtifactElement()) {
        {
          ...
          for (TDDIAbstractArtifactElementRef _iter1915 : struct.ArtifactElement)
          {
            _iter1915.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIArtifactPackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1916 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1916.size);
          TDDIImplementationConstraintRef _elem1917;
          for (int _i1918 = 0; _i1918 < _list1916.size; ++_i1918)
          {
            _elem1917 = new TDDIImplementationConstraintRef();
            _elem1917.read(iprot);
            struct.ImplementationConstraint.add(_elem1917);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list1919 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1919.size);
          TDDINoteRef _elem1920;
          for (int _i1921 = 0; _i1921 < _list1919.size; ++_i1921)
          {
            _elem1920 = new TDDINoteRef();
            _elem1920.read(iprot);
            struct.Note.add(_elem1920);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1922 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1922.size);
          TDDITaggedValueRef _elem1923;
          for (int _i1924 = 0; _i1924 < _list1922.size; ++_i1924)
          {
            _elem1923 = new TDDITaggedValueRef();
            _elem1923.read(iprot);
            struct.TaggedValue.add(_elem1923);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list1925 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ArtifactElement = new java.util.ArrayList<TDDIAbstractArtifactElementRef>(_list1925.size);
          TDDIAbstractArtifactElementRef _elem1926;
          for (int _i1927 = 0; _i1927 < _list1925.size; ++_i1927)
          {
            _elem1926 = new TDDIAbstractArtifactElementRef();
            _elem1926.read(iprot);
            struct.ArtifactElement.add(_elem1926);
          }
        }
        struct.setArtifactElementIsSet(true);
      }
