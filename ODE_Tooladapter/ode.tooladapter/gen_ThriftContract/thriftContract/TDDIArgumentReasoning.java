            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1600.size);
                TDDIImplementationConstraintRef _elem1601;
                for (int _i1602 = 0; _i1602 < _list1600.size; ++_i1602)
                {
                  _elem1601 = new TDDIImplementationConstraintRef();
                  _elem1601.read(iprot);
                  struct.ImplementationConstraint.add(_elem1601);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1603.size);
                TDDINoteRef _elem1604;
                for (int _i1605 = 0; _i1605 < _list1603.size; ++_i1605)
                {
                  _elem1604 = new TDDINoteRef();
                  _elem1604.read(iprot);
                  struct.Note.add(_elem1604);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1606.size);
                TDDITaggedValueRef _elem1607;
                for (int _i1608 = 0; _i1608 < _list1606.size; ++_i1608)
                {
                  _elem1607 = new TDDITaggedValueRef();
                  _elem1607.read(iprot);
                  struct.TaggedValue.add(_elem1607);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIArgumentReasoning struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1609 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1610 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1611 : struct.TaggedValue)
          {
            _iter1611.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1612 : struct.ImplementationConstraint)
          {
      ...
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1613 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1614 : struct.TaggedValue)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1615.size);
          TDDIImplementationConstraintRef _elem1616;
          for (int _i1617 = 0; _i1617 < _list1615.size; ++_i1617)
          {
            _elem1616 = new TDDIImplementationConstraintRef();
            _elem1616.read(iprot);
            struct.ImplementationConstraint.add(_elem1616);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1618.size);
          TDDINoteRef _elem1619;
          for (int _i1620 = 0; _i1620 < _list1618.size; ++_i1620)
          {
            _elem1619 = new TDDINoteRef();
            _elem1619.read(iprot);
            struct.Note.add(_elem1619);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1621.size);
          TDDITaggedValueRef _elem1622;
          for (int _i1623 = 0; _i1623 < _list1621.size; ++_i1623)
          {
            _elem1622 = new TDDITaggedValueRef();
            _elem1622.read(iprot);
            struct.TaggedValue.add(_elem1622);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
