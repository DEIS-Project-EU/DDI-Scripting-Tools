...
public class TDDIAttackerGoal implements org.apache.thrift.TBase<TDDIAttackerGoal, TDDIAttackerGoal._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAttackerGoal> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2928 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2928.size);
                TDDIKeyValueMap _elem2929;
                for (int _i2930 = 0; _i2930 < _list2928.size; ++_i2930)
                {
                  _elem2929 = new TDDIKeyValueMap();
                  _elem2929.read(iprot);
                  struct.KeyValueMaps.add(_elem2929);
                }
                iprot.readListEnd();
              }
          ...
          case 6: // ATTACKS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2931 = iprot.readListBegin();
                struct.Attacks = new java.util.ArrayList<TDDIAbstractAttack>(_list2931.size);
                TDDIAbstractAttack _elem2932;
                for (int _i2933 = 0; _i2933 < _list2931.size; ++_i2933)
                {
                  _elem2932 = new TDDIAbstractAttack();
                  _elem2932.read(iprot);
                  struct.Attacks.add(_elem2932);
                }
                iprot.readListEnd();
              }
          ...
          case 7: // ADDRESSED_BY
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2934 = iprot.readListBegin();
                struct.AddressedBy = new java.util.ArrayList<TDDISecurityCapability>(_list2934.size);
                TDDISecurityCapability _elem2935;
                for (int _i2936 = 0; _i2936 < _list2934.size; ++_i2936)
                {
                  _elem2935 = new TDDISecurityCapability();
                  _elem2935.read(iprot);
                  struct.AddressedBy.add(_elem2935);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // ATTACKED_ITEMS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2937 = iprot.readListBegin();
                struct.AttackedItems = new java.util.ArrayList<TDDIVulnerableItemRef>(_list2937.size);
                TDDIVulnerableItemRef _elem2938;
                for (int _i2939 = 0; _i2939 < _list2937.size; ++_i2939)
                {
                  _elem2938 = new TDDIVulnerableItemRef();
                  _elem2938.read(iprot);
                  struct.AttackedItems.add(_elem2938);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAttackerGoal struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2940 : struct.KeyValueMaps)
          {
            _iter2940.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Attacks != null) {
        oprot.writeFieldBegin(ATTACKS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractAttack _iter2941 : struct.Attacks)
          {
            _iter2941.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AddressedBy != null) {
        oprot.writeFieldBegin(ADDRESSED_BY_FIELD_DESC);
        {
          ...
          for (TDDISecurityCapability _iter2942 : struct.AddressedBy)
          {
            _iter2942.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AttackedItems != null) {
        oprot.writeFieldBegin(ATTACKED_ITEMS_FIELD_DESC);
        {
          ...
          for (TDDIVulnerableItemRef _iter2943 : struct.AttackedItems)
          {
            _iter2943.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIAttackerGoalTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAttackerGoal> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2944 : struct.KeyValueMaps)
          {
            _iter2944.write(oprot);
          }
        }
      }
      if (struct.isSetCategory()) {
      ...
      if (struct.isSetAttacks()) {
        {
          ...
          for (TDDIAbstractAttack _iter2945 : struct.Attacks)
          {
            _iter2945.write(oprot);
          }
        }
      }
      if (struct.isSetAddressedBy()) {
        {
          ...
          for (TDDISecurityCapability _iter2946 : struct.AddressedBy)
          {
            _iter2946.write(oprot);
          }
        }
      }
      if (struct.isSetAttackedItems()) {
        {
          ...
          for (TDDIVulnerableItemRef _iter2947 : struct.AttackedItems)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAttackerGoal struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2948 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2948.size);
          TDDIKeyValueMap _elem2949;
          for (int _i2950 = 0; _i2950 < _list2948.size; ++_i2950)
          {
            _elem2949 = new TDDIKeyValueMap();
            _elem2949.read(iprot);
            struct.KeyValueMaps.add(_elem2949);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list2951 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Attacks = new java.util.ArrayList<TDDIAbstractAttack>(_list2951.size);
          TDDIAbstractAttack _elem2952;
          for (int _i2953 = 0; _i2953 < _list2951.size; ++_i2953)
          {
            _elem2952 = new TDDIAbstractAttack();
            _elem2952.read(iprot);
            struct.Attacks.add(_elem2952);
          }
        }
        struct.setAttacksIsSet(true);
      }
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list2954 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.AddressedBy = new java.util.ArrayList<TDDISecurityCapability>(_list2954.size);
          TDDISecurityCapability _elem2955;
          for (int _i2956 = 0; _i2956 < _list2954.size; ++_i2956)
          {
            _elem2955 = new TDDISecurityCapability();
            _elem2955.read(iprot);
            struct.AddressedBy.add(_elem2955);
          }
        }
        struct.setAddressedByIsSet(true);
      }
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2957 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.AttackedItems = new java.util.ArrayList<TDDIVulnerableItemRef>(_list2957.size);
          TDDIVulnerableItemRef _elem2958;
          for (int _i2959 = 0; _i2959 < _list2957.size; ++_i2959)
          {
            _elem2958 = new TDDIVulnerableItemRef();
            _elem2958.read(iprot);
            struct.AttackedItems.add(_elem2958);
          }
        }
        struct.setAttackedItemsIsSet(true);
      }
