...
public class TDDIAction implements org.apache.thrift.TBase<TDDIAction, TDDIAction._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAction> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2872.size);
                TDDIKeyValueMap _elem2873;
                for (int _i2874 = 0; _i2874 < _list2872.size; ++_i2874)
                {
                  _elem2873 = new TDDIKeyValueMap();
                  _elem2873.read(iprot);
                  struct.KeyValueMaps.add(_elem2873);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2875.size);
                TDDIVulnerabilityRef _elem2876;
                for (int _i2877 = 0; _i2877 < _list2875.size; ++_i2877)
                {
                  _elem2876 = new TDDIVulnerabilityRef();
                  _elem2876.read(iprot);
                  struct.ExploitedVulnerabilities.add(_elem2876);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2878.size);
                TDDISecurityViolationRef _elem2879;
                for (int _i2880 = 0; _i2880 < _list2878.size; ++_i2880)
                {
                  _elem2879 = new TDDISecurityViolationRef();
                  _elem2879.read(iprot);
                  struct.Violations.add(_elem2879);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAction struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2881 : struct.KeyValueMaps)
          {
            _iter2881.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.ExploitedVulnerabilities != null) {
        oprot.writeFieldBegin(EXPLOITED_VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerabilityRef _iter2882 : struct.ExploitedVulnerabilities)
          {
            _iter2882.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Violations != null) {
        oprot.writeFieldBegin(VIOLATIONS_FIELD_DESC);
        {
          ...
          for (TDDISecurityViolationRef _iter2883 : struct.Violations)
          {
            _iter2883.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIActionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAction> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2884 : struct.KeyValueMaps)
          {
            _iter2884.write(oprot);
          }
        }
      }
      if (struct.isSetCategory()) {
      ...
      if (struct.isSetExploitedVulnerabilities()) {
        {
          ...
          for (TDDIVulnerabilityRef _iter2885 : struct.ExploitedVulnerabilities)
          {
            _iter2885.write(oprot);
          }
        }
      }
      if (struct.isSetViolations()) {
        {
          ...
          for (TDDISecurityViolationRef _iter2886 : struct.Violations)
          {
            _iter2886.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAction struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2887 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2887.size);
          TDDIKeyValueMap _elem2888;
          for (int _i2889 = 0; _i2889 < _list2887.size; ++_i2889)
          {
            _elem2888 = new TDDIKeyValueMap();
            _elem2888.read(iprot);
            struct.KeyValueMaps.add(_elem2888);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list2890 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2890.size);
          TDDIVulnerabilityRef _elem2891;
          for (int _i2892 = 0; _i2892 < _list2890.size; ++_i2892)
          {
            _elem2891 = new TDDIVulnerabilityRef();
            _elem2891.read(iprot);
            struct.ExploitedVulnerabilities.add(_elem2891);
          }
        }
        struct.setExploitedVulnerabilitiesIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2893.size);
          TDDISecurityViolationRef _elem2894;
          for (int _i2895 = 0; _i2895 < _list2893.size; ++_i2895)
          {
            _elem2894 = new TDDISecurityViolationRef();
            _elem2894.read(iprot);
            struct.Violations.add(_elem2894);
          }
        }
        struct.setViolationsIsSet(true);
      }
