...
public class TDDISystemBoundary implements org.apache.thrift.TBase<TDDISystemBoundary, TDDISystemBoundary._Fields>, java.io.Serializable, Cloneable, Comparable<TDDISystemBoundary> {
  ...
  private static final org.apache.thrift.protocol.TField PORTS_FIELD_DESC = new org.apache.thrift.protocol.TField("Ports", org.apache.thrift.protocol.TType.LIST, (short)5);
  ...
  public TDDISystemBoundary setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list136.size);
                TDDIKeyValueMap _elem137;
                for (int _i138 = 0; _i138 < _list136.size; ++_i138)
                {
                  _elem137 = new TDDIKeyValueMap();
                  _elem137.read(iprot);
                  struct.KeyValueMaps.add(_elem137);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Ports = new java.util.ArrayList<TDDIPortRef>(_list139.size);
                TDDIPortRef _elem140;
                for (int _i141 = 0; _i141 < _list139.size; ++_i141)
                {
                  _elem140 = new TDDIPortRef();
                  _elem140.read(iprot);
                  struct.Ports.add(_elem140);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDISystemBoundary struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter142 : struct.KeyValueMaps)
          {
      ...
      if (struct.Ports != null) {
        oprot.writeFieldBegin(PORTS_FIELD_DESC);
        {
          ...
          for (TDDIPortRef _iter143 : struct.Ports)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter144 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetPorts()) {
        {
          ...
          for (TDDIPortRef _iter145 : struct.Ports)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list146.size);
          TDDIKeyValueMap _elem147;
          for (int _i148 = 0; _i148 < _list146.size; ++_i148)
          {
            _elem147 = new TDDIKeyValueMap();
            _elem147.read(iprot);
            struct.KeyValueMaps.add(_elem147);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.Ports = new java.util.ArrayList<TDDIPortRef>(_list149.size);
          TDDIPortRef _elem150;
          for (int _i151 = 0; _i151 < _list149.size; ++_i151)
          {
            _elem150 = new TDDIPortRef();
            _elem150.read(iprot);
            struct.Ports.add(_elem150);
          }
        }
        struct.setPortsIsSet(true);
      }
