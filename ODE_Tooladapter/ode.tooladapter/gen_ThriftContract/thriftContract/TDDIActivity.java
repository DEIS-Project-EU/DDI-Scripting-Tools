...
public class TDDIActivity implements org.apache.thrift.TBase<TDDIActivity, TDDIActivity._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIActivity> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2128 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2128.size);
                TDDIImplementationConstraintRef _elem2129;
                for (int _i2130 = 0; _i2130 < _list2128.size; ++_i2130)
                {
                  _elem2129 = new TDDIImplementationConstraintRef();
                  _elem2129.read(iprot);
                  struct.ImplementationConstraint.add(_elem2129);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2131 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2131.size);
                TDDINoteRef _elem2132;
                for (int _i2133 = 0; _i2133 < _list2131.size; ++_i2133)
                {
                  _elem2132 = new TDDINoteRef();
                  _elem2132.read(iprot);
                  struct.Note.add(_elem2132);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2134.size);
                TDDITaggedValueRef _elem2135;
                for (int _i2136 = 0; _i2136 < _list2134.size; ++_i2136)
                {
                  _elem2135 = new TDDITaggedValueRef();
                  _elem2135.read(iprot);
                  struct.TaggedValue.add(_elem2135);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2137.size);
                TDDIPropertyRef _elem2138;
                for (int _i2139 = 0; _i2139 < _list2137.size; ++_i2139)
                {
                  _elem2138 = new TDDIPropertyRef();
                  _elem2138.read(iprot);
                  struct.Property.add(_elem2138);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIActivity struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2140 : struct.ImplementationConstraint)
          {
            _iter2140.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2141 : struct.Note)
          {
            _iter2141.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2142 : struct.TaggedValue)
          {
            _iter2142.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Property != null) {
        oprot.writeFieldBegin(PROPERTY_FIELD_DESC);
        {
          ...
          for (TDDIPropertyRef _iter2143 : struct.Property)
          {
            _iter2143.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIActivityTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIActivity> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2144 : struct.ImplementationConstraint)
          {
            _iter2144.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2145 : struct.Note)
          {
            _iter2145.write(oprot);
          }
        }
      }
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2146 : struct.TaggedValue)
          {
            _iter2146.write(oprot);
          }
        }
      }
      if (struct.isSetProperty()) {
        {
          ...
          for (TDDIPropertyRef _iter2147 : struct.Property)
          {
            _iter2147.write(oprot);
          }
        }
      }
      if (struct.isSetStartTime()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIActivity struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2148 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2148.size);
          TDDIImplementationConstraintRef _elem2149;
          for (int _i2150 = 0; _i2150 < _list2148.size; ++_i2150)
          {
            _elem2149 = new TDDIImplementationConstraintRef();
            _elem2149.read(iprot);
            struct.ImplementationConstraint.add(_elem2149);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2151 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2151.size);
          TDDINoteRef _elem2152;
          for (int _i2153 = 0; _i2153 < _list2151.size; ++_i2153)
          {
            _elem2152 = new TDDINoteRef();
            _elem2152.read(iprot);
            struct.Note.add(_elem2152);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2154 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2154.size);
          TDDITaggedValueRef _elem2155;
          for (int _i2156 = 0; _i2156 < _list2154.size; ++_i2156)
          {
            _elem2155 = new TDDITaggedValueRef();
            _elem2155.read(iprot);
            struct.TaggedValue.add(_elem2155);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2157 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Property = new java.util.ArrayList<TDDIPropertyRef>(_list2157.size);
          TDDIPropertyRef _elem2158;
          for (int _i2159 = 0; _i2159 < _list2157.size; ++_i2159)
          {
            _elem2158 = new TDDIPropertyRef();
            _elem2158.read(iprot);
            struct.Property.add(_elem2158);
          }
        }
        struct.setPropertyIsSet(true);
      }
