...
public class TDDIAssertedContext implements org.apache.thrift.TBase<TDDIAssertedContext, TDDIAssertedContext._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAssertedContext> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1848.size);
                TDDIImplementationConstraintRef _elem1849;
                for (int _i1850 = 0; _i1850 < _list1848.size; ++_i1850)
                {
                  _elem1849 = new TDDIImplementationConstraintRef();
                  _elem1849.read(iprot);
                  struct.ImplementationConstraint.add(_elem1849);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1851 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1851.size);
                TDDINoteRef _elem1852;
                for (int _i1853 = 0; _i1853 < _list1851.size; ++_i1853)
                {
                  _elem1852 = new TDDINoteRef();
                  _elem1852.read(iprot);
                  struct.Note.add(_elem1852);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1854.size);
                TDDITaggedValueRef _elem1855;
                for (int _i1856 = 0; _i1856 < _list1854.size; ++_i1856)
                {
                  _elem1855 = new TDDITaggedValueRef();
                  _elem1855.read(iprot);
                  struct.TaggedValue.add(_elem1855);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // META_CLAIM
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1857 = iprot.readListBegin();
                struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list1857.size);
                TDDIClaimRef _elem1858;
                for (int _i1859 = 0; _i1859 < _list1857.size; ++_i1859)
                {
                  _elem1858 = new TDDIClaimRef();
                  _elem1858.read(iprot);
                  struct.MetaClaim.add(_elem1858);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Source = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1860.size);
                TDDIAbstractArgumentAssetRef _elem1861;
                for (int _i1862 = 0; _i1862 < _list1860.size; ++_i1862)
                {
                  _elem1861 = new TDDIAbstractArgumentAssetRef();
                  _elem1861.read(iprot);
                  struct.Source.add(_elem1861);
                }
                iprot.readListEnd();
              }
          ...
          case 15: // TARGET
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list1863 = iprot.readListBegin();
                struct.Target = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1863.size);
                TDDIAbstractArgumentAssetRef _elem1864;
                for (int _i1865 = 0; _i1865 < _list1863.size; ++_i1865)
                {
                  _elem1864 = new TDDIAbstractArgumentAssetRef();
                  _elem1864.read(iprot);
                  struct.Target.add(_elem1864);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAssertedContext struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter1866 : struct.ImplementationConstraint)
          {
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter1867 : struct.Note)
          {
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter1868 : struct.TaggedValue)
          {
      ...
      if (struct.MetaClaim != null) {
        oprot.writeFieldBegin(META_CLAIM_FIELD_DESC);
        {
          ...
          for (TDDIClaimRef _iter1869 : struct.MetaClaim)
          {
      ...
      if (struct.Source != null) {
        oprot.writeFieldBegin(SOURCE_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1870 : struct.Source)
          {
      ...
      if (struct.Target != null) {
        oprot.writeFieldBegin(TARGET_FIELD_DESC);
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1871 : struct.Target)
          {
            _iter1871.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIAssertedContextTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAssertedContext> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter1872 : struct.ImplementationConstraint)
          {
            _iter1872.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter1873 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter1874 : struct.TaggedValue)
          {
      ...
      if (struct.isSetMetaClaim()) {
        {
          ...
          for (TDDIClaimRef _iter1875 : struct.MetaClaim)
          {
      ...
      if (struct.isSetSource()) {
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1876 : struct.Source)
          {
      ...
      if (struct.isSetTarget()) {
        {
          ...
          for (TDDIAbstractArgumentAssetRef _iter1877 : struct.Target)
          {
            _iter1877.write(oprot);
          }
        }
      }
      if (struct.isSetReasoning()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAssertedContext struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list1878 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list1878.size);
          TDDIImplementationConstraintRef _elem1879;
          for (int _i1880 = 0; _i1880 < _list1878.size; ++_i1880)
          {
            _elem1879 = new TDDIImplementationConstraintRef();
            _elem1879.read(iprot);
            struct.ImplementationConstraint.add(_elem1879);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list1881.size);
          TDDINoteRef _elem1882;
          for (int _i1883 = 0; _i1883 < _list1881.size; ++_i1883)
          {
            _elem1882 = new TDDINoteRef();
            _elem1882.read(iprot);
            struct.Note.add(_elem1882);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list1884 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list1884.size);
          TDDITaggedValueRef _elem1885;
          for (int _i1886 = 0; _i1886 < _list1884.size; ++_i1886)
          {
            _elem1885 = new TDDITaggedValueRef();
            _elem1885.read(iprot);
            struct.TaggedValue.add(_elem1885);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list1887 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.MetaClaim = new java.util.ArrayList<TDDIClaimRef>(_list1887.size);
          TDDIClaimRef _elem1888;
          for (int _i1889 = 0; _i1889 < _list1887.size; ++_i1889)
          {
            _elem1888 = new TDDIClaimRef();
            _elem1888.read(iprot);
            struct.MetaClaim.add(_elem1888);
          }
        }
        struct.setMetaClaimIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TList _list1890 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Source = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1890.size);
          TDDIAbstractArgumentAssetRef _elem1891;
          for (int _i1892 = 0; _i1892 < _list1890.size; ++_i1892)
          {
            _elem1891 = new TDDIAbstractArgumentAssetRef();
            _elem1891.read(iprot);
            struct.Source.add(_elem1891);
          }
        }
        struct.setSourceIsSet(true);
      }
      if (incoming.get(14)) {
        {
          org.apache.thrift.protocol.TList _list1893 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Target = new java.util.ArrayList<TDDIAbstractArgumentAssetRef>(_list1893.size);
          TDDIAbstractArgumentAssetRef _elem1894;
          for (int _i1895 = 0; _i1895 < _list1893.size; ++_i1895)
          {
            _elem1894 = new TDDIAbstractArgumentAssetRef();
            _elem1894.read(iprot);
            struct.Target.add(_elem1894);
          }
        }
        struct.setTargetIsSet(true);
      }
