...
public class TDDIAsset implements org.apache.thrift.TBase<TDDIAsset, TDDIAsset._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIAsset> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIAsset");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIAssetStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIAssetTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIAsset.class, metaDataMap);
  }
   ...
   */
  public TDDIAsset(TDDIAsset other) {
  ...
  public TDDIAsset deepCopy() {
    return new TDDIAsset(this);
  }
  ...
  public TDDIAsset setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIAsset setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIAsset setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIAsset setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIAsset setFinancialValue(double FinancialValue) {
    this.FinancialValue = FinancialValue;
    setFinancialValueIsSet(true);
    return this;
  }
   ...
   * @see TDDIFinancialCostType
   */
  public TDDIAsset setFinancialCostType(TDDIFinancialCostType FinancialCostType) {
    this.FinancialCostType = FinancialCostType;
    return this;
  }
  ...
  public TDDIAsset setOperationalCost(double OperationalCost) {
    this.OperationalCost = OperationalCost;
    setOperationalCostIsSet(true);
    return this;
  }
   ...
   * @see TDDIOperationalCostType
   */
  public TDDIAsset setOperationalCostType(TDDIOperationalCostType OperationalCostType) {
    this.OperationalCostType = OperationalCostType;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIAsset)
      return this.equals((TDDIAsset)that);
    return false;
  }

  public boolean equals(TDDIAsset that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIAsset other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIAsset(");
    boolean first = true;
  ...
  private static class TDDIAssetStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIAssetStandardScheme getScheme() {
      return new TDDIAssetStandardScheme();
    }
  }

  private static class TDDIAssetStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIAsset> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIAsset struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2776 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2776.size);
                TDDIKeyValueMap _elem2777;
                for (int _i2778 = 0; _i2778 < _list2776.size; ++_i2778)
                {
                  _elem2777 = new TDDIKeyValueMap();
                  _elem2777.read(iprot);
                  struct.KeyValueMaps.add(_elem2777);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIAsset struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2779 : struct.KeyValueMaps)
          {
  ...
  private static class TDDIAssetTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIAssetTupleScheme getScheme() {
      return new TDDIAssetTupleScheme();
    }
  }

  private static class TDDIAssetTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIAsset> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIAsset struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2780 : struct.KeyValueMaps)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIAsset struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2781 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2781.size);
          TDDIKeyValueMap _elem2782;
          for (int _i2783 = 0; _i2783 < _list2781.size; ++_i2783)
          {
            _elem2782 = new TDDIKeyValueMap();
            _elem2782.read(iprot);
            struct.KeyValueMaps.add(_elem2782);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
