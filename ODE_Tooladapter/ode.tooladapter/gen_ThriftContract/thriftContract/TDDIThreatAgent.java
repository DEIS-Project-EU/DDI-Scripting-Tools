...
public class TDDIThreatAgent implements org.apache.thrift.TBase<TDDIThreatAgent, TDDIThreatAgent._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIThreatAgent> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2952.size);
                TDDIKeyValueMap _elem2953;
                for (int _i2954 = 0; _i2954 < _list2952.size; ++_i2954)
                {
                  _elem2953 = new TDDIKeyValueMap();
                  _elem2953.read(iprot);
                  struct.KeyValueMaps.add(_elem2953);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list2955.size);
                TDDIAttackerGoal _elem2956;
                for (int _i2957 = 0; _i2957 < _list2955.size; ++_i2957)
                {
                  _elem2956 = new TDDIAttackerGoal();
                  _elem2956.read(iprot);
                  struct.AttackerGoals.add(_elem2956);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIThreatAgent struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2958 : struct.KeyValueMaps)
          {
            _iter2958.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.AttackerGoals != null) {
        oprot.writeFieldBegin(ATTACKER_GOALS_FIELD_DESC);
        {
          ...
          for (TDDIAttackerGoal _iter2959 : struct.AttackerGoals)
          {
            _iter2959.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIThreatAgentTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIThreatAgent> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2960 : struct.KeyValueMaps)
          {
            _iter2960.write(oprot);
          }
        }
      }
      if (struct.isSetSkillLevel()) {
      ...
      if (struct.isSetAttackerGoals()) {
        {
          ...
          for (TDDIAttackerGoal _iter2961 : struct.AttackerGoals)
          {
            _iter2961.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIThreatAgent struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2962 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2962.size);
          TDDIKeyValueMap _elem2963;
          for (int _i2964 = 0; _i2964 < _list2962.size; ++_i2964)
          {
            _elem2963 = new TDDIKeyValueMap();
            _elem2963.read(iprot);
            struct.KeyValueMaps.add(_elem2963);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2965 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list2965.size);
          TDDIAttackerGoal _elem2966;
          for (int _i2967 = 0; _i2967 < _list2965.size; ++_i2967)
          {
            _elem2966 = new TDDIAttackerGoal();
            _elem2966.read(iprot);
            struct.AttackerGoals.add(_elem2966);
          }
        }
        struct.setAttackerGoalsIsSet(true);
      }
