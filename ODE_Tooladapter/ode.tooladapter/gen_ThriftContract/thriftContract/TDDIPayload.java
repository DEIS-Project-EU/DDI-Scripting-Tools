...
public class TDDIPayload implements org.apache.thrift.TBase<TDDIPayload, TDDIPayload._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIPayload> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2904 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2904.size);
                TDDIKeyValueMap _elem2905;
                for (int _i2906 = 0; _i2906 < _list2904.size; ++_i2906)
                {
                  _elem2905 = new TDDIKeyValueMap();
                  _elem2905.read(iprot);
                  struct.KeyValueMaps.add(_elem2905);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // EXPLOITED_VULNERABILITIES
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2907 = iprot.readListBegin();
                struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2907.size);
                TDDIVulnerabilityRef _elem2908;
                for (int _i2909 = 0; _i2909 < _list2907.size; ++_i2909)
                {
                  _elem2908 = new TDDIVulnerabilityRef();
                  _elem2908.read(iprot);
                  struct.ExploitedVulnerabilities.add(_elem2908);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // VIOLATIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2910 = iprot.readListBegin();
                struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2910.size);
                TDDISecurityViolationRef _elem2911;
                for (int _i2912 = 0; _i2912 < _list2910.size; ++_i2912)
                {
                  _elem2911 = new TDDISecurityViolationRef();
                  _elem2911.read(iprot);
                  struct.Violations.add(_elem2911);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIPayload struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2913 : struct.KeyValueMaps)
          {
      ...
      if (struct.ExploitedVulnerabilities != null) {
        oprot.writeFieldBegin(EXPLOITED_VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerabilityRef _iter2914 : struct.ExploitedVulnerabilities)
          {
      ...
      if (struct.Violations != null) {
        oprot.writeFieldBegin(VIOLATIONS_FIELD_DESC);
        {
          ...
          for (TDDISecurityViolationRef _iter2915 : struct.Violations)
          {
  ...
  private static class TDDIPayloadTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIPayload> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2916 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetExploitedVulnerabilities()) {
        {
          ...
          for (TDDIVulnerabilityRef _iter2917 : struct.ExploitedVulnerabilities)
          {
            _iter2917.write(oprot);
          }
        }
      }
      if (struct.isSetViolations()) {
        {
          ...
          for (TDDISecurityViolationRef _iter2918 : struct.Violations)
          {
            _iter2918.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIPayload struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2919 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2919.size);
          TDDIKeyValueMap _elem2920;
          for (int _i2921 = 0; _i2921 < _list2919.size; ++_i2921)
          {
            _elem2920 = new TDDIKeyValueMap();
            _elem2920.read(iprot);
            struct.KeyValueMaps.add(_elem2920);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list2922 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2922.size);
          TDDIVulnerabilityRef _elem2923;
          for (int _i2924 = 0; _i2924 < _list2922.size; ++_i2924)
          {
            _elem2923 = new TDDIVulnerabilityRef();
            _elem2923.read(iprot);
            struct.ExploitedVulnerabilities.add(_elem2923);
          }
        }
        struct.setExploitedVulnerabilitiesIsSet(true);
      }
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TList _list2925 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2925.size);
          TDDISecurityViolationRef _elem2926;
          for (int _i2927 = 0; _i2927 < _list2925.size; ++_i2927)
          {
            _elem2926 = new TDDISecurityViolationRef();
            _elem2926.read(iprot);
            struct.Violations.add(_elem2926);
          }
        }
        struct.setViolationsIsSet(true);
      }
