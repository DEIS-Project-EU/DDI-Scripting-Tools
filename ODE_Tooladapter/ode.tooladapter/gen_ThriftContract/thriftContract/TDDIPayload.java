...
public class TDDIPayload implements org.apache.thrift.TBase<TDDIPayload, TDDIPayload._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIPayload> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2896.size);
                TDDIKeyValueMap _elem2897;
                for (int _i2898 = 0; _i2898 < _list2896.size; ++_i2898)
                {
                  _elem2897 = new TDDIKeyValueMap();
                  _elem2897.read(iprot);
                  struct.KeyValueMaps.add(_elem2897);
                }
                iprot.readListEnd();
              }
          ...
          case 12: // EXPLOITED_VULNERABILITIES
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2899 = iprot.readListBegin();
                struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2899.size);
                TDDIVulnerabilityRef _elem2900;
                for (int _i2901 = 0; _i2901 < _list2899.size; ++_i2901)
                {
                  _elem2900 = new TDDIVulnerabilityRef();
                  _elem2900.read(iprot);
                  struct.ExploitedVulnerabilities.add(_elem2900);
                }
                iprot.readListEnd();
              }
          ...
          case 13: // VIOLATIONS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2902 = iprot.readListBegin();
                struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2902.size);
                TDDISecurityViolationRef _elem2903;
                for (int _i2904 = 0; _i2904 < _list2902.size; ++_i2904)
                {
                  _elem2903 = new TDDISecurityViolationRef();
                  _elem2903.read(iprot);
                  struct.Violations.add(_elem2903);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIPayload struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2905 : struct.KeyValueMaps)
          {
      ...
      if (struct.ExploitedVulnerabilities != null) {
        oprot.writeFieldBegin(EXPLOITED_VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerabilityRef _iter2906 : struct.ExploitedVulnerabilities)
          {
      ...
      if (struct.Violations != null) {
        oprot.writeFieldBegin(VIOLATIONS_FIELD_DESC);
        {
          ...
          for (TDDISecurityViolationRef _iter2907 : struct.Violations)
          {
  ...
  private static class TDDIPayloadTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIPayload> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2908 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetExploitedVulnerabilities()) {
        {
          ...
          for (TDDIVulnerabilityRef _iter2909 : struct.ExploitedVulnerabilities)
          {
      ...
      if (struct.isSetViolations()) {
        {
          ...
          for (TDDISecurityViolationRef _iter2910 : struct.Violations)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIPayload struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2911 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2911.size);
          TDDIKeyValueMap _elem2912;
          for (int _i2913 = 0; _i2913 < _list2911.size; ++_i2913)
          {
            _elem2912 = new TDDIKeyValueMap();
            _elem2912.read(iprot);
            struct.KeyValueMaps.add(_elem2912);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list2914 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ExploitedVulnerabilities = new java.util.ArrayList<TDDIVulnerabilityRef>(_list2914.size);
          TDDIVulnerabilityRef _elem2915;
          for (int _i2916 = 0; _i2916 < _list2914.size; ++_i2916)
          {
            _elem2915 = new TDDIVulnerabilityRef();
            _elem2915.read(iprot);
            struct.ExploitedVulnerabilities.add(_elem2915);
          }
        }
        struct.setExploitedVulnerabilitiesIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.Violations = new java.util.ArrayList<TDDISecurityViolationRef>(_list2917.size);
          TDDISecurityViolationRef _elem2918;
          for (int _i2919 = 0; _i2919 < _list2917.size; ++_i2919)
          {
            _elem2918 = new TDDISecurityViolationRef();
            _elem2918.read(iprot);
            struct.Violations.add(_elem2918);
          }
        }
        struct.setViolationsIsSet(true);
      }
