...
public class TDDIProbDist implements org.apache.thrift.TBase<TDDIProbDist, TDDIProbDist._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIProbDist> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDDIProbDist");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDDIProbDistStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDDIProbDistTupleSchemeFactory();
  ...
  public java.util.List<TDDIProbDistParam> Parameters; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDDIProbDist.class, metaDataMap);
  }
  ...
  public TDDIProbDist() {
    ...
    this.Parameters = new java.util.ArrayList<TDDIProbDistParam>();
  ...
  public TDDIProbDist(
    ...
    java.util.List<TDDIProbDistParam> Parameters)
  {
    this();
    this.Id = Id;
    setIdIsSet(true);
   ...
   */
  public TDDIProbDist(TDDIProbDist other) {
    ...
    if (other.isSetParameters()) {
      java.util.List<TDDIProbDistParam> __this__Parameters = new java.util.ArrayList<TDDIProbDistParam>(other.Parameters.size());
      for (TDDIProbDistParam other_element : other.Parameters) {
        __this__Parameters.add(new TDDIProbDistParam(other_element));
      }
      this.Parameters = __this__Parameters;
    }
  }

  public TDDIProbDist deepCopy() {
    return new TDDIProbDist(this);
  }
  ...
  public TDDIProbDist setId(long Id) {
    this.Id = Id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TDDIProbDist setName(java.lang.String Name) {
    this.Name = Name;
    return this;
  }
  ...
  public TDDIProbDist setDescription(java.lang.String Description) {
    this.Description = Description;
    return this;
  }
  ...
  public TDDIProbDist setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDIProbDist setType(java.lang.String Type) {
    this.Type = Type;
    return this;
  }
  ...
  public java.util.Iterator<TDDIProbDistParam> getParametersIterator() {
    return (this.Parameters == null) ? null : this.Parameters.iterator();
  }

  public void addToParameters(TDDIProbDistParam elem) {
  ...
  public java.util.List<TDDIProbDistParam> getParameters() {
    return this.Parameters;
  }

  public TDDIProbDist setParameters(java.util.List<TDDIProbDistParam> Parameters) {
    this.Parameters = Parameters;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PARAMETERS:
      if (value == null) {
        ...
        setParameters((java.util.List<TDDIProbDistParam>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TDDIProbDist)
      return this.equals((TDDIProbDist)that);
    return false;
  }

  public boolean equals(TDDIProbDist that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TDDIProbDist other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TDDIProbDist(");
    boolean first = true;
  ...
  private static class TDDIProbDistStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIProbDistStandardScheme getScheme() {
      return new TDDIProbDistStandardScheme();
    }
  }

  private static class TDDIProbDistStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDDIProbDist> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TDDIProbDist struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list776.size);
                TDDIKeyValueMap _elem777;
                for (int _i778 = 0; _i778 < _list776.size; ++_i778)
                {
                  _elem777 = new TDDIKeyValueMap();
                  _elem777.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Parameters = new java.util.ArrayList<TDDIProbDistParam>(_list779.size);
                TDDIProbDistParam _elem780;
                for (int _i781 = 0; _i781 < _list779.size; ++_i781)
                {
                  _elem780 = new TDDIProbDistParam();
                  _elem780.read(iprot);
                  struct.Parameters.add(_elem780);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIProbDist struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter782 : struct.KeyValueMaps)
          {
      ...
      if (struct.Parameters != null) {
        oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
        {
          ...
          for (TDDIProbDistParam _iter783 : struct.Parameters)
          {
  ...
  private static class TDDIProbDistTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TDDIProbDistTupleScheme getScheme() {
      return new TDDIProbDistTupleScheme();
    }
  }

  private static class TDDIProbDistTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIProbDist> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDDIProbDist struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter784 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (TDDIProbDistParam _iter785 : struct.Parameters)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIProbDist struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list786.size);
          TDDIKeyValueMap _elem787;
          for (int _i788 = 0; _i788 < _list786.size; ++_i788)
          {
            _elem787 = new TDDIKeyValueMap();
            _elem787.read(iprot);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.Parameters = new java.util.ArrayList<TDDIProbDistParam>(_list789.size);
          TDDIProbDistParam _elem790;
          for (int _i791 = 0; _i791 < _list789.size; ++_i791)
          {
            _elem790 = new TDDIProbDistParam();
            _elem790.read(iprot);
            struct.Parameters.add(_elem790);
          }
        }
        struct.setParametersIsSet(true);
      }
