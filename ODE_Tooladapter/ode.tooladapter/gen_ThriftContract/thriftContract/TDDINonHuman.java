        ...
        switch (schemeField.id) {
          ...
          case 4: // KEY_VALUE_MAPS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2992 = iprot.readListBegin();
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2992.size);
                TDDIKeyValueMap _elem2993;
                for (int _i2994 = 0; _i2994 < _list2992.size; ++_i2994)
                {
                  _elem2993 = new TDDIKeyValueMap();
                  _elem2993.read(iprot);
                  struct.KeyValueMaps.add(_elem2993);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // ATTACKER_GOALS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2995 = iprot.readListBegin();
                struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list2995.size);
                TDDIAttackerGoal _elem2996;
                for (int _i2997 = 0; _i2997 < _list2995.size; ++_i2997)
                {
                  _elem2996 = new TDDIAttackerGoal();
                  _elem2996.read(iprot);
                  struct.AttackerGoals.add(_elem2996);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // PAYLOADS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2998 = iprot.readListBegin();
                struct.Payloads = new java.util.ArrayList<TDDIPayloadRef>(_list2998.size);
                TDDIPayloadRef _elem2999;
                for (int _i3000 = 0; _i3000 < _list2998.size; ++_i3000)
                {
                  _elem2999 = new TDDIPayloadRef();
                  _elem2999.read(iprot);
                  struct.Payloads.add(_elem2999);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDINonHuman struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter3001 : struct.KeyValueMaps)
          {
      ...
      if (struct.AttackerGoals != null) {
        oprot.writeFieldBegin(ATTACKER_GOALS_FIELD_DESC);
        {
          ...
          for (TDDIAttackerGoal _iter3002 : struct.AttackerGoals)
          {
      ...
      if (struct.Payloads != null) {
        oprot.writeFieldBegin(PAYLOADS_FIELD_DESC);
        {
          ...
          for (TDDIPayloadRef _iter3003 : struct.Payloads)
          {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter3004 : struct.KeyValueMaps)
          {
            _iter3004.write(oprot);
          }
        }
      }
      if (struct.isSetSkillLevel()) {
      ...
      if (struct.isSetAttackerGoals()) {
        {
          ...
          for (TDDIAttackerGoal _iter3005 : struct.AttackerGoals)
          {
            _iter3005.write(oprot);
          }
        }
      }
      if (struct.isSetPayloads()) {
        {
          ...
          for (TDDIPayloadRef _iter3006 : struct.Payloads)
          {
            _iter3006.write(oprot);
          }
        }
      }
    }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list3007.size);
          TDDIKeyValueMap _elem3008;
          for (int _i3009 = 0; _i3009 < _list3007.size; ++_i3009)
          {
            _elem3008 = new TDDIKeyValueMap();
            _elem3008.read(iprot);
            struct.KeyValueMaps.add(_elem3008);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.AttackerGoals = new java.util.ArrayList<TDDIAttackerGoal>(_list3010.size);
          TDDIAttackerGoal _elem3011;
          for (int _i3012 = 0; _i3012 < _list3010.size; ++_i3012)
          {
            _elem3011 = new TDDIAttackerGoal();
            _elem3011.read(iprot);
            struct.AttackerGoals.add(_elem3011);
          }
        }
        struct.setAttackerGoalsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.Payloads = new java.util.ArrayList<TDDIPayloadRef>(_list3013.size);
          TDDIPayloadRef _elem3014;
          for (int _i3015 = 0; _i3015 < _list3013.size; ++_i3015)
          {
            _elem3014 = new TDDIPayloadRef();
            _elem3014.read(iprot);
            struct.Payloads.add(_elem3014);
          }
        }
        struct.setPayloadsIsSet(true);
      }
