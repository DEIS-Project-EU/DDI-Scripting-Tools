...
public class TDDITerminologyPackage implements org.apache.thrift.TBase<TDDITerminologyPackage, TDDITerminologyPackage._Fields>, java.io.Serializable, Cloneable, Comparable<TDDITerminologyPackage> {
        ...
        switch (schemeField.id) {
          ...
          case 8: // IMPLEMENTATION_CONSTRAINT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2544 = iprot.readListBegin();
                struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2544.size);
                TDDIImplementationConstraintRef _elem2545;
                for (int _i2546 = 0; _i2546 < _list2544.size; ++_i2546)
                {
                  _elem2545 = new TDDIImplementationConstraintRef();
                  _elem2545.read(iprot);
                  struct.ImplementationConstraint.add(_elem2545);
                }
                iprot.readListEnd();
              }
          ...
          case 9: // NOTE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2547 = iprot.readListBegin();
                struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2547.size);
                TDDINoteRef _elem2548;
                for (int _i2549 = 0; _i2549 < _list2547.size; ++_i2549)
                {
                  _elem2548 = new TDDINoteRef();
                  _elem2548.read(iprot);
                  struct.Note.add(_elem2548);
                }
                iprot.readListEnd();
              }
          ...
          case 10: // TAGGED_VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2550 = iprot.readListBegin();
                struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2550.size);
                TDDITaggedValueRef _elem2551;
                for (int _i2552 = 0; _i2552 < _list2550.size; ++_i2552)
                {
                  _elem2551 = new TDDITaggedValueRef();
                  _elem2551.read(iprot);
                  struct.TaggedValue.add(_elem2551);
                }
                iprot.readListEnd();
              }
          ...
          case 11: // TERMINOLOGY_ELEMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2553 = iprot.readListBegin();
                struct.TerminologyElement = new java.util.ArrayList<TDDIAbstractTerminologyElement>(_list2553.size);
                TDDIAbstractTerminologyElement _elem2554;
                for (int _i2555 = 0; _i2555 < _list2553.size; ++_i2555)
                {
                  _elem2554 = new TDDIAbstractTerminologyElement();
                  _elem2554.read(iprot);
                  struct.TerminologyElement.add(_elem2554);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDITerminologyPackage struct) throws org.apache.thrift.TException {
      ...
      if (struct.ImplementationConstraint != null) {
        oprot.writeFieldBegin(IMPLEMENTATION_CONSTRAINT_FIELD_DESC);
        {
          ...
          for (TDDIImplementationConstraintRef _iter2556 : struct.ImplementationConstraint)
          {
            _iter2556.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Note != null) {
        oprot.writeFieldBegin(NOTE_FIELD_DESC);
        {
          ...
          for (TDDINoteRef _iter2557 : struct.Note)
          {
            _iter2557.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TaggedValue != null) {
        oprot.writeFieldBegin(TAGGED_VALUE_FIELD_DESC);
        {
          ...
          for (TDDITaggedValueRef _iter2558 : struct.TaggedValue)
          {
            _iter2558.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.TerminologyElement != null) {
        oprot.writeFieldBegin(TERMINOLOGY_ELEMENT_FIELD_DESC);
        {
          ...
          for (TDDIAbstractTerminologyElement _iter2559 : struct.TerminologyElement)
          {
            _iter2559.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDITerminologyPackageTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDITerminologyPackage> {
      ...
      if (struct.isSetImplementationConstraint()) {
        {
          ...
          for (TDDIImplementationConstraintRef _iter2560 : struct.ImplementationConstraint)
          {
            _iter2560.write(oprot);
          }
        }
      }
      if (struct.isSetNote()) {
        {
          ...
          for (TDDINoteRef _iter2561 : struct.Note)
          {
      ...
      if (struct.isSetTaggedValue()) {
        {
          ...
          for (TDDITaggedValueRef _iter2562 : struct.TaggedValue)
          {
      ...
      if (struct.isSetTerminologyElement()) {
        {
          ...
          for (TDDIAbstractTerminologyElement _iter2563 : struct.TerminologyElement)
          {
            _iter2563.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDITerminologyPackage struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list2564 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.ImplementationConstraint = new java.util.ArrayList<TDDIImplementationConstraintRef>(_list2564.size);
          TDDIImplementationConstraintRef _elem2565;
          for (int _i2566 = 0; _i2566 < _list2564.size; ++_i2566)
          {
            _elem2565 = new TDDIImplementationConstraintRef();
            _elem2565.read(iprot);
            struct.ImplementationConstraint.add(_elem2565);
          }
        }
        struct.setImplementationConstraintIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list2567 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Note = new java.util.ArrayList<TDDINoteRef>(_list2567.size);
          TDDINoteRef _elem2568;
          for (int _i2569 = 0; _i2569 < _list2567.size; ++_i2569)
          {
            _elem2568 = new TDDINoteRef();
            _elem2568.read(iprot);
            struct.Note.add(_elem2568);
          }
        }
        struct.setNoteIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list2570 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TaggedValue = new java.util.ArrayList<TDDITaggedValueRef>(_list2570.size);
          TDDITaggedValueRef _elem2571;
          for (int _i2572 = 0; _i2572 < _list2570.size; ++_i2572)
          {
            _elem2571 = new TDDITaggedValueRef();
            _elem2571.read(iprot);
            struct.TaggedValue.add(_elem2571);
          }
        }
        struct.setTaggedValueIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TList _list2573 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.TerminologyElement = new java.util.ArrayList<TDDIAbstractTerminologyElement>(_list2573.size);
          TDDIAbstractTerminologyElement _elem2574;
          for (int _i2575 = 0; _i2575 < _list2573.size; ++_i2575)
          {
            _elem2574 = new TDDIAbstractTerminologyElement();
            _elem2574.read(iprot);
            struct.TerminologyElement.add(_elem2574);
          }
        }
        struct.setTerminologyElementIsSet(true);
      }
