...
public class TDDIVulnerableItem implements org.apache.thrift.TBase<TDDIVulnerableItem, TDDIVulnerableItem._Fields>, java.io.Serializable, Cloneable, Comparable<TDDIVulnerableItem> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 9: // VULNERABILITIES
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list2787 = iprot.readListBegin();
                struct.Vulnerabilities = new java.util.ArrayList<TDDIVulnerability>(_list2787.size);
                TDDIVulnerability _elem2788;
                for (int _i2789 = 0; _i2789 < _list2787.size; ++_i2789)
                {
                  _elem2788 = new TDDIVulnerability();
                  _elem2788.read(iprot);
                  struct.Vulnerabilities.add(_elem2788);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDIVulnerableItem struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter2790 : struct.KeyValueMaps)
          {
            _iter2790.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.Vulnerabilities != null) {
        oprot.writeFieldBegin(VULNERABILITIES_FIELD_DESC);
        {
          ...
          for (TDDIVulnerability _iter2791 : struct.Vulnerabilities)
          {
            _iter2791.write(oprot);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TDDIVulnerableItemTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDIVulnerableItem> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter2792 : struct.KeyValueMaps)
          {
            _iter2792.write(oprot);
          }
        }
      }
      if (struct.isSetFinancialValue()) {
      ...
      if (struct.isSetVulnerabilities()) {
        {
          ...
          for (TDDIVulnerability _iter2793 : struct.Vulnerabilities)
          {
            _iter2793.write(oprot);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDIVulnerableItem struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list2794 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list2794.size);
          TDDIKeyValueMap _elem2795;
          for (int _i2796 = 0; _i2796 < _list2794.size; ++_i2796)
          {
            _elem2795 = new TDDIKeyValueMap();
            _elem2795.read(iprot);
            struct.KeyValueMaps.add(_elem2795);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.Vulnerabilities = new java.util.ArrayList<TDDIVulnerability>(_list2797.size);
          TDDIVulnerability _elem2798;
          for (int _i2799 = 0; _i2799 < _list2797.size; ++_i2799)
          {
            _elem2798 = new TDDIVulnerability();
            _elem2798.read(iprot);
            struct.Vulnerabilities.add(_elem2798);
          }
        }
        struct.setVulnerabilitiesIsSet(true);
      }
