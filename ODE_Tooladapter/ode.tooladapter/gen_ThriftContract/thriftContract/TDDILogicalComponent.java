...
public class TDDILogicalComponent implements org.apache.thrift.TBase<TDDILogicalComponent, TDDILogicalComponent._Fields>, java.io.Serializable, Cloneable, Comparable<TDDILogicalComponent> {
  ...
  public TDDILogicalComponent setKeyValueMaps(java.util.List<TDDIKeyValueMap> KeyValueMaps) {
    this.KeyValueMaps = KeyValueMaps;
    return this;
  }
  ...
  public TDDILogicalComponent setPorts(java.util.List<TDDIPort> Ports) {
    this.Ports = Ports;
    return this;
  }
  ...
  public TDDILogicalComponent setSignals(java.util.List<TDDISignal> Signals) {
    this.Signals = Signals;
    return this;
  }
  ...
  public TDDILogicalComponent setAsAsset(TDDIAbstractAsset AsAsset) {
    this.AsAsset = AsAsset;
    return this;
  }
  ...
  public TDDILogicalComponent setFailureModels(java.util.List<TDDIAbstractFailureModelRef> FailureModels) {
    this.FailureModels = FailureModels;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list392.size);
                TDDIKeyValueMap _elem393;
                for (int _i394 = 0; _i394 < _list392.size; ++_i394)
                {
                  _elem393 = new TDDIKeyValueMap();
                  _elem393.read(iprot);
                  struct.KeyValueMaps.add(_elem393);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Contexts = new java.util.ArrayList<TDDIContext>(_list395.size);
                TDDIContext _elem396;
                for (int _i397 = 0; _i397 < _list395.size; ++_i397)
                {
                  _elem396 = new TDDIContext();
                  _elem396.read(iprot);
                  struct.Contexts.add(_elem396);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Configurations = new java.util.ArrayList<TDDIConfiguration>(_list398.size);
                TDDIConfiguration _elem399;
                for (int _i400 = 0; _i400 < _list398.size; ++_i400)
                {
                  _elem399 = new TDDIConfiguration();
                  _elem399.read(iprot);
                  struct.Configurations.add(_elem399);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Ports = new java.util.ArrayList<TDDIPort>(_list401.size);
                TDDIPort _elem402;
                for (int _i403 = 0; _i403 < _list401.size; ++_i403)
                {
                  _elem402 = new TDDIPort();
                  _elem402.read(iprot);
                  struct.Ports.add(_elem402);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.Signals = new java.util.ArrayList<TDDISignal>(_list404.size);
                TDDISignal _elem405;
                for (int _i406 = 0; _i406 < _list404.size; ++_i406)
                {
                  _elem405 = new TDDISignal();
                  _elem405.read(iprot);
                  struct.Signals.add(_elem405);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.SystemBoundaries = new java.util.ArrayList<TDDISystemBoundary>(_list407.size);
                TDDISystemBoundary _elem408;
                for (int _i409 = 0; _i409 < _list407.size; ++_i409)
                {
                  _elem408 = new TDDISystemBoundary();
                  _elem408.read(iprot);
                  struct.SystemBoundaries.add(_elem408);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.AppliedStandards = new java.util.ArrayList<TDDIAbstractStandardRef>(_list410.size);
                TDDIAbstractStandardRef _elem411;
                for (int _i412 = 0; _i412 < _list410.size; ++_i412)
                {
                  _elem411 = new TDDIAbstractStandardRef();
                  _elem411.read(iprot);
                  struct.AppliedStandards.add(_elem411);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.RealisedFunctions = new java.util.ArrayList<TDDIAbstractFunctionRef>(_list413.size);
                TDDIAbstractFunctionRef _elem414;
                for (int _i415 = 0; _i415 < _list413.size; ++_i415)
                {
                  _elem414 = new TDDIAbstractFunctionRef();
                  _elem414.read(iprot);
                  struct.RealisedFunctions.add(_elem414);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list416.size);
                TDDIAbstractDependabilityRequirementRef _elem417;
                for (int _i418 = 0; _i418 < _list416.size; ++_i418)
                {
                  _elem417 = new TDDIAbstractDependabilityRequirementRef();
                  _elem417.read(iprot);
                  struct.DependabilityRequirements.add(_elem417);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.FailureModels = new java.util.ArrayList<TDDIAbstractFailureModelRef>(_list419.size);
                TDDIAbstractFailureModelRef _elem420;
                for (int _i421 = 0; _i421 < _list419.size; ++_i421)
                {
                  _elem420 = new TDDIAbstractFailureModelRef();
                  _elem420.read(iprot);
                  struct.FailureModels.add(_elem420);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.SubSystems = new java.util.ArrayList<TDDIAbstractSystemRef>(_list422.size);
                TDDIAbstractSystemRef _elem423;
                for (int _i424 = 0; _i424 < _list422.size; ++_i424)
                {
                  _elem423 = new TDDIAbstractSystemRef();
                  _elem423.read(iprot);
                  struct.SubSystems.add(_elem423);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDDILogicalComponent struct) throws org.apache.thrift.TException {
      ...
      if (struct.KeyValueMaps != null) {
        oprot.writeFieldBegin(KEY_VALUE_MAPS_FIELD_DESC);
        {
          ...
          for (TDDIKeyValueMap _iter425 : struct.KeyValueMaps)
          {
      ...
      if (struct.Contexts != null) {
        oprot.writeFieldBegin(CONTEXTS_FIELD_DESC);
        {
          ...
          for (TDDIContext _iter426 : struct.Contexts)
          {
      ...
      if (struct.Configurations != null) {
        oprot.writeFieldBegin(CONFIGURATIONS_FIELD_DESC);
        {
          ...
          for (TDDIConfiguration _iter427 : struct.Configurations)
          {
      ...
      if (struct.Ports != null) {
        oprot.writeFieldBegin(PORTS_FIELD_DESC);
        {
          ...
          for (TDDIPort _iter428 : struct.Ports)
          {
      ...
      if (struct.Signals != null) {
        oprot.writeFieldBegin(SIGNALS_FIELD_DESC);
        {
          ...
          for (TDDISignal _iter429 : struct.Signals)
          {
      ...
      if (struct.SystemBoundaries != null) {
        oprot.writeFieldBegin(SYSTEM_BOUNDARIES_FIELD_DESC);
        {
          ...
          for (TDDISystemBoundary _iter430 : struct.SystemBoundaries)
          {
      ...
      if (struct.AppliedStandards != null) {
        oprot.writeFieldBegin(APPLIED_STANDARDS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractStandardRef _iter431 : struct.AppliedStandards)
          {
      ...
      if (struct.RealisedFunctions != null) {
        oprot.writeFieldBegin(REALISED_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFunctionRef _iter432 : struct.RealisedFunctions)
          {
      ...
      if (struct.DependabilityRequirements != null) {
        oprot.writeFieldBegin(DEPENDABILITY_REQUIREMENTS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter433 : struct.DependabilityRequirements)
          {
      ...
      if (struct.FailureModels != null) {
        oprot.writeFieldBegin(FAILURE_MODELS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractFailureModelRef _iter434 : struct.FailureModels)
          {
      ...
      if (struct.SubSystems != null) {
        oprot.writeFieldBegin(SUB_SYSTEMS_FIELD_DESC);
        {
          ...
          for (TDDIAbstractSystemRef _iter435 : struct.SubSystems)
          {
  ...
  private static class TDDILogicalComponentTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDDILogicalComponent> {
      ...
      if (struct.isSetKeyValueMaps()) {
        {
          ...
          for (TDDIKeyValueMap _iter436 : struct.KeyValueMaps)
          {
      ...
      if (struct.isSetContexts()) {
        {
          ...
          for (TDDIContext _iter437 : struct.Contexts)
          {
      ...
      if (struct.isSetConfigurations()) {
        {
          ...
          for (TDDIConfiguration _iter438 : struct.Configurations)
          {
      ...
      if (struct.isSetPorts()) {
        {
          ...
          for (TDDIPort _iter439 : struct.Ports)
          {
      ...
      if (struct.isSetSignals()) {
        {
          ...
          for (TDDISignal _iter440 : struct.Signals)
          {
      ...
      if (struct.isSetSystemBoundaries()) {
        {
          ...
          for (TDDISystemBoundary _iter441 : struct.SystemBoundaries)
          {
      ...
      if (struct.isSetAppliedStandards()) {
        {
          ...
          for (TDDIAbstractStandardRef _iter442 : struct.AppliedStandards)
          {
      ...
      if (struct.isSetRealisedFunctions()) {
        {
          ...
          for (TDDIAbstractFunctionRef _iter443 : struct.RealisedFunctions)
          {
      ...
      if (struct.isSetDependabilityRequirements()) {
        {
          ...
          for (TDDIAbstractDependabilityRequirementRef _iter444 : struct.DependabilityRequirements)
          {
      ...
      if (struct.isSetFailureModels()) {
        {
          ...
          for (TDDIAbstractFailureModelRef _iter445 : struct.FailureModels)
          {
      ...
      if (struct.isSetSubSystems()) {
        {
          ...
          for (TDDIAbstractSystemRef _iter446 : struct.SubSystems)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDDILogicalComponent struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.KeyValueMaps = new java.util.ArrayList<TDDIKeyValueMap>(_list447.size);
          TDDIKeyValueMap _elem448;
          for (int _i449 = 0; _i449 < _list447.size; ++_i449)
          {
            _elem448 = new TDDIKeyValueMap();
            _elem448.read(iprot);
            struct.KeyValueMaps.add(_elem448);
          }
        }
        struct.setKeyValueMapsIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list450 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Contexts = new java.util.ArrayList<TDDIContext>(_list450.size);
          TDDIContext _elem451;
          for (int _i452 = 0; _i452 < _list450.size; ++_i452)
          {
            _elem451 = new TDDIContext();
            _elem451.read(iprot);
            struct.Contexts.add(_elem451);
          }
        }
        struct.setContextsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.Configurations = new java.util.ArrayList<TDDIConfiguration>(_list453.size);
          TDDIConfiguration _elem454;
          for (int _i455 = 0; _i455 < _list453.size; ++_i455)
          {
            _elem454 = new TDDIConfiguration();
            _elem454.read(iprot);
            struct.Configurations.add(_elem454);
          }
        }
        struct.setConfigurationsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TList _list456 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.Ports = new java.util.ArrayList<TDDIPort>(_list456.size);
          TDDIPort _elem457;
          for (int _i458 = 0; _i458 < _list456.size; ++_i458)
          {
            _elem457 = new TDDIPort();
            _elem457.read(iprot);
            struct.Ports.add(_elem457);
          }
        }
        struct.setPortsIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.Signals = new java.util.ArrayList<TDDISignal>(_list459.size);
          TDDISignal _elem460;
          for (int _i461 = 0; _i461 < _list459.size; ++_i461)
          {
            _elem460 = new TDDISignal();
            _elem460.read(iprot);
            struct.Signals.add(_elem460);
          }
        }
        struct.setSignalsIsSet(true);
      }
      if (incoming.get(10)) {
        {
          ...
          struct.SystemBoundaries = new java.util.ArrayList<TDDISystemBoundary>(_list462.size);
          TDDISystemBoundary _elem463;
          for (int _i464 = 0; _i464 < _list462.size; ++_i464)
          {
            _elem463 = new TDDISystemBoundary();
            _elem463.read(iprot);
            struct.SystemBoundaries.add(_elem463);
          }
        }
        struct.setSystemBoundariesIsSet(true);
      }
      if (incoming.get(11)) {
        {
          ...
          struct.AppliedStandards = new java.util.ArrayList<TDDIAbstractStandardRef>(_list465.size);
          TDDIAbstractStandardRef _elem466;
          for (int _i467 = 0; _i467 < _list465.size; ++_i467)
          {
            _elem466 = new TDDIAbstractStandardRef();
            _elem466.read(iprot);
            struct.AppliedStandards.add(_elem466);
          }
        }
        struct.setAppliedStandardsIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.RealisedFunctions = new java.util.ArrayList<TDDIAbstractFunctionRef>(_list468.size);
          TDDIAbstractFunctionRef _elem469;
          for (int _i470 = 0; _i470 < _list468.size; ++_i470)
          {
            _elem469 = new TDDIAbstractFunctionRef();
            _elem469.read(iprot);
            struct.RealisedFunctions.add(_elem469);
          }
        }
        struct.setRealisedFunctionsIsSet(true);
      }
      ...
      if (incoming.get(14)) {
        {
          ...
          struct.DependabilityRequirements = new java.util.ArrayList<TDDIAbstractDependabilityRequirementRef>(_list471.size);
          TDDIAbstractDependabilityRequirementRef _elem472;
          for (int _i473 = 0; _i473 < _list471.size; ++_i473)
          {
            _elem472 = new TDDIAbstractDependabilityRequirementRef();
            _elem472.read(iprot);
            struct.DependabilityRequirements.add(_elem472);
          }
        }
        struct.setDependabilityRequirementsIsSet(true);
      }
      ...
      if (incoming.get(16)) {
        {
          org.apache.thrift.protocol.TList _list474 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.FailureModels = new java.util.ArrayList<TDDIAbstractFailureModelRef>(_list474.size);
          TDDIAbstractFailureModelRef _elem475;
          for (int _i476 = 0; _i476 < _list474.size; ++_i476)
          {
            _elem475 = new TDDIAbstractFailureModelRef();
            _elem475.read(iprot);
            struct.FailureModels.add(_elem475);
          }
        }
        struct.setFailureModelsIsSet(true);
      }
      if (incoming.get(17)) {
        {
          ...
          struct.SubSystems = new java.util.ArrayList<TDDIAbstractSystemRef>(_list477.size);
          TDDIAbstractSystemRef _elem478;
          for (int _i479 = 0; _i479 < _list477.size; ++_i479)
          {
            _elem478 = new TDDIAbstractSystemRef();
            _elem478.read(iprot);
            struct.SubSystems.add(_elem478);
          }
        }
        struct.setSubSystemsIsSet(true);
      }
